...
export function dataAzurermRedisEnterpriseDatabaseTimeoutsToTerraform(struct?: DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference | DataAzurermRedisEnterpriseDatabaseTimeouts): any {
...
export class DataAzurermRedisEnterpriseDatabase extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermRedisEnterpriseDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
