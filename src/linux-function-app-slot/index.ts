...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.13.0/docs/resources/linux_function_app_slot
...
export class LinuxFunctionAppSlot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinuxFunctionAppSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.13.0/docs/resources/linux_function_app_slot#import import section} in the documentation of this resource for the id to use
