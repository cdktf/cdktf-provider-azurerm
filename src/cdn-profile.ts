...
export function cdnProfileTimeoutsToTerraform(struct?: CdnProfileTimeoutsOutputReference | CdnProfileTimeouts): any {
...
export class CdnProfileTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CdnProfileTimeouts | undefined {
  ...
  public set internalValue(value: CdnProfileTimeouts | undefined) {
    if (value === undefined) {
...
export class CdnProfile extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new CdnProfileTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
