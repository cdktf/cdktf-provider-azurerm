...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/sql_database
...
export class SqlDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/sql_database#import import section} in the documentation of this resource for the id to use
