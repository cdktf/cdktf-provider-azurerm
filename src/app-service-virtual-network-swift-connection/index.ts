// https://registry.terraform.io/providers/hashicorp/azurerm/4.17.0/docs/resources/app_service_virtual_network_swift_connection
...
export class AppServiceVirtualNetworkSwiftConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppServiceVirtualNetworkSwiftConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.17.0/docs/resources/app_service_virtual_network_swift_connection#import import section} in the documentation of this resource for the id to use
