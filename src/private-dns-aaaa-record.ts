...
export interface PrivateDnsAaaaRecordConfig extends TerraformMetaArguments {
...
export class PrivateDnsAaaaRecord extends TerraformResource {
  ...
  public set timeouts(value: PrivateDnsAaaaRecordTimeouts | undefined) {
