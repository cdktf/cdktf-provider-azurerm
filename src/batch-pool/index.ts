...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/batch_pool
...
export interface BatchPoolConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly securityProfile?: BatchPoolSecurityProfile;
  /**
  * start_task block
  *
...
export interface BatchPoolSecurityProfile {
  /**
...
export function batchPoolSecurityProfileToTerraform(struct?: BatchPoolSecurityProfileOutputReference | BatchPoolSecurityProfile): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function batchPoolSecurityProfileToHclTerraform(struct?: BatchPoolSecurityProfileOutputReference | BatchPoolSecurityProfile): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class BatchPoolSecurityProfileOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): BatchPoolSecurityProfile | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: BatchPoolSecurityProfile | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class BatchPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BatchPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/batch_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/batch_pool azurerm_batch_pool} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _securityProfile = new BatchPoolSecurityProfileOutputReference(this, "security_profile");
  public get securityProfile() {
    return this._securityProfile;
  }
  public putSecurityProfile(value: BatchPoolSecurityProfile) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      security_profile: batchPoolSecurityProfileToTerraform(this._securityProfile.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      security_profile: {
        value: batchPoolSecurityProfileToHclTerraform(this._securityProfile.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "BatchPoolSecurityProfileList",
      },
      start_task: {
