...
export function iothubEndpointEventhubTimeoutsToTerraform(struct?: IothubEndpointEventhubTimeoutsOutputReference | IothubEndpointEventhubTimeouts | cdktf.IResolvable): any {
...
export class IothubEndpointEventhubTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IothubEndpointEventhubTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IothubEndpointEventhubTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class IothubEndpointEventhub extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_iothub_endpoint_eventhub";
  ...
  */
  ...
  private _timeouts = new IothubEndpointEventhubTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
