...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/healthcare_dicom_service
...
export class HealthcareDicomService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareDicomService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/healthcare_dicom_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/healthcare_dicom_service azurerm_healthcare_dicom_service} Resource
  *
  * @param scope The scope in which to define this construct
