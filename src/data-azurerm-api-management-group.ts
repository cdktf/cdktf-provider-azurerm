...
export function dataAzurermApiManagementGroupTimeoutsToTerraform(struct?: DataAzurermApiManagementGroupTimeoutsOutputReference | DataAzurermApiManagementGroupTimeouts): any {
...
export class DataAzurermApiManagementGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApiManagementGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
