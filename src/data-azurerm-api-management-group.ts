// https://www.terraform.io/docs/providers/azurerm/d/api_management_group
...
export function dataAzurermApiManagementGroupTimeoutsToTerraform(struct?: DataAzurermApiManagementGroupTimeoutsOutputReference | DataAzurermApiManagementGroupTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermApiManagementGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermApiManagementGroupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermApiManagementGroupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermApiManagementGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApiManagementGroupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermApiManagementGroupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermApiManagementGroupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
