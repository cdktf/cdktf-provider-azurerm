...
export class DataAzurermApiManagementGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermApiManagementGroupTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermApiManagementGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermApiManagementGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApiManagementGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
