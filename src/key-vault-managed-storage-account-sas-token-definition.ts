...
export function keyVaultManagedStorageAccountSasTokenDefinitionTimeoutsToTerraform(struct?: KeyVaultManagedStorageAccountSasTokenDefinitionTimeoutsOutputReference | KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts): any {
...
export class KeyVaultManagedStorageAccountSasTokenDefinitionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts | undefined {
  ...
  public set internalValue(value: KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts | undefined) {
    if (value === undefined) {
...
export class KeyVaultManagedStorageAccountSasTokenDefinition extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new KeyVaultManagedStorageAccountSasTokenDefinitionTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
