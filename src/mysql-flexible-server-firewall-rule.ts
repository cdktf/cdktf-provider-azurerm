// https://www.terraform.io/docs/providers/azurerm/r/mysql_flexible_server_firewall_rule.html
...
function mysqlFlexibleServerFirewallRuleTimeoutsToTerraform(struct?: MysqlFlexibleServerFirewallRuleTimeoutsOutputReference | MysqlFlexibleServerFirewallRuleTimeouts): any {
...
export class MysqlFlexibleServerFirewallRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_mysql_flexible_server_firewall_rule";
  ...
  */
  ...
  private _timeouts?: MysqlFlexibleServerFirewallRuleTimeouts | undefined; 
  private __timeoutsOutput = new MysqlFlexibleServerFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: MysqlFlexibleServerFirewallRuleTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: mysqlFlexibleServerFirewallRuleTimeoutsToTerraform(this._timeouts),
    };
  }
}
