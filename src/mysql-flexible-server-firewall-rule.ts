...
export function mysqlFlexibleServerFirewallRuleTimeoutsToTerraform(struct?: MysqlFlexibleServerFirewallRuleTimeoutsOutputReference | MysqlFlexibleServerFirewallRuleTimeouts): any {
...
export class MysqlFlexibleServerFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlFlexibleServerFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: MysqlFlexibleServerFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MysqlFlexibleServerFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlFlexibleServerFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
