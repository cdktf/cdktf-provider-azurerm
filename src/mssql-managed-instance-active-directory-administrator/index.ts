// https://registry.terraform.io/providers/hashicorp/azurerm/3.83.0/docs/resources/mssql_managed_instance_active_directory_administrator
...
export class MssqlManagedInstanceActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlManagedInstanceActiveDirectoryAdministrator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.83.0/docs/resources/mssql_managed_instance_active_directory_administrator#import import section} in the documentation of this resource for the id to use
