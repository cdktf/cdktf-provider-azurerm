...
export function redisFirewallRuleTimeoutsToTerraform(struct?: RedisFirewallRuleTimeoutsOutputReference | RedisFirewallRuleTimeouts | cdktf.IResolvable): any {
...
export class RedisFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RedisFirewallRuleTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
