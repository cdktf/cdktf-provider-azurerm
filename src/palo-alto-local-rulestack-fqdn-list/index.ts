// https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/palo_alto_local_rulestack_fqdn_list
...
export class PaloAltoLocalRulestackFqdnList extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PaloAltoLocalRulestackFqdnList that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/palo_alto_local_rulestack_fqdn_list#import import section} in the documentation of this resource for the id to use
