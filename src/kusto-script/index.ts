...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/kusto_script
...
export class KustoScript extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KustoScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/kusto_script#import import section} in the documentation of this resource for the id to use
