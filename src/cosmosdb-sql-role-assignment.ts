...
export class CosmosdbSqlRoleAssignmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CosmosdbSqlRoleAssignmentTimeouts | undefined {
  ...
  public set internalValue(value: CosmosdbSqlRoleAssignmentTimeouts | undefined) {
    if (value === undefined) {
...
export class CosmosdbSqlRoleAssignment extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_cosmosdb_sql_role_assignment";
  ...
  */
  ...
  private _timeouts = new CosmosdbSqlRoleAssignmentTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
