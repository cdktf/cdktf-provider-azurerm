...
export function dataAzurermSshPublicKeyTimeoutsToTerraform(struct?: DataAzurermSshPublicKeyTimeoutsOutputReference | DataAzurermSshPublicKeyTimeouts): any {
...
export class DataAzurermSshPublicKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermSshPublicKeyTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermSshPublicKeyTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermSshPublicKey extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSshPublicKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
