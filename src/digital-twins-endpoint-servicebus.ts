...
export function digitalTwinsEndpointServicebusTimeoutsToTerraform(struct?: DigitalTwinsEndpointServicebusTimeoutsOutputReference | DigitalTwinsEndpointServicebusTimeouts): any {
...
export class DigitalTwinsEndpointServicebus extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DigitalTwinsEndpointServicebusTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
