// https://www.terraform.io/docs/providers/azurerm/r/automation_connection
...
export class AutomationConnectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutomationConnectionTimeouts | undefined {
  ...
  public set internalValue(value: AutomationConnectionTimeouts | undefined) {
    if (value === undefined) {
