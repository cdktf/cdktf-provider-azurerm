...
export function automationDscConfigurationTimeoutsToTerraform(struct?: AutomationDscConfigurationTimeoutsOutputReference | AutomationDscConfigurationTimeouts | cdktf.IResolvable): any {
...
export class AutomationDscConfigurationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutomationDscConfigurationTimeouts | undefined {
  ...
  public set internalValue(value: AutomationDscConfigurationTimeouts | undefined) {
    if (value === undefined) {
...
export class AutomationDscConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AutomationDscConfigurationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
