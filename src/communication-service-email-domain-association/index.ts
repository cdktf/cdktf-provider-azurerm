// https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/resources/communication_service_email_domain_association
...
export class CommunicationServiceEmailDomainAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CommunicationServiceEmailDomainAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/resources/communication_service_email_domain_association#import import section} in the documentation of this resource for the id to use
