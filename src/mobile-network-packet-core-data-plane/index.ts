...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/mobile_network_packet_core_data_plane
...
export class MobileNetworkPacketCoreDataPlane extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MobileNetworkPacketCoreDataPlane that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/mobile_network_packet_core_data_plane#import import section} in the documentation of this resource for the id to use
