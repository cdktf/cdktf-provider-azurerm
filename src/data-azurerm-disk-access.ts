...
export function dataAzurermDiskAccessTimeoutsToTerraform(struct?: DataAzurermDiskAccessTimeoutsOutputReference | DataAzurermDiskAccessTimeouts): any {
...
export class DataAzurermDiskAccessTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDiskAccessTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDiskAccessTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDiskAccess extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDiskAccessTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
