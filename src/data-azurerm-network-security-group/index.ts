// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/data-sources/network_security_group
...
export class DataAzurermNetworkSecurityGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetworkSecurityGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/data-sources/network_security_group#import import section} in the documentation of this resource for the id to use
