// https://registry.terraform.io/providers/hashicorp/azurerm/4.6.0/docs/resources/maps_creator
...
export class MapsCreator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MapsCreator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.6.0/docs/resources/maps_creator#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.6.0/docs/resources/maps_creator azurerm_maps_creator} Resource
  *
  * @param scope The scope in which to define this construct
