...
export function loadTestTimeoutsToTerraform(struct?: LoadTestTimeoutsOutputReference | LoadTestTimeouts): any {
...
export class LoadTestTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LoadTestTimeouts | undefined {
  ...
  public set internalValue(value: LoadTestTimeouts | undefined) {
    if (value === undefined) {
...
export class LoadTest extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_load_test";
  ...
  */
  ...
  private _timeouts = new LoadTestTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
