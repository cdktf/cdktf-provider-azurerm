...
export function dataAzurermManagedDiskTimeoutsToTerraform(struct?: DataAzurermManagedDiskTimeoutsOutputReference | DataAzurermManagedDiskTimeouts): any {
...
export class DataAzurermManagedDisk extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermManagedDiskTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
