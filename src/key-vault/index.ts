...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/key_vault
...
export interface KeyVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly rbacAuthorizationEnabled?: boolean | cdktf.IResolvable;
  /**
...
export class KeyVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/key_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/key_vault azurerm_key_vault} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _rbacAuthorizationEnabled?: boolean | cdktf.IResolvable; 
  public get rbacAuthorizationEnabled() {
    return this.getBooleanAttribute('rbac_authorization_enabled');
  }
  public set rbacAuthorizationEnabled(value: boolean | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rbac_authorization_enabled: cdktf.booleanToTerraform(this._rbacAuthorizationEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rbac_authorization_enabled: {
        value: cdktf.booleanToHclTerraform(this._rbacAuthorizationEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
