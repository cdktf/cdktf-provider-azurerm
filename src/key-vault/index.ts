// https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/key_vault
...
export class KeyVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/key_vault#import import section} in the documentation of this resource for the id to use
