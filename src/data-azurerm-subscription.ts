...
export function dataAzurermSubscriptionTimeoutsToTerraform(struct?: DataAzurermSubscriptionTimeoutsOutputReference | DataAzurermSubscriptionTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermSubscription extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSubscriptionTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
