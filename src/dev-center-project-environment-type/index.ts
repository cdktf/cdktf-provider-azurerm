// https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/dev_center_project_environment_type
...
export class DevCenterProjectEnvironmentType extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevCenterProjectEnvironmentType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/dev_center_project_environment_type#import import section} in the documentation of this resource for the id to use
