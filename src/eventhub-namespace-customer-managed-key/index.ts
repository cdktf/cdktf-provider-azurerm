...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.88.0/docs/resources/eventhub_namespace_customer_managed_key
...
export class EventhubNamespaceCustomerManagedKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventhubNamespaceCustomerManagedKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.88.0/docs/resources/eventhub_namespace_customer_managed_key#import import section} in the documentation of this resource for the id to use
