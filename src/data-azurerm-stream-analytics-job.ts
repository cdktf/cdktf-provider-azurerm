...
export function dataAzurermStreamAnalyticsJobTimeoutsToTerraform(struct?: DataAzurermStreamAnalyticsJobTimeoutsOutputReference | DataAzurermStreamAnalyticsJobTimeouts): any {
...
export class DataAzurermStreamAnalyticsJob extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermStreamAnalyticsJobTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
