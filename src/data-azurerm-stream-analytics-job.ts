...
export function dataAzurermStreamAnalyticsJobTimeoutsToTerraform(struct?: DataAzurermStreamAnalyticsJobTimeoutsOutputReference | DataAzurermStreamAnalyticsJobTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermStreamAnalyticsJobTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermStreamAnalyticsJobTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermStreamAnalyticsJob extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public identity(index: string) {
    return new DataAzurermStreamAnalyticsJobIdentity(this, 'identity', index, false);
  }
  ...
  private _timeouts = new DataAzurermStreamAnalyticsJobTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
