...
export class DataAzurermEventhubNamespaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermEventhubNamespaceTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermEventhubNamespace extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermEventhubNamespaceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
