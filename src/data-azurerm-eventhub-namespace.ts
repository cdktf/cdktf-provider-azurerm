...
export function dataAzurermEventhubNamespaceTimeoutsToTerraform(struct?: DataAzurermEventhubNamespaceTimeoutsOutputReference | DataAzurermEventhubNamespaceTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermEventhubNamespaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermEventhubNamespaceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermEventhubNamespaceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermEventhubNamespace extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermEventhubNamespaceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermEventhubNamespaceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermEventhubNamespaceTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
