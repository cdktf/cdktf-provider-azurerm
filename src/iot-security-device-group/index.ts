...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/iot_security_device_group
...
export class IotSecurityDeviceGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotSecurityDeviceGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/iot_security_device_group#import import section} in the documentation of this resource for the id to use
