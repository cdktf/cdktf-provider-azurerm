...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/video_indexer_account
...
export class VideoIndexerAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VideoIndexerAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/video_indexer_account#import import section} in the documentation of this resource for the id to use
