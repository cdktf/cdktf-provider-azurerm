...
export function expressRouteCircuitAuthorizationTimeoutsToTerraform(struct?: ExpressRouteCircuitAuthorizationTimeoutsOutputReference | ExpressRouteCircuitAuthorizationTimeouts): any {
...
export class ExpressRouteCircuitAuthorizationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ExpressRouteCircuitAuthorizationTimeouts | undefined {
  ...
  public set internalValue(value: ExpressRouteCircuitAuthorizationTimeouts | undefined) {
    if (value === undefined) {
...
export class ExpressRouteCircuitAuthorization extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ExpressRouteCircuitAuthorizationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
