...
export interface FirewallNetworkRuleCollectionConfig extends TerraformMetaArguments {
...
export class FirewallNetworkRuleCollection extends TerraformResource {
  ...
  public set timeouts(value: FirewallNetworkRuleCollectionTimeouts | undefined) {
