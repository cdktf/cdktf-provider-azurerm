...
function firewallNetworkRuleCollectionTimeoutsToTerraform(struct?: FirewallNetworkRuleCollectionTimeoutsOutputReference | FirewallNetworkRuleCollectionTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FirewallNetworkRuleCollection extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: FirewallNetworkRuleCollectionTimeouts | undefined; 
  private __timeoutsOutput = new FirewallNetworkRuleCollectionTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: FirewallNetworkRuleCollectionTimeouts | undefined) {
