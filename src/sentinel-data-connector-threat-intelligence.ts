...
export function sentinelDataConnectorThreatIntelligenceTimeoutsToTerraform(struct?: SentinelDataConnectorThreatIntelligenceTimeoutsOutputReference | SentinelDataConnectorThreatIntelligenceTimeouts): any {
...
export class SentinelDataConnectorThreatIntelligenceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SentinelDataConnectorThreatIntelligenceTimeouts | undefined {
  ...
  public set internalValue(value: SentinelDataConnectorThreatIntelligenceTimeouts | undefined) {
    if (value === undefined) {
...
export class SentinelDataConnectorThreatIntelligence extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SentinelDataConnectorThreatIntelligenceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
