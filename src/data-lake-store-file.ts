...
export function dataLakeStoreFileTimeoutsToTerraform(struct?: DataLakeStoreFileTimeoutsOutputReference | DataLakeStoreFileTimeouts): any {
...
export class DataLakeStoreFile extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataLakeStoreFileTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
