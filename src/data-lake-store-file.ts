...
export function dataLakeStoreFileTimeoutsToTerraform(struct?: DataLakeStoreFileTimeoutsOutputReference | DataLakeStoreFileTimeouts | cdktf.IResolvable): any {
...
export class DataLakeStoreFileTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeStoreFileTimeouts | undefined {
  ...
  public set internalValue(value: DataLakeStoreFileTimeouts | undefined) {
    if (value === undefined) {
...
export class DataLakeStoreFile extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataLakeStoreFileTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
