...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.38.1/docs/resources/web_application_firewall_policy
...
export interface WebApplicationFirewallPolicyPolicySettings {
  ...
  */
  readonly fileUploadEnforcement?: boolean | cdktf.IResolvable;
  /**
...
export function webApplicationFirewallPolicyPolicySettingsToTerraform(struct?: WebApplicationFirewallPolicyPolicySettingsOutputReference | WebApplicationFirewallPolicyPolicySettings): any {
  ...
  return {
    enabled: cdktf.booleanToTerraform(struct!.enabled),
    file_upload_enforcement: cdktf.booleanToTerraform(struct!.fileUploadEnforcement),
...
export function webApplicationFirewallPolicyPolicySettingsToHclTerraform(struct?: WebApplicationFirewallPolicyPolicySettingsOutputReference | WebApplicationFirewallPolicyPolicySettings): any {
  ...
  const attrs = {
    ...
    file_upload_enforcement: {
      value: cdktf.booleanToHclTerraform(struct!.fileUploadEnforcement),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
...
export class WebApplicationFirewallPolicyPolicySettingsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WebApplicationFirewallPolicyPolicySettings | undefined {
    ...
    if (this._fileUploadEnforcement !== undefined) {
      hasAnyValues = true;
      internalValueResult.fileUploadEnforcement = this._fileUploadEnforcement;
    }
  ...
  public set internalValue(value: WebApplicationFirewallPolicyPolicySettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._enabled = undefined;
      this._fileUploadEnforcement = undefined;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this._enabled = value.enabled;
      this._fileUploadEnforcement = value.fileUploadEnforcement;
  ...
  // file_upload_enforcement - computed: true, optional: true, required: false
  private _fileUploadEnforcement?: boolean | cdktf.IResolvable; 
  public get fileUploadEnforcement() {
    return this.getBooleanAttribute('file_upload_enforcement');
  }
  public set fileUploadEnforcement(value: boolean | cdktf.IResolvable) {
    this._fileUploadEnforcement = value;
  }
  public resetFileUploadEnforcement() {
    this._fileUploadEnforcement = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get fileUploadEnforcementInput() {
    return this._fileUploadEnforcement;
  }
...
export class WebApplicationFirewallPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebApplicationFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.1/docs/resources/web_application_firewall_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.1/docs/resources/web_application_firewall_policy azurerm_web_application_firewall_policy} Resource
  *
  * @param scope The scope in which to define this construct
