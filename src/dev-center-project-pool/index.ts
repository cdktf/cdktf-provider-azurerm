...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/dev_center_project_pool
...
export class DevCenterProjectPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DevCenterProjectPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/dev_center_project_pool#import import section} in the documentation of this resource for the id to use
