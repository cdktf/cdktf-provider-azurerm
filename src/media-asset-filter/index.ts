...
export class MediaAssetFilter extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.66.0/docs/resources/media_asset_filter azurerm_media_asset_filter} Resource
  *
