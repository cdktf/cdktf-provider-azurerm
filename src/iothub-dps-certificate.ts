...
export function iothubDpsCertificateTimeoutsToTerraform(struct?: IothubDpsCertificateTimeoutsOutputReference | IothubDpsCertificateTimeouts): any {
...
export class IothubDpsCertificate extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IothubDpsCertificateTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
