...
export class DataAzurermAttestationProviderTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAttestationProviderTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermAttestationProviderTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermAttestationProvider extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAttestationProviderTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
