...
export function dataAzurermAttestationProviderTimeoutsToTerraform(struct?: DataAzurermAttestationProviderTimeoutsOutputReference | DataAzurermAttestationProviderTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermAttestationProviderTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAttestationProviderTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermAttestationProviderTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermAttestationProvider extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAttestationProviderTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermAttestationProviderTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermAttestationProviderTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
