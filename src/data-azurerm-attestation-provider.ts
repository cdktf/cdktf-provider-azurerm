...
export function dataAzurermAttestationProviderTimeoutsToTerraform(struct?: DataAzurermAttestationProviderTimeoutsOutputReference | DataAzurermAttestationProviderTimeouts): any {
...
export class DataAzurermAttestationProvider extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAttestationProviderTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
