// https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/mongo_cluster
...
export class MongoCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongoCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/mongo_cluster#import import section} in the documentation of this resource for the id to use
