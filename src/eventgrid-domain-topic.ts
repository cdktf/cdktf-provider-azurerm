// https://www.terraform.io/docs/providers/azurerm/r/eventgrid_domain_topic
...
export function eventgridDomainTopicTimeoutsToTerraform(struct?: EventgridDomainTopicTimeoutsOutputReference | EventgridDomainTopicTimeouts): any {
...
export class EventgridDomainTopicTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: EventgridDomainTopicTimeouts | undefined) {
    if (value === undefined) {
...
export class EventgridDomainTopic extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new EventgridDomainTopicTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
