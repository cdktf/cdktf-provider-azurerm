...
export function dataAzurermProximityPlacementGroupTimeoutsToTerraform(struct?: DataAzurermProximityPlacementGroupTimeoutsOutputReference | DataAzurermProximityPlacementGroupTimeouts): any {
...
export class DataAzurermProximityPlacementGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermProximityPlacementGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermProximityPlacementGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermProximityPlacementGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
