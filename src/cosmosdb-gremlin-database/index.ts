// https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/resources/cosmosdb_gremlin_database
...
export class CosmosdbGremlinDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbGremlinDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/resources/cosmosdb_gremlin_database#import import section} in the documentation of this resource for the id to use
