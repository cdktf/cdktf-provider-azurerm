...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app
...
export interface DataAzurermContainerAppConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app#id DataAzurermContainerApp#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app#name DataAzurermContainerApp#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app#resource_group_name DataAzurermContainerApp#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app#timeouts DataAzurermContainerApp#timeouts}
  */
...
export interface DataAzurermContainerAppIngressCors {
}
...
export class DataAzurermContainerAppIngressCorsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermContainerAppIngressCors | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermContainerAppIngressCors | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  // allow_credentials_enabled - computed: true, optional: false, required: false
...
export class DataAzurermContainerAppIngressCorsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataAzurermContainerAppIngressCorsOutputReference {
    return new DataAzurermContainerAppIngressCorsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermContainerAppIngressOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _cors = new DataAzurermContainerAppIngressCorsList(this, "cors", false);
  public get cors() {
    return this._cors;
  }
...
export class DataAzurermContainerAppTemplateOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // cooldown_period_in_seconds - computed: true, optional: false, required: false
  ...
  // polling_interval_in_seconds - computed: true, optional: false, required: false
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app azurerm_container_app}
*/
export class DataAzurermContainerApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermContainerApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/container_app azurerm_container_app} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // max_inactive_revisions - computed: true, optional: false, required: false
