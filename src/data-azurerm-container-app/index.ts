...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/data-sources/container_app
...
export class DataAzurermContainerApp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermContainerApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/data-sources/container_app#import import section} in the documentation of this resource for the id to use
