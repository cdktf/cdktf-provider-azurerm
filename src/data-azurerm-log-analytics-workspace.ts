...
export function dataAzurermLogAnalyticsWorkspaceTimeoutsToTerraform(struct?: DataAzurermLogAnalyticsWorkspaceTimeoutsOutputReference | DataAzurermLogAnalyticsWorkspaceTimeouts): any {
...
export class DataAzurermLogAnalyticsWorkspace extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermLogAnalyticsWorkspaceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
