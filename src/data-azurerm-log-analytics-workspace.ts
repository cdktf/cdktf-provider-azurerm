...
export function dataAzurermLogAnalyticsWorkspaceTimeoutsToTerraform(struct?: DataAzurermLogAnalyticsWorkspaceTimeoutsOutputReference | DataAzurermLogAnalyticsWorkspaceTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermLogAnalyticsWorkspaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermLogAnalyticsWorkspaceTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermLogAnalyticsWorkspaceTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermLogAnalyticsWorkspace extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermLogAnalyticsWorkspaceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
