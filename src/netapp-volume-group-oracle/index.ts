...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/netapp_volume_group_oracle
...
export class NetappVolumeGroupOracle extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappVolumeGroupOracle that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/netapp_volume_group_oracle#import import section} in the documentation of this resource for the id to use
