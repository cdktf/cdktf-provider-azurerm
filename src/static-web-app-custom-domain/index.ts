// https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/static_web_app_custom_domain
...
export class StaticWebAppCustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StaticWebAppCustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/static_web_app_custom_domain#import import section} in the documentation of this resource for the id to use
