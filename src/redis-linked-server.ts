...
export function redisLinkedServerTimeoutsToTerraform(struct?: RedisLinkedServerTimeoutsOutputReference | RedisLinkedServerTimeouts): any {
...
export class RedisLinkedServer extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RedisLinkedServerTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
