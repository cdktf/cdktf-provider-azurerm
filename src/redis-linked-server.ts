// https://www.terraform.io/docs/providers/azurerm/r/redis_linked_server
...
export function redisLinkedServerTimeoutsToTerraform(struct?: RedisLinkedServerTimeoutsOutputReference | RedisLinkedServerTimeouts | cdktf.IResolvable): any {
...
export class RedisLinkedServerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RedisLinkedServerTimeouts | undefined {
  ...
  public set internalValue(value: RedisLinkedServerTimeouts | undefined) {
    if (value === undefined) {
...
export class RedisLinkedServer extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RedisLinkedServerTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
