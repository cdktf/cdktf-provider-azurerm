// https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/security_center_storage_defender
...
export class SecurityCenterStorageDefender extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityCenterStorageDefender that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/security_center_storage_defender#import import section} in the documentation of this resource for the id to use
