...
export class BlueprintAssignment extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.66.0/docs/resources/blueprint_assignment azurerm_blueprint_assignment} Resource
  *
