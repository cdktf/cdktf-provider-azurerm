...
export function dataAzurermPostgresqlServerTimeoutsToTerraform(struct?: DataAzurermPostgresqlServerTimeoutsOutputReference | DataAzurermPostgresqlServerTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermPostgresqlServerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermPostgresqlServerTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermPostgresqlServerTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermPostgresqlServer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public identity(index: string) {
    return new DataAzurermPostgresqlServerIdentity(this, 'identity', index, false);
  }
  ...
  private _timeouts = new DataAzurermPostgresqlServerTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
