...
export function dataAzurermPostgresqlServerTimeoutsToTerraform(struct?: DataAzurermPostgresqlServerTimeoutsOutputReference | DataAzurermPostgresqlServerTimeouts): any {
...
export class DataAzurermPostgresqlServer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPostgresqlServerTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
