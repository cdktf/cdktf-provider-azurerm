...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.26.0/docs/resources/arc_kubernetes_cluster_extension
...
export class ArcKubernetesClusterExtension extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ArcKubernetesClusterExtension that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.26.0/docs/resources/arc_kubernetes_cluster_extension#import import section} in the documentation of this resource for the id to use
