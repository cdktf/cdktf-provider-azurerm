...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/resources/traffic_manager_nested_endpoint
...
export class TrafficManagerNestedEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrafficManagerNestedEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/resources/traffic_manager_nested_endpoint#import import section} in the documentation of this resource for the id to use
