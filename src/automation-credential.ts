...
export function automationCredentialTimeoutsToTerraform(struct?: AutomationCredentialTimeoutsOutputReference | AutomationCredentialTimeouts): any {
...
export class AutomationCredential extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AutomationCredentialTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
