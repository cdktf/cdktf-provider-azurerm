...
export class AutomationCredentialTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutomationCredentialTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AutomationCredentialTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AutomationCredential extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_automation_credential";
  ...
  */
  ...
  private _timeouts = new AutomationCredentialTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
