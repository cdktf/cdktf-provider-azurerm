...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/network_manager_ipam_pool
...
export class NetworkManagerIpamPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkManagerIpamPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/network_manager_ipam_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/network_manager_ipam_pool azurerm_network_manager_ipam_pool} Resource
  *
  * @param scope The scope in which to define this construct
