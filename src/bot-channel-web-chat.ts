...
export function botChannelWebChatTimeoutsToTerraform(struct?: BotChannelWebChatTimeoutsOutputReference | BotChannelWebChatTimeouts): any {
...
export class BotChannelWebChatTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BotChannelWebChatTimeouts | undefined {
  ...
  public set internalValue(value: BotChannelWebChatTimeouts | undefined) {
    if (value === undefined) {
...
export class BotChannelWebChat extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelWebChatTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
