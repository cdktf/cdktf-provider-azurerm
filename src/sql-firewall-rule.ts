...
export interface SqlFirewallRuleConfig extends TerraformMetaArguments {
...
export class SqlFirewallRule extends TerraformResource {
  ...
  public set timeouts(value: SqlFirewallRuleTimeouts | undefined) {
