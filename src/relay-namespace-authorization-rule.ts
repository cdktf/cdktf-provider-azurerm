...
export function relayNamespaceAuthorizationRuleTimeoutsToTerraform(struct?: RelayNamespaceAuthorizationRuleTimeoutsOutputReference | RelayNamespaceAuthorizationRuleTimeouts): any {
...
export class RelayNamespaceAuthorizationRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RelayNamespaceAuthorizationRuleTimeouts | undefined {
  ...
  public set internalValue(value: RelayNamespaceAuthorizationRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class RelayNamespaceAuthorizationRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RelayNamespaceAuthorizationRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
