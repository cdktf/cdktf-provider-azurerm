...
function relayNamespaceAuthorizationRuleTimeoutsToTerraform(struct?: RelayNamespaceAuthorizationRuleTimeouts): any {
...
export class RelayNamespaceAuthorizationRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: RelayNamespaceAuthorizationRuleTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: RelayNamespaceAuthorizationRuleTimeouts ) {
