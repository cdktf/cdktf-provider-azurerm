...
export class DataLakeStoreVirtualNetworkRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeStoreVirtualNetworkRuleTimeouts | undefined {
  ...
  public set internalValue(value: DataLakeStoreVirtualNetworkRuleTimeouts | undefined) {
    if (value === undefined) {
