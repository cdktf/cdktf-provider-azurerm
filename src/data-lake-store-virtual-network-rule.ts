...
export function dataLakeStoreVirtualNetworkRuleTimeoutsToTerraform(struct?: DataLakeStoreVirtualNetworkRuleTimeoutsOutputReference | DataLakeStoreVirtualNetworkRuleTimeouts): any {
...
export class DataLakeStoreVirtualNetworkRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataLakeStoreVirtualNetworkRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
