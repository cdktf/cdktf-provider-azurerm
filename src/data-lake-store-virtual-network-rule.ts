...
export interface DataLakeStoreVirtualNetworkRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_lake_store_virtual_network_rule#id DataLakeStoreVirtualNetworkRule#id}
  *
...
export function dataLakeStoreVirtualNetworkRuleTimeoutsToTerraform(struct?: DataLakeStoreVirtualNetworkRuleTimeoutsOutputReference | DataLakeStoreVirtualNetworkRuleTimeouts | cdktf.IResolvable): any {
...
export class DataLakeStoreVirtualNetworkRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeStoreVirtualNetworkRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataLakeStoreVirtualNetworkRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataLakeStoreVirtualNetworkRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_data_lake_store_virtual_network_rule";
  ...
  */
  ...
  private _timeouts = new DataLakeStoreVirtualNetworkRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataLakeStoreVirtualNetworkRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataLakeStoreVirtualNetworkRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
