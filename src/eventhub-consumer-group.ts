...
export function eventhubConsumerGroupTimeoutsToTerraform(struct?: EventhubConsumerGroupTimeoutsOutputReference | EventhubConsumerGroupTimeouts | cdktf.IResolvable): any {
...
export class EventhubConsumerGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new EventhubConsumerGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
