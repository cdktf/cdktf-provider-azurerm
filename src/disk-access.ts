...
export function diskAccessTimeoutsToTerraform(struct?: DiskAccessTimeoutsOutputReference | DiskAccessTimeouts): any {
...
export class DiskAccessTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DiskAccessTimeouts | undefined {
  ...
  public set internalValue(value: DiskAccessTimeouts | undefined) {
    if (value === undefined) {
...
export class DiskAccess extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DiskAccessTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
