...
function diskAccessTimeoutsToTerraform(struct?: DiskAccessTimeoutsOutputReference | DiskAccessTimeouts): any {
...
export class DiskAccess extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: DiskAccessTimeouts | undefined; 
  private __timeoutsOutput = new DiskAccessTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: DiskAccessTimeouts | undefined) {
