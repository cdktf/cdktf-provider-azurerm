...
export class DataAzurermDatabaseMigrationServiceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDatabaseMigrationServiceTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDatabaseMigrationServiceTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDatabaseMigrationService extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDatabaseMigrationServiceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
