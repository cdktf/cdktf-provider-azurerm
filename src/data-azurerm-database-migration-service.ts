// https://www.terraform.io/docs/providers/azurerm/d/database_migration_service
...
export function dataAzurermDatabaseMigrationServiceTimeoutsToTerraform(struct?: DataAzurermDatabaseMigrationServiceTimeoutsOutputReference | DataAzurermDatabaseMigrationServiceTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermDatabaseMigrationServiceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDatabaseMigrationServiceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermDatabaseMigrationServiceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermDatabaseMigrationService extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDatabaseMigrationServiceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermDatabaseMigrationServiceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermDatabaseMigrationServiceTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
