...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/data-sources/private_dns_soa_record
...
export class DataAzurermPrivateDnsSoaRecord extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPrivateDnsSoaRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/data-sources/private_dns_soa_record#import import section} in the documentation of this resource for the id to use
