...
export interface DataFactoryDatasetMysqlConfig extends TerraformMetaArguments {
...
export class DataFactoryDatasetMysql extends TerraformResource {
  ...
  public set timeouts(value: DataFactoryDatasetMysqlTimeouts | undefined) {
