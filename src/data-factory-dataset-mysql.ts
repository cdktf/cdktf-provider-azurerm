...
function dataFactoryDatasetMysqlTimeoutsToTerraform(struct?: DataFactoryDatasetMysqlTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
...
export class DataFactoryDatasetMysql extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_data_factory_dataset_mysql";
  ...
  */
  ...
  private _timeouts?: DataFactoryDatasetMysqlTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: DataFactoryDatasetMysqlTimeouts ) {
