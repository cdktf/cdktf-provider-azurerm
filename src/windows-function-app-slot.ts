...
export function windowsFunctionAppSlotSiteConfigIpRestrictionToTerraform(struct?: WindowsFunctionAppSlotSiteConfigIpRestriction | cdktf.IResolvable): any {
  ...
  return {
    ...
    headers: cdktf.listMapper(windowsFunctionAppSlotSiteConfigIpRestrictionHeadersToTerraform)(struct!.headers),
...
export function windowsFunctionAppSlotSiteConfigScmIpRestrictionToTerraform(struct?: WindowsFunctionAppSlotSiteConfigScmIpRestriction | cdktf.IResolvable): any {
  ...
  return {
    action: cdktf.stringToTerraform(struct!.action),
    headers: cdktf.listMapper(windowsFunctionAppSlotSiteConfigScmIpRestrictionHeadersToTerraform)(struct!.headers),
    ip_address: cdktf.stringToTerraform(struct!.ipAddress),
    name: cdktf.stringToTerraform(struct!.name),
    priority: cdktf.numberToTerraform(struct!.priority),
    service_tag: cdktf.stringToTerraform(struct!.serviceTag),
...
export function windowsFunctionAppSlotSiteConfigToTerraform(struct?: WindowsFunctionAppSlotSiteConfigOutputReference | WindowsFunctionAppSlotSiteConfig): any {
  ...
  return {
    ...
    ip_restriction: cdktf.listMapper(windowsFunctionAppSlotSiteConfigIpRestrictionToTerraform)(struct!.ipRestriction),
    ...
    scm_ip_restriction: cdktf.listMapper(windowsFunctionAppSlotSiteConfigScmIpRestrictionToTerraform)(struct!.scmIpRestriction),
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      connection_string: cdktf.listMapper(windowsFunctionAppSlotConnectionStringToTerraform)(this._connectionString.internalValue),
