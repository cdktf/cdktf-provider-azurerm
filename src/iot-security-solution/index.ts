...
export class IotSecuritySolution extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.76.0/docs/resources/iot_security_solution azurerm_iot_security_solution} Resource
  *
