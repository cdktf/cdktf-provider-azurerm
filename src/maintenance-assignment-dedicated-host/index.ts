...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/maintenance_assignment_dedicated_host
...
export class MaintenanceAssignmentDedicatedHost extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MaintenanceAssignmentDedicatedHost that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/maintenance_assignment_dedicated_host#import import section} in the documentation of this resource for the id to use
