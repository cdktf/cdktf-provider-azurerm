...
export function iotTimeSeriesInsightsEventSourceIothubTimeoutsToTerraform(struct?: IotTimeSeriesInsightsEventSourceIothubTimeoutsOutputReference | IotTimeSeriesInsightsEventSourceIothubTimeouts): any {
...
export class IotTimeSeriesInsightsEventSourceIothubTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IotTimeSeriesInsightsEventSourceIothubTimeouts | undefined {
  ...
  public set internalValue(value: IotTimeSeriesInsightsEventSourceIothubTimeouts | undefined) {
    if (value === undefined) {
...
export class IotTimeSeriesInsightsEventSourceIothub extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IotTimeSeriesInsightsEventSourceIothubTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
