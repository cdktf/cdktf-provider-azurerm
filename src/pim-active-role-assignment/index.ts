...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/pim_active_role_assignment
...
export class PimActiveRoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PimActiveRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/pim_active_role_assignment#import import section} in the documentation of this resource for the id to use
