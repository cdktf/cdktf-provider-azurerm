...
function privateDnsARecordTimeoutsToTerraform(struct?: PrivateDnsARecordTimeoutsOutputReference | PrivateDnsARecordTimeouts): any {
...
export class PrivateDnsARecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: PrivateDnsARecordTimeouts | undefined; 
  private __timeoutsOutput = new PrivateDnsARecordTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: PrivateDnsARecordTimeouts | undefined) {
