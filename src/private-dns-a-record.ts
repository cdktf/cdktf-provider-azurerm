...
export interface PrivateDnsARecordConfig extends TerraformMetaArguments {
...
export class PrivateDnsARecord extends TerraformResource {
  ...
  public set timeouts(value: PrivateDnsARecordTimeouts | undefined) {
