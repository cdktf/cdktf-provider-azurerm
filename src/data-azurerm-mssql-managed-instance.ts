...
export class DataAzurermMssqlManagedInstanceIdentity extends cdktf.ComplexComputedList {
...
export class DataAzurermMssqlManagedInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermMssqlManagedInstanceTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermMssqlManagedInstanceTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermMssqlManagedInstance extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public identity(index: string) {
    return new DataAzurermMssqlManagedInstanceIdentity(this, 'identity', index, false);
  }
  ...
  private _timeouts = new DataAzurermMssqlManagedInstanceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
