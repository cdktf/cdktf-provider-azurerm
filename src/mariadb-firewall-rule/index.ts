...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/mariadb_firewall_rule
...
export class MariadbFirewallRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MariadbFirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/mariadb_firewall_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/resources/mariadb_firewall_rule azurerm_mariadb_firewall_rule} Resource
  *
  * @param scope The scope in which to define this construct
