...
function dataFactoryLinkedServiceAzureTableStorageTimeoutsToTerraform(struct?: DataFactoryLinkedServiceAzureTableStorageTimeouts): any {
...
export class DataFactoryLinkedServiceAzureTableStorage extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: DataFactoryLinkedServiceAzureTableStorageTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: DataFactoryLinkedServiceAzureTableStorageTimeouts ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataFactoryLinkedServiceAzureTableStorageTimeoutsToTerraform(this._timeouts),
    };
  }
}
