// https://www.terraform.io/docs/providers/azurerm/r/iothub_route
...
export function iothubRouteTimeoutsToTerraform(struct?: IothubRouteTimeoutsOutputReference | IothubRouteTimeouts | cdktf.IResolvable): any {
...
export class IothubRouteA extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IothubRouteTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
