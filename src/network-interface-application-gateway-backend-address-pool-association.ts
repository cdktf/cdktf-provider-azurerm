...
export function networkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeoutsToTerraform(struct?: NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeoutsOutputReference | NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeouts): any {
...
export class NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeouts | undefined {
  ...
  public set internalValue(value: NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeouts | undefined) {
    if (value === undefined) {
...
export class NetworkInterfaceApplicationGatewayBackendAddressPoolAssociation extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new NetworkInterfaceApplicationGatewayBackendAddressPoolAssociationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
