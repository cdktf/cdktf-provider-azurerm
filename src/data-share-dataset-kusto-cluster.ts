...
export function dataShareDatasetKustoClusterTimeoutsToTerraform(struct?: DataShareDatasetKustoClusterTimeoutsOutputReference | DataShareDatasetKustoClusterTimeouts): any {
...
export class DataShareDatasetKustoCluster extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataShareDatasetKustoClusterTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
