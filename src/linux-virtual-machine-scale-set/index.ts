// https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/linux_virtual_machine_scale_set
...
export function linuxVirtualMachineScaleSetGalleryApplicationsToHclTerraform(struct?: LinuxVirtualMachineScaleSetGalleryApplications | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    configuration_reference_blob_uri: {
      value: cdktf.stringToHclTerraform(struct!.configurationReferenceBlobUri),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    package_reference_id: {
      value: cdktf.stringToHclTerraform(struct!.packageReferenceId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export function linuxVirtualMachineScaleSetTerminateNotificationToHclTerraform(struct?: LinuxVirtualMachineScaleSetTerminateNotificationOutputReference | LinuxVirtualMachineScaleSetTerminateNotification): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class LinuxVirtualMachineScaleSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinuxVirtualMachineScaleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/linux_virtual_machine_scale_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/resources/linux_virtual_machine_scale_set azurerm_linux_virtual_machine_scale_set} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scale_in_policy: {
        value: cdktf.stringToHclTerraform(this._scaleInPolicy),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      gallery_applications: {
        value: cdktf.listMapperHcl(linuxVirtualMachineScaleSetGalleryApplicationsToHclTerraform, true)(this._galleryApplications.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "LinuxVirtualMachineScaleSetGalleryApplicationsList",
      },
      identity: {
      ...
      terminate_notification: {
        value: linuxVirtualMachineScaleSetTerminateNotificationToHclTerraform(this._terminateNotification.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "LinuxVirtualMachineScaleSetTerminateNotificationList",
      },
