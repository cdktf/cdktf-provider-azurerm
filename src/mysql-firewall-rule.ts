...
function mysqlFirewallRuleTimeoutsToTerraform(struct?: MysqlFirewallRuleTimeoutsOutputReference | MysqlFirewallRuleTimeouts): any {
...
export class MysqlFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: MysqlFirewallRuleTimeouts | undefined; 
  private __timeoutsOutput = new MysqlFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: MysqlFirewallRuleTimeouts | undefined) {
