...
export function mysqlFirewallRuleTimeoutsToTerraform(struct?: MysqlFirewallRuleTimeoutsOutputReference | MysqlFirewallRuleTimeouts): any {
...
export class MysqlFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: MysqlFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MysqlFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
