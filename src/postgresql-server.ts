...
export interface PostgresqlServerConfig extends TerraformMetaArguments {
...
export class PostgresqlServer extends TerraformResource {
  ...
  public set timeouts(value: PostgresqlServerTimeouts | undefined) {
