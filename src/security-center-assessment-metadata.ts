...
export interface SecurityCenterAssessmentMetadataConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/security_center_assessment_metadata#id SecurityCenterAssessmentMetadata#id}
  *
...
export function securityCenterAssessmentMetadataTimeoutsToTerraform(struct?: SecurityCenterAssessmentMetadataTimeoutsOutputReference | SecurityCenterAssessmentMetadataTimeouts | cdktf.IResolvable): any {
...
export class SecurityCenterAssessmentMetadataTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SecurityCenterAssessmentMetadataTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SecurityCenterAssessmentMetadataTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SecurityCenterAssessmentMetadata extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_security_center_assessment_metadata";
  ...
  */
  ...
  private _timeouts = new SecurityCenterAssessmentMetadataTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
