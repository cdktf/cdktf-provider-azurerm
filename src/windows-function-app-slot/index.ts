// https://www.terraform.io/docs/providers/azurerm/r/windows_function_app_slot
...
export function windowsFunctionAppSlotSiteConfigToTerraform(struct?: WindowsFunctionAppSlotSiteConfigOutputReference | WindowsFunctionAppSlotSiteConfig): any {
  ...
  return {
    ...
    ip_restriction: cdktf.listMapper(windowsFunctionAppSlotSiteConfigIpRestrictionToTerraform, false)(struct!.ipRestriction),
    ...
    scm_ip_restriction: cdktf.listMapper(windowsFunctionAppSlotSiteConfigScmIpRestrictionToTerraform, false)(struct!.scmIpRestriction),
...
export function windowsFunctionAppSlotTimeoutsToTerraform(struct?: WindowsFunctionAppSlotTimeoutsOutputReference | WindowsFunctionAppSlotTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
