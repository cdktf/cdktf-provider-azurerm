...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.111.0/docs/resources/windows_function_app_slot
...
export class WindowsFunctionAppSlot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WindowsFunctionAppSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.111.0/docs/resources/windows_function_app_slot#import import section} in the documentation of this resource for the id to use
