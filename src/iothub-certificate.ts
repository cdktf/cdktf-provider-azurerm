// https://www.terraform.io/docs/providers/azurerm/r/iothub_certificate
...
export function iothubCertificateTimeoutsToTerraform(struct?: IothubCertificateTimeoutsOutputReference | IothubCertificateTimeouts | cdktf.IResolvable): any {
...
export class IothubCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IothubCertificateTimeouts | undefined {
  ...
  public set internalValue(value: IothubCertificateTimeouts | undefined) {
    if (value === undefined) {
...
export class IothubCertificate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_iothub_certificate";
  ...
  */
  ...
  private _timeouts = new IothubCertificateTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
