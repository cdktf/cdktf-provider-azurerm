...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.78.0/docs/resources/mysql_server_key
...
export class MysqlServerKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlServerKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.78.0/docs/resources/mysql_server_key#import import section} in the documentation of this resource for the id to use
