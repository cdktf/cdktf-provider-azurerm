// https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/data-sources/servicebus_topic_authorization_rule
...
export class DataAzurermServicebusTopicAuthorizationRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermServicebusTopicAuthorizationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.114.0/docs/data-sources/servicebus_topic_authorization_rule#import import section} in the documentation of this resource for the id to use
