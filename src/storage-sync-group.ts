// https://www.terraform.io/docs/providers/azurerm/r/storage_sync_group
...
export function storageSyncGroupTimeoutsToTerraform(struct?: StorageSyncGroupTimeoutsOutputReference | StorageSyncGroupTimeouts | cdktf.IResolvable): any {
...
export class StorageSyncGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new StorageSyncGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
