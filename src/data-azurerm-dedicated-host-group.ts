...
export function dataAzurermDedicatedHostGroupTimeoutsToTerraform(struct?: DataAzurermDedicatedHostGroupTimeoutsOutputReference | DataAzurermDedicatedHostGroupTimeouts): any {
...
export class DataAzurermDedicatedHostGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDedicatedHostGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
