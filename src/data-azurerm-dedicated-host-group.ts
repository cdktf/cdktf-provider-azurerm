// https://www.terraform.io/docs/providers/azurerm/d/dedicated_host_group
...
export function dataAzurermDedicatedHostGroupTimeoutsToTerraform(struct?: DataAzurermDedicatedHostGroupTimeoutsOutputReference | DataAzurermDedicatedHostGroupTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermDedicatedHostGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDedicatedHostGroupTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDedicatedHostGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDedicatedHostGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDedicatedHostGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
