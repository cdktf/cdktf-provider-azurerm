// https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/servicebus_namespace
...
export class ServicebusNamespace extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicebusNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/servicebus_namespace#import import section} in the documentation of this resource for the id to use
