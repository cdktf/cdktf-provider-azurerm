...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/storage_data_lake_gen2_filesystem
...
export class StorageDataLakeGen2Filesystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageDataLakeGen2Filesystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/storage_data_lake_gen2_filesystem#import import section} in the documentation of this resource for the id to use
