// https://www.terraform.io/docs/providers/azurerm/r/iotcentral_application
...
export function iotcentralApplicationTimeoutsToTerraform(struct?: IotcentralApplicationTimeoutsOutputReference | IotcentralApplicationTimeouts | cdktf.IResolvable): any {
...
export class IotcentralApplicationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IotcentralApplicationTimeouts | undefined {
  ...
  public set internalValue(value: IotcentralApplicationTimeouts | undefined) {
    if (value === undefined) {
...
export class IotcentralApplication extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IotcentralApplicationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
