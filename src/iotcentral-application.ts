...
export function iotcentralApplicationTimeoutsToTerraform(struct?: IotcentralApplicationTimeoutsOutputReference | IotcentralApplicationTimeouts): any {
...
export class IotcentralApplication extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IotcentralApplicationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
