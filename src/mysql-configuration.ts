...
function mysqlConfigurationTimeoutsToTerraform(struct?: MysqlConfigurationTimeoutsOutputReference | MysqlConfigurationTimeouts): any {
...
export class MysqlConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: MysqlConfigurationTimeouts | undefined; 
  private __timeoutsOutput = new MysqlConfigurationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: MysqlConfigurationTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: mysqlConfigurationTimeoutsToTerraform(this._timeouts),
    };
  }
}
