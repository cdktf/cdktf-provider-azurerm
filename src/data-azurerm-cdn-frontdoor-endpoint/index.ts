...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/data-sources/cdn_frontdoor_endpoint
...
export class DataAzurermCdnFrontdoorEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermCdnFrontdoorEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/data-sources/cdn_frontdoor_endpoint#import import section} in the documentation of this resource for the id to use
