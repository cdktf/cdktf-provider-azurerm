...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/resources/eventgrid_partner_registration
...
export function eventgridPartnerRegistrationTimeoutsToTerraform(struct?: EventgridPartnerRegistrationTimeouts | cdktf.IResolvable): any {
...
export function eventgridPartnerRegistrationTimeoutsToHclTerraform(struct?: EventgridPartnerRegistrationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EventgridPartnerRegistrationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EventgridPartnerRegistrationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: EventgridPartnerRegistrationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class EventgridPartnerRegistration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventgridPartnerRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/resources/eventgrid_partner_registration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/resources/eventgrid_partner_registration azurerm_eventgrid_partner_registration} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EventgridPartnerRegistrationConfig
  */
  public constructor(scope: Construct, id: string, config: EventgridPartnerRegistrationConfig) {
    super(scope, id, {
  ...
  private _timeouts = new EventgridPartnerRegistrationTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: EventgridPartnerRegistrationTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: eventgridPartnerRegistrationTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: eventgridPartnerRegistrationTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EventgridPartnerRegistrationTimeouts",
      },
    };
