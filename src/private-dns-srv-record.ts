...
export interface PrivateDnsSrvRecordConfig extends TerraformMetaArguments {
...
export class PrivateDnsSrvRecord extends TerraformResource {
  ...
  public set timeouts(value: PrivateDnsSrvRecordTimeouts | undefined) {
