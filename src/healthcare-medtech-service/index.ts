...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/healthcare_medtech_service
...
export class HealthcareMedtechService extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareMedtechService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/healthcare_medtech_service#import import section} in the documentation of this resource for the id to use
