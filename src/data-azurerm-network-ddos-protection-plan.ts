...
export function dataAzurermNetworkDdosProtectionPlanTimeoutsToTerraform(struct?: DataAzurermNetworkDdosProtectionPlanTimeoutsOutputReference | DataAzurermNetworkDdosProtectionPlanTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermNetworkDdosProtectionPlanTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermNetworkDdosProtectionPlanTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermNetworkDdosProtectionPlanTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermNetworkDdosProtectionPlan extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermNetworkDdosProtectionPlanTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
