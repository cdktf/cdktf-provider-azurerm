...
export function mysqlDatabaseTimeoutsToTerraform(struct?: MysqlDatabaseTimeoutsOutputReference | MysqlDatabaseTimeouts | cdktf.IResolvable): any {
...
export class MysqlDatabase extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
