...
export interface MysqlDatabaseConfig extends TerraformMetaArguments {
...
export class MysqlDatabase extends TerraformResource {
  ...
  public set timeouts(value: MysqlDatabaseTimeouts | undefined) {
