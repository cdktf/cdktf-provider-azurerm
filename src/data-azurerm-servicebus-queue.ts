...
export function dataAzurermServicebusQueueTimeoutsToTerraform(struct?: DataAzurermServicebusQueueTimeoutsOutputReference | DataAzurermServicebusQueueTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermServicebusQueueTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermServicebusQueueTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermServicebusQueueTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermServicebusQueue extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermServicebusQueueTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
