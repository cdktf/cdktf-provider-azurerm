...
export function mysqlServerKeyTimeoutsToTerraform(struct?: MysqlServerKeyTimeoutsOutputReference | MysqlServerKeyTimeouts): any {
...
export class MysqlServerKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlServerKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
