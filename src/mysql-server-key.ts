// https://www.terraform.io/docs/providers/azurerm/r/mysql_server_key
...
export function mysqlServerKeyTimeoutsToTerraform(struct?: MysqlServerKeyTimeoutsOutputReference | MysqlServerKeyTimeouts | cdktf.IResolvable): any {
...
export class MysqlServerKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlServerKeyTimeouts | undefined {
  ...
  public set internalValue(value: MysqlServerKeyTimeouts | undefined) {
    if (value === undefined) {
...
export class MysqlServerKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlServerKeyTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
