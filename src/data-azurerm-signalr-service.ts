// https://www.terraform.io/docs/providers/azurerm/d/signalr_service
...
export function dataAzurermSignalrServiceTimeoutsToTerraform(struct?: DataAzurermSignalrServiceTimeoutsOutputReference | DataAzurermSignalrServiceTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermSignalrServiceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermSignalrServiceTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermSignalrServiceTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermSignalrService extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSignalrServiceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
