...
export function dataAzurermSignalrServiceTimeoutsToTerraform(struct?: DataAzurermSignalrServiceTimeoutsOutputReference | DataAzurermSignalrServiceTimeouts): any {
...
export class DataAzurermSignalrService extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSignalrServiceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
