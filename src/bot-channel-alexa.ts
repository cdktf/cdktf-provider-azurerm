...
export function botChannelAlexaTimeoutsToTerraform(struct?: BotChannelAlexaTimeoutsOutputReference | BotChannelAlexaTimeouts | cdktf.IResolvable): any {
...
export class BotChannelAlexaTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BotChannelAlexaTimeouts | undefined {
  ...
  public set internalValue(value: BotChannelAlexaTimeouts | undefined) {
    if (value === undefined) {
...
export class BotChannelAlexa extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelAlexaTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
