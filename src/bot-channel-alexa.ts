...
export function botChannelAlexaTimeoutsToTerraform(struct?: BotChannelAlexaTimeoutsOutputReference | BotChannelAlexaTimeouts): any {
...
export class BotChannelAlexa extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelAlexaTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
