...
function servicebusNamespaceAuthorizationRuleTimeoutsToTerraform(struct?: ServicebusNamespaceAuthorizationRuleTimeoutsOutputReference | ServicebusNamespaceAuthorizationRuleTimeouts): any {
...
export class ServicebusNamespaceAuthorizationRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ServicebusNamespaceAuthorizationRuleTimeouts | undefined; 
  private __timeoutsOutput = new ServicebusNamespaceAuthorizationRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: ServicebusNamespaceAuthorizationRuleTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: servicebusNamespaceAuthorizationRuleTimeoutsToTerraform(this._timeouts),
    };
  }
}
