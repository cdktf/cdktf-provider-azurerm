...
function servicebusNamespaceAuthorizationRuleTimeoutsToTerraform(struct?: ServicebusNamespaceAuthorizationRuleTimeouts): any {
...
export class ServicebusNamespaceAuthorizationRule extends cdktf.TerraformResource {
  ...
  */
  ...
  public set timeouts(value: ServicebusNamespaceAuthorizationRuleTimeouts ) {
