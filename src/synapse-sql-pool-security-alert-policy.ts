...
export function synapseSqlPoolSecurityAlertPolicyTimeoutsToTerraform(struct?: SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference | SynapseSqlPoolSecurityAlertPolicyTimeouts | cdktf.IResolvable): any {
...
export class SynapseSqlPoolSecurityAlertPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SynapseSqlPoolSecurityAlertPolicyTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
