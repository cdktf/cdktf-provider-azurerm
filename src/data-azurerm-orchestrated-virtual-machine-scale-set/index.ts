...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/data-sources/orchestrated_virtual_machine_scale_set
...
export class DataAzurermOrchestratedVirtualMachineScaleSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOrchestratedVirtualMachineScaleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/data-sources/orchestrated_virtual_machine_scale_set#import import section} in the documentation of this resource for the id to use
