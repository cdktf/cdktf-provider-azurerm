...
export class DataAzurermMariadbServerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermMariadbServerTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermMariadbServerTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAzurermMariadbServer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public putTimeouts(value: DataAzurermMariadbServerTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermMariadbServerTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
