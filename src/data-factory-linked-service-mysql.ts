...
export interface DataFactoryLinkedServiceMysqlConfig extends TerraformMetaArguments {
...
export class DataFactoryLinkedServiceMysql extends TerraformResource {
  ...
  public set timeouts(value: DataFactoryLinkedServiceMysqlTimeouts | undefined) {
