...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/data-sources/mobile_network_slice
...
export class DataAzurermMobileNetworkSlice extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMobileNetworkSlice that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/data-sources/mobile_network_slice#import import section} in the documentation of this resource for the id to use
