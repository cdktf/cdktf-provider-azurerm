...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.83.0/docs/data-sources/marketplace_agreement
...
export class DataAzurermMarketplaceAgreement extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMarketplaceAgreement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.83.0/docs/data-sources/marketplace_agreement#import import section} in the documentation of this resource for the id to use
