...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/storage_share
...
export class DataAzurermStorageShare extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermStorageShare that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/storage_share#import import section} in the documentation of this resource for the id to use
