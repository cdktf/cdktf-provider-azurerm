...
export function subscriptionTemplateDeploymentTimeoutsToTerraform(struct?: SubscriptionTemplateDeploymentTimeoutsOutputReference | SubscriptionTemplateDeploymentTimeouts): any {
...
export class SubscriptionTemplateDeploymentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SubscriptionTemplateDeploymentTimeouts | undefined {
  ...
  public set internalValue(value: SubscriptionTemplateDeploymentTimeouts | undefined) {
    if (value === undefined) {
...
export class SubscriptionTemplateDeployment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SubscriptionTemplateDeploymentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
