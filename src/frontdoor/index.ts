...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.82.0/docs/resources/frontdoor
...
export class Frontdoor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Frontdoor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.82.0/docs/resources/frontdoor#import import section} in the documentation of this resource for the id to use
