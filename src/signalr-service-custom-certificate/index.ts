...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/signalr_service_custom_certificate
...
export class SignalrServiceCustomCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SignalrServiceCustomCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/signalr_service_custom_certificate#import import section} in the documentation of this resource for the id to use
