...
export function sentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsToTerraform(struct?: SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference | SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeouts): any {
...
export class SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeouts | undefined {
  ...
  public set internalValue(value: SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeouts | undefined) {
    if (value === undefined) {
...
export class SentinelAlertRuleMachineLearningBehaviorAnalytics extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SentinelAlertRuleMachineLearningBehaviorAnalyticsTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
