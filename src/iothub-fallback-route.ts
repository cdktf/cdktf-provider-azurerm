...
export function iothubFallbackRouteTimeoutsToTerraform(struct?: IothubFallbackRouteTimeoutsOutputReference | IothubFallbackRouteTimeouts | cdktf.IResolvable): any {
...
export class IothubFallbackRouteA extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IothubFallbackRouteTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
