...
export function mysqlFlexibleServerConfigurationTimeoutsToTerraform(struct?: MysqlFlexibleServerConfigurationTimeoutsOutputReference | MysqlFlexibleServerConfigurationTimeouts | cdktf.IResolvable): any {
...
export class MysqlFlexibleServerConfigurationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlFlexibleServerConfigurationTimeouts | undefined {
  ...
  public set internalValue(value: MysqlFlexibleServerConfigurationTimeouts | undefined) {
    if (value === undefined) {
...
export class MysqlFlexibleServerConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlFlexibleServerConfigurationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
