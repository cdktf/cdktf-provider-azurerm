...
export function mysqlFlexibleServerConfigurationTimeoutsToTerraform(struct?: MysqlFlexibleServerConfigurationTimeoutsOutputReference | MysqlFlexibleServerConfigurationTimeouts): any {
...
export class MysqlFlexibleServerConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlFlexibleServerConfigurationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
