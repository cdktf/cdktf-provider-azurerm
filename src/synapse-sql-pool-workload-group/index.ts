...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/synapse_sql_pool_workload_group
...
export class SynapseSqlPoolWorkloadGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SynapseSqlPoolWorkloadGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/synapse_sql_pool_workload_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/synapse_sql_pool_workload_group azurerm_synapse_sql_pool_workload_group} Resource
  *
  * @param scope The scope in which to define this construct
