...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/data-sources/oracle_autonomous_database_clone_from_backup
...
export function dataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleToTerraform(struct?: DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupSchedule): any {
...
export function dataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleToHclTerraform(struct?: DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupSchedule): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupSchedule | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupSchedule | undefined) {
    if (value === undefined) {
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleOutputReference {
    return new DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsToTerraform(struct?: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsToHclTerraform(struct?: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataAzurermOracleAutonomousDatabaseCloneFromBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleAutonomousDatabaseCloneFromBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/data-sources/oracle_autonomous_database_clone_from_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: DataAzurermOracleAutonomousDatabaseCloneFromBackupConfig) {
    super(scope, id, {
  ...
  private _longTermBackupSchedule = new DataAzurermOracleAutonomousDatabaseCloneFromBackupLongTermBackupScheduleList(this, "long_term_backup_schedule", false);
  ...
  private _timeouts = new DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: dataAzurermOracleAutonomousDatabaseCloneFromBackupTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataAzurermOracleAutonomousDatabaseCloneFromBackupTimeouts",
      },
    };
