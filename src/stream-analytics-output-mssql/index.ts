// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/stream_analytics_output_mssql
...
export class StreamAnalyticsOutputMssql extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamAnalyticsOutputMssql that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/stream_analytics_output_mssql#import import section} in the documentation of this resource for the id to use
