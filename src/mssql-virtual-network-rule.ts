...
export function mssqlVirtualNetworkRuleTimeoutsToTerraform(struct?: MssqlVirtualNetworkRuleTimeoutsOutputReference | MssqlVirtualNetworkRuleTimeouts): any {
...
export class MssqlVirtualNetworkRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlVirtualNetworkRuleTimeouts | undefined {
  ...
  public set internalValue(value: MssqlVirtualNetworkRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MssqlVirtualNetworkRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MssqlVirtualNetworkRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
