// https://www.terraform.io/docs/providers/azurerm/r/logic_app_trigger_http_request
...
export function logicAppTriggerHttpRequestTimeoutsToTerraform(struct?: LogicAppTriggerHttpRequestTimeoutsOutputReference | LogicAppTriggerHttpRequestTimeouts | cdktf.IResolvable): any {
...
export class LogicAppTriggerHttpRequest extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LogicAppTriggerHttpRequestTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
