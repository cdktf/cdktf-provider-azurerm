...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/virtual_hub_ip
...
export class VirtualHubIp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualHubIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/virtual_hub_ip#import import section} in the documentation of this resource for the id to use
