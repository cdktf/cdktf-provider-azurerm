...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/data-sources/storage_containers
...
export class DataAzurermStorageContainers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermStorageContainers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/data-sources/storage_containers#import import section} in the documentation of this resource for the id to use
