// https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/function_app_function
...
export class FunctionAppFunction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionAppFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/function_app_function#import import section} in the documentation of this resource for the id to use
