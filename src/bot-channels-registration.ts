// https://www.terraform.io/docs/providers/azurerm/r/bot_channels_registration
...
export function botChannelsRegistrationTimeoutsToTerraform(struct?: BotChannelsRegistrationTimeoutsOutputReference | BotChannelsRegistrationTimeouts | cdktf.IResolvable): any {
...
export class BotChannelsRegistration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelsRegistrationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
