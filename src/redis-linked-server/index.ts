...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/redis_linked_server
...
export class RedisLinkedServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisLinkedServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/redis_linked_server#import import section} in the documentation of this resource for the id to use
