...
export function iothubEnrichmentTimeoutsToTerraform(struct?: IothubEnrichmentTimeoutsOutputReference | IothubEnrichmentTimeouts): any {
...
export class IothubEnrichmentA extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IothubEnrichmentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
