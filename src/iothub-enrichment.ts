...
function iothubEnrichmentTimeoutsToTerraform(struct?: IothubEnrichmentTimeoutsOutputReference | IothubEnrichmentTimeouts): any {
...
export class IothubEnrichmentA extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: IothubEnrichmentTimeouts | undefined; 
  private __timeoutsOutput = new IothubEnrichmentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: IothubEnrichmentTimeouts | undefined) {
