// https://www.terraform.io/docs/providers/azurerm/r/mssql_managed_instance_active_directory_administrator
...
export function mssqlManagedInstanceActiveDirectoryAdministratorTimeoutsToTerraform(struct?: MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference | MssqlManagedInstanceActiveDirectoryAdministratorTimeouts | cdktf.IResolvable): any {
...
export class MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlManagedInstanceActiveDirectoryAdministratorTimeouts | undefined {
  ...
  public set internalValue(value: MssqlManagedInstanceActiveDirectoryAdministratorTimeouts | undefined) {
    if (value === undefined) {
...
export class MssqlManagedInstanceActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_mssql_managed_instance_active_directory_administrator";
  ...
  */
  ...
  private _timeouts = new MssqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
