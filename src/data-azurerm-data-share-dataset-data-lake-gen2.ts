...
export function dataAzurermDataShareDatasetDataLakeGen2TimeoutsToTerraform(struct?: DataAzurermDataShareDatasetDataLakeGen2TimeoutsOutputReference | DataAzurermDataShareDatasetDataLakeGen2Timeouts): any {
...
export class DataAzurermDataShareDatasetDataLakeGen2 extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDataShareDatasetDataLakeGen2TimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
