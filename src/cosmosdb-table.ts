// https://www.terraform.io/docs/providers/azurerm/r/cosmosdb_table
...
export function cosmosdbTableTimeoutsToTerraform(struct?: CosmosdbTableTimeoutsOutputReference | CosmosdbTableTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CosmosdbTableTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: CosmosdbTableTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class CosmosdbTable extends cdktf.TerraformResource {
  ...
  */
  ...
  private _autoscaleSettings = new CosmosdbTableAutoscaleSettingsOutputReference(this as any, "autoscale_settings", true);
  ...
  private _timeouts = new CosmosdbTableTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
