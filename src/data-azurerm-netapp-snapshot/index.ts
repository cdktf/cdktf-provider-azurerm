// https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/data-sources/netapp_snapshot
...
export class DataAzurermNetappSnapshot extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetappSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.115.0/docs/data-sources/netapp_snapshot#import import section} in the documentation of this resource for the id to use
