...
export interface ServiceFabricMeshSecretConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/service_fabric_mesh_secret#id ServiceFabricMeshSecret#id}
  *
...
export function serviceFabricMeshSecretTimeoutsToTerraform(struct?: ServiceFabricMeshSecretTimeoutsOutputReference | ServiceFabricMeshSecretTimeouts | cdktf.IResolvable): any {
...
export class ServiceFabricMeshSecretTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServiceFabricMeshSecretTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ServiceFabricMeshSecretTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ServiceFabricMeshSecret extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_service_fabric_mesh_secret";
  ...
  */
  ...
  private _timeouts = new ServiceFabricMeshSecretTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ServiceFabricMeshSecretTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: serviceFabricMeshSecretTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
