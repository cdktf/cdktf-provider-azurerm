...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/data-sources/lb_outbound_rule
...
export class DataAzurermLbOutboundRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermLbOutboundRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.0/docs/data-sources/lb_outbound_rule#import import section} in the documentation of this resource for the id to use
