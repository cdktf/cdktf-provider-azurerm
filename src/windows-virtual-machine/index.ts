...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/windows_virtual_machine
...
export class WindowsVirtualMachine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WindowsVirtualMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/windows_virtual_machine#import import section} in the documentation of this resource for the id to use
