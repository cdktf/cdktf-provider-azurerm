...
export function mysqlActiveDirectoryAdministratorTimeoutsToTerraform(struct?: MysqlActiveDirectoryAdministratorTimeoutsOutputReference | MysqlActiveDirectoryAdministratorTimeouts | cdktf.IResolvable): any {
...
export class MysqlActiveDirectoryAdministratorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlActiveDirectoryAdministratorTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MysqlActiveDirectoryAdministratorTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class MysqlActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_mysql_active_directory_administrator";
  ...
  */
  ...
  private _timeouts = new MysqlActiveDirectoryAdministratorTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
