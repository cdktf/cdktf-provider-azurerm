...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/automation_watcher
...
export class AutomationWatcher extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AutomationWatcher that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/automation_watcher#import import section} in the documentation of this resource for the id to use
