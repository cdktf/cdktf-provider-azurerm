...
function containerRegistryTokenTimeoutsToTerraform(struct?: ContainerRegistryTokenTimeoutsOutputReference | ContainerRegistryTokenTimeouts): any {
...
export class ContainerRegistryToken extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ContainerRegistryTokenTimeouts | undefined; 
  private __timeoutsOutput = new ContainerRegistryTokenTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: ContainerRegistryTokenTimeouts | undefined) {
