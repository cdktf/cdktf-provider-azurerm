...
export function containerRegistryTokenTimeoutsToTerraform(struct?: ContainerRegistryTokenTimeoutsOutputReference | ContainerRegistryTokenTimeouts): any {
...
export class ContainerRegistryToken extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ContainerRegistryTokenTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
