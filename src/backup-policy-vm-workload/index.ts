...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.51.0/docs/resources/backup_policy_vm_workload
...
export class BackupPolicyVmWorkload extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupPolicyVmWorkload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.51.0/docs/resources/backup_policy_vm_workload#import import section} in the documentation of this resource for the id to use
