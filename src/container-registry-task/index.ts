...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.35.0/docs/resources/container_registry_task
...
export class ContainerRegistryTask extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerRegistryTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.35.0/docs/resources/container_registry_task#import import section} in the documentation of this resource for the id to use
