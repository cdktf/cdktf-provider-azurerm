// https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/resources/powerbi_embedded
...
export class PowerbiEmbedded extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PowerbiEmbedded that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/resources/powerbi_embedded#import import section} in the documentation of this resource for the id to use
