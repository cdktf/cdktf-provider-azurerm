...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/data-sources/mssql_failover_group
...
export class DataAzurermMssqlFailoverGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMssqlFailoverGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/data-sources/mssql_failover_group#import import section} in the documentation of this resource for the id to use
