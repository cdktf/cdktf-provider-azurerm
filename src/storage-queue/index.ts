...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/storage_queue
...
export class StorageQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/storage_queue#import import section} in the documentation of this resource for the id to use
