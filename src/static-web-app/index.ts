// https://registry.terraform.io/providers/hashicorp/azurerm/4.20.0/docs/resources/static_web_app
...
export class StaticWebApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StaticWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.20.0/docs/resources/static_web_app#import import section} in the documentation of this resource for the id to use
