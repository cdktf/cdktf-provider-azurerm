...
function networkDdosProtectionPlanTimeoutsToTerraform(struct?: NetworkDdosProtectionPlanTimeoutsOutputReference | NetworkDdosProtectionPlanTimeouts): any {
...
export class NetworkDdosProtectionPlan extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: NetworkDdosProtectionPlanTimeouts | undefined; 
  private __timeoutsOutput = new NetworkDdosProtectionPlanTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: NetworkDdosProtectionPlanTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: networkDdosProtectionPlanTimeoutsToTerraform(this._timeouts),
    };
  }
}
