...
export function devTestLabTimeoutsToTerraform(struct?: DevTestLabTimeoutsOutputReference | DevTestLabTimeouts): any {
...
export class DevTestLab extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DevTestLabTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
