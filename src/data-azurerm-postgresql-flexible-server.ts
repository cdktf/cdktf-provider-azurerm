...
export function dataAzurermPostgresqlFlexibleServerTimeoutsToTerraform(struct?: DataAzurermPostgresqlFlexibleServerTimeoutsOutputReference | DataAzurermPostgresqlFlexibleServerTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermPostgresqlFlexibleServer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPostgresqlFlexibleServerTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
