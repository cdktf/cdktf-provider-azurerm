...
export function dataAzurermPostgresqlFlexibleServerTimeoutsToTerraform(struct?: DataAzurermPostgresqlFlexibleServerTimeoutsOutputReference | DataAzurermPostgresqlFlexibleServerTimeouts): any {
...
export class DataAzurermPostgresqlFlexibleServer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPostgresqlFlexibleServerTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
