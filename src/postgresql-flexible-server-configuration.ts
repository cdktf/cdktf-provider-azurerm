// https://www.terraform.io/docs/providers/azurerm/r/postgresql_flexible_server_configuration
...
export function postgresqlFlexibleServerConfigurationTimeoutsToTerraform(struct?: PostgresqlFlexibleServerConfigurationTimeoutsOutputReference | PostgresqlFlexibleServerConfigurationTimeouts | cdktf.IResolvable): any {
...
export class PostgresqlFlexibleServerConfigurationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresqlFlexibleServerConfigurationTimeouts | undefined {
  ...
  public set internalValue(value: PostgresqlFlexibleServerConfigurationTimeouts | undefined) {
    if (value === undefined) {
...
export class PostgresqlFlexibleServerConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlFlexibleServerConfigurationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
