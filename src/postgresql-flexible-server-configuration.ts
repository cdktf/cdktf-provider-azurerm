...
export function postgresqlFlexibleServerConfigurationTimeoutsToTerraform(struct?: PostgresqlFlexibleServerConfigurationTimeoutsOutputReference | PostgresqlFlexibleServerConfigurationTimeouts): any {
...
export class PostgresqlFlexibleServerConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlFlexibleServerConfigurationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
