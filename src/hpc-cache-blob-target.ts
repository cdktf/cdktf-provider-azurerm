...
function hpcCacheBlobTargetTimeoutsToTerraform(struct?: HpcCacheBlobTargetTimeoutsOutputReference | HpcCacheBlobTargetTimeouts): any {
...
export class HpcCacheBlobTarget extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: HpcCacheBlobTargetTimeouts | undefined; 
  private __timeoutsOutput = new HpcCacheBlobTargetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: HpcCacheBlobTargetTimeouts | undefined) {
