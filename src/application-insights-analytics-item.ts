...
export function applicationInsightsAnalyticsItemTimeoutsToTerraform(struct?: ApplicationInsightsAnalyticsItemTimeoutsOutputReference | ApplicationInsightsAnalyticsItemTimeouts | cdktf.IResolvable): any {
...
export class ApplicationInsightsAnalyticsItemTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApplicationInsightsAnalyticsItemTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApplicationInsightsAnalyticsItemTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApplicationInsightsAnalyticsItem extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_application_insights_analytics_item";
  ...
  */
  ...
  private _timeouts = new ApplicationInsightsAnalyticsItemTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
