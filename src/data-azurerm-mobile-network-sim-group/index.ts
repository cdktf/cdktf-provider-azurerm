// https://www.terraform.io/docs/providers/azurerm/d/mobile_network_sim_group
...
export interface DataAzurermMobileNetworkSimGroupTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/mobile_network_sim_group#read DataAzurermMobileNetworkSimGroup#read}
  */
  readonly read?: string;
}

export function dataAzurermMobileNetworkSimGroupTimeoutsToTerraform(struct?: DataAzurermMobileNetworkSimGroupTimeoutsOutputReference | DataAzurermMobileNetworkSimGroupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://www.terraform.io/docs/providers/azurerm/d/mobile_network_sim_group azurerm_mobile_network_sim_group}
*/
export class DataAzurermMobileNetworkSimGroup extends cdktf.TerraformDataSource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/azurerm/d/mobile_network_sim_group azurerm_mobile_network_sim_group} Data Source
  *
