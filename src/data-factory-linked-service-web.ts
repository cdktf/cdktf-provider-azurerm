...
export interface DataFactoryLinkedServiceWebConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_factory_linked_service_web.html#data_factory_id DataFactoryLinkedServiceWeb#data_factory_id}
  */
...
export function dataFactoryLinkedServiceWebTimeoutsToTerraform(struct?: DataFactoryLinkedServiceWebTimeoutsOutputReference | DataFactoryLinkedServiceWebTimeouts): any {
...
export class DataFactoryLinkedServiceWebTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataFactoryLinkedServiceWebTimeouts | undefined {
  ...
  public set internalValue(value: DataFactoryLinkedServiceWebTimeouts | undefined) {
    if (value === undefined) {
...
export class DataFactoryLinkedServiceWeb extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataFactoryLinkedServiceWebTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
