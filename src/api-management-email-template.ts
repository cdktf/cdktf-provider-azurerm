...
export interface ApiManagementEmailTemplateConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/api_management_email_template#id ApiManagementEmailTemplate#id}
  *
...
export function apiManagementEmailTemplateTimeoutsToTerraform(struct?: ApiManagementEmailTemplateTimeoutsOutputReference | ApiManagementEmailTemplateTimeouts | cdktf.IResolvable): any {
...
export class ApiManagementEmailTemplateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementEmailTemplateTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApiManagementEmailTemplateTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApiManagementEmailTemplate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_api_management_email_template";
  ...
  */
  ...
  private _timeouts = new ApiManagementEmailTemplateTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
