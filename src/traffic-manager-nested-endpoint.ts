...
export class TrafficManagerNestedEndpoint extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_traffic_manager_nested_endpoint";
  ...
  */
  ...
  private _timeouts = new TrafficManagerNestedEndpointTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
