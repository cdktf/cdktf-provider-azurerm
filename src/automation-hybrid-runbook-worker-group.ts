// https://www.terraform.io/docs/providers/azurerm/r/automation_hybrid_runbook_worker_group
...
export interface AutomationHybridRunbookWorkerGroupConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function automationHybridRunbookWorkerGroupTimeoutsToTerraform(struct?: AutomationHybridRunbookWorkerGroupTimeoutsOutputReference | AutomationHybridRunbookWorkerGroupTimeouts | cdktf.IResolvable): any {
...
export class AutomationHybridRunbookWorkerGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutomationHybridRunbookWorkerGroupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AutomationHybridRunbookWorkerGroupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class AutomationHybridRunbookWorkerGroup extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_automation_hybrid_runbook_worker_group";
  ...
  * @param options AutomationHybridRunbookWorkerGroupConfig
  */
  public constructor(scope: Construct, id: string, config: AutomationHybridRunbookWorkerGroupConfig) {
    super(scope, id, {
  ...
  private _timeouts = new AutomationHybridRunbookWorkerGroupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AutomationHybridRunbookWorkerGroupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: automationHybridRunbookWorkerGroupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
