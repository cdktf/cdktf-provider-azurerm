...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/netapp_account_encryption
...
export class NetappAccountEncryption extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappAccountEncryption that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/netapp_account_encryption#import import section} in the documentation of this resource for the id to use
