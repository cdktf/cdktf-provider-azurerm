...
export function apiManagementIdentityProviderMicrosoftTimeoutsToTerraform(struct?: ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference | ApiManagementIdentityProviderMicrosoftTimeouts): any {
...
export class ApiManagementIdentityProviderMicrosoft extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
