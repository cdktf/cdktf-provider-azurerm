...
export function apiManagementIdentityProviderMicrosoftTimeoutsToTerraform(struct?: ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference | ApiManagementIdentityProviderMicrosoftTimeouts | cdktf.IResolvable): any {
...
export class ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementIdentityProviderMicrosoftTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementIdentityProviderMicrosoftTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementIdentityProviderMicrosoft extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementIdentityProviderMicrosoftTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
