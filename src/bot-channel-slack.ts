...
export function botChannelSlackTimeoutsToTerraform(struct?: BotChannelSlackTimeoutsOutputReference | BotChannelSlackTimeouts): any {
...
export class BotChannelSlackTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BotChannelSlackTimeouts | undefined {
  ...
  public set internalValue(value: BotChannelSlackTimeouts | undefined) {
    if (value === undefined) {
...
export class BotChannelSlack extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelSlackTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
