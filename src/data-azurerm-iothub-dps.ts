...
export class DataAzurermIothubDpsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermIothubDpsTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermIothubDpsTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermIothubDps extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermIothubDpsTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
