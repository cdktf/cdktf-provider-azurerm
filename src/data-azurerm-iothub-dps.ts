...
export function dataAzurermIothubDpsTimeoutsToTerraform(struct?: DataAzurermIothubDpsTimeoutsOutputReference | DataAzurermIothubDpsTimeouts): any {
...
export class DataAzurermIothubDps extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermIothubDpsTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
