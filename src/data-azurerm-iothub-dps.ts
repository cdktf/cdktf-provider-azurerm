// https://www.terraform.io/docs/providers/azurerm/d/iothub_dps
...
export function dataAzurermIothubDpsTimeoutsToTerraform(struct?: DataAzurermIothubDpsTimeoutsOutputReference | DataAzurermIothubDpsTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermIothubDpsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermIothubDpsTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermIothubDpsTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermIothubDps extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermIothubDpsTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermIothubDpsTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermIothubDpsTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
