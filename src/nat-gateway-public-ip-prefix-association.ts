...
export function natGatewayPublicIpPrefixAssociationTimeoutsToTerraform(struct?: NatGatewayPublicIpPrefixAssociationTimeoutsOutputReference | NatGatewayPublicIpPrefixAssociationTimeouts | cdktf.IResolvable): any {
...
export class NatGatewayPublicIpPrefixAssociation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_nat_gateway_public_ip_prefix_association";
  ...
  */
  ...
  private _timeouts = new NatGatewayPublicIpPrefixAssociationTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
