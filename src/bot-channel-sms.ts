...
export function botChannelSmsTimeoutsToTerraform(struct?: BotChannelSmsTimeoutsOutputReference | BotChannelSmsTimeouts): any {
...
export class BotChannelSms extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelSmsTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
