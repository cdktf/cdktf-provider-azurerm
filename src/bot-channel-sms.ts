// https://www.terraform.io/docs/providers/azurerm/r/bot_channel_sms
...
export function botChannelSmsTimeoutsToTerraform(struct?: BotChannelSmsTimeoutsOutputReference | BotChannelSmsTimeouts | cdktf.IResolvable): any {
...
export class BotChannelSmsTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BotChannelSmsTimeouts | undefined {
  ...
  public set internalValue(value: BotChannelSmsTimeouts | undefined) {
    if (value === undefined) {
...
export class BotChannelSms extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelSmsTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
