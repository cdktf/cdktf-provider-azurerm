...
export class CosmosdbGremlinDatabase extends cdktf.TerraformResource {
  ...
  */
  ...
  private _autoscaleSettings = new CosmosdbGremlinDatabaseAutoscaleSettingsOutputReference(this, "autoscale_settings", true);
  ...
  private _timeouts = new CosmosdbGremlinDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
