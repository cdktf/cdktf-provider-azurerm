...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.15.0/docs/resources/virtual_machine_automanage_configuration_assignment
...
export class VirtualMachineAutomanageConfigurationAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualMachineAutomanageConfigurationAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.15.0/docs/resources/virtual_machine_automanage_configuration_assignment#import import section} in the documentation of this resource for the id to use
