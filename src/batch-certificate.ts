// https://www.terraform.io/docs/providers/azurerm/r/batch_certificate
...
export function batchCertificateTimeoutsToTerraform(struct?: BatchCertificateTimeoutsOutputReference | BatchCertificateTimeouts | cdktf.IResolvable): any {
...
export class BatchCertificate extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BatchCertificateTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
