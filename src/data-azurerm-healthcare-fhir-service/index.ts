...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/data-sources/healthcare_fhir_service
...
export class DataAzurermHealthcareFhirService extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermHealthcareFhirService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/data-sources/healthcare_fhir_service#import import section} in the documentation of this resource for the id to use
