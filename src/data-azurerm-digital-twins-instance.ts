...
export interface DataAzurermDigitalTwinsInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/digital_twins_instance#id DataAzurermDigitalTwinsInstance#id}
  *
...
export class DataAzurermDigitalTwinsInstanceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDigitalTwinsInstanceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermDigitalTwinsInstanceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermDigitalTwinsInstance extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_digital_twins_instance";
  ...
  */
  ...
  private _timeouts = new DataAzurermDigitalTwinsInstanceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
