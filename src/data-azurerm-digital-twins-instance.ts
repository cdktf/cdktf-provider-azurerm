...
export function dataAzurermDigitalTwinsInstanceTimeoutsToTerraform(struct?: DataAzurermDigitalTwinsInstanceTimeoutsOutputReference | DataAzurermDigitalTwinsInstanceTimeouts): any {
...
export class DataAzurermDigitalTwinsInstance extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDigitalTwinsInstanceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
