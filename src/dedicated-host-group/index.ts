// https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/dedicated_host_group
...
export class DedicatedHostGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DedicatedHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/dedicated_host_group#import import section} in the documentation of this resource for the id to use
