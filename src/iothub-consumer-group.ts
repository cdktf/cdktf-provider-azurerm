...
function iothubConsumerGroupTimeoutsToTerraform(struct?: IothubConsumerGroupTimeoutsOutputReference | IothubConsumerGroupTimeouts): any {
...
export class IothubConsumerGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: IothubConsumerGroupTimeouts | undefined; 
  private __timeoutsOutput = new IothubConsumerGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: IothubConsumerGroupTimeouts | undefined) {
