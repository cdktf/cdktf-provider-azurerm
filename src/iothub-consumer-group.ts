...
export function iothubConsumerGroupTimeoutsToTerraform(struct?: IothubConsumerGroupTimeoutsOutputReference | IothubConsumerGroupTimeouts): any {
...
export class IothubConsumerGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IothubConsumerGroupTimeouts | undefined {
  ...
  public set internalValue(value: IothubConsumerGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class IothubConsumerGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IothubConsumerGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
