...
export function spatialAnchorsAccountTimeoutsToTerraform(struct?: SpatialAnchorsAccountTimeoutsOutputReference | SpatialAnchorsAccountTimeouts): any {
...
export class SpatialAnchorsAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SpatialAnchorsAccountTimeouts | undefined {
  ...
  public set internalValue(value: SpatialAnchorsAccountTimeouts | undefined) {
    if (value === undefined) {
...
export class SpatialAnchorsAccount extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SpatialAnchorsAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: SpatialAnchorsAccountTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: spatialAnchorsAccountTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
