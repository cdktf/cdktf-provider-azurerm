...
function postgresqlServerKeyTimeoutsToTerraform(struct?: PostgresqlServerKeyTimeoutsOutputReference | PostgresqlServerKeyTimeouts): any {
...
export class PostgresqlServerKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: PostgresqlServerKeyTimeouts | undefined; 
  private __timeoutsOutput = new PostgresqlServerKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: PostgresqlServerKeyTimeouts | undefined) {
