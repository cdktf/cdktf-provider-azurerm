...
export class DataAzurermApplicationSecurityGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermApplicationSecurityGroupTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermApplicationSecurityGroupTimeouts | undefined) {
    if (value === undefined) {
