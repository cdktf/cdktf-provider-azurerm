...
export function dataAzurermPublicIpPrefixTimeoutsToTerraform(struct?: DataAzurermPublicIpPrefixTimeoutsOutputReference | DataAzurermPublicIpPrefixTimeouts): any {
...
export class DataAzurermPublicIpPrefix extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPublicIpPrefixTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
