// https://www.terraform.io/docs/providers/azurerm/d/public_ip_prefix
...
export function dataAzurermPublicIpPrefixTimeoutsToTerraform(struct?: DataAzurermPublicIpPrefixTimeoutsOutputReference | DataAzurermPublicIpPrefixTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermPublicIpPrefixTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermPublicIpPrefixTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermPublicIpPrefixTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermPublicIpPrefix extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPublicIpPrefixTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
