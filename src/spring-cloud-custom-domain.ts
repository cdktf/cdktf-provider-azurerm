...
export function springCloudCustomDomainTimeoutsToTerraform(struct?: SpringCloudCustomDomainTimeoutsOutputReference | SpringCloudCustomDomainTimeouts): any {
...
export class SpringCloudCustomDomainTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SpringCloudCustomDomainTimeouts | undefined {
  ...
  public set internalValue(value: SpringCloudCustomDomainTimeouts | undefined) {
    if (value === undefined) {
...
export class SpringCloudCustomDomain extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SpringCloudCustomDomainTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
