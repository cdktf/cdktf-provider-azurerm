...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/data-sources/oracle_exadata_infrastructure
...
export class DataAzurermOracleExadataInfrastructure extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleExadataInfrastructure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/data-sources/oracle_exadata_infrastructure#import import section} in the documentation of this resource for the id to use
