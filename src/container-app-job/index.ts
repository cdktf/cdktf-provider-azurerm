...
export class ContainerAppJob extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerAppJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/container_app_job#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/container_app_job azurerm_container_app_job} Resource
  *
  * @param scope The scope in which to define this construct
