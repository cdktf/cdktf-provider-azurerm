...
export interface DataFactoryDatasetSqlServerTableConfig extends TerraformMetaArguments {
...
export class DataFactoryDatasetSqlServerTable extends TerraformResource {
  ...
  public set schemaColumn(value: DataFactoryDatasetSqlServerTableSchemaColumn[] | undefined) {
  ...
  public set timeouts(value: DataFactoryDatasetSqlServerTableTimeouts | undefined) {
