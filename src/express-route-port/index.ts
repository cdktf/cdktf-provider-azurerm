...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.4.0/docs/resources/express_route_port
...
export class ExpressRoutePort extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ExpressRoutePort that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.4.0/docs/resources/express_route_port#import import section} in the documentation of this resource for the id to use
