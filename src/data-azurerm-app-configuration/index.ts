// https://registry.terraform.io/providers/hashicorp/azurerm/4.17.0/docs/data-sources/app_configuration
...
export class DataAzurermAppConfiguration extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermAppConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.17.0/docs/data-sources/app_configuration#import import section} in the documentation of this resource for the id to use
