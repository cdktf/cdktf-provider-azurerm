// https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/machine_learning_datastore_blobstorage
...
export class MachineLearningDatastoreBlobstorage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MachineLearningDatastoreBlobstorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/machine_learning_datastore_blobstorage#import import section} in the documentation of this resource for the id to use
