...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/mssql_job_schedule
...
export interface MssqlJobScheduleConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function mssqlJobScheduleTimeoutsToTerraform(struct?: MssqlJobScheduleTimeouts | cdktf.IResolvable): any {
...
export function mssqlJobScheduleTimeoutsToHclTerraform(struct?: MssqlJobScheduleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MssqlJobScheduleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlJobScheduleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MssqlJobScheduleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class MssqlJobSchedule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlJobSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/mssql_job_schedule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MssqlJobSchedule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_mssql_job_schedule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/mssql_job_schedule azurerm_mssql_job_schedule} Resource
  *
  * @param scope The scope in which to define this construct
