...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.10.0/docs/data-sources/data_share_dataset_blob_storage
...
export class DataAzurermDataShareDatasetBlobStorage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDataShareDatasetBlobStorage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.10.0/docs/data-sources/data_share_dataset_blob_storage#import import section} in the documentation of this resource for the id to use
