...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/service_plan
...
export interface ServicePlanConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly premiumPlanAutoScaleEnabled?: boolean | cdktf.IResolvable;
  /**
...
export class ServicePlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/service_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/service_plan azurerm_service_plan} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ServicePlanConfig) {
    ...
    this._premiumPlanAutoScaleEnabled = config.premiumPlanAutoScaleEnabled;
  ...
  // premium_plan_auto_scale_enabled - computed: false, optional: true, required: false
  private _premiumPlanAutoScaleEnabled?: boolean | cdktf.IResolvable; 
  public get premiumPlanAutoScaleEnabled() {
    return this.getBooleanAttribute('premium_plan_auto_scale_enabled');
  }
  public set premiumPlanAutoScaleEnabled(value: boolean | cdktf.IResolvable) {
    this._premiumPlanAutoScaleEnabled = value;
  }
  public resetPremiumPlanAutoScaleEnabled() {
    this._premiumPlanAutoScaleEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get premiumPlanAutoScaleEnabledInput() {
    return this._premiumPlanAutoScaleEnabled;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      premium_plan_auto_scale_enabled: cdktf.booleanToTerraform(this._premiumPlanAutoScaleEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      premium_plan_auto_scale_enabled: {
        value: cdktf.booleanToHclTerraform(this._premiumPlanAutoScaleEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
