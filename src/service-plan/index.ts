...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/resources/service_plan
...
export class ServicePlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/resources/service_plan#import import section} in the documentation of this resource for the id to use
