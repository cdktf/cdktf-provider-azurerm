...
export function sqlManagedInstanceActiveDirectoryAdministratorTimeoutsToTerraform(struct?: SqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference | SqlManagedInstanceActiveDirectoryAdministratorTimeouts): any {
...
export class SqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SqlManagedInstanceActiveDirectoryAdministratorTimeouts | undefined {
  ...
  public set internalValue(value: SqlManagedInstanceActiveDirectoryAdministratorTimeouts | undefined) {
    if (value === undefined) {
...
export class SqlManagedInstanceActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_sql_managed_instance_active_directory_administrator";
  ...
  */
  ...
  private _timeouts = new SqlManagedInstanceActiveDirectoryAdministratorTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
