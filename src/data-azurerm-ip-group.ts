...
export function dataAzurermIpGroupTimeoutsToTerraform(struct?: DataAzurermIpGroupTimeoutsOutputReference | DataAzurermIpGroupTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermIpGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermIpGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
