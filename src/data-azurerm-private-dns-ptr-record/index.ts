...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/data-sources/private_dns_ptr_record
...
export class DataAzurermPrivateDnsPtrRecord extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPrivateDnsPtrRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/data-sources/private_dns_ptr_record#import import section} in the documentation of this resource for the id to use
