// https://www.terraform.io/docs/providers/azurerm/r/dns_a_record
...
export class DnsARecordTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DnsARecordTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DnsARecordTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DnsARecord extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_dns_a_record";
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/azurerm/r/dns_a_record azurerm_dns_a_record} Resource
  *
  ...
  */
  ...
  private _timeouts = new DnsARecordTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DnsARecordTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dnsARecordTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
