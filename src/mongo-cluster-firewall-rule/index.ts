...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/mongo_cluster_firewall_rule
...
export interface MongoClusterFirewallRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: MongoClusterFirewallRuleTimeouts;
}
export interface MongoClusterFirewallRuleTimeouts {
  /**
...
export function mongoClusterFirewallRuleTimeoutsToTerraform(struct?: MongoClusterFirewallRuleTimeouts | cdktf.IResolvable): any {
...
export function mongoClusterFirewallRuleTimeoutsToHclTerraform(struct?: MongoClusterFirewallRuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class MongoClusterFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MongoClusterFirewallRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: MongoClusterFirewallRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class MongoClusterFirewallRule extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_mongo_cluster_firewall_rule";
  ...
  * @param importToId The construct id used in the generated config for the MongoClusterFirewallRule to import
  * @param importFromId The id of the existing MongoClusterFirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/mongo_cluster_firewall_rule#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the MongoClusterFirewallRule to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_mongo_cluster_firewall_rule", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/mongo_cluster_firewall_rule azurerm_mongo_cluster_firewall_rule} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options MongoClusterFirewallRuleConfig
  */
  public constructor(scope: Construct, id: string, config: MongoClusterFirewallRuleConfig) {
    super(scope, id, {
      terraformResourceType: 'azurerm_mongo_cluster_firewall_rule',
  ...
  private _timeouts = new MongoClusterFirewallRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: MongoClusterFirewallRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: mongoClusterFirewallRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: mongoClusterFirewallRuleTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "MongoClusterFirewallRuleTimeouts",
      },
    };
