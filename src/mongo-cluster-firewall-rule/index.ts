...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/mongo_cluster_firewall_rule
...
export class MongoClusterFirewallRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MongoClusterFirewallRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/mongo_cluster_firewall_rule#import import section} in the documentation of this resource for the id to use
