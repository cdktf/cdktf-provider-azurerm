...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.96.0/docs/data-sources/eventhub_namespace_authorization_rule
...
export class DataAzurermEventhubNamespaceAuthorizationRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermEventhubNamespaceAuthorizationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.96.0/docs/data-sources/eventhub_namespace_authorization_rule#import import section} in the documentation of this resource for the id to use
