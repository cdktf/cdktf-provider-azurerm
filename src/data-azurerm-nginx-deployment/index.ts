...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.39.0/docs/data-sources/nginx_deployment
...
export class DataAzurermNginxDeployment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNginxDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.39.0/docs/data-sources/nginx_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.39.0/docs/data-sources/nginx_deployment azurerm_nginx_deployment} Data Source
  *
  * @param scope The scope in which to define this construct
