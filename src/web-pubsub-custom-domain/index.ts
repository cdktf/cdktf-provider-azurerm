...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/resources/web_pubsub_custom_domain
...
export class WebPubsubCustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebPubsubCustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/resources/web_pubsub_custom_domain#import import section} in the documentation of this resource for the id to use
