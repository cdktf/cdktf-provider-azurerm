// https://www.terraform.io/docs/providers/azurerm/r/app_service_managed_certificate
...
export interface AppServiceManagedCertificateConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/app_service_managed_certificate#id AppServiceManagedCertificate#id}
  *
...
export class AppServiceManagedCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppServiceManagedCertificateTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AppServiceManagedCertificateTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AppServiceManagedCertificate extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_app_service_managed_certificate";
  ...
  */
  ...
  private _timeouts = new AppServiceManagedCertificateTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AppServiceManagedCertificateTimeouts) {
