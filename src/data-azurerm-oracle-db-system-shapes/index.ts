...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/data-sources/oracle_db_system_shapes
...
export class DataAzurermOracleDbSystemShapes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleDbSystemShapes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/data-sources/oracle_db_system_shapes#import import section} in the documentation of this resource for the id to use
