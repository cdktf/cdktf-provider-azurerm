// https://www.terraform.io/docs/providers/azurerm/d/firewall
...
export class DataAzurermFirewallTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermFirewallTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermFirewallTimeouts | undefined) {
    if (value === undefined) {
