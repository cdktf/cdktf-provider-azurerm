...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/orbital_contact
...
export class OrbitalContact extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrbitalContact that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/orbital_contact#import import section} in the documentation of this resource for the id to use
