...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/data-sources/storage_table_entity
...
export class DataAzurermStorageTableEntity extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermStorageTableEntity that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/data-sources/storage_table_entity#import import section} in the documentation of this resource for the id to use
