// https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/traffic_manager_azure_endpoint
...
export class TrafficManagerAzureEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrafficManagerAzureEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.103.1/docs/resources/traffic_manager_azure_endpoint#import import section} in the documentation of this resource for the id to use
