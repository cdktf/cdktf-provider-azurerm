// https://registry.terraform.io/providers/hashicorp/azurerm/4.20.0/docs/resources/linux_function_app
...
export class LinuxFunctionApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinuxFunctionApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.20.0/docs/resources/linux_function_app#import import section} in the documentation of this resource for the id to use
