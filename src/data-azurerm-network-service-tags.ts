...
export function dataAzurermNetworkServiceTagsTimeoutsToTerraform(struct?: DataAzurermNetworkServiceTagsTimeoutsOutputReference | DataAzurermNetworkServiceTagsTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermNetworkServiceTags extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermNetworkServiceTagsTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
