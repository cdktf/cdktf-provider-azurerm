...
export function dataAzurermKeyVaultSecretTimeoutsToTerraform(struct?: DataAzurermKeyVaultSecretTimeoutsOutputReference | DataAzurermKeyVaultSecretTimeouts): any {
...
export class DataAzurermKeyVaultSecret extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermKeyVaultSecretTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
