// https://www.terraform.io/docs/providers/azurerm/d/key_vault_secret
...
export function dataAzurermKeyVaultSecretTimeoutsToTerraform(struct?: DataAzurermKeyVaultSecretTimeoutsOutputReference | DataAzurermKeyVaultSecretTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermKeyVaultSecret extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermKeyVaultSecretTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
