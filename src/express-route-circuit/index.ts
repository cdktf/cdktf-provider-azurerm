...
export class ExpressRouteCircuit extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.66.0/docs/resources/express_route_circuit azurerm_express_route_circuit} Resource
  *
