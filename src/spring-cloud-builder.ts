// https://www.terraform.io/docs/providers/azurerm/r/spring_cloud_builder
...
export function springCloudBuilderBuildPackGroupToTerraform(struct?: SpringCloudBuilderBuildPackGroup | cdktf.IResolvable): any {
  ...
  return {
    build_pack_ids: cdktf.listMapper(cdktf.stringToTerraform)(struct!.buildPackIds),
...
export function springCloudBuilderTimeoutsToTerraform(struct?: SpringCloudBuilderTimeoutsOutputReference | SpringCloudBuilderTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      build_pack_group: cdktf.listMapper(springCloudBuilderBuildPackGroupToTerraform)(this._buildPackGroup.internalValue),
