...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/oracle_autonomous_database_backup
...
export interface OracleAutonomousDatabaseBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: OracleAutonomousDatabaseBackupTimeouts;
}
export interface OracleAutonomousDatabaseBackupTimeouts {
  /**
...
export function oracleAutonomousDatabaseBackupTimeoutsToTerraform(struct?: OracleAutonomousDatabaseBackupTimeouts | cdktf.IResolvable): any {
...
export function oracleAutonomousDatabaseBackupTimeoutsToHclTerraform(struct?: OracleAutonomousDatabaseBackupTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class OracleAutonomousDatabaseBackupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OracleAutonomousDatabaseBackupTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: OracleAutonomousDatabaseBackupTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class OracleAutonomousDatabaseBackup extends cdktf.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the OracleAutonomousDatabaseBackup to import
  * @param importFromId The id of the existing OracleAutonomousDatabaseBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/oracle_autonomous_database_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/oracle_autonomous_database_backup azurerm_oracle_autonomous_database_backup} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OracleAutonomousDatabaseBackupConfig
  */
  public constructor(scope: Construct, id: string, config: OracleAutonomousDatabaseBackupConfig) {
    super(scope, id, {
  ...
  private _timeouts = new OracleAutonomousDatabaseBackupTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OracleAutonomousDatabaseBackupTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: oracleAutonomousDatabaseBackupTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: oracleAutonomousDatabaseBackupTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OracleAutonomousDatabaseBackupTimeouts",
      },
    };
