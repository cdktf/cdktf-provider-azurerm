// https://registry.terraform.io/providers/hashicorp/azurerm/3.85.0/docs/resources/synapse_spark_pool
...
export class SynapseSparkPool extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SynapseSparkPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.85.0/docs/resources/synapse_spark_pool#import import section} in the documentation of this resource for the id to use
