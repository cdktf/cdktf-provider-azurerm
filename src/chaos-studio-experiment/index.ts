...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/resources/chaos_studio_experiment
...
export class ChaosStudioExperiment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ChaosStudioExperiment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/resources/chaos_studio_experiment#import import section} in the documentation of this resource for the id to use
