...
export class DataAzurermAutomationVariableBoolTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariableBoolTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermAutomationVariableBoolTimeouts | undefined) {
    if (value === undefined) {
