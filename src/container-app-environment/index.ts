...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/container_app_environment
...
export interface ContainerAppEnvironmentConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly logsDestination?: string;
  /**
  ...
  */
  readonly identity?: ContainerAppEnvironmentIdentity;
  /**
  * timeouts block
  *
...
export class ContainerAppEnvironmentIdentityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ContainerAppEnvironmentIdentity | undefined {
  ...
  public set internalValue(value: ContainerAppEnvironmentIdentity | undefined) {
    if (value === undefined) {
...
export class ContainerAppEnvironment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerAppEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/container_app_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/container_app_environment azurerm_container_app_environment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ContainerAppEnvironmentConfig) {
    ...
    this._logsDestination = config.logsDestination;
  ...
  // logs_destination - computed: true, optional: true, required: false
  private _logsDestination?: string; 
  public get logsDestination() {
    return this.getStringAttribute('logs_destination');
  }
  public set logsDestination(value: string) {
    this._logsDestination = value;
  }
  public resetLogsDestination() {
    this._logsDestination = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get logsDestinationInput() {
    return this._logsDestination;
  }
  ...
  private _identity = new ContainerAppEnvironmentIdentityOutputReference(this, "identity");
  public get identity() {
    return this._identity;
  }
  public putIdentity(value: ContainerAppEnvironmentIdentity) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      identity: {
        value: containerAppEnvironmentIdentityToHclTerraform(this._identity.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ContainerAppEnvironmentIdentityList",
      },
      timeouts: {
