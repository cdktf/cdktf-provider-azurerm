...
export function apiManagementApiOperationTagTimeoutsToTerraform(struct?: ApiManagementApiOperationTagTimeoutsOutputReference | ApiManagementApiOperationTagTimeouts): any {
...
export class ApiManagementApiOperationTagTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementApiOperationTagTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementApiOperationTagTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementApiOperationTag extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementApiOperationTagTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
