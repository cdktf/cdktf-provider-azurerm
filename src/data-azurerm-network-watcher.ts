...
export function dataAzurermNetworkWatcherTimeoutsToTerraform(struct?: DataAzurermNetworkWatcherTimeoutsOutputReference | DataAzurermNetworkWatcherTimeouts): any {
...
export class DataAzurermNetworkWatcherTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermNetworkWatcherTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermNetworkWatcherTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermNetworkWatcher extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermNetworkWatcherTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
