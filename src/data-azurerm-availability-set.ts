...
export function dataAzurermAvailabilitySetTimeoutsToTerraform(struct?: DataAzurermAvailabilitySetTimeoutsOutputReference | DataAzurermAvailabilitySetTimeouts): any {
...
export class DataAzurermAvailabilitySetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAvailabilitySetTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermAvailabilitySetTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermAvailabilitySet extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAvailabilitySetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
