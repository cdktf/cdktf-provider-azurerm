...
export class DataAzurermDevTestLabTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDevTestLabTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermDevTestLabTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermDevTestLab extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDevTestLabTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
