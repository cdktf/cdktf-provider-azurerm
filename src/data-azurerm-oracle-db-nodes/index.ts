...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/data-sources/oracle_db_nodes
...
export class DataAzurermOracleDbNodes extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleDbNodes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/data-sources/oracle_db_nodes#import import section} in the documentation of this resource for the id to use
