...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.28.0/docs/data-sources/images
...
export class DataAzurermImages extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermImages that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.28.0/docs/data-sources/images#import import section} in the documentation of this resource for the id to use
