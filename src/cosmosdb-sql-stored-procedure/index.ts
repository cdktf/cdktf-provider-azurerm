// https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/cosmosdb_sql_stored_procedure
...
export class CosmosdbSqlStoredProcedure extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbSqlStoredProcedure that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/cosmosdb_sql_stored_procedure#import import section} in the documentation of this resource for the id to use
