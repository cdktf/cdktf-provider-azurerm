// https://registry.terraform.io/providers/hashicorp/azurerm/4.16.0/docs/resources/trusted_signing_account
...
export class TrustedSigningAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TrustedSigningAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.16.0/docs/resources/trusted_signing_account#import import section} in the documentation of this resource for the id to use
