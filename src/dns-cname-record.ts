...
export function dnsCnameRecordTimeoutsToTerraform(struct?: DnsCnameRecordTimeoutsOutputReference | DnsCnameRecordTimeouts): any {
...
export class DnsCnameRecordTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DnsCnameRecordTimeouts | undefined {
  ...
  public set internalValue(value: DnsCnameRecordTimeouts | undefined) {
    if (value === undefined) {
...
export class DnsCnameRecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DnsCnameRecordTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
