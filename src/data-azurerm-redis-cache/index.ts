...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.33.0/docs/data-sources/redis_cache
...
export class DataAzurermRedisCache extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermRedisCache that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.33.0/docs/data-sources/redis_cache#import import section} in the documentation of this resource for the id to use
