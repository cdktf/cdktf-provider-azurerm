...
export function apiManagementApiOperationPolicyTimeoutsToTerraform(struct?: ApiManagementApiOperationPolicyTimeoutsOutputReference | ApiManagementApiOperationPolicyTimeouts): any {
...
export class ApiManagementApiOperationPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementApiOperationPolicyTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementApiOperationPolicyTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementApiOperationPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementApiOperationPolicyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
