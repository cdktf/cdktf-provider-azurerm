...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.101.0/docs/data-sources/template_spec_version
...
export class DataAzurermTemplateSpecVersion extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermTemplateSpecVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.101.0/docs/data-sources/template_spec_version#import import section} in the documentation of this resource for the id to use
