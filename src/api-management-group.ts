...
export function apiManagementGroupTimeoutsToTerraform(struct?: ApiManagementGroupTimeoutsOutputReference | ApiManagementGroupTimeouts): any {
...
export class ApiManagementGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
