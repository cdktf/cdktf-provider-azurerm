// https://www.terraform.io/docs/providers/azurerm/r/api_management_group
...
export function apiManagementGroupTimeoutsToTerraform(struct?: ApiManagementGroupTimeoutsOutputReference | ApiManagementGroupTimeouts | cdktf.IResolvable): any {
...
export class ApiManagementGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementGroupTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
