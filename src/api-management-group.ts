...
function apiManagementGroupTimeoutsToTerraform(struct?: ApiManagementGroupTimeoutsOutputReference | ApiManagementGroupTimeouts): any {
...
export class ApiManagementGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ApiManagementGroupTimeouts | undefined; 
  private __timeoutsOutput = new ApiManagementGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: ApiManagementGroupTimeouts | undefined) {
