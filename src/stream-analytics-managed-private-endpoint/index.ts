...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/stream_analytics_managed_private_endpoint
...
export class StreamAnalyticsManagedPrivateEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamAnalyticsManagedPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/stream_analytics_managed_private_endpoint#import import section} in the documentation of this resource for the id to use
