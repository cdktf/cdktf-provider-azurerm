...
function managementGroupTemplateDeploymentTimeoutsToTerraform(struct?: ManagementGroupTemplateDeploymentTimeouts): any {
...
export class ManagementGroupTemplateDeployment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ManagementGroupTemplateDeploymentTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: ManagementGroupTemplateDeploymentTimeouts ) {
