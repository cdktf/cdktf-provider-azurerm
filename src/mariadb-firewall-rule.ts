...
export interface MariadbFirewallRuleConfig extends TerraformMetaArguments {
...
export class MariadbFirewallRule extends TerraformResource {
  ...
  public set timeouts(value: MariadbFirewallRuleTimeouts | undefined) {
