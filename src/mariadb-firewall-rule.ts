...
export function mariadbFirewallRuleTimeoutsToTerraform(struct?: MariadbFirewallRuleTimeoutsOutputReference | MariadbFirewallRuleTimeouts): any {
...
export class MariadbFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MariadbFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: MariadbFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MariadbFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MariadbFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
