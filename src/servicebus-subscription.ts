// https://www.terraform.io/docs/providers/azurerm/r/servicebus_subscription
...
export class ServicebusSubscriptionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicebusSubscriptionTimeouts | undefined {
  ...
  public set internalValue(value: ServicebusSubscriptionTimeouts | undefined) {
    if (value === undefined) {
