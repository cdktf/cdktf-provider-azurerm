...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/security_center_assessment_policy
...
export class SecurityCenterAssessmentPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityCenterAssessmentPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/security_center_assessment_policy#import import section} in the documentation of this resource for the id to use
