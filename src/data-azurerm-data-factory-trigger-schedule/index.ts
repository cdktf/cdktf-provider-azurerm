// https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/data-sources/data_factory_trigger_schedule
...
export class DataAzurermDataFactoryTriggerSchedule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermDataFactoryTriggerSchedule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/data-sources/data_factory_trigger_schedule#import import section} in the documentation of this resource for the id to use
