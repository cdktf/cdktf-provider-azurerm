...
export function mysqlVirtualNetworkRuleTimeoutsToTerraform(struct?: MysqlVirtualNetworkRuleTimeoutsOutputReference | MysqlVirtualNetworkRuleTimeouts): any {
...
export class MysqlVirtualNetworkRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlVirtualNetworkRuleTimeouts | undefined {
  ...
  public set internalValue(value: MysqlVirtualNetworkRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MysqlVirtualNetworkRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MysqlVirtualNetworkRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
