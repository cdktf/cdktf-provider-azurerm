...
export function dataAzurermBillingEnrollmentAccountScopeTimeoutsToTerraform(struct?: DataAzurermBillingEnrollmentAccountScopeTimeoutsOutputReference | DataAzurermBillingEnrollmentAccountScopeTimeouts): any {
...
export class DataAzurermBillingEnrollmentAccountScope extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermBillingEnrollmentAccountScopeTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
