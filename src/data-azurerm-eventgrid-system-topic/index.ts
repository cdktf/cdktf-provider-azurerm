...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/data-sources/eventgrid_system_topic
...
export class DataAzurermEventgridSystemTopic extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermEventgridSystemTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/data-sources/eventgrid_system_topic#import import section} in the documentation of this resource for the id to use
