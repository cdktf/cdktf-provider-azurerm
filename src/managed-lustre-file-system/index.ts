// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/managed_lustre_file_system
...
export class ManagedLustreFileSystem extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedLustreFileSystem that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/managed_lustre_file_system#import import section} in the documentation of this resource for the id to use
