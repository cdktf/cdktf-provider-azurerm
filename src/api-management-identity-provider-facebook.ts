...
export function apiManagementIdentityProviderFacebookTimeoutsToTerraform(struct?: ApiManagementIdentityProviderFacebookTimeoutsOutputReference | ApiManagementIdentityProviderFacebookTimeouts): any {
...
export class ApiManagementIdentityProviderFacebook extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementIdentityProviderFacebookTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
