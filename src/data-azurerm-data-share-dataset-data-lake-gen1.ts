...
export interface DataAzurermDataShareDatasetDataLakeGen1Config extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/data_share_dataset_data_lake_gen1#id DataAzurermDataShareDatasetDataLakeGen1#id}
  *
...
export function dataAzurermDataShareDatasetDataLakeGen1TimeoutsToTerraform(struct?: DataAzurermDataShareDatasetDataLakeGen1TimeoutsOutputReference | DataAzurermDataShareDatasetDataLakeGen1Timeouts | cdktf.IResolvable): any {
...
export class DataAzurermDataShareDatasetDataLakeGen1TimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDataShareDatasetDataLakeGen1Timeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermDataShareDatasetDataLakeGen1Timeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermDataShareDatasetDataLakeGen1 extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_data_share_dataset_data_lake_gen1";
  ...
  */
  ...
  private _timeouts = new DataAzurermDataShareDatasetDataLakeGen1TimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
