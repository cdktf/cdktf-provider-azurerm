...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/data_protection_backup_vault_customer_managed_key
...
export interface DataProtectionBackupVaultCustomerManagedKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: DataProtectionBackupVaultCustomerManagedKeyTimeouts;
}
export interface DataProtectionBackupVaultCustomerManagedKeyTimeouts {
  /**
...
export function dataProtectionBackupVaultCustomerManagedKeyTimeoutsToTerraform(struct?: DataProtectionBackupVaultCustomerManagedKeyTimeouts | cdktf.IResolvable): any {
...
export function dataProtectionBackupVaultCustomerManagedKeyTimeoutsToHclTerraform(struct?: DataProtectionBackupVaultCustomerManagedKeyTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataProtectionBackupVaultCustomerManagedKeyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataProtectionBackupVaultCustomerManagedKeyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataProtectionBackupVaultCustomerManagedKeyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataProtectionBackupVaultCustomerManagedKey extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_data_protection_backup_vault_customer_managed_key";
  ...
  * @param importToId The construct id used in the generated config for the DataProtectionBackupVaultCustomerManagedKey to import
  * @param importFromId The id of the existing DataProtectionBackupVaultCustomerManagedKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/data_protection_backup_vault_customer_managed_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_data_protection_backup_vault_customer_managed_key", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/data_protection_backup_vault_customer_managed_key azurerm_data_protection_backup_vault_customer_managed_key} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataProtectionBackupVaultCustomerManagedKeyConfig
  */
  public constructor(scope: Construct, id: string, config: DataProtectionBackupVaultCustomerManagedKeyConfig) {
    super(scope, id, {
      terraformResourceType: 'azurerm_data_protection_backup_vault_customer_managed_key',
  ...
  private _timeouts = new DataProtectionBackupVaultCustomerManagedKeyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataProtectionBackupVaultCustomerManagedKeyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      data_protection_backup_vault_id: cdktf.stringToTerraform(this._dataProtectionBackupVaultId),
      id: cdktf.stringToTerraform(this._id),
      key_vault_key_id: cdktf.stringToTerraform(this._keyVaultKeyId),
      timeouts: dataProtectionBackupVaultCustomerManagedKeyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      data_protection_backup_vault_id: {
        value: cdktf.stringToHclTerraform(this._dataProtectionBackupVaultId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      timeouts: {
        value: dataProtectionBackupVaultCustomerManagedKeyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "DataProtectionBackupVaultCustomerManagedKeyTimeouts",
      },
    };
