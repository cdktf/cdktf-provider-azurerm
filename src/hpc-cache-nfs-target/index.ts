// https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/resources/hpc_cache_nfs_target
...
export class HpcCacheNfsTarget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HpcCacheNfsTarget that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/resources/hpc_cache_nfs_target#import import section} in the documentation of this resource for the id to use
