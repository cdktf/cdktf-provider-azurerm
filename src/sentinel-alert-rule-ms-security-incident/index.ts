...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/sentinel_alert_rule_ms_security_incident
...
export class SentinelAlertRuleMsSecurityIncident extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SentinelAlertRuleMsSecurityIncident that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/sentinel_alert_rule_ms_security_incident#import import section} in the documentation of this resource for the id to use
