...
export function loadTestTimeoutsToTerraform(struct?: LoadTestTimeoutsOutputReference | LoadTestTimeouts | cdktf.IResolvable): any {
...
export class LoadTest extends cdktf.TerraformResource {
  ...
  */
  ...
  // dataplane_uri - computed: true, optional: false, required: false
  public get dataplaneUri() {
    return this.getStringAttribute('dataplane_uri');
  }
