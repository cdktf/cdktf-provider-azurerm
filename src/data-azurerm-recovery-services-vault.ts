...
export class DataAzurermRecoveryServicesVaultTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermRecoveryServicesVaultTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermRecoveryServicesVault extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermRecoveryServicesVaultTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
