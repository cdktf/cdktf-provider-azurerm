...
export function dataAzurermRecoveryServicesVaultTimeoutsToTerraform(struct?: DataAzurermRecoveryServicesVaultTimeoutsOutputReference | DataAzurermRecoveryServicesVaultTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermRecoveryServicesVaultTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermRecoveryServicesVaultTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermRecoveryServicesVaultTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermRecoveryServicesVault extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermRecoveryServicesVaultTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermRecoveryServicesVaultTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermRecoveryServicesVaultTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
