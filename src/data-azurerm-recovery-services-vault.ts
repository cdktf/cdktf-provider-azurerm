...
export function dataAzurermRecoveryServicesVaultTimeoutsToTerraform(struct?: DataAzurermRecoveryServicesVaultTimeoutsOutputReference | DataAzurermRecoveryServicesVaultTimeouts): any {
...
export class DataAzurermRecoveryServicesVault extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermRecoveryServicesVaultTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
