...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/resources/lb_backend_address_pool_address
...
export class LbBackendAddressPoolAddress extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbBackendAddressPoolAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/resources/lb_backend_address_pool_address#import import section} in the documentation of this resource for the id to use
