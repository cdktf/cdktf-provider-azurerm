...
export function diskPoolTimeoutsToTerraform(struct?: DiskPoolTimeoutsOutputReference | DiskPoolTimeouts | cdktf.IResolvable): any {
...
export class DiskPoolTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DiskPoolTimeouts | undefined {
  ...
  public set internalValue(value: DiskPoolTimeouts | undefined) {
    if (value === undefined) {
...
export class DiskPool extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_disk_pool";
  ...
  */
  ...
  private _timeouts = new DiskPoolTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
