...
export function diskPoolTimeoutsToTerraform(struct?: DiskPoolTimeoutsOutputReference | DiskPoolTimeouts): any {
...
export class DiskPool extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DiskPoolTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
