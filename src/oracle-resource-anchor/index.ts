...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/oracle_resource_anchor
...
export class OracleResourceAnchor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OracleResourceAnchor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/oracle_resource_anchor#import import section} in the documentation of this resource for the id to use
