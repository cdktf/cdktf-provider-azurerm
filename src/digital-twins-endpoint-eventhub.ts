// https://www.terraform.io/docs/providers/azurerm/r/digital_twins_endpoint_eventhub
...
export function digitalTwinsEndpointEventhubTimeoutsToTerraform(struct?: DigitalTwinsEndpointEventhubTimeoutsOutputReference | DigitalTwinsEndpointEventhubTimeouts | cdktf.IResolvable): any {
...
export class DigitalTwinsEndpointEventhubTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DigitalTwinsEndpointEventhubTimeouts | undefined {
  ...
  public set internalValue(value: DigitalTwinsEndpointEventhubTimeouts | undefined) {
    if (value === undefined) {
...
export class DigitalTwinsEndpointEventhub extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DigitalTwinsEndpointEventhubTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
