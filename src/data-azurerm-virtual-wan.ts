...
export function dataAzurermVirtualWanTimeoutsToTerraform(struct?: DataAzurermVirtualWanTimeoutsOutputReference | DataAzurermVirtualWanTimeouts): any {
...
export class DataAzurermVirtualWan extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermVirtualWanTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
