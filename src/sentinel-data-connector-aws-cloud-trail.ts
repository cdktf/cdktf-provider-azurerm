...
export function sentinelDataConnectorAwsCloudTrailTimeoutsToTerraform(struct?: SentinelDataConnectorAwsCloudTrailTimeoutsOutputReference | SentinelDataConnectorAwsCloudTrailTimeouts): any {
...
export class SentinelDataConnectorAwsCloudTrailTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: SentinelDataConnectorAwsCloudTrailTimeouts | undefined) {
    if (value === undefined) {
...
export class SentinelDataConnectorAwsCloudTrail extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SentinelDataConnectorAwsCloudTrailTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
