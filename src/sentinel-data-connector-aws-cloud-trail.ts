...
export function sentinelDataConnectorAwsCloudTrailTimeoutsToTerraform(struct?: SentinelDataConnectorAwsCloudTrailTimeoutsOutputReference | SentinelDataConnectorAwsCloudTrailTimeouts | cdktf.IResolvable): any {
...
export class SentinelDataConnectorAwsCloudTrailTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SentinelDataConnectorAwsCloudTrailTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SentinelDataConnectorAwsCloudTrailTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SentinelDataConnectorAwsCloudTrail extends cdktf.TerraformResource {
  ...
  */
  ...
  public putTimeouts(value: SentinelDataConnectorAwsCloudTrailTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: sentinelDataConnectorAwsCloudTrailTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
