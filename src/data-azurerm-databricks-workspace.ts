...
export function dataAzurermDatabricksWorkspaceTimeoutsToTerraform(struct?: DataAzurermDatabricksWorkspaceTimeoutsOutputReference | DataAzurermDatabricksWorkspaceTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermDatabricksWorkspaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDatabricksWorkspaceTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDatabricksWorkspaceTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDatabricksWorkspace extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDatabricksWorkspaceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
