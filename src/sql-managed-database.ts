...
export function sqlManagedDatabaseTimeoutsToTerraform(struct?: SqlManagedDatabaseTimeoutsOutputReference | SqlManagedDatabaseTimeouts | cdktf.IResolvable): any {
...
export class SqlManagedDatabase extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SqlManagedDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
