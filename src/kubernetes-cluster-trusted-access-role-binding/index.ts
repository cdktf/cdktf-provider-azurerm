...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/kubernetes_cluster_trusted_access_role_binding
...
export class KubernetesClusterTrustedAccessRoleBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesClusterTrustedAccessRoleBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/kubernetes_cluster_trusted_access_role_binding#import import section} in the documentation of this resource for the id to use
