...
export function monitorPrivateLinkScopedServiceTimeoutsToTerraform(struct?: MonitorPrivateLinkScopedServiceTimeoutsOutputReference | MonitorPrivateLinkScopedServiceTimeouts | cdktf.IResolvable): any {
...
export class MonitorPrivateLinkScopedService extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MonitorPrivateLinkScopedServiceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
