...
function monitorPrivateLinkScopedServiceTimeoutsToTerraform(struct?: MonitorPrivateLinkScopedServiceTimeoutsOutputReference | MonitorPrivateLinkScopedServiceTimeouts): any {
...
export class MonitorPrivateLinkScopedService extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: MonitorPrivateLinkScopedServiceTimeouts | undefined; 
  private __timeoutsOutput = new MonitorPrivateLinkScopedServiceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: MonitorPrivateLinkScopedServiceTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: monitorPrivateLinkScopedServiceTimeoutsToTerraform(this._timeouts),
    };
  }
}
