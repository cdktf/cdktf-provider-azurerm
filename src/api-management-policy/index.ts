...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/resources/api_management_policy
...
export class ApiManagementPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/resources/api_management_policy#import import section} in the documentation of this resource for the id to use
