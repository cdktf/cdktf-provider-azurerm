...
function dataAzurermSubnetTimeoutsToTerraform(struct?: DataAzurermSubnetTimeoutsOutputReference | DataAzurermSubnetTimeouts): any {
...
export class DataAzurermSubnet extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts?: DataAzurermSubnetTimeouts | undefined; 
  private __timeoutsOutput = new DataAzurermSubnetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: DataAzurermSubnetTimeouts | undefined) {
