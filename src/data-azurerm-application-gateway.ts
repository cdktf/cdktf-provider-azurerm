...
export function dataAzurermApplicationGatewayTimeoutsToTerraform(struct?: DataAzurermApplicationGatewayTimeoutsOutputReference | DataAzurermApplicationGatewayTimeouts): any {
...
export class DataAzurermApplicationGatewayTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermApplicationGatewayTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermApplicationGateway extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApplicationGatewayTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
