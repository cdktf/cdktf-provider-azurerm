...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/web_pubsub_shared_private_link_resource
...
export class WebPubsubSharedPrivateLinkResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebPubsubSharedPrivateLinkResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/web_pubsub_shared_private_link_resource#import import section} in the documentation of this resource for the id to use
