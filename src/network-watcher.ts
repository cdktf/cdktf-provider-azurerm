...
export function networkWatcherTimeoutsToTerraform(struct?: NetworkWatcherTimeoutsOutputReference | NetworkWatcherTimeouts): any {
...
export class NetworkWatcherTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkWatcherTimeouts | undefined {
  ...
  public set internalValue(value: NetworkWatcherTimeouts | undefined) {
    if (value === undefined) {
...
export class NetworkWatcher extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new NetworkWatcherTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
