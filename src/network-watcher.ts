...
function networkWatcherTimeoutsToTerraform(struct?: NetworkWatcherTimeoutsOutputReference | NetworkWatcherTimeouts): any {
...
export class NetworkWatcher extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: NetworkWatcherTimeouts | undefined; 
  private __timeoutsOutput = new NetworkWatcherTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: NetworkWatcherTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: networkWatcherTimeoutsToTerraform(this._timeouts),
    };
  }
}
