...
function networkWatcherTimeoutsToTerraform(struct?: NetworkWatcherTimeouts): any {
...
export class NetworkWatcher extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: NetworkWatcherTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: NetworkWatcherTimeouts ) {
