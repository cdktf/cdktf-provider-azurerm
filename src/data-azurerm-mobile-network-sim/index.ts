...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim
...
export interface DataAzurermMobileNetworkSimConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim#id DataAzurermMobileNetworkSim#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim#mobile_network_sim_group_id DataAzurermMobileNetworkSim#mobile_network_sim_group_id}
  */
  readonly mobileNetworkSimGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim#name DataAzurermMobileNetworkSim#name}
  */
  readonly name: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim#timeouts DataAzurermMobileNetworkSim#timeouts}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim azurerm_mobile_network_sim}
*/
export class DataAzurermMobileNetworkSim extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMobileNetworkSim that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.113.0/docs/data-sources/mobile_network_sim azurerm_mobile_network_sim} Data Source
  *
  * @param scope The scope in which to define this construct
