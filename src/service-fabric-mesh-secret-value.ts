// https://www.terraform.io/docs/providers/azurerm/r/service_fabric_mesh_secret_value
...
export interface ServiceFabricMeshSecretValueConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/service_fabric_mesh_secret_value#id ServiceFabricMeshSecretValue#id}
  *
...
export function serviceFabricMeshSecretValueTimeoutsToTerraform(struct?: ServiceFabricMeshSecretValueTimeoutsOutputReference | ServiceFabricMeshSecretValueTimeouts | cdktf.IResolvable): any {
...
export class ServiceFabricMeshSecretValueTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServiceFabricMeshSecretValueTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ServiceFabricMeshSecretValueTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ServiceFabricMeshSecretValue extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_service_fabric_mesh_secret_value";
  ...
  */
  ...
  private _timeouts = new ServiceFabricMeshSecretValueTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
