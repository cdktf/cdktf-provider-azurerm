...
function serviceFabricMeshSecretValueTimeoutsToTerraform(struct?: ServiceFabricMeshSecretValueTimeoutsOutputReference | ServiceFabricMeshSecretValueTimeouts): any {
...
export class ServiceFabricMeshSecretValue extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ServiceFabricMeshSecretValueTimeouts | undefined; 
  private __timeoutsOutput = new ServiceFabricMeshSecretValueTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: ServiceFabricMeshSecretValueTimeouts | undefined) {
