...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/elastic_san_volume_group
...
export class ElasticSanVolumeGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ElasticSanVolumeGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/elastic_san_volume_group#import import section} in the documentation of this resource for the id to use
