...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/windows_web_app
...
export class WindowsWebApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WindowsWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/windows_web_app#import import section} in the documentation of this resource for the id to use
