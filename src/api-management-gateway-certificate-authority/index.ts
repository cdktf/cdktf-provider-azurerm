...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/api_management_gateway_certificate_authority
...
export class ApiManagementGatewayCertificateAuthority extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementGatewayCertificateAuthority that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/api_management_gateway_certificate_authority#import import section} in the documentation of this resource for the id to use
