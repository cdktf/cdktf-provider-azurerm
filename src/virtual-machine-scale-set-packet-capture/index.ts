// https://www.terraform.io/docs/providers/azurerm/r/virtual_machine_scale_set_packet_capture
...
export function virtualMachineScaleSetPacketCaptureTimeoutsToTerraform(struct?: VirtualMachineScaleSetPacketCaptureTimeoutsOutputReference | VirtualMachineScaleSetPacketCaptureTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
