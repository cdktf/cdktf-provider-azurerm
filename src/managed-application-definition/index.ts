...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/resources/managed_application_definition
...
export class ManagedApplicationDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedApplicationDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/resources/managed_application_definition#import import section} in the documentation of this resource for the id to use
