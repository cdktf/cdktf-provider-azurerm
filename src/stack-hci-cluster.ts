...
export function stackHciClusterTimeoutsToTerraform(struct?: StackHciClusterTimeoutsOutputReference | StackHciClusterTimeouts): any {
...
export class StackHciClusterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: StackHciClusterTimeouts | undefined) {
    if (value === undefined) {
...
export class StackHciCluster extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new StackHciClusterTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
