...
export class DnsTxtRecordTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DnsTxtRecordTimeouts | undefined {
  ...
  public set internalValue(value: DnsTxtRecordTimeouts | undefined) {
    if (value === undefined) {
...
export class DnsTxtRecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _record?: DnsTxtRecordRecord[] | cdktf.IResolvable; 
  public get record() {
    // Getting the computed value is not yet implemented
    return cdktf.Token.asAny(cdktf.Fn.tolist(this.interpolationForAttribute('record')));
  }
  public set record(value: DnsTxtRecordRecord[] | cdktf.IResolvable) {
    this._record = value;
  }
  // Temporarily expose input value. Use with caution.
  ...
  private _timeouts = new DnsTxtRecordTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
