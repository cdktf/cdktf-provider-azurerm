...
export function dnsTxtRecordRecordToTerraform(struct?: DnsTxtRecordRecord): any {
...
export function dnsTxtRecordTimeoutsToTerraform(struct?: DnsTxtRecordTimeoutsOutputReference | DnsTxtRecordTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DnsTxtRecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DnsTxtRecordTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
