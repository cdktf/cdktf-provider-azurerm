...
export function apiManagementProductPolicyTimeoutsToTerraform(struct?: ApiManagementProductPolicyTimeoutsOutputReference | ApiManagementProductPolicyTimeouts): any {
...
export class ApiManagementProductPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementProductPolicyTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementProductPolicyTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementProductPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementProductPolicyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
