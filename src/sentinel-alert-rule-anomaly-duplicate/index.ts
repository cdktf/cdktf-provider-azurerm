...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.19.0/docs/resources/sentinel_alert_rule_anomaly_duplicate
...
export class SentinelAlertRuleAnomalyDuplicate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SentinelAlertRuleAnomalyDuplicate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.19.0/docs/resources/sentinel_alert_rule_anomaly_duplicate#import import section} in the documentation of this resource for the id to use
