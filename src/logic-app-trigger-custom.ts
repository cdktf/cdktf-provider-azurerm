...
export function logicAppTriggerCustomTimeoutsToTerraform(struct?: LogicAppTriggerCustomTimeoutsOutputReference | LogicAppTriggerCustomTimeouts): any {
...
export class LogicAppTriggerCustomTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LogicAppTriggerCustomTimeouts | undefined {
  ...
  public set internalValue(value: LogicAppTriggerCustomTimeouts | undefined) {
    if (value === undefined) {
...
export class LogicAppTriggerCustom extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LogicAppTriggerCustomTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
