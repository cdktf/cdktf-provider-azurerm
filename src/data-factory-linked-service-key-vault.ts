...
export function dataFactoryLinkedServiceKeyVaultTimeoutsToTerraform(struct?: DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference | DataFactoryLinkedServiceKeyVaultTimeouts): any {
...
export class DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataFactoryLinkedServiceKeyVaultTimeouts | undefined) {
    if (value === undefined) {
...
export class DataFactoryLinkedServiceKeyVault extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataFactoryLinkedServiceKeyVaultTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
