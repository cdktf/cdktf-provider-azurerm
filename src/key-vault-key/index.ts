// https://registry.terraform.io/providers/hashicorp/azurerm/4.11.0/docs/resources/key_vault_key
...
export class KeyVaultKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyVaultKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.11.0/docs/resources/key_vault_key#import import section} in the documentation of this resource for the id to use
