...
export function dataAzurermDataShareDatasetKustoDatabaseTimeoutsToTerraform(struct?: DataAzurermDataShareDatasetKustoDatabaseTimeoutsOutputReference | DataAzurermDataShareDatasetKustoDatabaseTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermDataShareDatasetKustoDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermDataShareDatasetKustoDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDataShareDatasetKustoDatabase extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDataShareDatasetKustoDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
