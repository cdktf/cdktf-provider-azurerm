// https://registry.terraform.io/providers/hashicorp/azurerm/4.29.0/docs/resources/backup_policy_vm
...
export class BackupPolicyVm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupPolicyVm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.29.0/docs/resources/backup_policy_vm#import import section} in the documentation of this resource for the id to use
