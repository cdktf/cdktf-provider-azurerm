// https://www.terraform.io/docs/providers/azurerm/r/private_dns_zone_virtual_network_link
...
export function privateDnsZoneVirtualNetworkLinkTimeoutsToTerraform(struct?: PrivateDnsZoneVirtualNetworkLinkTimeoutsOutputReference | PrivateDnsZoneVirtualNetworkLinkTimeouts): any {
...
export class PrivateDnsZoneVirtualNetworkLinkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PrivateDnsZoneVirtualNetworkLinkTimeouts | undefined {
  ...
  public set internalValue(value: PrivateDnsZoneVirtualNetworkLinkTimeouts | undefined) {
    if (value === undefined) {
...
export class PrivateDnsZoneVirtualNetworkLink extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PrivateDnsZoneVirtualNetworkLinkTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
