...
export function dataLakeAnalyticsFirewallRuleTimeoutsToTerraform(struct?: DataLakeAnalyticsFirewallRuleTimeoutsOutputReference | DataLakeAnalyticsFirewallRuleTimeouts): any {
...
export class DataLakeAnalyticsFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataLakeAnalyticsFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
