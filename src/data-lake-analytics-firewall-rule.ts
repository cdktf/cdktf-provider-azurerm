// https://www.terraform.io/docs/providers/azurerm/r/data_lake_analytics_firewall_rule
...
export interface DataLakeAnalyticsFirewallRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_lake_analytics_firewall_rule#id DataLakeAnalyticsFirewallRule#id}
  *
...
export function dataLakeAnalyticsFirewallRuleTimeoutsToTerraform(struct?: DataLakeAnalyticsFirewallRuleTimeoutsOutputReference | DataLakeAnalyticsFirewallRuleTimeouts | cdktf.IResolvable): any {
...
export class DataLakeAnalyticsFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeAnalyticsFirewallRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataLakeAnalyticsFirewallRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataLakeAnalyticsFirewallRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_data_lake_analytics_firewall_rule";
  ...
  */
  ...
  private _timeouts = new DataLakeAnalyticsFirewallRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataLakeAnalyticsFirewallRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataLakeAnalyticsFirewallRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
