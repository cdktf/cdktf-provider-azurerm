...
export class DataLakeAnalyticsFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeAnalyticsFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: DataLakeAnalyticsFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
