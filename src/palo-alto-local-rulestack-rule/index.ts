// https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/palo_alto_local_rulestack_rule
...
export class PaloAltoLocalRulestackRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PaloAltoLocalRulestackRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/palo_alto_local_rulestack_rule#import import section} in the documentation of this resource for the id to use
