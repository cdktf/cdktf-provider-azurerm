// https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/stack_hci_marketplace_gallery_image
...
export class StackHciMarketplaceGalleryImage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackHciMarketplaceGalleryImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/stack_hci_marketplace_gallery_image#import import section} in the documentation of this resource for the id to use
