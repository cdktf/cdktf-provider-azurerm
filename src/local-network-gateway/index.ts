...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/resources/local_network_gateway
...
export class LocalNetworkGateway extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LocalNetworkGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.0.1/docs/resources/local_network_gateway#import import section} in the documentation of this resource for the id to use
