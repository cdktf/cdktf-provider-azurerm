...
export function relayNamespaceTimeoutsToTerraform(struct?: RelayNamespaceTimeoutsOutputReference | RelayNamespaceTimeouts): any {
...
export class RelayNamespaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RelayNamespaceTimeouts | undefined {
  ...
  public set internalValue(value: RelayNamespaceTimeouts | undefined) {
    if (value === undefined) {
...
export class RelayNamespace extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RelayNamespaceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
