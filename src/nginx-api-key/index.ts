...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key
...
export interface NginxApiKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#end_date_time NginxApiKey#end_date_time}
  */
  readonly endDateTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#id NginxApiKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#name NginxApiKey#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#nginx_deployment_id NginxApiKey#nginx_deployment_id}
  */
  readonly nginxDeploymentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#secret_text NginxApiKey#secret_text}
  */
  readonly secretText: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#timeouts NginxApiKey#timeouts}
  */
  readonly timeouts?: NginxApiKeyTimeouts;
}
export interface NginxApiKeyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#create NginxApiKey#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#delete NginxApiKey#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#read NginxApiKey#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#update NginxApiKey#update}
  */
...
export class NginxApiKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NginxApiKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/nginx_api_key#import import section} in the documentation of this resource for the id to use
