...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/resources/management_group_subscription_association
...
export class ManagementGroupSubscriptionAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagementGroupSubscriptionAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/resources/management_group_subscription_association#import import section} in the documentation of this resource for the id to use
