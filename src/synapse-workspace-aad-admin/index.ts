// https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/synapse_workspace_aad_admin
...
export class SynapseWorkspaceAadAdmin extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SynapseWorkspaceAadAdmin that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.22.0/docs/resources/synapse_workspace_aad_admin#import import section} in the documentation of this resource for the id to use
