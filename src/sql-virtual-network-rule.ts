...
export function sqlVirtualNetworkRuleTimeoutsToTerraform(struct?: SqlVirtualNetworkRuleTimeoutsOutputReference | SqlVirtualNetworkRuleTimeouts): any {
...
export class SqlVirtualNetworkRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SqlVirtualNetworkRuleTimeouts | undefined {
  ...
  public set internalValue(value: SqlVirtualNetworkRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class SqlVirtualNetworkRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SqlVirtualNetworkRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
