...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/hdinsight_kafka_cluster
...
export class HdinsightKafkaCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing HdinsightKafkaCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/hdinsight_kafka_cluster#import import section} in the documentation of this resource for the id to use
