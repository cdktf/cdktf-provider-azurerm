...
export function dataAzurermKeyVaultAccessPolicyTimeoutsToTerraform(struct?: DataAzurermKeyVaultAccessPolicyTimeoutsOutputReference | DataAzurermKeyVaultAccessPolicyTimeouts): any {
...
export class DataAzurermKeyVaultAccessPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermKeyVaultAccessPolicyTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermKeyVaultAccessPolicyA extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermKeyVaultAccessPolicyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
