// https://www.terraform.io/docs/providers/azurerm/r/communication_service
...
export function communicationServiceTimeoutsToTerraform(struct?: CommunicationServiceTimeoutsOutputReference | CommunicationServiceTimeouts | cdktf.IResolvable): any {
...
export class CommunicationService extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new CommunicationServiceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
