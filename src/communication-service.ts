...
function communicationServiceTimeoutsToTerraform(struct?: CommunicationServiceTimeoutsOutputReference | CommunicationServiceTimeouts): any {
...
export class CommunicationService extends cdktf.TerraformResource {
  ...
  */
  ...
  private _dataLocation?: string | undefined; 
  public get dataLocation() {
    return this.getStringAttribute('data_location');
  }
  public set dataLocation(value: string | undefined) {
  ...
  private _timeouts?: CommunicationServiceTimeouts | undefined; 
  private __timeoutsOutput = new CommunicationServiceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: CommunicationServiceTimeouts | undefined) {
