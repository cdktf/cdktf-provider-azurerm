...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/data-sources/key_vault_certificates
...
export class DataAzurermKeyVaultCertificates extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermKeyVaultCertificates that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/data-sources/key_vault_certificates#import import section} in the documentation of this resource for the id to use
