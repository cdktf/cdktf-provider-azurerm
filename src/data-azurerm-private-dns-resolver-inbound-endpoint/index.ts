...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/data-sources/private_dns_resolver_inbound_endpoint
...
export class DataAzurermPrivateDnsResolverInboundEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermPrivateDnsResolverInboundEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/data-sources/private_dns_resolver_inbound_endpoint#import import section} in the documentation of this resource for the id to use
