...
export interface DnsMxRecordConfig extends TerraformMetaArguments {
...
export class DnsMxRecord extends TerraformResource {
  ...
  public set timeouts(value: DnsMxRecordTimeouts | undefined) {
