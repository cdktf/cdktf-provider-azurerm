...
export function apiManagementIdentityProviderGoogleTimeoutsToTerraform(struct?: ApiManagementIdentityProviderGoogleTimeoutsOutputReference | ApiManagementIdentityProviderGoogleTimeouts | cdktf.IResolvable): any {
...
export class ApiManagementIdentityProviderGoogleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementIdentityProviderGoogleTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementIdentityProviderGoogleTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementIdentityProviderGoogle extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementIdentityProviderGoogleTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
