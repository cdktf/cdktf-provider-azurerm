...
export class DataboxEdgeDevice extends cdktf.TerraformResource {
  ...
  */
  ...
  public deviceProperties(index: string) {
    return new DataboxEdgeDeviceDeviceProperties(this, 'device_properties', index, false);
  }
  ...
  private _timeouts = new DataboxEdgeDeviceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
