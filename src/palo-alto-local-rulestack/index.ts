// https://registry.terraform.io/providers/hashicorp/azurerm/3.85.0/docs/resources/palo_alto_local_rulestack
...
export class PaloAltoLocalRulestack extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PaloAltoLocalRulestack that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.85.0/docs/resources/palo_alto_local_rulestack#import import section} in the documentation of this resource for the id to use
