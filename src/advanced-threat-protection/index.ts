...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.79.0/docs/resources/advanced_threat_protection
...
export class AdvancedThreatProtection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AdvancedThreatProtection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.79.0/docs/resources/advanced_threat_protection#import import section} in the documentation of this resource for the id to use
