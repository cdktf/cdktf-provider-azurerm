// https://registry.terraform.io/providers/hashicorp/azurerm/3.91.0/docs/resources/media_transform
...
export class MediaTransform extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaTransform that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.91.0/docs/resources/media_transform#import import section} in the documentation of this resource for the id to use
