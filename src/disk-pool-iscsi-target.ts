...
export class DiskPoolIscsiTargetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DiskPoolIscsiTargetTimeouts | undefined {
  ...
  public set internalValue(value: DiskPoolIscsiTargetTimeouts | undefined) {
    if (value === undefined) {
...
export class DiskPoolIscsiTarget extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_disk_pool_iscsi_target";
  ...
  */
  ...
  private _timeouts = new DiskPoolIscsiTargetTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
