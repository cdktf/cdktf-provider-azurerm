// https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/pim_eligible_role_assignment
...
export class PimEligibleRoleAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PimEligibleRoleAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.106.1/docs/resources/pim_eligible_role_assignment#import import section} in the documentation of this resource for the id to use
