...
export function siteRecoveryNetworkMappingTimeoutsToTerraform(struct?: SiteRecoveryNetworkMappingTimeoutsOutputReference | SiteRecoveryNetworkMappingTimeouts): any {
...
export class SiteRecoveryNetworkMappingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SiteRecoveryNetworkMappingTimeouts | undefined {
  ...
  public set internalValue(value: SiteRecoveryNetworkMappingTimeouts | undefined) {
    if (value === undefined) {
...
export class SiteRecoveryNetworkMapping extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SiteRecoveryNetworkMappingTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
