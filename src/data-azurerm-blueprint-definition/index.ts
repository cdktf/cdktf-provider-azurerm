...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/data-sources/blueprint_definition
...
export class DataAzurermBlueprintDefinition extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermBlueprintDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/data-sources/blueprint_definition#import import section} in the documentation of this resource for the id to use
