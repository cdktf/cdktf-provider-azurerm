...
export function dataAzurermDedicatedHostTimeoutsToTerraform(struct?: DataAzurermDedicatedHostTimeoutsOutputReference | DataAzurermDedicatedHostTimeouts): any {
...
export class DataAzurermDedicatedHostTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDedicatedHostTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDedicatedHostTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDedicatedHost extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDedicatedHostTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
