...
export function dataAzurermDiskEncryptionSetTimeoutsToTerraform(struct?: DataAzurermDiskEncryptionSetTimeoutsOutputReference | DataAzurermDiskEncryptionSetTimeouts): any {
...
export class DataAzurermDiskEncryptionSetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDiskEncryptionSetTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDiskEncryptionSetTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDiskEncryptionSet extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDiskEncryptionSetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
