// https://www.terraform.io/docs/providers/azurerm/d/private_dns_zone
...
export function dataAzurermPrivateDnsZoneTimeoutsToTerraform(struct?: DataAzurermPrivateDnsZoneTimeoutsOutputReference | DataAzurermPrivateDnsZoneTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermPrivateDnsZoneTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermPrivateDnsZoneTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermPrivateDnsZoneTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermPrivateDnsZone extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPrivateDnsZoneTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
