// https://www.terraform.io/docs/providers/azurerm/r/postgresql_configuration
...
export function postgresqlConfigurationTimeoutsToTerraform(struct?: PostgresqlConfigurationTimeoutsOutputReference | PostgresqlConfigurationTimeouts | cdktf.IResolvable): any {
...
export class PostgresqlConfigurationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresqlConfigurationTimeouts | undefined {
  ...
  public set internalValue(value: PostgresqlConfigurationTimeouts | undefined) {
    if (value === undefined) {
...
export class PostgresqlConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlConfigurationTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
