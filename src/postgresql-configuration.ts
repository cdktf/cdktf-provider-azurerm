...
export function postgresqlConfigurationTimeoutsToTerraform(struct?: PostgresqlConfigurationTimeoutsOutputReference | PostgresqlConfigurationTimeouts): any {
...
export class PostgresqlConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlConfigurationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
