...
export function dataAzurermServicebusNamespaceAuthorizationRuleTimeoutsToTerraform(struct?: DataAzurermServicebusNamespaceAuthorizationRuleTimeoutsOutputReference | DataAzurermServicebusNamespaceAuthorizationRuleTimeouts): any {
...
export class DataAzurermServicebusNamespaceAuthorizationRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermServicebusNamespaceAuthorizationRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermServicebusNamespaceAuthorizationRule extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermServicebusNamespaceAuthorizationRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
