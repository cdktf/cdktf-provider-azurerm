...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/data-sources/nginx_certificate
...
export class DataAzurermNginxCertificate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNginxCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.1/docs/data-sources/nginx_certificate#import import section} in the documentation of this resource for the id to use
