// https://www.terraform.io/docs/providers/azurerm/r/media_live_event_output
...
export function mediaLiveEventOutputTimeoutsToTerraform(struct?: MediaLiveEventOutputTimeoutsOutputReference | MediaLiveEventOutputTimeouts): any {
...
export class MediaLiveEventOutputTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: MediaLiveEventOutputTimeouts | undefined) {
    if (value === undefined) {
...
export class MediaLiveEventOutput extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MediaLiveEventOutputTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
