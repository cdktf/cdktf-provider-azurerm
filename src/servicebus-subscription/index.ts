// https://registry.terraform.io/providers/hashicorp/azurerm/3.85.0/docs/resources/servicebus_subscription
...
export class ServicebusSubscription extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ServicebusSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.85.0/docs/resources/servicebus_subscription#import import section} in the documentation of this resource for the id to use
