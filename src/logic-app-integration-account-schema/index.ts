...
export function logicAppIntegrationAccountSchemaTimeoutsToTerraform(struct?: LogicAppIntegrationAccountSchemaTimeoutsOutputReference | LogicAppIntegrationAccountSchemaTimeouts | cdktf.IResolvable): any {
