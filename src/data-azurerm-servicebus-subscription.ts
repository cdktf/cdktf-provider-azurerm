...
export function dataAzurermServicebusSubscriptionTimeoutsToTerraform(struct?: DataAzurermServicebusSubscriptionTimeoutsOutputReference | DataAzurermServicebusSubscriptionTimeouts): any {
...
export class DataAzurermServicebusSubscriptionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermServicebusSubscriptionTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermServicebusSubscription extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermServicebusSubscriptionTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
