...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/ai_foundry
...
export class AiFoundry extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AiFoundry that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/ai_foundry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/ai_foundry azurerm_ai_foundry} Resource
  *
  * @param scope The scope in which to define this construct
