...
export class DataAzurermContainerGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermContainerGroupTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermContainerGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermContainerGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermContainerGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
