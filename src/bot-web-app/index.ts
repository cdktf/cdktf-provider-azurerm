// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/bot_web_app
...
export class BotWebApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/bot_web_app#import import section} in the documentation of this resource for the id to use
