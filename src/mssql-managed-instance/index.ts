...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/mssql_managed_instance
...
export class MssqlManagedInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlManagedInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/mssql_managed_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/mssql_managed_instance azurerm_mssql_managed_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: MssqlManagedInstanceConfig) {
    ...
    this._databaseFormat = config.databaseFormat;
    this._dnsZonePartnerId = config.dnsZonePartnerId;
    this._hybridSecondaryUsage = config.hybridSecondaryUsage;
    this._id = config.id;
  ...
  // database_format - computed: false, optional: true, required: false
  private _databaseFormat?: string; 
  public get databaseFormat() {
    return this.getStringAttribute('database_format');
  }
  public set databaseFormat(value: string) {
    this._databaseFormat = value;
  }
  public resetDatabaseFormat() {
    this._databaseFormat = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get databaseFormatInput() {
    return this._databaseFormat;
  }
  ...
  // hybrid_secondary_usage - computed: false, optional: true, required: false
  private _hybridSecondaryUsage?: string; 
  public get hybridSecondaryUsage() {
    return this.getStringAttribute('hybrid_secondary_usage');
  }
  public set hybridSecondaryUsage(value: string) {
    this._hybridSecondaryUsage = value;
  }
  public resetHybridSecondaryUsage() {
    this._hybridSecondaryUsage = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get hybridSecondaryUsageInput() {
    return this._hybridSecondaryUsage;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      database_format: cdktf.stringToTerraform(this._databaseFormat),
      dns_zone_partner_id: cdktf.stringToTerraform(this._dnsZonePartnerId),
      hybrid_secondary_usage: cdktf.stringToTerraform(this._hybridSecondaryUsage),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      database_format: {
        value: cdktf.stringToHclTerraform(this._databaseFormat),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      hybrid_secondary_usage: {
        value: cdktf.stringToHclTerraform(this._hybridSecondaryUsage),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
