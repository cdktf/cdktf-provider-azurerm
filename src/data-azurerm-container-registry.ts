...
export function dataAzurermContainerRegistryTimeoutsToTerraform(struct?: DataAzurermContainerRegistryTimeoutsOutputReference | DataAzurermContainerRegistryTimeouts): any {
...
export class DataAzurermContainerRegistryTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermContainerRegistryTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermContainerRegistryTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermContainerRegistry extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermContainerRegistryTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
