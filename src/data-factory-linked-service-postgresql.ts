...
export function dataFactoryLinkedServicePostgresqlTimeoutsToTerraform(struct?: DataFactoryLinkedServicePostgresqlTimeoutsOutputReference | DataFactoryLinkedServicePostgresqlTimeouts): any {
...
export class DataFactoryLinkedServicePostgresqlTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataFactoryLinkedServicePostgresqlTimeouts | undefined {
  ...
  public set internalValue(value: DataFactoryLinkedServicePostgresqlTimeouts | undefined) {
    if (value === undefined) {
...
export class DataFactoryLinkedServicePostgresql extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataFactoryLinkedServicePostgresqlTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
