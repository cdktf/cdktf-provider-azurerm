...
export interface DataFactoryLinkedServicePostgresqlConfig extends TerraformMetaArguments {
...
export class DataFactoryLinkedServicePostgresql extends TerraformResource {
  ...
  public set timeouts(value: DataFactoryLinkedServicePostgresqlTimeouts | undefined) {
