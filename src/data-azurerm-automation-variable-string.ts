// https://www.terraform.io/docs/providers/azurerm/d/automation_variable_string
...
export class DataAzurermAutomationVariableStringTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationVariableStringTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermAutomationVariableStringTimeouts | undefined) {
    if (value === undefined) {
