// https://registry.terraform.io/providers/hashicorp/azurerm/4.13.0/docs/resources/lb_probe
...
export class LbProbe extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LbProbe that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.13.0/docs/resources/lb_probe#import import section} in the documentation of this resource for the id to use
