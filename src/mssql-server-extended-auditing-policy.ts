...
export class MssqlServerExtendedAuditingPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlServerExtendedAuditingPolicyTimeouts | undefined {
  ...
  public set internalValue(value: MssqlServerExtendedAuditingPolicyTimeouts | undefined) {
    if (value === undefined) {
