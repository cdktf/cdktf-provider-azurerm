...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/cdn_frontdoor_firewall_policy
...
export class DataAzurermCdnFrontdoorFirewallPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermCdnFrontdoorFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/cdn_frontdoor_firewall_policy#import import section} in the documentation of this resource for the id to use
