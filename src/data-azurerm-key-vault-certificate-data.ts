...
export function dataAzurermKeyVaultCertificateDataTimeoutsToTerraform(struct?: DataAzurermKeyVaultCertificateDataTimeoutsOutputReference | DataAzurermKeyVaultCertificateDataTimeouts): any {
...
export class DataAzurermKeyVaultCertificateDataTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermKeyVaultCertificateDataTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermKeyVaultCertificateDataTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermKeyVaultCertificateData extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermKeyVaultCertificateDataTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
