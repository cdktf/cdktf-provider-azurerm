...
export class BackupProtectedVm extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.73.0/docs/resources/backup_protected_vm azurerm_backup_protected_vm} Resource
  *
