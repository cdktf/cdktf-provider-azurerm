...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/resources/logic_app_workflow
...
export class LogicAppWorkflowAccessControlTriggerOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // allowed_caller_ip_address_range - computed: false, optional: true, required: false
  private _allowedCallerIpAddressRange?: string[]; 
  public get allowedCallerIpAddressRange() {
    return cdktf.Fn.tolist(this.getListAttribute('allowed_caller_ip_address_range'));
  }
  ...
  public resetAllowedCallerIpAddressRange() {
    this._allowedCallerIpAddressRange = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get allowedCallerIpAddressRangeInput() {
...
export class LogicAppWorkflow extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogicAppWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/resources/logic_app_workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/resources/logic_app_workflow azurerm_logic_app_workflow} Resource
  *
  * @param scope The scope in which to define this construct
