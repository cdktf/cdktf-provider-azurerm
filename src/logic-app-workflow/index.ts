...
export class LogicAppWorkflow extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.73.0/docs/resources/logic_app_workflow azurerm_logic_app_workflow} Resource
  *
