// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/application_insights_workbook_template
...
export class ApplicationInsightsWorkbookTemplate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationInsightsWorkbookTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.2/docs/resources/application_insights_workbook_template#import import section} in the documentation of this resource for the id to use
