...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/resources/storage_sync_server_endpoint
...
export class StorageSyncServerEndpoint extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageSyncServerEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/resources/storage_sync_server_endpoint#import import section} in the documentation of this resource for the id to use
