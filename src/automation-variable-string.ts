...
export function automationVariableStringTimeoutsToTerraform(struct?: AutomationVariableStringTimeoutsOutputReference | AutomationVariableStringTimeouts): any {
...
export class AutomationVariableString extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AutomationVariableStringTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
