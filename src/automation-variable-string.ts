// https://www.terraform.io/docs/providers/azurerm/r/automation_variable_string
...
export function automationVariableStringTimeoutsToTerraform(struct?: AutomationVariableStringTimeoutsOutputReference | AutomationVariableStringTimeouts | cdktf.IResolvable): any {
...
export class AutomationVariableStringTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutomationVariableStringTimeouts | undefined {
  ...
  public set internalValue(value: AutomationVariableStringTimeouts | undefined) {
    if (value === undefined) {
...
export class AutomationVariableString extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AutomationVariableStringTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
