...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/linux_virtual_machine
...
export interface LinuxVirtualMachineConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly osManagedDiskId?: string;
  /**
...
export class LinuxVirtualMachineOsDiskOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // storage_account_type - computed: true, optional: true, required: false
...
export class LinuxVirtualMachine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinuxVirtualMachine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/linux_virtual_machine#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/linux_virtual_machine azurerm_linux_virtual_machine} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: LinuxVirtualMachineConfig) {
    ...
    this._osManagedDiskId = config.osManagedDiskId;
  ...
  // allow_extension_operations - computed: true, optional: true, required: false
  ...
  // disable_password_authentication - computed: true, optional: true, required: false
  ...
  // os_managed_disk_id - computed: true, optional: true, required: false
  private _osManagedDiskId?: string; 
  public get osManagedDiskId() {
    return this.getStringAttribute('os_managed_disk_id');
  }
  public set osManagedDiskId(value: string) {
    this._osManagedDiskId = value;
  }
  public resetOsManagedDiskId() {
    this._osManagedDiskId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get osManagedDiskIdInput() {
    return this._osManagedDiskId;
  }

  // patch_assessment_mode - computed: true, optional: true, required: false
  ...
  // patch_mode - computed: true, optional: true, required: false
  ...
  // vm_agent_platform_updates_enabled - computed: true, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      os_managed_disk_id: cdktf.stringToTerraform(this._osManagedDiskId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      os_managed_disk_id: {
        value: cdktf.stringToHclTerraform(this._osManagedDiskId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
