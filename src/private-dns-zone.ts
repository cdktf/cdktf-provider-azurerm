...
export class PrivateDnsZone extends TerraformResource {
  ...
  // max_number_of_virtual_network_links - computed: true, optional: false, required: true
  public get maxNumberOfVirtualNetworkLinks() {
    return this.getNumberAttribute('max_number_of_virtual_network_links');
  }

  // max_number_of_virtual_network_links_with_registration - computed: true, optional: false, required: true
  ...
  public set timeouts(value: PrivateDnsZoneTimeouts | undefined) {
