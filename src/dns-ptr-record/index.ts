// https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/dns_ptr_record
...
export class DnsPtrRecord extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsPtrRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/dns_ptr_record#import import section} in the documentation of this resource for the id to use
