...
export function dnsSrvRecordRecordToTerraform(struct?: DnsSrvRecordRecord): any {
...
export function dnsSrvRecordTimeoutsToTerraform(struct?: DnsSrvRecordTimeoutsOutputReference | DnsSrvRecordTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DnsSrvRecordTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DnsSrvRecordTimeouts | undefined) {
    if (value === undefined) {
...
export class DnsSrvRecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DnsSrvRecordTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
