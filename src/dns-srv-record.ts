...
export interface DnsSrvRecordConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dns_srv_record#id DnsSrvRecord#id}
  *
...
export class DnsSrvRecordRecordList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DnsSrvRecordRecordOutputReference {
    return new DnsSrvRecordRecordOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dnsSrvRecordTimeoutsToTerraform(struct?: DnsSrvRecordTimeoutsOutputReference | DnsSrvRecordTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DnsSrvRecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _record = new DnsSrvRecordRecordList(this, "record", true);
  public get record() {
    return this._record;
  }
  ...
  public putTimeouts(value: DnsSrvRecordTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      record: cdktf.listMapper(dnsSrvRecordRecordToTerraform)(this._record.internalValue),
