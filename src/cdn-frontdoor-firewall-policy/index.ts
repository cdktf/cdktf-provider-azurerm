...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy
...
export interface CdnFrontdoorFirewallPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#captcha_cookie_expiration_in_minutes CdnFrontdoorFirewallPolicy#captcha_cookie_expiration_in_minutes}
  */
  readonly captchaCookieExpirationInMinutes?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#custom_block_response_body CdnFrontdoorFirewallPolicy#custom_block_response_body}
  */
  readonly customBlockResponseBody?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#custom_block_response_status_code CdnFrontdoorFirewallPolicy#custom_block_response_status_code}
  */
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#id CdnFrontdoorFirewallPolicy#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#js_challenge_cookie_expiration_in_minutes CdnFrontdoorFirewallPolicy#js_challenge_cookie_expiration_in_minutes}
  */
  readonly jsChallengeCookieExpirationInMinutes?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#mode CdnFrontdoorFirewallPolicy#mode}
  */
  readonly mode: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#name CdnFrontdoorFirewallPolicy#name}
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#redirect_url CdnFrontdoorFirewallPolicy#redirect_url}
  */
  readonly redirectUrl?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#request_body_check_enabled CdnFrontdoorFirewallPolicy#request_body_check_enabled}
  */
  readonly requestBodyCheckEnabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#resource_group_name CdnFrontdoorFirewallPolicy#resource_group_name}
  */
  readonly resourceGroupName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#sku_name CdnFrontdoorFirewallPolicy#sku_name}
  */
  readonly skuName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#tags CdnFrontdoorFirewallPolicy#tags}
  */
  readonly tags?: { [key: string]: string };
  /**
  * custom_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#custom_rule CdnFrontdoorFirewallPolicy#custom_rule}
  */
  readonly customRule?: CdnFrontdoorFirewallPolicyCustomRule[] | cdktf.IResolvable;
  /**
  * log_scrubbing block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#log_scrubbing CdnFrontdoorFirewallPolicy#log_scrubbing}
  */
  readonly logScrubbing?: CdnFrontdoorFirewallPolicyLogScrubbing;
  /**
  * managed_rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#managed_rule CdnFrontdoorFirewallPolicy#managed_rule}
  */
  readonly managedRule?: CdnFrontdoorFirewallPolicyManagedRule[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#timeouts CdnFrontdoorFirewallPolicy#timeouts}
  */
  readonly timeouts?: CdnFrontdoorFirewallPolicyTimeouts;
}
export interface CdnFrontdoorFirewallPolicyCustomRuleMatchCondition {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#match_values CdnFrontdoorFirewallPolicy#match_values}
  */
  readonly matchValues: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#match_variable CdnFrontdoorFirewallPolicy#match_variable}
  */
  readonly matchVariable: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#negation_condition CdnFrontdoorFirewallPolicy#negation_condition}
  */
  readonly negationCondition?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#operator CdnFrontdoorFirewallPolicy#operator}
  */
  readonly operator: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#selector CdnFrontdoorFirewallPolicy#selector}
  */
  readonly selector?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#transforms CdnFrontdoorFirewallPolicy#transforms}
  */
...
export interface CdnFrontdoorFirewallPolicyCustomRule {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#action CdnFrontdoorFirewallPolicy#action}
  */
  ...
  */
  readonly name: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#priority CdnFrontdoorFirewallPolicy#priority}
  */
  readonly priority?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#rate_limit_duration_in_minutes CdnFrontdoorFirewallPolicy#rate_limit_duration_in_minutes}
  */
  readonly rateLimitDurationInMinutes?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#rate_limit_threshold CdnFrontdoorFirewallPolicy#rate_limit_threshold}
  */
  readonly rateLimitThreshold?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#type CdnFrontdoorFirewallPolicy#type}
  */
  readonly type: string;
  /**
  * match_condition block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#match_condition CdnFrontdoorFirewallPolicy#match_condition}
  */
...
export interface CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#enabled CdnFrontdoorFirewallPolicy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
...
export function cdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleToTerraform(struct?: CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function cdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleToHclTerraform(struct?: CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._enabled = undefined;
...
export class CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleList extends cdktf.ComplexList {
  public internalValue? : CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleOutputReference {
    return new CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface CdnFrontdoorFirewallPolicyLogScrubbing {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#enabled CdnFrontdoorFirewallPolicy#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  ...
  */
  readonly scrubbingRule: CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule[] | cdktf.IResolvable;
}

export function cdnFrontdoorFirewallPolicyLogScrubbingToTerraform(struct?: CdnFrontdoorFirewallPolicyLogScrubbingOutputReference | CdnFrontdoorFirewallPolicyLogScrubbing): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  return {
    enabled: cdktf.booleanToTerraform(struct!.enabled),
    scrubbing_rule: cdktf.listMapper(cdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleToTerraform, true)(struct!.scrubbingRule),
  }
}


export function cdnFrontdoorFirewallPolicyLogScrubbingToHclTerraform(struct?: CdnFrontdoorFirewallPolicyLogScrubbingOutputReference | CdnFrontdoorFirewallPolicyLogScrubbing): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    scrubbing_rule: {
      value: cdktf.listMapperHcl(cdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleToHclTerraform, true)(struct!.scrubbingRule),
      isBlock: true,
      type: "list",
      storageClassType: "CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleList",
    },
  };
...
export class CdnFrontdoorFirewallPolicyLogScrubbingOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): CdnFrontdoorFirewallPolicyLogScrubbing | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._enabled !== undefined) {
      hasAnyValues = true;
    ...
    if (this._scrubbingRule?.internalValue !== undefined) {
      hasAnyValues = true;
      internalValueResult.scrubbingRule = this._scrubbingRule?.internalValue;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CdnFrontdoorFirewallPolicyLogScrubbing | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._enabled = undefined;
      this._scrubbingRule.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._enabled = value.enabled;
      this._scrubbingRule.internalValue = value.scrubbingRule;
    }
  }
  ...
  // scrubbing_rule - computed: false, optional: false, required: true
  private _scrubbingRule = new CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRuleList(this, "scrubbing_rule", false);
  public get scrubbingRule() {
    return this._scrubbingRule;
  }
  public putScrubbingRule(value: CdnFrontdoorFirewallPolicyLogScrubbingScrubbingRule[] | cdktf.IResolvable) {
    this._scrubbingRule.internalValue = value;
  }
  // Temporarily expose input value. Use with caution.
  public get scrubbingRuleInput() {
    return this._scrubbingRule.internalValue;
  }
}
...
export interface CdnFrontdoorFirewallPolicyManagedRuleOverrideRule {
  ...
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#rule_id CdnFrontdoorFirewallPolicy#rule_id}
  */
  readonly ruleId: string;
  /**
  * exclusion block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#exclusion CdnFrontdoorFirewallPolicy#exclusion}
  */
...
export interface CdnFrontdoorFirewallPolicyManagedRuleOverride {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#rule_group_name CdnFrontdoorFirewallPolicy#rule_group_name}
  */
  ...
  * rule block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#rule CdnFrontdoorFirewallPolicy#rule}
  */
...
export interface CdnFrontdoorFirewallPolicyManagedRule {
  ...
  */
  readonly type: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#version CdnFrontdoorFirewallPolicy#version}
  */
  ...
  * override block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#override CdnFrontdoorFirewallPolicy#override}
  */
...
export interface CdnFrontdoorFirewallPolicyTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#create CdnFrontdoorFirewallPolicy#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#delete CdnFrontdoorFirewallPolicy#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#read CdnFrontdoorFirewallPolicy#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#update CdnFrontdoorFirewallPolicy#update}
  */
...
export class CdnFrontdoorFirewallPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnFrontdoorFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cdn_frontdoor_firewall_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: CdnFrontdoorFirewallPolicyConfig) {
    ...
    this._captchaCookieExpirationInMinutes = config.captchaCookieExpirationInMinutes;
    ...
    this._id = config.id;
    this._jsChallengeCookieExpirationInMinutes = config.jsChallengeCookieExpirationInMinutes;
    ...
    this._logScrubbing.internalValue = config.logScrubbing;
  ...
  // captcha_cookie_expiration_in_minutes - computed: true, optional: true, required: false
  private _captchaCookieExpirationInMinutes?: number; 
  public get captchaCookieExpirationInMinutes() {
    return this.getNumberAttribute('captcha_cookie_expiration_in_minutes');
  }
  public set captchaCookieExpirationInMinutes(value: number) {
    this._captchaCookieExpirationInMinutes = value;
  }
  public resetCaptchaCookieExpirationInMinutes() {
    this._captchaCookieExpirationInMinutes = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get captchaCookieExpirationInMinutesInput() {
    return this._captchaCookieExpirationInMinutes;
  }
  ...
  // js_challenge_cookie_expiration_in_minutes - computed: true, optional: true, required: false
  ...
  private _logScrubbing = new CdnFrontdoorFirewallPolicyLogScrubbingOutputReference(this, "log_scrubbing");
  public get logScrubbing() {
    return this._logScrubbing;
  }
  public putLogScrubbing(value: CdnFrontdoorFirewallPolicyLogScrubbing) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      captcha_cookie_expiration_in_minutes: cdktf.numberToTerraform(this._captchaCookieExpirationInMinutes),
      ...
      js_challenge_cookie_expiration_in_minutes: cdktf.numberToTerraform(this._jsChallengeCookieExpirationInMinutes),
      ...
      log_scrubbing: cdnFrontdoorFirewallPolicyLogScrubbingToTerraform(this._logScrubbing.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      captcha_cookie_expiration_in_minutes: {
        value: cdktf.numberToHclTerraform(this._captchaCookieExpirationInMinutes),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      js_challenge_cookie_expiration_in_minutes: {
        value: cdktf.numberToHclTerraform(this._jsChallengeCookieExpirationInMinutes),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      log_scrubbing: {
        value: cdnFrontdoorFirewallPolicyLogScrubbingToHclTerraform(this._logScrubbing.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "CdnFrontdoorFirewallPolicyLogScrubbingList",
      },
      managed_rule: {
