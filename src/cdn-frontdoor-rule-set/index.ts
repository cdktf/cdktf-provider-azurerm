// https://registry.terraform.io/providers/hashicorp/azurerm/4.13.0/docs/resources/cdn_frontdoor_rule_set
...
export class CdnFrontdoorRuleSet extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnFrontdoorRuleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.13.0/docs/resources/cdn_frontdoor_rule_set#import import section} in the documentation of this resource for the id to use
