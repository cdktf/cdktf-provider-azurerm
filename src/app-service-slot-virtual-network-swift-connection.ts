...
export function appServiceSlotVirtualNetworkSwiftConnectionTimeoutsToTerraform(struct?: AppServiceSlotVirtualNetworkSwiftConnectionTimeoutsOutputReference | AppServiceSlotVirtualNetworkSwiftConnectionTimeouts | cdktf.IResolvable): any {
...
export class AppServiceSlotVirtualNetworkSwiftConnection extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AppServiceSlotVirtualNetworkSwiftConnectionTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
