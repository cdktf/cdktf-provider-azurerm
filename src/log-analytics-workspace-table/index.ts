...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/log_analytics_workspace_table
...
export class LogAnalyticsWorkspaceTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAnalyticsWorkspaceTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.31.0/docs/resources/log_analytics_workspace_table#import import section} in the documentation of this resource for the id to use
