...
export function kustoClusterPrincipalAssignmentTimeoutsToTerraform(struct?: KustoClusterPrincipalAssignmentTimeoutsOutputReference | KustoClusterPrincipalAssignmentTimeouts | cdktf.IResolvable): any {
...
export class KustoClusterPrincipalAssignmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): KustoClusterPrincipalAssignmentTimeouts | undefined {
  ...
  public set internalValue(value: KustoClusterPrincipalAssignmentTimeouts | undefined) {
    if (value === undefined) {
...
export class KustoClusterPrincipalAssignment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new KustoClusterPrincipalAssignmentTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
