...
export function kustoClusterPrincipalAssignmentTimeoutsToTerraform(struct?: KustoClusterPrincipalAssignmentTimeoutsOutputReference | KustoClusterPrincipalAssignmentTimeouts): any {
...
export class KustoClusterPrincipalAssignment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new KustoClusterPrincipalAssignmentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
