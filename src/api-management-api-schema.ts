...
export function apiManagementApiSchemaTimeoutsToTerraform(struct?: ApiManagementApiSchemaTimeoutsOutputReference | ApiManagementApiSchemaTimeouts): any {
...
export class ApiManagementApiSchemaTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementApiSchemaTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementApiSchemaTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementApiSchema extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_api_management_api_schema";
  ...
  */
  ...
  private _timeouts = new ApiManagementApiSchemaTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
