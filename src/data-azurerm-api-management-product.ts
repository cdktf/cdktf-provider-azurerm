...
export function dataAzurermApiManagementProductTimeoutsToTerraform(struct?: DataAzurermApiManagementProductTimeoutsOutputReference | DataAzurermApiManagementProductTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermApiManagementProduct extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApiManagementProductTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
