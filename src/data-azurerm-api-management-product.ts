...
export function dataAzurermApiManagementProductTimeoutsToTerraform(struct?: DataAzurermApiManagementProductTimeoutsOutputReference | DataAzurermApiManagementProductTimeouts): any {
...
export class DataAzurermApiManagementProduct extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApiManagementProductTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
