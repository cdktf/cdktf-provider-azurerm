...
export function dataAzurermPolicyVirtualMachineConfigurationAssignmentTimeoutsToTerraform(struct?: DataAzurermPolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference | DataAzurermPolicyVirtualMachineConfigurationAssignmentTimeouts): any {
...
export class DataAzurermPolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermPolicyVirtualMachineConfigurationAssignmentTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermPolicyVirtualMachineConfigurationAssignmentTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermPolicyVirtualMachineConfigurationAssignment extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPolicyVirtualMachineConfigurationAssignmentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
