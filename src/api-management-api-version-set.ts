...
export function apiManagementApiVersionSetTimeoutsToTerraform(struct?: ApiManagementApiVersionSetTimeoutsOutputReference | ApiManagementApiVersionSetTimeouts | cdktf.IResolvable): any {
...
export class ApiManagementApiVersionSet extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementApiVersionSetTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
