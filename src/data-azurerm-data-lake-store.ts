...
export function dataAzurermDataLakeStoreTimeoutsToTerraform(struct?: DataAzurermDataLakeStoreTimeoutsOutputReference | DataAzurermDataLakeStoreTimeouts): any {
...
export class DataAzurermDataLakeStore extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDataLakeStoreTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
