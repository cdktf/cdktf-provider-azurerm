...
export function apiManagementApiPolicyTimeoutsToTerraform(struct?: ApiManagementApiPolicyTimeoutsOutputReference | ApiManagementApiPolicyTimeouts | cdktf.IResolvable): any {
...
export class ApiManagementApiPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementApiPolicyTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ApiManagementApiPolicyTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class ApiManagementApiPolicy extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_api_management_api_policy";
  ...
  */
  ...
  private _timeouts = new ApiManagementApiPolicyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ApiManagementApiPolicyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: apiManagementApiPolicyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
