...
export function apiManagementApiPolicyTimeoutsToTerraform(struct?: ApiManagementApiPolicyTimeoutsOutputReference | ApiManagementApiPolicyTimeouts): any {
...
export class ApiManagementApiPolicy extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementApiPolicyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
