...
export interface CosmosdbSqlDatabaseConfig extends TerraformMetaArguments {
...
export class CosmosdbSqlDatabase extends TerraformResource {
  ...
  public set timeouts(value: CosmosdbSqlDatabaseTimeouts | undefined) {
