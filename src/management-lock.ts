...
export function managementLockTimeoutsToTerraform(struct?: ManagementLockTimeoutsOutputReference | ManagementLockTimeouts | cdktf.IResolvable): any {
...
export class ManagementLockTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ManagementLockTimeouts | undefined {
  ...
  public set internalValue(value: ManagementLockTimeouts | undefined) {
    if (value === undefined) {
...
export class ManagementLock extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ManagementLockTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
