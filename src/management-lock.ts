...
export class ManagementLockTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ManagementLockTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ManagementLockTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
