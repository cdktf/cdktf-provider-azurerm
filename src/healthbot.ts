...
export function healthbotTimeoutsToTerraform(struct?: HealthbotTimeoutsOutputReference | HealthbotTimeouts | cdktf.IResolvable): any {
...
export class HealthbotTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): HealthbotTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: HealthbotTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class Healthbot extends cdktf.TerraformResource {
  ...
  */
  ...
  public putTimeouts(value: HealthbotTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: healthbotTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
