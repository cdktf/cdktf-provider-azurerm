...
export function healthbotTimeoutsToTerraform(struct?: HealthbotTimeoutsOutputReference | HealthbotTimeouts): any {
...
export class HealthbotTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: HealthbotTimeouts | undefined) {
    if (value === undefined) {
...
export class Healthbot extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new HealthbotTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
