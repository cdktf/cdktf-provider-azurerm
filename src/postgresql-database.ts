// https://www.terraform.io/docs/providers/azurerm/r/postgresql_database
...
export function postgresqlDatabaseTimeoutsToTerraform(struct?: PostgresqlDatabaseTimeoutsOutputReference | PostgresqlDatabaseTimeouts | cdktf.IResolvable): any {
...
export class PostgresqlDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresqlDatabaseTimeouts | undefined {
  ...
  public set internalValue(value: PostgresqlDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class PostgresqlDatabase extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
