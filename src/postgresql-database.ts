...
export function postgresqlDatabaseTimeoutsToTerraform(struct?: PostgresqlDatabaseTimeoutsOutputReference | PostgresqlDatabaseTimeouts): any {
...
export class PostgresqlDatabase extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
