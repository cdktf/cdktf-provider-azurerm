...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.30.0/docs/resources/site_recovery_vmware_replication_policy_association
...
export class SiteRecoveryVmwareReplicationPolicyAssociation extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SiteRecoveryVmwareReplicationPolicyAssociation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.30.0/docs/resources/site_recovery_vmware_replication_policy_association#import import section} in the documentation of this resource for the id to use
