...
export function springCloudActiveDeploymentTimeoutsToTerraform(struct?: SpringCloudActiveDeploymentTimeoutsOutputReference | SpringCloudActiveDeploymentTimeouts): any {
...
export class SpringCloudActiveDeployment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SpringCloudActiveDeploymentTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
