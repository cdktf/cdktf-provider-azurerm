...
export class NetworkSecurityRule extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.73.0/docs/resources/network_security_rule azurerm_network_security_rule} Resource
  *
