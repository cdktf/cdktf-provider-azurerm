...
function containerRegistryScopeMapTimeoutsToTerraform(struct?: ContainerRegistryScopeMapTimeoutsOutputReference | ContainerRegistryScopeMapTimeouts): any {
...
export class ContainerRegistryScopeMap extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ContainerRegistryScopeMapTimeouts | undefined; 
  private __timeoutsOutput = new ContainerRegistryScopeMapTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: ContainerRegistryScopeMapTimeouts | undefined) {
