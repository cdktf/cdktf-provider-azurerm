...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/data-sources/web_application_firewall_policy
...
export class DataAzurermWebApplicationFirewallPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermWebApplicationFirewallPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/data-sources/web_application_firewall_policy#import import section} in the documentation of this resource for the id to use
