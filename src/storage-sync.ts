...
export function storageSyncTimeoutsToTerraform(struct?: StorageSyncTimeoutsOutputReference | StorageSyncTimeouts): any {
...
export class StorageSyncTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StorageSyncTimeouts | undefined {
  ...
  public set internalValue(value: StorageSyncTimeouts | undefined) {
    if (value === undefined) {
...
export class StorageSync extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new StorageSyncTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
