...
export function synapsePrivateLinkHubTimeoutsToTerraform(struct?: SynapsePrivateLinkHubTimeoutsOutputReference | SynapsePrivateLinkHubTimeouts): any {
...
export class SynapsePrivateLinkHub extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SynapsePrivateLinkHubTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
