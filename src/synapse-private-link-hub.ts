...
export function synapsePrivateLinkHubTimeoutsToTerraform(struct?: SynapsePrivateLinkHubTimeoutsOutputReference | SynapsePrivateLinkHubTimeouts | cdktf.IResolvable): any {
...
export class SynapsePrivateLinkHubTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SynapsePrivateLinkHubTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SynapsePrivateLinkHubTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SynapsePrivateLinkHub extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_synapse_private_link_hub";
  ...
  */
  ...
  private _timeouts = new SynapsePrivateLinkHubTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: SynapsePrivateLinkHubTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: synapsePrivateLinkHubTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
