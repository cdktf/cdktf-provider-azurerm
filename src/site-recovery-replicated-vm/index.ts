...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/site_recovery_replicated_vm
...
export class SiteRecoveryReplicatedVm extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SiteRecoveryReplicatedVm that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/site_recovery_replicated_vm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/site_recovery_replicated_vm azurerm_site_recovery_replicated_vm} Resource
  *
  * @param scope The scope in which to define this construct
