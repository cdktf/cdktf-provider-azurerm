// https://registry.terraform.io/providers/hashicorp/azurerm/4.27.0/docs/data-sources/netapp_volume_group_oracle
...
export class DataAzurermNetappVolumeGroupOracle extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetappVolumeGroupOracle that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.27.0/docs/data-sources/netapp_volume_group_oracle#import import section} in the documentation of this resource for the id to use
