// https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/eventhub_authorization_rule
...
export class EventhubAuthorizationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EventhubAuthorizationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/eventhub_authorization_rule#import import section} in the documentation of this resource for the id to use
