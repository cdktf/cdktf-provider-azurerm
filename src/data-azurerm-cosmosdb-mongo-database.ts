...
export class DataAzurermCosmosdbMongoDatabase extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_cosmosdb_mongo_database";
  ...
  */
  ...
  private _timeouts = new DataAzurermCosmosdbMongoDatabaseTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
