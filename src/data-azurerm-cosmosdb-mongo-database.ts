...
export function dataAzurermCosmosdbMongoDatabaseTimeoutsToTerraform(struct?: DataAzurermCosmosdbMongoDatabaseTimeoutsOutputReference | DataAzurermCosmosdbMongoDatabaseTimeouts): any {
...
export class DataAzurermCosmosdbMongoDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermCosmosdbMongoDatabaseTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermCosmosdbMongoDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermCosmosdbMongoDatabase extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermCosmosdbMongoDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermCosmosdbMongoDatabaseTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermCosmosdbMongoDatabaseTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
