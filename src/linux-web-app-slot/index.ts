...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/linux_web_app_slot
...
export class LinuxWebAppSlot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinuxWebAppSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/linux_web_app_slot#import import section} in the documentation of this resource for the id to use
