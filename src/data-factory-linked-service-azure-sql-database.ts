...
export interface DataFactoryLinkedServiceAzureSqlDatabaseConfig extends TerraformMetaArguments {
...
export class DataFactoryLinkedServiceAzureSqlDatabase extends TerraformResource {
