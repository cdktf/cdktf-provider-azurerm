...
export function dataAzurermMssqlDatabaseTimeoutsToTerraform(struct?: DataAzurermMssqlDatabaseTimeoutsOutputReference | DataAzurermMssqlDatabaseTimeouts): any {
...
export class DataAzurermMssqlDatabase extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermMssqlDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
