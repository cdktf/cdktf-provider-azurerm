// https://www.terraform.io/docs/providers/azurerm/d/mssql_database
...
export function dataAzurermMssqlDatabaseTimeoutsToTerraform(struct?: DataAzurermMssqlDatabaseTimeoutsOutputReference | DataAzurermMssqlDatabaseTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermMssqlDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermMssqlDatabaseTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermMssqlDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermMssqlDatabase extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermMssqlDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
