...
export function dataAzurermStorageSyncTimeoutsToTerraform(struct?: DataAzurermStorageSyncTimeoutsOutputReference | DataAzurermStorageSyncTimeouts): any {
...
export class DataAzurermStorageSyncTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermStorageSyncTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermStorageSyncTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermStorageSync extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermStorageSyncTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
