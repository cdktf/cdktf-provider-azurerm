...
export function securityCenterSettingTimeoutsToTerraform(struct?: SecurityCenterSettingTimeoutsOutputReference | SecurityCenterSettingTimeouts): any {
...
export class SecurityCenterSettingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SecurityCenterSettingTimeouts | undefined {
  ...
  public set internalValue(value: SecurityCenterSettingTimeouts | undefined) {
    if (value === undefined) {
...
export class SecurityCenterSetting extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_security_center_setting";
  ...
  */
  ...
  private _timeouts = new SecurityCenterSettingTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
