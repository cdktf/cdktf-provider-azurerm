...
export function mssqlFirewallRuleTimeoutsToTerraform(struct?: MssqlFirewallRuleTimeoutsOutputReference | MssqlFirewallRuleTimeouts): any {
...
export class MssqlFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MssqlFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
