...
export function mssqlFirewallRuleTimeoutsToTerraform(struct?: MssqlFirewallRuleTimeoutsOutputReference | MssqlFirewallRuleTimeouts | cdktf.IResolvable): any {
...
export class MssqlFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: MssqlFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MssqlFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MssqlFirewallRuleTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
