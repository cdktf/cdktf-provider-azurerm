...
export function appServiceVirtualNetworkSwiftConnectionTimeoutsToTerraform(struct?: AppServiceVirtualNetworkSwiftConnectionTimeoutsOutputReference | AppServiceVirtualNetworkSwiftConnectionTimeouts | cdktf.IResolvable): any {
...
export class AppServiceVirtualNetworkSwiftConnectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppServiceVirtualNetworkSwiftConnectionTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AppServiceVirtualNetworkSwiftConnectionTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AppServiceVirtualNetworkSwiftConnection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_app_service_virtual_network_swift_connection";
  ...
  */
  ...
  private _timeouts = new AppServiceVirtualNetworkSwiftConnectionTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AppServiceVirtualNetworkSwiftConnectionTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: appServiceVirtualNetworkSwiftConnectionTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
