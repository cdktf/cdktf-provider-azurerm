...
export class AppServiceVirtualNetworkSwiftConnectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppServiceVirtualNetworkSwiftConnectionTimeouts | undefined {
  ...
  public set internalValue(value: AppServiceVirtualNetworkSwiftConnectionTimeouts | undefined) {
    if (value === undefined) {
