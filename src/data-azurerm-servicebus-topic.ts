...
export function dataAzurermServicebusTopicTimeoutsToTerraform(struct?: DataAzurermServicebusTopicTimeoutsOutputReference | DataAzurermServicebusTopicTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermServicebusTopicTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermServicebusTopicTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermServicebusTopicTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermServicebusTopic extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermServicebusTopicTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
