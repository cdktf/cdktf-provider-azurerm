// https://www.terraform.io/docs/providers/azurerm/r/vpn_gateway_nat_rule.html
...
export function vpnGatewayNatRuleTimeoutsToTerraform(struct?: VpnGatewayNatRuleTimeoutsOutputReference | VpnGatewayNatRuleTimeouts): any {
...
export class VpnGatewayNatRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_vpn_gateway_nat_rule";
  ...
  */
  ...
  private _timeouts = new VpnGatewayNatRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
