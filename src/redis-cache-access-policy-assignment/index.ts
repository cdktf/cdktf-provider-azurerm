// https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/redis_cache_access_policy_assignment
...
export class RedisCacheAccessPolicyAssignment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisCacheAccessPolicyAssignment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/redis_cache_access_policy_assignment#import import section} in the documentation of this resource for the id to use
