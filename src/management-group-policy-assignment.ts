...
export class ManagementGroupPolicyAssignment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _nonComplianceMessage?: ManagementGroupPolicyAssignmentNonComplianceMessage[] | cdktf.IResolvable; 
  public get nonComplianceMessage() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('non_compliance_message');
  }
  public set nonComplianceMessage(value: ManagementGroupPolicyAssignmentNonComplianceMessage[] | cdktf.IResolvable) {
