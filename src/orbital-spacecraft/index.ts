...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/orbital_spacecraft
...
export class OrbitalSpacecraft extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OrbitalSpacecraft that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/orbital_spacecraft#import import section} in the documentation of this resource for the id to use
