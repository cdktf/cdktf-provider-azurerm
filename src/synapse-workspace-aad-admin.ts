...
export class SynapseWorkspaceAadAdminTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SynapseWorkspaceAadAdminTimeouts | undefined {
  ...
  public set internalValue(value: SynapseWorkspaceAadAdminTimeouts | undefined) {
    if (value === undefined) {
...
export class SynapseWorkspaceAadAdminA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_synapse_workspace_aad_admin";
  ...
  */
  ...
  private _timeouts = new SynapseWorkspaceAadAdminTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
