...
export function synapseWorkspaceAadAdminTimeoutsToTerraform(struct?: SynapseWorkspaceAadAdminTimeoutsOutputReference | SynapseWorkspaceAadAdminTimeouts): any {
...
export class SynapseWorkspaceAadAdminA extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SynapseWorkspaceAadAdminTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
