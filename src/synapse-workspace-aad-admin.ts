...
export function synapseWorkspaceAadAdminTimeoutsToTerraform(struct?: SynapseWorkspaceAadAdminTimeoutsOutputReference | SynapseWorkspaceAadAdminTimeouts | cdktf.IResolvable): any {
...
export class SynapseWorkspaceAadAdminTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SynapseWorkspaceAadAdminTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SynapseWorkspaceAadAdminTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class SynapseWorkspaceAadAdminA extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_synapse_workspace_aad_admin";
  ...
  */
  public constructor(scope: Construct, id: string, config: SynapseWorkspaceAadAdminAConfig) {
    super(scope, id, {
      terraformResourceType: 'azurerm_synapse_workspace_aad_admin',
  ...
  private _timeouts = new SynapseWorkspaceAadAdminTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: SynapseWorkspaceAadAdminTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: synapseWorkspaceAadAdminTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
