...
export function networkInterfaceBackendAddressPoolAssociationTimeoutsToTerraform(struct?: NetworkInterfaceBackendAddressPoolAssociationTimeoutsOutputReference | NetworkInterfaceBackendAddressPoolAssociationTimeouts): any {
...
export class NetworkInterfaceBackendAddressPoolAssociationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkInterfaceBackendAddressPoolAssociationTimeouts | undefined {
  ...
  public set internalValue(value: NetworkInterfaceBackendAddressPoolAssociationTimeouts | undefined) {
    if (value === undefined) {
...
export class NetworkInterfaceBackendAddressPoolAssociation extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_network_interface_backend_address_pool_association";
  ...
  */
  ...
  private _timeouts = new NetworkInterfaceBackendAddressPoolAssociationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
