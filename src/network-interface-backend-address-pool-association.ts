...
function networkInterfaceBackendAddressPoolAssociationTimeoutsToTerraform(struct?: NetworkInterfaceBackendAddressPoolAssociationTimeoutsOutputReference | NetworkInterfaceBackendAddressPoolAssociationTimeouts): any {
...
export class NetworkInterfaceBackendAddressPoolAssociation extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: NetworkInterfaceBackendAddressPoolAssociationTimeouts | undefined; 
  private __timeoutsOutput = new NetworkInterfaceBackendAddressPoolAssociationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: NetworkInterfaceBackendAddressPoolAssociationTimeouts | undefined) {
