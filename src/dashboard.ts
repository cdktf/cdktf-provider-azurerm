...
export function dashboardTimeoutsToTerraform(struct?: DashboardTimeoutsOutputReference | DashboardTimeouts | cdktf.IResolvable): any {
...
export class DashboardTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DashboardTimeouts | undefined {
  ...
  public set internalValue(value: DashboardTimeouts | undefined) {
    if (value === undefined) {
...
export class Dashboard extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DashboardTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
