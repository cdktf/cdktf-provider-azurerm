...
export function dashboardTimeoutsToTerraform(struct?: DashboardTimeoutsOutputReference | DashboardTimeouts): any {
...
export class Dashboard extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DashboardTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
