...
function dashboardTimeoutsToTerraform(struct?: DashboardTimeoutsOutputReference | DashboardTimeouts): any {
...
export class Dashboard extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_dashboard";
  ...
  */
  ...
  private _dashboardProperties?: string | undefined; 
  ...
  private _timeouts?: DashboardTimeouts | undefined; 
  private __timeoutsOutput = new DashboardTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: DashboardTimeouts | undefined) {
