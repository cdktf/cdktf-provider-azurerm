...
export function dataAzurermWebApplicationFirewallPolicyTimeoutsToTerraform(struct?: DataAzurermWebApplicationFirewallPolicyTimeoutsOutputReference | DataAzurermWebApplicationFirewallPolicyTimeouts): any {
...
export class DataAzurermWebApplicationFirewallPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermWebApplicationFirewallPolicyTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermWebApplicationFirewallPolicyTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermWebApplicationFirewallPolicy extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermWebApplicationFirewallPolicyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
