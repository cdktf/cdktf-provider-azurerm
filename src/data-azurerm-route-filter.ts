...
export interface DataAzurermRouteFilterConfig extends TerraformMetaArguments {
  readonly name: string;
  readonly resourceGroupName: string;
  /** timeouts block */
  readonly timeouts?: DataAzurermRouteFilterTimeouts;
}
export class DataAzurermRouteFilterRule extends ComplexComputedList {
...
export class DataAzurermRouteFilter extends TerraformDataSource {
