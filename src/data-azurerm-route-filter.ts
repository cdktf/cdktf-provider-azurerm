...
export interface DataAzurermRouteFilterRule {
}

export function dataAzurermRouteFilterRuleToTerraform(struct?: DataAzurermRouteFilterRule): any {
...
export class DataAzurermRouteFilterRuleOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermRouteFilterRule | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermRouteFilterRule | undefined) {
    if (value === undefined) {
...
export class DataAzurermRouteFilterRuleList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermRouteFilterRuleOutputReference {
    return new DataAzurermRouteFilterRuleOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermRouteFilterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermRouteFilterTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermRouteFilterTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAzurermRouteFilter extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _rule = new DataAzurermRouteFilterRuleList(this, "rule", false);
  public get rule() {
    return this._rule;
  }
  ...
  private _timeouts = new DataAzurermRouteFilterTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermRouteFilterTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermRouteFilterTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
