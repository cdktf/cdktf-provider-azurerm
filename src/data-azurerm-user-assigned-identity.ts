...
export function dataAzurermUserAssignedIdentityTimeoutsToTerraform(struct?: DataAzurermUserAssignedIdentityTimeoutsOutputReference | DataAzurermUserAssignedIdentityTimeouts): any {
...
export class DataAzurermUserAssignedIdentityTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermUserAssignedIdentityTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermUserAssignedIdentityTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermUserAssignedIdentity extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermUserAssignedIdentityTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
