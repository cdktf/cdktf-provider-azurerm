...
export function dataFactoryLinkedServiceOdbcTimeoutsToTerraform(struct?: DataFactoryLinkedServiceOdbcTimeoutsOutputReference | DataFactoryLinkedServiceOdbcTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataFactoryLinkedServiceOdbcTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataFactoryLinkedServiceOdbcTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DataFactoryLinkedServiceOdbcTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataFactoryLinkedServiceOdbc extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_data_factory_linked_service_odbc";
  ...
  */
  ...
  private _basicAuthentication = new DataFactoryLinkedServiceOdbcBasicAuthenticationOutputReference(this as any, "basic_authentication", true);
  ...
  private _timeouts = new DataFactoryLinkedServiceOdbcTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
