...
export function botChannelEmailTimeoutsToTerraform(struct?: BotChannelEmailTimeoutsOutputReference | BotChannelEmailTimeouts): any {
...
export class BotChannelEmail extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelEmailTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
