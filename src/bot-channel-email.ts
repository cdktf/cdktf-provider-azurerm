...
export function botChannelEmailTimeoutsToTerraform(struct?: BotChannelEmailTimeoutsOutputReference | BotChannelEmailTimeouts | cdktf.IResolvable): any {
...
export class BotChannelEmailTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BotChannelEmailTimeouts | undefined {
  ...
  public set internalValue(value: BotChannelEmailTimeouts | undefined) {
    if (value === undefined) {
...
export class BotChannelEmail extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelEmailTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
