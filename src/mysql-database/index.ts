// https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/mysql_database
...
export class MysqlDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.87.0/docs/resources/mysql_database#import import section} in the documentation of this resource for the id to use
