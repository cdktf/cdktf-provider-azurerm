...
export function dataShareAccountTimeoutsToTerraform(struct?: DataShareAccountTimeoutsOutputReference | DataShareAccountTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataShareAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataShareAccountTimeouts | undefined {
    let hasAnyValues = false;
    const internalValueResult: any = {};
    if (this._create) {
      hasAnyValues = true;
  ...
  public set internalValue(value: DataShareAccountTimeouts | undefined) {
    if (value === undefined) {
...
export class DataShareAccount extends cdktf.TerraformResource {
  ...
  */
  ...
  private _identity = new DataShareAccountIdentityOutputReference(this as any, "identity", true);
  public get identity() {
  ...
  private _timeouts = new DataShareAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
