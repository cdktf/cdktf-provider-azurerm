...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/mysql_flexible_server_active_directory_administrator
...
export class MysqlFlexibleServerActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MysqlFlexibleServerActiveDirectoryAdministrator that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.53.0/docs/resources/mysql_flexible_server_active_directory_administrator#import import section} in the documentation of this resource for the id to use
