...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/container_app_environment_custom_domain
...
export class ContainerAppEnvironmentCustomDomain extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContainerAppEnvironmentCustomDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/container_app_environment_custom_domain#import import section} in the documentation of this resource for the id to use
