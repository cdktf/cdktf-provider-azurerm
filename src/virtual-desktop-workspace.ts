...
export function virtualDesktopWorkspaceTimeoutsToTerraform(struct?: VirtualDesktopWorkspaceTimeoutsOutputReference | VirtualDesktopWorkspaceTimeouts): any {
...
export class VirtualDesktopWorkspace extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new VirtualDesktopWorkspaceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
