...
export function backupProtectedFileShareTimeoutsToTerraform(struct?: BackupProtectedFileShareTimeoutsOutputReference | BackupProtectedFileShareTimeouts): any {
...
export class BackupProtectedFileShare extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BackupProtectedFileShareTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
