...
export class SentinelDataConnectorAzureAdvancedThreatProtectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SentinelDataConnectorAzureAdvancedThreatProtectionTimeouts | undefined {
  ...
  public set internalValue(value: SentinelDataConnectorAzureAdvancedThreatProtectionTimeouts | undefined) {
    if (value === undefined) {
