...
export function mariadbDatabaseTimeoutsToTerraform(struct?: MariadbDatabaseTimeoutsOutputReference | MariadbDatabaseTimeouts): any {
...
export class MariadbDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MariadbDatabaseTimeouts | undefined {
  ...
  public set internalValue(value: MariadbDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class MariadbDatabase extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_mariadb_database";
  ...
  */
  ...
  private _timeouts = new MariadbDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
