...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/stack_hci_cluster
...
export class StackHciCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing StackHciCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.48.0/docs/resources/stack_hci_cluster#import import section} in the documentation of this resource for the id to use
