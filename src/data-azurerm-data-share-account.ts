...
export function dataAzurermDataShareAccountTimeoutsToTerraform(struct?: DataAzurermDataShareAccountTimeoutsOutputReference | DataAzurermDataShareAccountTimeouts): any {
...
export class DataAzurermDataShareAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermDataShareAccountTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermDataShareAccountTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermDataShareAccount extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermDataShareAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
