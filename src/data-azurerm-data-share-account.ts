...
export class DataAzurermDataShareAccount extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public identity(index: string) {
    return new DataAzurermDataShareAccountIdentity(this, 'identity', index, false);
  }
  ...
  private _timeouts = new DataAzurermDataShareAccountTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
