...
export function dataAzurermApiManagementApiVersionSetTimeoutsToTerraform(struct?: DataAzurermApiManagementApiVersionSetTimeoutsOutputReference | DataAzurermApiManagementApiVersionSetTimeouts): any {
...
export class DataAzurermApiManagementApiVersionSetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermApiManagementApiVersionSetTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermApiManagementApiVersionSetTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermApiManagementApiVersionSet extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermApiManagementApiVersionSetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
