...
export function postgresqlActiveDirectoryAdministratorTimeoutsToTerraform(struct?: PostgresqlActiveDirectoryAdministratorTimeoutsOutputReference | PostgresqlActiveDirectoryAdministratorTimeouts): any {
...
export class PostgresqlActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlActiveDirectoryAdministratorTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
