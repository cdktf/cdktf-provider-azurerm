...
export interface PostgresqlActiveDirectoryAdministratorConfig extends TerraformMetaArguments {
...
export class PostgresqlActiveDirectoryAdministrator extends TerraformResource {
