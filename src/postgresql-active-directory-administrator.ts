// https://www.terraform.io/docs/providers/azurerm/r/postgresql_active_directory_administrator
...
export function postgresqlActiveDirectoryAdministratorTimeoutsToTerraform(struct?: PostgresqlActiveDirectoryAdministratorTimeoutsOutputReference | PostgresqlActiveDirectoryAdministratorTimeouts | cdktf.IResolvable): any {
...
export class PostgresqlActiveDirectoryAdministratorTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresqlActiveDirectoryAdministratorTimeouts | undefined {
  ...
  public set internalValue(value: PostgresqlActiveDirectoryAdministratorTimeouts | undefined) {
    if (value === undefined) {
...
export class PostgresqlActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlActiveDirectoryAdministratorTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
