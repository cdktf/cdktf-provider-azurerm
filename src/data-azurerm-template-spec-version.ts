...
export function dataAzurermTemplateSpecVersionTimeoutsToTerraform(struct?: DataAzurermTemplateSpecVersionTimeoutsOutputReference | DataAzurermTemplateSpecVersionTimeouts): any {
...
export class DataAzurermTemplateSpecVersionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermTemplateSpecVersionTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermTemplateSpecVersionTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermTemplateSpecVersion extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermTemplateSpecVersionTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
