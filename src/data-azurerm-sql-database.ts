...
export function dataAzurermSqlDatabaseTimeoutsToTerraform(struct?: DataAzurermSqlDatabaseTimeoutsOutputReference | DataAzurermSqlDatabaseTimeouts): any {
...
export class DataAzurermSqlDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermSqlDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermSqlDatabase extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSqlDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
