...
export function streamAnalyticsOutputMssqlTimeoutsToTerraform(struct?: StreamAnalyticsOutputMssqlTimeoutsOutputReference | StreamAnalyticsOutputMssqlTimeouts): any {
...
export class StreamAnalyticsOutputMssqlTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StreamAnalyticsOutputMssqlTimeouts | undefined {
  ...
  public set internalValue(value: StreamAnalyticsOutputMssqlTimeouts | undefined) {
    if (value === undefined) {
...
export class StreamAnalyticsOutputMssql extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new StreamAnalyticsOutputMssqlTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
