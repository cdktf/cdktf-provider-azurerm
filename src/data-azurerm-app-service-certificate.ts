...
export function dataAzurermAppServiceCertificateTimeoutsToTerraform(struct?: DataAzurermAppServiceCertificateTimeoutsOutputReference | DataAzurermAppServiceCertificateTimeouts): any {
...
export class DataAzurermAppServiceCertificateTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAppServiceCertificateTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermAppServiceCertificateTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermAppServiceCertificate extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAppServiceCertificateTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
