// https://registry.terraform.io/providers/hashicorp/azurerm/4.19.0/docs/resources/data_factory_linked_service_odbc
...
export class DataFactoryLinkedServiceOdbc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataFactoryLinkedServiceOdbc that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.19.0/docs/resources/data_factory_linked_service_odbc#import import section} in the documentation of this resource for the id to use
