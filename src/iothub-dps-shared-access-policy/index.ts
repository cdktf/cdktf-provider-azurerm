...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/iothub_dps_shared_access_policy
...
export class IothubDpsSharedAccessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IothubDpsSharedAccessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/iothub_dps_shared_access_policy#import import section} in the documentation of this resource for the id to use
