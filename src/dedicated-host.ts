...
export interface DedicatedHostConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dedicated_host#id DedicatedHost#id}
  *
...
export function dedicatedHostTimeoutsToTerraform(struct?: DedicatedHostTimeoutsOutputReference | DedicatedHostTimeouts | cdktf.IResolvable): any {
...
export class DedicatedHostTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DedicatedHostTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DedicatedHostTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DedicatedHost extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_dedicated_host";
  ...
  */
  ...
  private _timeouts = new DedicatedHostTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
