...
export function automationVariableIntTimeoutsToTerraform(struct?: AutomationVariableIntTimeoutsOutputReference | AutomationVariableIntTimeouts): any {
...
export class AutomationVariableIntTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AutomationVariableIntTimeouts | undefined {
  ...
  public set internalValue(value: AutomationVariableIntTimeouts | undefined) {
    if (value === undefined) {
...
export class AutomationVariableInt extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AutomationVariableIntTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
