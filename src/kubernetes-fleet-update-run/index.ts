...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/kubernetes_fleet_update_run
...
export class KubernetesFleetUpdateRun extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KubernetesFleetUpdateRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/kubernetes_fleet_update_run#import import section} in the documentation of this resource for the id to use
