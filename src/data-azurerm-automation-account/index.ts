...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.78.0/docs/data-sources/automation_account
...
export class DataAzurermAutomationAccount extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermAutomationAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.78.0/docs/data-sources/automation_account#import import section} in the documentation of this resource for the id to use
