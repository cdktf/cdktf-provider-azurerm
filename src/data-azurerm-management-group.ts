...
export function dataAzurermManagementGroupTimeoutsToTerraform(struct?: DataAzurermManagementGroupTimeoutsOutputReference | DataAzurermManagementGroupTimeouts): any {
...
export class DataAzurermManagementGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermManagementGroupTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermManagementGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermManagementGroup extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermManagementGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
