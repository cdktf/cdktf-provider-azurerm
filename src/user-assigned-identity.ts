...
function userAssignedIdentityTimeoutsToTerraform(struct?: UserAssignedIdentityTimeoutsOutputReference | UserAssignedIdentityTimeouts): any {
...
export class UserAssignedIdentity extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: UserAssignedIdentityTimeouts | undefined; 
  private __timeoutsOutput = new UserAssignedIdentityTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: UserAssignedIdentityTimeouts | undefined) {
