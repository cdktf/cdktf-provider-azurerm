...
export function appServicePublicCertificateTimeoutsToTerraform(struct?: AppServicePublicCertificateTimeoutsOutputReference | AppServicePublicCertificateTimeouts | cdktf.IResolvable): any {
...
export class AppServicePublicCertificate extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AppServicePublicCertificateTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
