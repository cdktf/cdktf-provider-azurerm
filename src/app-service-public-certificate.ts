...
function appServicePublicCertificateTimeoutsToTerraform(struct?: AppServicePublicCertificateTimeoutsOutputReference | AppServicePublicCertificateTimeouts): any {
...
export class AppServicePublicCertificate extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: AppServicePublicCertificateTimeouts | undefined; 
  private __timeoutsOutput = new AppServicePublicCertificateTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: AppServicePublicCertificateTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: appServicePublicCertificateTimeoutsToTerraform(this._timeouts),
    };
  }
}
