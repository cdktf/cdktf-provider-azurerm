...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.49.0/docs/resources/oracle_exascale_database_storage_vault
...
export interface OracleExascaleDatabaseStorageVaultConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  readonly highCapacityDatabaseStorage: OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorage;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: OracleExascaleDatabaseStorageVaultTimeouts;
}
export interface OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorage {
  /**
...
export class OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorageOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorage | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._totalSizeInGb !== undefined) {
      hasAnyValues = true;
      internalValueResult.totalSizeInGb = this._totalSizeInGb;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorage | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._totalSizeInGb = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._totalSizeInGb = value.totalSizeInGb;
    }
  }
  ...
  // total_size_in_gb - computed: false, optional: false, required: true
  private _totalSizeInGb?: number; 
  public get totalSizeInGb() {
    return this.getNumberAttribute('total_size_in_gb');
  }
  public set totalSizeInGb(value: number) {
    this._totalSizeInGb = value;
  }
  // Temporarily expose input value. Use with caution.
  public get totalSizeInGbInput() {
    return this._totalSizeInGb;
  }
}
export interface OracleExascaleDatabaseStorageVaultTimeouts {
  /**
...
export class OracleExascaleDatabaseStorageVault extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing OracleExascaleDatabaseStorageVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.49.0/docs/resources/oracle_exascale_database_storage_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.49.0/docs/resources/oracle_exascale_database_storage_vault azurerm_oracle_exascale_database_storage_vault} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options OracleExascaleDatabaseStorageVaultConfig
  */
  public constructor(scope: Construct, id: string, config: OracleExascaleDatabaseStorageVaultConfig) {
    super(scope, id, {
    ...
    this._additionalFlashCachePercentage = config.additionalFlashCachePercentage;
  ...
  // additional_flash_cache_percentage - computed: false, optional: false, required: true
  private _additionalFlashCachePercentage?: number; 
  public get additionalFlashCachePercentage() {
    return this.getNumberAttribute('additional_flash_cache_percentage');
  }
  public set additionalFlashCachePercentage(value: number) {
    this._additionalFlashCachePercentage = value;
  }
  // Temporarily expose input value. Use with caution.
  public get additionalFlashCachePercentageInput() {
    return this._additionalFlashCachePercentage;
  }
  ...
  private _highCapacityDatabaseStorage = new OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorageOutputReference(this, "high_capacity_database_storage");
  public get highCapacityDatabaseStorage() {
    return this._highCapacityDatabaseStorage;
  }
  public putHighCapacityDatabaseStorage(value: OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorage) {
  ...
  private _timeouts = new OracleExascaleDatabaseStorageVaultTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: OracleExascaleDatabaseStorageVaultTimeouts) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      high_capacity_database_storage: {
        value: oracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorageToHclTerraform(this._highCapacityDatabaseStorage.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "OracleExascaleDatabaseStorageVaultHighCapacityDatabaseStorageList",
      },
      timeouts: {
        value: oracleExascaleDatabaseStorageVaultTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "OracleExascaleDatabaseStorageVaultTimeouts",
      },
    };
