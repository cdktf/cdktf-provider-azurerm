// https://www.terraform.io/docs/providers/azurerm/r/policy_assignment
...
export class PolicyAssignment extends cdktf.TerraformResource {
  ...
  */
  ...
  private _identity = new PolicyAssignmentIdentityOutputReference(this, "identity");
  public get identity() {
  ...
  private _timeouts = new PolicyAssignmentTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
