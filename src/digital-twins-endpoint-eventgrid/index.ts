...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/digital_twins_endpoint_eventgrid
...
export class DigitalTwinsEndpointEventgrid extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DigitalTwinsEndpointEventgrid that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/resources/digital_twins_endpoint_eventgrid#import import section} in the documentation of this resource for the id to use
