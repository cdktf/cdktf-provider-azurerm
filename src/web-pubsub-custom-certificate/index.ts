...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.88.0/docs/resources/web_pubsub_custom_certificate
...
export class WebPubsubCustomCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebPubsubCustomCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.88.0/docs/resources/web_pubsub_custom_certificate#import import section} in the documentation of this resource for the id to use
