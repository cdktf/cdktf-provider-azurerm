...
export function dataAzurermSnapshotTimeoutsToTerraform(struct?: DataAzurermSnapshotTimeoutsOutputReference | DataAzurermSnapshotTimeouts): any {
...
export class DataAzurermSnapshotTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermSnapshotTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermSnapshot extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSnapshotTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
