...
export class PolicySetDefinition extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.73.0/docs/resources/policy_set_definition azurerm_policy_set_definition} Resource
  *
