// https://www.terraform.io/docs/providers/azurerm/r/virtual_hub_ip
...
export function virtualHubIpTimeoutsToTerraform(struct?: VirtualHubIpTimeoutsOutputReference | VirtualHubIpTimeouts | cdktf.IResolvable): any {
...
export class VirtualHubIp extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new VirtualHubIpTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
