// https://www.terraform.io/docs/providers/azurerm/r/relay_hybrid_connection
...
export function relayHybridConnectionTimeoutsToTerraform(struct?: RelayHybridConnectionTimeoutsOutputReference | RelayHybridConnectionTimeouts | cdktf.IResolvable): any {
...
export class RelayHybridConnection extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new RelayHybridConnectionTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
