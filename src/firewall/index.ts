...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.84.0/docs/resources/firewall
...
export class Firewall extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Firewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.84.0/docs/resources/firewall#import import section} in the documentation of this resource for the id to use
