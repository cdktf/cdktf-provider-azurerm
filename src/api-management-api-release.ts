...
export function apiManagementApiReleaseTimeoutsToTerraform(struct?: ApiManagementApiReleaseTimeoutsOutputReference | ApiManagementApiReleaseTimeouts): any {
...
export class ApiManagementApiReleaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApiManagementApiReleaseTimeouts | undefined {
  ...
  public set internalValue(value: ApiManagementApiReleaseTimeouts | undefined) {
    if (value === undefined) {
...
export class ApiManagementApiRelease extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ApiManagementApiReleaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
