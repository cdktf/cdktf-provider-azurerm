...
export function logicAppIntegrationAccountSchemaTimeoutsToTerraform(struct?: LogicAppIntegrationAccountSchemaTimeoutsOutputReference | LogicAppIntegrationAccountSchemaTimeouts): any {
...
export class LogicAppIntegrationAccountSchemaTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LogicAppIntegrationAccountSchemaTimeouts | undefined {
  ...
  public set internalValue(value: LogicAppIntegrationAccountSchemaTimeouts | undefined) {
    if (value === undefined) {
...
export class LogicAppIntegrationAccountSchema extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LogicAppIntegrationAccountSchemaTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
