...
export function siteRecoveryProtectionContainerTimeoutsToTerraform(struct?: SiteRecoveryProtectionContainerTimeoutsOutputReference | SiteRecoveryProtectionContainerTimeouts): any {
...
export class SiteRecoveryProtectionContainer extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SiteRecoveryProtectionContainerTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
