...
export function siteRecoveryProtectionContainerTimeoutsToTerraform(struct?: SiteRecoveryProtectionContainerTimeoutsOutputReference | SiteRecoveryProtectionContainerTimeouts | cdktf.IResolvable): any {
...
export class SiteRecoveryProtectionContainerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SiteRecoveryProtectionContainerTimeouts | undefined {
  ...
  public set internalValue(value: SiteRecoveryProtectionContainerTimeouts | undefined) {
    if (value === undefined) {
...
export class SiteRecoveryProtectionContainer extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SiteRecoveryProtectionContainerTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
