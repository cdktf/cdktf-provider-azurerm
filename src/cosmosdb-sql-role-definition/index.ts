...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/cosmosdb_sql_role_definition
...
export class CosmosdbSqlRoleDefinition extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CosmosdbSqlRoleDefinition that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.112.0/docs/resources/cosmosdb_sql_role_definition#import import section} in the documentation of this resource for the id to use
