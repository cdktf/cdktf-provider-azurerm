...
export function dataAzurermKeyVaultCertificateIssuerTimeoutsToTerraform(struct?: DataAzurermKeyVaultCertificateIssuerTimeoutsOutputReference | DataAzurermKeyVaultCertificateIssuerTimeouts): any {
...
export class DataAzurermKeyVaultCertificateIssuerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermKeyVaultCertificateIssuerTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermKeyVaultCertificateIssuer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermKeyVaultCertificateIssuerTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
