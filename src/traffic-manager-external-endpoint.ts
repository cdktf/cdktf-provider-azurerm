...
export class TrafficManagerExternalEndpoint extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_traffic_manager_external_endpoint";
  ...
  */
  ...
  private _timeouts = new TrafficManagerExternalEndpointTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
