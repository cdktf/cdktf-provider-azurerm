...
export function dataAzurermVirtualNetworkTimeoutsToTerraform(struct?: DataAzurermVirtualNetworkTimeoutsOutputReference | DataAzurermVirtualNetworkTimeouts): any {
...
export class DataAzurermVirtualNetworkTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermVirtualNetworkTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermVirtualNetworkTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermVirtualNetwork extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermVirtualNetworkTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
