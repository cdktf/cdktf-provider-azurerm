...
export function iothubEndpointServicebusQueueTimeoutsToTerraform(struct?: IothubEndpointServicebusQueueTimeoutsOutputReference | IothubEndpointServicebusQueueTimeouts): any {
...
export class IothubEndpointServicebusQueueTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IothubEndpointServicebusQueueTimeouts | undefined {
  ...
  public set internalValue(value: IothubEndpointServicebusQueueTimeouts | undefined) {
    if (value === undefined) {
...
export class IothubEndpointServicebusQueue extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new IothubEndpointServicebusQueueTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
