...
export class DataAzurermPublicIpTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermPublicIpTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermPublicIpTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermPublicIp extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _ipTags = new cdktf.StringMap(this, "ip_tags");
  public get ipTags() {
    return this._ipTags;
  }
  ...
  private _timeouts = new DataAzurermPublicIpTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
