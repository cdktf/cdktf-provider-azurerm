...
export function dataAzurermPublicIpTimeoutsToTerraform(struct?: DataAzurermPublicIpTimeoutsOutputReference | DataAzurermPublicIpTimeouts): any {
...
export class DataAzurermPublicIp extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermPublicIpTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
