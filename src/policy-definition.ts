...
export function policyDefinitionTimeoutsToTerraform(struct?: PolicyDefinitionTimeoutsOutputReference | PolicyDefinitionTimeouts | cdktf.IResolvable): any {
...
export class PolicyDefinition extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PolicyDefinitionTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
