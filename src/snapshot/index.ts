// https://registry.terraform.io/providers/hashicorp/azurerm/4.5.0/docs/resources/snapshot
...
export class Snapshot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Snapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.5.0/docs/resources/snapshot#import import section} in the documentation of this resource for the id to use
