...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/function_app_slot
...
export class FunctionAppSlot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FunctionAppSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/function_app_slot#import import section} in the documentation of this resource for the id to use
