...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/mariadb_database
...
export class MariadbDatabase extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MariadbDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/mariadb_database#import import section} in the documentation of this resource for the id to use
