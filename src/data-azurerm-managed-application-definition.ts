// https://www.terraform.io/docs/providers/azurerm/d/managed_application_definition
...
export function dataAzurermManagedApplicationDefinitionTimeoutsToTerraform(struct?: DataAzurermManagedApplicationDefinitionTimeoutsOutputReference | DataAzurermManagedApplicationDefinitionTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermManagedApplicationDefinitionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermManagedApplicationDefinitionTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermManagedApplicationDefinitionTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataAzurermManagedApplicationDefinition extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermManagedApplicationDefinitionTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermManagedApplicationDefinitionTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermManagedApplicationDefinitionTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
