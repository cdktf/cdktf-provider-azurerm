...
function dataAzurermManagedApplicationDefinitionTimeoutsToTerraform(struct?: DataAzurermManagedApplicationDefinitionTimeoutsOutputReference | DataAzurermManagedApplicationDefinitionTimeouts): any {
...
export class DataAzurermManagedApplicationDefinition extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts?: DataAzurermManagedApplicationDefinitionTimeouts | undefined; 
  private __timeoutsOutput = new DataAzurermManagedApplicationDefinitionTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: DataAzurermManagedApplicationDefinitionTimeouts | undefined) {
