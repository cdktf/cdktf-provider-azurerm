...
export class DataAzurermManagedApplicationDefinitionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermManagedApplicationDefinitionTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermManagedApplicationDefinitionTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermManagedApplicationDefinition extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermManagedApplicationDefinitionTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
