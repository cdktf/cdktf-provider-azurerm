...
export interface DataLakeAnalyticsAccountConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_lake_analytics_account#id DataLakeAnalyticsAccount#id}
  *
...
export function dataLakeAnalyticsAccountTimeoutsToTerraform(struct?: DataLakeAnalyticsAccountTimeoutsOutputReference | DataLakeAnalyticsAccountTimeouts | cdktf.IResolvable): any {
...
export class DataLakeAnalyticsAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeAnalyticsAccountTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataLakeAnalyticsAccountTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataLakeAnalyticsAccount extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_data_lake_analytics_account";
  ...
  */
  ...
  private _timeouts = new DataLakeAnalyticsAccountTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataLakeAnalyticsAccountTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataLakeAnalyticsAccountTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
