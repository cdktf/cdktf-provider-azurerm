...
export function dataLakeAnalyticsAccountTimeoutsToTerraform(struct?: DataLakeAnalyticsAccountTimeoutsOutputReference | DataLakeAnalyticsAccountTimeouts): any {
...
export class DataLakeAnalyticsAccount extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataLakeAnalyticsAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
