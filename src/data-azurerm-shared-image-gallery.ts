...
export function dataAzurermSharedImageGalleryTimeoutsToTerraform(struct?: DataAzurermSharedImageGalleryTimeoutsOutputReference | DataAzurermSharedImageGalleryTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermSharedImageGalleryTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermSharedImageGalleryTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermSharedImageGalleryTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermSharedImageGallery extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSharedImageGalleryTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
