...
export function dataAzurermSharedImageGalleryTimeoutsToTerraform(struct?: DataAzurermSharedImageGalleryTimeoutsOutputReference | DataAzurermSharedImageGalleryTimeouts): any {
...
export class DataAzurermSharedImageGallery extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermSharedImageGalleryTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
