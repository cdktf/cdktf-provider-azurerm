...
export function mariadbConfigurationTimeoutsToTerraform(struct?: MariadbConfigurationTimeoutsOutputReference | MariadbConfigurationTimeouts): any {
...
export class MariadbConfigurationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MariadbConfigurationTimeouts | undefined {
  ...
  public set internalValue(value: MariadbConfigurationTimeouts | undefined) {
    if (value === undefined) {
...
export class MariadbConfiguration extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MariadbConfigurationTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
