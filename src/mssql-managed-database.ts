// https://www.terraform.io/docs/providers/azurerm/r/mssql_managed_database
...
export function mssqlManagedDatabaseTimeoutsToTerraform(struct?: MssqlManagedDatabaseTimeoutsOutputReference | MssqlManagedDatabaseTimeouts | cdktf.IResolvable): any {
...
export class MssqlManagedDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlManagedDatabaseTimeouts | undefined {
  ...
  public set internalValue(value: MssqlManagedDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class MssqlManagedDatabase extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_mssql_managed_database";
  ...
  */
  ...
  private _timeouts = new MssqlManagedDatabaseTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
