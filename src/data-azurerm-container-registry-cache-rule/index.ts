...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/data-sources/container_registry_cache_rule
...
export class DataAzurermContainerRegistryCacheRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermContainerRegistryCacheRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.44.0/docs/data-sources/container_registry_cache_rule#import import section} in the documentation of this resource for the id to use
