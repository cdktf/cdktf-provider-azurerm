...
export function activeDirectoryDomainServiceReplicaSetTimeoutsToTerraform(struct?: ActiveDirectoryDomainServiceReplicaSetTimeoutsOutputReference | ActiveDirectoryDomainServiceReplicaSetTimeouts | cdktf.IResolvable): any {
...
export class ActiveDirectoryDomainServiceReplicaSet extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ActiveDirectoryDomainServiceReplicaSetTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
