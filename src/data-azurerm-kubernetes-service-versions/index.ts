// https://registry.terraform.io/providers/hashicorp/azurerm/4.29.0/docs/data-sources/kubernetes_service_versions
...
export class DataAzurermKubernetesServiceVersions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermKubernetesServiceVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.29.0/docs/data-sources/kubernetes_service_versions#import import section} in the documentation of this resource for the id to use
