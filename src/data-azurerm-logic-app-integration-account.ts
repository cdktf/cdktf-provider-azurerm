...
export interface DataAzurermLogicAppIntegrationAccountConfig extends TerraformMetaArguments {
...
export class DataAzurermLogicAppIntegrationAccount extends TerraformDataSource {
