...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/key_vault_certificate_contacts
...
export class KeyVaultCertificateContacts extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KeyVaultCertificateContacts that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/key_vault_certificate_contacts#import import section} in the documentation of this resource for the id to use
