...
export interface DataAzurermFunctionAppHostKeysConfig extends TerraformMetaArguments {
...
export class DataAzurermFunctionAppHostKeys extends TerraformDataSource {
