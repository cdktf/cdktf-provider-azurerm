...
export function dataAzurermFunctionAppHostKeysTimeoutsToTerraform(struct?: DataAzurermFunctionAppHostKeysTimeoutsOutputReference | DataAzurermFunctionAppHostKeysTimeouts): any {
...
export class DataAzurermFunctionAppHostKeysTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: DataAzurermFunctionAppHostKeysTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermFunctionAppHostKeys extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermFunctionAppHostKeysTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
