...
export function appServiceHybridConnectionTimeoutsToTerraform(struct?: AppServiceHybridConnectionTimeoutsOutputReference | AppServiceHybridConnectionTimeouts): any {
...
export class AppServiceHybridConnection extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new AppServiceHybridConnectionTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
