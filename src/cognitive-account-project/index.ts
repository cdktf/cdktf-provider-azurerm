...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cognitive_account_project
...
export interface CognitiveAccountProjectConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly identity: CognitiveAccountProjectIdentity;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: CognitiveAccountProjectTimeouts;
}
export interface CognitiveAccountProjectIdentity {
  /**
...
export function cognitiveAccountProjectIdentityToTerraform(struct?: CognitiveAccountProjectIdentityOutputReference | CognitiveAccountProjectIdentity): any {
...
export function cognitiveAccountProjectIdentityToHclTerraform(struct?: CognitiveAccountProjectIdentityOutputReference | CognitiveAccountProjectIdentity): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CognitiveAccountProjectIdentityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CognitiveAccountProjectIdentity | undefined {
  ...
  public set internalValue(value: CognitiveAccountProjectIdentity | undefined) {
    if (value === undefined) {
...
export interface CognitiveAccountProjectTimeouts {
  /**
...
export function cognitiveAccountProjectTimeoutsToTerraform(struct?: CognitiveAccountProjectTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function cognitiveAccountProjectTimeoutsToHclTerraform(struct?: CognitiveAccountProjectTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CognitiveAccountProjectTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): CognitiveAccountProjectTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CognitiveAccountProjectTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class CognitiveAccountProject extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_cognitive_account_project";
  ...
  * @param importToId The construct id used in the generated config for the CognitiveAccountProject to import
  * @param importFromId The id of the existing CognitiveAccountProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/cognitive_account_project#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CognitiveAccountProject to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "azurerm_cognitive_account_project", importId: importFromId, provider });
      }
  ...
  * @param options CognitiveAccountProjectConfig
  */
  public constructor(scope: Construct, id: string, config: CognitiveAccountProjectConfig) {
    super(scope, id, {
      terraformResourceType: 'azurerm_cognitive_account_project',
  ...
  private _identity = new CognitiveAccountProjectIdentityOutputReference(this, "identity");
  public get identity() {
    return this._identity;
  }
  public putIdentity(value: CognitiveAccountProjectIdentity) {
  ...
  private _timeouts = new CognitiveAccountProjectTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: CognitiveAccountProjectTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      identity: cognitiveAccountProjectIdentityToTerraform(this._identity.internalValue),
      timeouts: cognitiveAccountProjectTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      identity: {
        value: cognitiveAccountProjectIdentityToHclTerraform(this._identity.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "CognitiveAccountProjectIdentityList",
      },
      timeouts: {
        value: cognitiveAccountProjectTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CognitiveAccountProjectTimeouts",
      },
    };
