...
export function dataAzurermNetappAccountTimeoutsToTerraform(struct?: DataAzurermNetappAccountTimeoutsOutputReference | DataAzurermNetappAccountTimeouts): any {
...
export class DataAzurermNetappAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermNetappAccountTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermNetappAccountTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermNetappAccount extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermNetappAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
