...
export function mssqlJobCredentialTimeoutsToTerraform(struct?: MssqlJobCredentialTimeoutsOutputReference | MssqlJobCredentialTimeouts | cdktf.IResolvable): any {
...
export class MssqlJobCredential extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MssqlJobCredentialTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
