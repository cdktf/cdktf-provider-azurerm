...
export function dataAzurermNetappPoolTimeoutsToTerraform(struct?: DataAzurermNetappPoolTimeoutsOutputReference | DataAzurermNetappPoolTimeouts): any {
...
export class DataAzurermNetappPoolTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermNetappPoolTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermNetappPoolTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermNetappPool extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermNetappPoolTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
