...
export class RedisFirewallRule extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.66.0/docs/resources/redis_firewall_rule azurerm_redis_firewall_rule} Resource
  *
