...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.24.0/docs/resources/web_pubsub_hub
...
export class WebPubsubHub extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing WebPubsubHub that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.24.0/docs/resources/web_pubsub_hub#import import section} in the documentation of this resource for the id to use
