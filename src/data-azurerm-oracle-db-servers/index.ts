// https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/data-sources/oracle_db_servers
...
export interface DataAzurermOracleDbServersTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/data-sources/oracle_db_servers#read DataAzurermOracleDbServers#read}
  */
...
export class DataAzurermOracleDbServers extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleDbServers that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.9.0/docs/data-sources/oracle_db_servers#import import section} in the documentation of this resource for the id to use
