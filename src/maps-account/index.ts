...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/maps_account
...
export class MapsAccount extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MapsAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/maps_account#import import section} in the documentation of this resource for the id to use
