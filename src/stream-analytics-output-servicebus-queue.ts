// https://www.terraform.io/docs/providers/azurerm/r/stream_analytics_output_servicebus_queue
...
export function streamAnalyticsOutputServicebusQueueTimeoutsToTerraform(struct?: StreamAnalyticsOutputServicebusQueueTimeoutsOutputReference | StreamAnalyticsOutputServicebusQueueTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class StreamAnalyticsOutputServicebusQueueTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): StreamAnalyticsOutputServicebusQueueTimeouts | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: StreamAnalyticsOutputServicebusQueueTimeouts | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class StreamAnalyticsOutputServicebusQueue extends cdktf.TerraformResource {
  ...
  */
  ...
  private _serialization = new StreamAnalyticsOutputServicebusQueueSerializationOutputReference(this, "serialization", true);
  ...
  private _timeouts = new StreamAnalyticsOutputServicebusQueueTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
