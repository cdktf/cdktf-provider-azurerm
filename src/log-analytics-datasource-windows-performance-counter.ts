...
export function logAnalyticsDatasourceWindowsPerformanceCounterTimeoutsToTerraform(struct?: LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference | LogAnalyticsDatasourceWindowsPerformanceCounterTimeouts): any {
...
export class LogAnalyticsDatasourceWindowsPerformanceCounter extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
