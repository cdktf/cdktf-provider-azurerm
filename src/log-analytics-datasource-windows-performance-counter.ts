// https://www.terraform.io/docs/providers/azurerm/r/log_analytics_datasource_windows_performance_counter
...
export function logAnalyticsDatasourceWindowsPerformanceCounterTimeoutsToTerraform(struct?: LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference | LogAnalyticsDatasourceWindowsPerformanceCounterTimeouts | cdktf.IResolvable): any {
...
export class LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LogAnalyticsDatasourceWindowsPerformanceCounterTimeouts | undefined {
  ...
  public set internalValue(value: LogAnalyticsDatasourceWindowsPerformanceCounterTimeouts | undefined) {
    if (value === undefined) {
...
export class LogAnalyticsDatasourceWindowsPerformanceCounter extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new LogAnalyticsDatasourceWindowsPerformanceCounterTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
