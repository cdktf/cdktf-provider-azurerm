...
export interface DataAzurermMachineLearningWorkspaceIdentity {
}

export function dataAzurermMachineLearningWorkspaceIdentityToTerraform(struct?: DataAzurermMachineLearningWorkspaceIdentity): any {
...
export class DataAzurermMachineLearningWorkspaceIdentityOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermMachineLearningWorkspaceIdentity | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataAzurermMachineLearningWorkspaceIdentity | undefined) {
    if (value === undefined) {
...
export class DataAzurermMachineLearningWorkspaceIdentityList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataAzurermMachineLearningWorkspaceIdentityOutputReference {
    return new DataAzurermMachineLearningWorkspaceIdentityOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataAzurermMachineLearningWorkspaceTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermMachineLearningWorkspaceTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataAzurermMachineLearningWorkspaceTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class DataAzurermMachineLearningWorkspace extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _identity = new DataAzurermMachineLearningWorkspaceIdentityList(this, "identity", false);
  public get identity() {
  ...
  private _timeouts = new DataAzurermMachineLearningWorkspaceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataAzurermMachineLearningWorkspaceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataAzurermMachineLearningWorkspaceTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
