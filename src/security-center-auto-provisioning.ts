...
export function securityCenterAutoProvisioningTimeoutsToTerraform(struct?: SecurityCenterAutoProvisioningTimeoutsOutputReference | SecurityCenterAutoProvisioningTimeouts): any {
...
export class SecurityCenterAutoProvisioningTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: SecurityCenterAutoProvisioningTimeouts | undefined) {
    if (value === undefined) {
...
export class SecurityCenterAutoProvisioning extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SecurityCenterAutoProvisioningTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
