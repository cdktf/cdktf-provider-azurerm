// https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/spring_cloud_certificate
...
export class SpringCloudCertificate extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpringCloudCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.14.0/docs/resources/spring_cloud_certificate#import import section} in the documentation of this resource for the id to use
