...
function servicebusQueueAuthorizationRuleTimeoutsToTerraform(struct?: ServicebusQueueAuthorizationRuleTimeoutsOutputReference | ServicebusQueueAuthorizationRuleTimeouts): any {
...
export class ServicebusQueueAuthorizationRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: ServicebusQueueAuthorizationRuleTimeouts | undefined; 
  private __timeoutsOutput = new ServicebusQueueAuthorizationRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: ServicebusQueueAuthorizationRuleTimeouts | undefined) {
