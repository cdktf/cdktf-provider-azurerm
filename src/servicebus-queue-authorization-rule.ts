...
export interface ServicebusQueueAuthorizationRuleConfig extends TerraformMetaArguments {
...
export class ServicebusQueueAuthorizationRule extends TerraformResource {
  ...
  public set timeouts(value: ServicebusQueueAuthorizationRuleTimeouts | undefined) {
