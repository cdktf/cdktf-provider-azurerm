// https://www.terraform.io/docs/providers/azurerm/r/servicebus_queue_authorization_rule
...
export class ServicebusQueueAuthorizationRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServicebusQueueAuthorizationRuleTimeouts | undefined {
  ...
  public set internalValue(value: ServicebusQueueAuthorizationRuleTimeouts | undefined) {
    if (value === undefined) {
