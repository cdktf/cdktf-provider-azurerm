...
function dnsPtrRecordTimeoutsToTerraform(struct?: DnsPtrRecordTimeoutsOutputReference | DnsPtrRecordTimeouts): any {
...
export class DnsPtrRecord extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: DnsPtrRecordTimeouts | undefined; 
  private __timeoutsOutput = new DnsPtrRecordTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: DnsPtrRecordTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dnsPtrRecordTimeoutsToTerraform(this._timeouts),
    };
  }
}
