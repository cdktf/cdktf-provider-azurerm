...
export function dataProtectionBackupInstanceDiskTimeoutsToTerraform(struct?: DataProtectionBackupInstanceDiskTimeoutsOutputReference | DataProtectionBackupInstanceDiskTimeouts): any {
...
export class DataProtectionBackupInstanceDiskTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataProtectionBackupInstanceDiskTimeouts | undefined {
  ...
  public set internalValue(value: DataProtectionBackupInstanceDiskTimeouts | undefined) {
    if (value === undefined) {
...
export class DataProtectionBackupInstanceDisk extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new DataProtectionBackupInstanceDiskTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
