// https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/network_manager_deployment
...
export class NetworkManagerDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkManagerDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.12.0/docs/resources/network_manager_deployment#import import section} in the documentation of this resource for the id to use
