...
export * as aiFoundry from './ai-foundry';
export * as aiFoundryProject from './ai-foundry-project';
...
export * as apiManagementStandaloneGateway from './api-management-standalone-gateway';
...
export * as applicationLoadBalancerSecurityPolicy from './application-load-balancer-security-policy';
...
export * as arcKubernetesProvisionedCluster from './arc-kubernetes-provisioned-cluster';
...
export * as cognitiveAccountProject from './cognitive-account-project';
export * as cognitiveAccountRaiBlocklist from './cognitive-account-rai-blocklist';
export * as cognitiveAccountRaiPolicy from './cognitive-account-rai-policy';
...
export * as dashboardGrafanaManagedPrivateEndpoint from './dashboard-grafana-managed-private-endpoint';
...
export * as devCenterProjectPool from './dev-center-project-pool';
...
export * as dynatraceMonitor from './dynatrace-monitor';
export * as dynatraceTagRules from './dynatrace-tag-rules';
...
export * as emailCommunicationServiceDomainSenderUsername from './email-communication-service-domain-sender-username';
...
export * as functionAppFlexConsumption from './function-app-flex-consumption';
...
export * as logAnalyticsWorkspaceTableCustomLog from './log-analytics-workspace-table-custom-log';
...
export * as machineLearningWorkspaceNetworkOutboundRuleFqdn from './machine-learning-workspace-network-outbound-rule-fqdn';
export * as machineLearningWorkspaceNetworkOutboundRulePrivateEndpoint from './machine-learning-workspace-network-outbound-rule-private-endpoint';
export * as machineLearningWorkspaceNetworkOutboundRuleServiceTag from './machine-learning-workspace-network-outbound-rule-service-tag';
...
export * as managementGroupPolicySetDefinition from './management-group-policy-set-definition';
...
export * as mssqlJobStep from './mssql-job-step';
export * as mssqlJobTargetGroup from './mssql-job-target-group';
...
export * as mssqlManagedInstanceStartStopSchedule from './mssql-managed-instance-start-stop-schedule';
...
export * as netappVolumeGroupOracle from './netapp-volume-group-oracle';
...
export * as paloAltoNextGenerationFirewallVirtualHubStrataCloudManager from './palo-alto-next-generation-firewall-virtual-hub-strata-cloud-manager';
...
export * as paloAltoNextGenerationFirewallVirtualNetworkStrataCloudManager from './palo-alto-next-generation-firewall-virtual-network-strata-cloud-manager';
...
export * as postgresqlFlexibleServerBackup from './postgresql-flexible-server-backup';
...
export * as servicebusNamespaceCustomerManagedKey from './servicebus-namespace-customer-managed-key';
...
export * as stackHciExtension from './stack-hci-extension';
export * as stackHciLogicalNetwork from './stack-hci-logical-network';
export * as stackHciMarketplaceGalleryImage from './stack-hci-marketplace-gallery-image';
export * as stackHciNetworkInterface from './stack-hci-network-interface';
...
export * as streamAnalyticsJobStorageAccount from './stream-analytics-job-storage-account';
...
export * as trustedSigningAccount from './trusted-signing-account';
export * as userAssignedIdentity from './user-assigned-identity';
export * as videoIndexerAccount from './video-indexer-account';
...
export * as virtualMachineScaleSetStandbyPool from './virtual-machine-scale-set-standby-pool';
...
export * as webPubsubSocketio from './web-pubsub-socketio';
...
export * as dataAzurermApiConnection from './data-azurerm-api-connection';
...
export * as dataAzurermApiManagementSubscription from './data-azurerm-api-management-subscription';
export * as dataAzurermApiManagementUser from './data-azurerm-api-management-user';
export * as dataAzurermApiManagementWorkspace from './data-azurerm-api-management-workspace';
...
export * as dataAzurermDevCenterEnvironmentType from './data-azurerm-dev-center-environment-type';
...
export * as dataAzurermDevCenterProjectPool from './data-azurerm-dev-center-project-pool';
...
export * as dataAzurermEventgridPartnerNamespace from './data-azurerm-eventgrid-partner-namespace';
export * as dataAzurermEventgridPartnerRegistration from './data-azurerm-eventgrid-partner-registration';
...
export * as dataAzurermGraphServicesAccount from './data-azurerm-graph-services-account';
...
export * as dataAzurermKubernetesFleetManager from './data-azurerm-kubernetes-fleet-manager';
...
export * as dataAzurermLogAnalyticsWorkspaceTable from './data-azurerm-log-analytics-workspace-table';
...
export * as dataAzurermMssqlFailoverGroup from './data-azurerm-mssql-failover-group';
...
export * as dataAzurermNetappVolumeGroupOracle from './data-azurerm-netapp-volume-group-oracle';
...
export * as dataAzurermOracleAdbsCharacterSets from './data-azurerm-oracle-adbs-character-sets';
export * as dataAzurermOracleAdbsNationalCharacterSets from './data-azurerm-oracle-adbs-national-character-sets';
...
export * as dataAzurermStackHciStoragePath from './data-azurerm-stack-hci-storage-path';
...
export * as dataAzurermTrustedSigningAccount from './data-azurerm-trusted-signing-account';
...
export * as dataAzurermVirtualNetworkPeering from './data-azurerm-virtual-network-peering';
