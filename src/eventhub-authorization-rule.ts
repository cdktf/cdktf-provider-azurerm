...
export interface EventhubAuthorizationRuleConfig extends TerraformMetaArguments {
...
export class EventhubAuthorizationRule extends TerraformResource {
  ...
  public set timeouts(value: EventhubAuthorizationRuleTimeouts | undefined) {
