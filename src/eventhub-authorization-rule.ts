...
export function eventhubAuthorizationRuleTimeoutsToTerraform(struct?: EventhubAuthorizationRuleTimeoutsOutputReference | EventhubAuthorizationRuleTimeouts): any {
...
export class EventhubAuthorizationRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EventhubAuthorizationRuleTimeouts | undefined {
  ...
  public set internalValue(value: EventhubAuthorizationRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class EventhubAuthorizationRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new EventhubAuthorizationRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
