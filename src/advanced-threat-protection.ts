...
export function advancedThreatProtectionTimeoutsToTerraform(struct?: AdvancedThreatProtectionTimeoutsOutputReference | AdvancedThreatProtectionTimeouts | cdktf.IResolvable): any {
...
export class AdvancedThreatProtectionTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AdvancedThreatProtectionTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AdvancedThreatProtectionTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AdvancedThreatProtection extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_advanced_threat_protection";
  ...
  */
  ...
  private _timeouts = new AdvancedThreatProtectionTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: AdvancedThreatProtectionTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: advancedThreatProtectionTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
