...
function sqlActiveDirectoryAdministratorTimeoutsToTerraform(struct?: SqlActiveDirectoryAdministratorTimeoutsOutputReference | SqlActiveDirectoryAdministratorTimeouts): any {
...
export class SqlActiveDirectoryAdministrator extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: SqlActiveDirectoryAdministratorTimeouts | undefined; 
  private __timeoutsOutput = new SqlActiveDirectoryAdministratorTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: SqlActiveDirectoryAdministratorTimeouts | undefined) {
