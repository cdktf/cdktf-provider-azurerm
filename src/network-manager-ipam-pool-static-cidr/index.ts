...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/network_manager_ipam_pool_static_cidr
...
export class NetworkManagerIpamPoolStaticCidr extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkManagerIpamPoolStaticCidr that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/resources/network_manager_ipam_pool_static_cidr#import import section} in the documentation of this resource for the id to use
