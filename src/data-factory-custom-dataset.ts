...
function dataFactoryCustomDatasetTimeoutsToTerraform(struct?: DataFactoryCustomDatasetTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
...
export class DataFactoryCustomDataset extends cdktf.TerraformResource {
  ...
  */
  ...
  public get linkedService() {
    return this.interpolationForAttribute('linked_service') as any;
  }
  public set linkedService(value: DataFactoryCustomDatasetLinkedService[]) {
  ...
  private _timeouts?: DataFactoryCustomDatasetTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: DataFactoryCustomDatasetTimeouts ) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      linked_service: cdktf.listMapper(dataFactoryCustomDatasetLinkedServiceToTerraform)(this._linkedService),
