...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/app_service_source_control_slot
...
export class AppServiceSourceControlSlot extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppServiceSourceControlSlot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/app_service_source_control_slot#import import section} in the documentation of this resource for the id to use
