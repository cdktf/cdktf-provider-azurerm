...
export interface ProximityPlacementGroupConfig extends TerraformMetaArguments {
...
export class ProximityPlacementGroup extends TerraformResource {
  ...
  public set timeouts(value: ProximityPlacementGroupTimeouts | undefined) {
