...
export function proximityPlacementGroupTimeoutsToTerraform(struct?: ProximityPlacementGroupTimeoutsOutputReference | ProximityPlacementGroupTimeouts): any {
...
export class ProximityPlacementGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ProximityPlacementGroupTimeouts | undefined {
  ...
  public set internalValue(value: ProximityPlacementGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class ProximityPlacementGroup extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new ProximityPlacementGroupTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
