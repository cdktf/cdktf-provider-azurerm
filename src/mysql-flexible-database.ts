...
export function mysqlFlexibleDatabaseTimeoutsToTerraform(struct?: MysqlFlexibleDatabaseTimeoutsOutputReference | MysqlFlexibleDatabaseTimeouts): any {
...
export class MysqlFlexibleDatabaseTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MysqlFlexibleDatabaseTimeouts | undefined {
  ...
  public set internalValue(value: MysqlFlexibleDatabaseTimeouts | undefined) {
    if (value === undefined) {
...
export class MysqlFlexibleDatabase extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_mysql_flexible_database";
  ...
  */
  ...
  private _timeouts = new MysqlFlexibleDatabaseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
