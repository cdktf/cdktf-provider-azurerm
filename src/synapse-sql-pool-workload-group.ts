...
export function synapseSqlPoolWorkloadGroupTimeoutsToTerraform(struct?: SynapseSqlPoolWorkloadGroupTimeoutsOutputReference | SynapseSqlPoolWorkloadGroupTimeouts | cdktf.IResolvable): any {
...
export class SynapseSqlPoolWorkloadGroupTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SynapseSqlPoolWorkloadGroupTimeouts | undefined {
  ...
  public set internalValue(value: SynapseSqlPoolWorkloadGroupTimeouts | undefined) {
    if (value === undefined) {
...
export class SynapseSqlPoolWorkloadGroup extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_synapse_sql_pool_workload_group";
  ...
  */
  ...
  private _timeouts = new SynapseSqlPoolWorkloadGroupTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
