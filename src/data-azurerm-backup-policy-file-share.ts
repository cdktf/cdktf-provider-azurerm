...
export function dataAzurermBackupPolicyFileShareTimeoutsToTerraform(struct?: DataAzurermBackupPolicyFileShareTimeoutsOutputReference | DataAzurermBackupPolicyFileShareTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermBackupPolicyFileShare extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermBackupPolicyFileShareTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
