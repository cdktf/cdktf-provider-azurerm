// https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/cdn_frontdoor_secret
...
export class CdnFrontdoorSecret extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CdnFrontdoorSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.8.0/docs/resources/cdn_frontdoor_secret#import import section} in the documentation of this resource for the id to use
