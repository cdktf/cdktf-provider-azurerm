...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/resources/virtual_machine_implicit_data_disk_from_source
...
export class VirtualMachineImplicitDataDiskFromSource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VirtualMachineImplicitDataDiskFromSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.36.0/docs/resources/virtual_machine_implicit_data_disk_from_source#import import section} in the documentation of this resource for the id to use
