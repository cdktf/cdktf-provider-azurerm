...
export interface PacketCaptureConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/packet_capture#id PacketCapture#id}
  *
...
export class PacketCaptureFilterOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PacketCaptureFilter | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: PacketCaptureFilter | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class PacketCaptureFilterList extends cdktf.ComplexList {
  public internalValue? : PacketCaptureFilter[] | cdktf.IResolvable
  ...
  */
  public get(index: number): PacketCaptureFilterOutputReference {
    return new PacketCaptureFilterOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class PacketCaptureTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PacketCaptureTimeouts | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: PacketCaptureTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class PacketCapture extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_packet_capture";
  ...
  */
  ...
  private _filter = new PacketCaptureFilterList(this, "filter", false);
  public get filter() {
    return this._filter;
  }
  public putFilter(value: PacketCaptureFilter[] | cdktf.IResolvable) {
  ...
  private _storageLocation = new PacketCaptureStorageLocationOutputReference(this, "storage_location");
  ...
  private _timeouts = new PacketCaptureTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      filter: cdktf.listMapper(packetCaptureFilterToTerraform)(this._filter.internalValue),
