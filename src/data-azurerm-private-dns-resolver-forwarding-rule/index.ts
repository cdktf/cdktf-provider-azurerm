// https://www.terraform.io/docs/providers/azurerm/d/private_dns_resolver_forwarding_rule
...
export interface DataAzurermPrivateDnsResolverForwardingRuleTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/d/private_dns_resolver_forwarding_rule#read DataAzurermPrivateDnsResolverForwardingRule#read}
  */
  readonly read?: string;
}

export function dataAzurermPrivateDnsResolverForwardingRuleTimeoutsToTerraform(struct?: DataAzurermPrivateDnsResolverForwardingRuleTimeoutsOutputReference | DataAzurermPrivateDnsResolverForwardingRuleTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
