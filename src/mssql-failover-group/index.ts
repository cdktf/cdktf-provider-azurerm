...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/resources/mssql_failover_group
...
export class MssqlFailoverGroup extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MssqlFailoverGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.40.0/docs/resources/mssql_failover_group#import import section} in the documentation of this resource for the id to use
