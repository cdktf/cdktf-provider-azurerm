...
export interface PostgresqlFirewallRuleConfig extends TerraformMetaArguments {
...
export class PostgresqlFirewallRule extends TerraformResource {
  ...
  public set timeouts(value: PostgresqlFirewallRuleTimeouts | undefined) {
