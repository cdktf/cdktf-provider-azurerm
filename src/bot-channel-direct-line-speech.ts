...
export function botChannelDirectLineSpeechTimeoutsToTerraform(struct?: BotChannelDirectLineSpeechTimeoutsOutputReference | BotChannelDirectLineSpeechTimeouts | cdktf.IResolvable): any {
...
export class BotChannelDirectLineSpeech extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new BotChannelDirectLineSpeechTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
