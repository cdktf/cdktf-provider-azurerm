...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.35.0/docs/data-sources/sentinel_alert_rule_template
...
export class DataAzurermSentinelAlertRuleTemplate extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermSentinelAlertRuleTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.35.0/docs/data-sources/sentinel_alert_rule_template#import import section} in the documentation of this resource for the id to use
