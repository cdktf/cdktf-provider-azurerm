...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/data-sources/eventhub_namespace
...
export class DataAzurermEventhubNamespace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermEventhubNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/data-sources/eventhub_namespace#import import section} in the documentation of this resource for the id to use
