...
export function dataAzurermVirtualMachineTimeoutsToTerraform(struct?: DataAzurermVirtualMachineTimeoutsOutputReference | DataAzurermVirtualMachineTimeouts): any {
...
export class DataAzurermVirtualMachine extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermVirtualMachineTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
