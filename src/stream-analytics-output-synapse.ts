...
function streamAnalyticsOutputSynapseTimeoutsToTerraform(struct?: StreamAnalyticsOutputSynapseTimeoutsOutputReference | StreamAnalyticsOutputSynapseTimeouts): any {
...
export class StreamAnalyticsOutputSynapse extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts?: StreamAnalyticsOutputSynapseTimeouts | undefined; 
  private __timeoutsOutput = new StreamAnalyticsOutputSynapseTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
    return this.__timeoutsOutput;
  }
  public putTimeouts(value: StreamAnalyticsOutputSynapseTimeouts | undefined) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: streamAnalyticsOutputSynapseTimeoutsToTerraform(this._timeouts),
    };
  }
}
