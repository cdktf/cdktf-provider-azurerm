// https://registry.terraform.io/providers/hashicorp/azurerm/4.7.0/docs/resources/api_management_authorization_server
...
export class ApiManagementAuthorizationServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiManagementAuthorizationServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.7.0/docs/resources/api_management_authorization_server#import import section} in the documentation of this resource for the id to use
