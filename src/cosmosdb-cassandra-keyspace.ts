...
export interface CosmosdbCassandraKeyspaceConfig extends TerraformMetaArguments {
...
export class CosmosdbCassandraKeyspace extends TerraformResource {
  ...
  public set timeouts(value: CosmosdbCassandraKeyspaceTimeouts | undefined) {
