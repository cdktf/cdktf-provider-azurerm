...
export class CosmosdbCassandraKeyspace extends cdktf.TerraformResource {
  ...
  */
  ...
  private _autoscaleSettings = new CosmosdbCassandraKeyspaceAutoscaleSettingsOutputReference(this, "autoscale_settings", true);
  ...
  private _timeouts = new CosmosdbCassandraKeyspaceTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
