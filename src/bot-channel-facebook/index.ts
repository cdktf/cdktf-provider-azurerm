// https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/bot_channel_facebook
...
export class BotChannelFacebook extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BotChannelFacebook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/bot_channel_facebook#import import section} in the documentation of this resource for the id to use
