...
export function dataAzurermKustoClusterTimeoutsToTerraform(struct?: DataAzurermKustoClusterTimeoutsOutputReference | DataAzurermKustoClusterTimeouts): any {
...
export class DataAzurermKustoClusterTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermKustoClusterTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermKustoClusterTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermKustoCluster extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermKustoClusterTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
