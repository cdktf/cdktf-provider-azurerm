...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/virtual_machine_scale_set
...
export class DataAzurermVirtualMachineScaleSet extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermVirtualMachineScaleSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/virtual_machine_scale_set#import import section} in the documentation of this resource for the id to use
