// https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/kusto_cosmosdb_data_connection
...
export class KustoCosmosdbDataConnection extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing KustoCosmosdbDataConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.2.0/docs/resources/kusto_cosmosdb_data_connection#import import section} in the documentation of this resource for the id to use
