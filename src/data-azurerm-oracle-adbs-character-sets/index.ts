...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/oracle_adbs_character_sets
...
export class DataAzurermOracleAdbsCharacterSets extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermOracleAdbsCharacterSets that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/data-sources/oracle_adbs_character_sets#import import section} in the documentation of this resource for the id to use
