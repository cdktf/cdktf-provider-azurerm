...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/signalr_shared_private_link_resource
...
export class SignalrSharedPrivateLinkResource extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SignalrSharedPrivateLinkResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/signalr_shared_private_link_resource#import import section} in the documentation of this resource for the id to use
