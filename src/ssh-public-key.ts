...
export function sshPublicKeyTimeoutsToTerraform(struct?: SshPublicKeyTimeoutsOutputReference | SshPublicKeyTimeouts): any {
...
export class SshPublicKey extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new SshPublicKeyTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
