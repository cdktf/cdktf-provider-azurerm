// https://registry.terraform.io/providers/hashicorp/azurerm/4.30.0/docs/resources/linux_web_app
...
export class LinuxWebApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LinuxWebApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.30.0/docs/resources/linux_web_app#import import section} in the documentation of this resource for the id to use
