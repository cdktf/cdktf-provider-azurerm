...
export function mapsAccountTimeoutsToTerraform(struct?: MapsAccountTimeoutsOutputReference | MapsAccountTimeouts): any {
...
export class MapsAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MapsAccountTimeouts | undefined {
  ...
  public set internalValue(value: MapsAccountTimeouts | undefined) {
    if (value === undefined) {
...
export class MapsAccount extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MapsAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
