...
export function postgresqlFlexibleServerFirewallRuleTimeoutsToTerraform(struct?: PostgresqlFlexibleServerFirewallRuleTimeoutsOutputReference | PostgresqlFlexibleServerFirewallRuleTimeouts): any {
...
export class PostgresqlFlexibleServerFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PostgresqlFlexibleServerFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: PostgresqlFlexibleServerFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class PostgresqlFlexibleServerFirewallRule extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new PostgresqlFlexibleServerFirewallRuleTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
