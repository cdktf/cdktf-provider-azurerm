// https://registry.terraform.io/providers/hashicorp/azurerm/3.108.0/docs/resources/lab_service_plan
...
export class LabServicePlan extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LabServicePlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.108.0/docs/resources/lab_service_plan#import import section} in the documentation of this resource for the id to use
