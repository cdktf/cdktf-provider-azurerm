...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/role_management_policy
...
export class RoleManagementPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RoleManagementPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.54.0/docs/resources/role_management_policy#import import section} in the documentation of this resource for the id to use
