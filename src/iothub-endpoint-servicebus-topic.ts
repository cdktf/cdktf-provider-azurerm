// https://www.terraform.io/docs/providers/azurerm/r/iothub_endpoint_servicebus_topic.html
...
export function iothubEndpointServicebusTopicTimeoutsToTerraform(struct?: IothubEndpointServicebusTopicTimeoutsOutputReference | IothubEndpointServicebusTopicTimeouts): any {
...
export class IothubEndpointServicebusTopicTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IothubEndpointServicebusTopicTimeouts | undefined {
  ...
  public set internalValue(value: IothubEndpointServicebusTopicTimeouts | undefined) {
    if (value === undefined) {
...
export class IothubEndpointServicebusTopic extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_iothub_endpoint_servicebus_topic";
  ...
  */
  ...
  private _timeouts = new IothubEndpointServicebusTopicTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
