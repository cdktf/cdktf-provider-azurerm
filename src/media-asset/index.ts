...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/media_asset
...
export class MediaAsset extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MediaAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.116.0/docs/resources/media_asset#import import section} in the documentation of this resource for the id to use
