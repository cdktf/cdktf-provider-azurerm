...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/data-sources/mysql_flexible_server
...
export class DataAzurermMysqlFlexibleServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermMysqlFlexibleServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.41.0/docs/data-sources/mysql_flexible_server#import import section} in the documentation of this resource for the id to use
