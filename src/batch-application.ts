// https://www.terraform.io/docs/providers/azurerm/r/batch_application
...
export interface BatchApplicationConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/batch_application#id BatchApplication#id}
  *
...
export class BatchApplicationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BatchApplicationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: BatchApplicationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class BatchApplication extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_batch_application";
  ...
  */
  ...
  private _timeouts = new BatchApplicationTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
