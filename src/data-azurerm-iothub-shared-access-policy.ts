...
export function dataAzurermIothubSharedAccessPolicyTimeoutsToTerraform(struct?: DataAzurermIothubSharedAccessPolicyTimeoutsOutputReference | DataAzurermIothubSharedAccessPolicyTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermIothubSharedAccessPolicyTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermIothubSharedAccessPolicyTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermIothubSharedAccessPolicyTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermIothubSharedAccessPolicy extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermIothubSharedAccessPolicyTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
