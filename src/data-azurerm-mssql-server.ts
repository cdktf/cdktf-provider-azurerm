...
export function dataAzurermMssqlServerTimeoutsToTerraform(struct?: DataAzurermMssqlServerTimeoutsOutputReference | DataAzurermMssqlServerTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermMssqlServerTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermMssqlServerTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermMssqlServerTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermMssqlServer extends cdktf.TerraformDataSource {
  ...
  */
  ...
  public identity(index: string) {
    return new DataAzurermMssqlServerIdentity(this, 'identity', index, false);
  }
  ...
  private _timeouts = new DataAzurermMssqlServerTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
