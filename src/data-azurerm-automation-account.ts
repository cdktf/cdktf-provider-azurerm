...
export function dataAzurermAutomationAccountTimeoutsToTerraform(struct?: DataAzurermAutomationAccountTimeoutsOutputReference | DataAzurermAutomationAccountTimeouts): any {
...
export class DataAzurermAutomationAccount extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAutomationAccountTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
