...
export function dataAzurermAutomationAccountTimeoutsToTerraform(struct?: DataAzurermAutomationAccountTimeoutsOutputReference | DataAzurermAutomationAccountTimeouts | cdktf.IResolvable): any {
...
export class DataAzurermAutomationAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermAutomationAccountTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermAutomationAccountTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermAutomationAccount extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermAutomationAccountTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
