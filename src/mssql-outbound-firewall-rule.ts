...
export class MssqlOutboundFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MssqlOutboundFirewallRuleTimeouts | undefined {
  ...
  public set internalValue(value: MssqlOutboundFirewallRuleTimeouts | undefined) {
    if (value === undefined) {
...
export class MssqlOutboundFirewallRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "azurerm_mssql_outbound_firewall_rule";
  ...
  */
  ...
  private _timeouts = new MssqlOutboundFirewallRuleTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
