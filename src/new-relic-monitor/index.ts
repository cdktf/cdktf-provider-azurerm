// https://registry.terraform.io/providers/hashicorp/azurerm/4.26.0/docs/resources/new_relic_monitor
...
export class NewRelicMonitor extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NewRelicMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.26.0/docs/resources/new_relic_monitor#import import section} in the documentation of this resource for the id to use
