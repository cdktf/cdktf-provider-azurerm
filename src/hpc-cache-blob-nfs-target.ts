...
export function hpcCacheBlobNfsTargetTimeoutsToTerraform(struct?: HpcCacheBlobNfsTargetTimeoutsOutputReference | HpcCacheBlobNfsTargetTimeouts): any {
...
export class HpcCacheBlobNfsTargetTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public set internalValue(value: HpcCacheBlobNfsTargetTimeouts | undefined) {
    if (value === undefined) {
...
export class HpcCacheBlobNfsTarget extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new HpcCacheBlobNfsTargetTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
