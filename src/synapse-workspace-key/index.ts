// https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/synapse_workspace_key
...
export class SynapseWorkspaceKey extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SynapseWorkspaceKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/synapse_workspace_key#import import section} in the documentation of this resource for the id to use
