...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.37.0/docs/resources/spring_cloud_app
...
export class SpringCloudApp extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SpringCloudApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.37.0/docs/resources/spring_cloud_app#import import section} in the documentation of this resource for the id to use
