...
export interface LogicAppIntegrationAccountConfig extends TerraformMetaArguments {
...
export class LogicAppIntegrationAccount extends TerraformResource {
  ...
  private _timeouts?: LogicAppIntegrationAccountTimeouts;
  public get timeouts() {
    return this.interpolationForAttribute('timeouts') as any;
  }
  public set timeouts(value: LogicAppIntegrationAccountTimeouts ) {
