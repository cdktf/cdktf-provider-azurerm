// https://www.terraform.io/docs/providers/azurerm/r/virtual_desktop_application
...
export class VirtualDesktopApplicationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VirtualDesktopApplicationTimeouts | undefined {
  ...
  public set internalValue(value: VirtualDesktopApplicationTimeouts | undefined) {
    if (value === undefined) {
