...
export function dataAzurermEventgridDomainTopicTimeoutsToTerraform(struct?: DataAzurermEventgridDomainTopicTimeoutsOutputReference | DataAzurermEventgridDomainTopicTimeouts): any {
...
export class DataAzurermEventgridDomainTopic extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermEventgridDomainTopicTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
