...
export class DataAzurermEventgridDomainTopicTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataAzurermEventgridDomainTopicTimeouts | undefined {
  ...
  public set internalValue(value: DataAzurermEventgridDomainTopicTimeouts | undefined) {
    if (value === undefined) {
...
export class DataAzurermEventgridDomainTopic extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _timeouts = new DataAzurermEventgridDomainTopicTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
