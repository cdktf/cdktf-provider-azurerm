...
export function maintenanceAssignmentDedicatedHostTimeoutsToTerraform(struct?: MaintenanceAssignmentDedicatedHostTimeoutsOutputReference | MaintenanceAssignmentDedicatedHostTimeouts): any {
...
export class MaintenanceAssignmentDedicatedHost extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MaintenanceAssignmentDedicatedHostTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
