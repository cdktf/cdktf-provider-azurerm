...
export function maintenanceAssignmentDedicatedHostTimeoutsToTerraform(struct?: MaintenanceAssignmentDedicatedHostTimeoutsOutputReference | MaintenanceAssignmentDedicatedHostTimeouts | cdktf.IResolvable): any {
...
export class MaintenanceAssignmentDedicatedHostTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MaintenanceAssignmentDedicatedHostTimeouts | undefined {
  ...
  public set internalValue(value: MaintenanceAssignmentDedicatedHostTimeouts | undefined) {
    if (value === undefined) {
...
export class MaintenanceAssignmentDedicatedHost extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new MaintenanceAssignmentDedicatedHostTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
