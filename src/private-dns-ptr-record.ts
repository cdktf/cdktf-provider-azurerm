...
export interface PrivateDnsPtrRecordConfig extends TerraformMetaArguments {
...
export class PrivateDnsPtrRecord extends TerraformResource {
  ...
  public set timeouts(value: PrivateDnsPtrRecordTimeouts | undefined) {
