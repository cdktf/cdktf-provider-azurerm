...
export interface DataLakeStoreFirewallRuleConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_lake_store_firewall_rule#id DataLakeStoreFirewallRule#id}
  *
...
export function dataLakeStoreFirewallRuleTimeoutsToTerraform(struct?: DataLakeStoreFirewallRuleTimeoutsOutputReference | DataLakeStoreFirewallRuleTimeouts | cdktf.IResolvable): any {
...
export class DataLakeStoreFirewallRuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataLakeStoreFirewallRuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataLakeStoreFirewallRuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataLakeStoreFirewallRule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_data_lake_store_firewall_rule";
  ...
  */
  ...
  private _timeouts = new DataLakeStoreFirewallRuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: DataLakeStoreFirewallRuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: dataLakeStoreFirewallRuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
