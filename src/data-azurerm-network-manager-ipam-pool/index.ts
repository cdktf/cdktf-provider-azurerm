...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/network_manager_ipam_pool
...
export class DataAzurermNetworkManagerIpamPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermNetworkManagerIpamPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/network_manager_ipam_pool#import import section} in the documentation of this resource for the id to use
