...
export interface DataAzurermCdnProfileConfig extends TerraformMetaArguments {
...
export class DataAzurermCdnProfile extends TerraformDataSource {
  ...
  public set timeouts(value: DataAzurermCdnProfileTimeouts | undefined) {
