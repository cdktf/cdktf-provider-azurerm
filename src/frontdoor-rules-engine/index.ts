...
// https://registry.terraform.io/providers/hashicorp/azurerm/3.93.0/docs/resources/frontdoor_rules_engine
...
export class FrontdoorRulesEngine extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FrontdoorRulesEngine that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.93.0/docs/resources/frontdoor_rules_engine#import import section} in the documentation of this resource for the id to use
