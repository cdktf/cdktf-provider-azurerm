...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.33.0/docs/data-sources/storage_encryption_scope
...
export class DataAzurermStorageEncryptionScope extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataAzurermStorageEncryptionScope that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.33.0/docs/data-sources/storage_encryption_scope#import import section} in the documentation of this resource for the id to use
