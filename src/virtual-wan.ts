...
export function virtualWanTimeoutsToTerraform(struct?: VirtualWanTimeoutsOutputReference | VirtualWanTimeouts | cdktf.IResolvable): any {
...
export class VirtualWan extends cdktf.TerraformResource {
  ...
  */
  ...
  private _timeouts = new VirtualWanTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
