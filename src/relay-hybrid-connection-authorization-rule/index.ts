...
// https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/relay_hybrid_connection_authorization_rule
...
export class RelayHybridConnectionAuthorizationRule extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RelayHybridConnectionAuthorizationRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/relay_hybrid_connection_authorization_rule#import import section} in the documentation of this resource for the id to use
