...
export class DataFactoryDatasetAzureBlob extends cdktf.TerraformResource {
  ...
  */
  ...
  private _schemaColumn?: DataFactoryDatasetAzureBlobSchemaColumn[] | cdktf.IResolvable; 
  public get schemaColumn() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('schema_column');
  }
  public set schemaColumn(value: DataFactoryDatasetAzureBlobSchemaColumn[] | cdktf.IResolvable) {
  ...
  private _timeouts = new DataFactoryDatasetAzureBlobTimeoutsOutputReference(this, "timeouts", true);
  public get timeouts() {
