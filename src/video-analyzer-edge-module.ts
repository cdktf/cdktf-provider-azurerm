...
export function videoAnalyzerEdgeModuleTimeoutsToTerraform(struct?: VideoAnalyzerEdgeModuleTimeoutsOutputReference | VideoAnalyzerEdgeModuleTimeouts | cdktf.IResolvable): any {
...
export class VideoAnalyzerEdgeModuleTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VideoAnalyzerEdgeModuleTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: VideoAnalyzerEdgeModuleTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class VideoAnalyzerEdgeModule extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "azurerm_video_analyzer_edge_module";
  ...
  */
  ...
  private _timeouts = new VideoAnalyzerEdgeModuleTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: VideoAnalyzerEdgeModuleTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: videoAnalyzerEdgeModuleTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
}
