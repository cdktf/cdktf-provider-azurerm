...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermdatabricksworkspace"
...
&dataazurermdatabricksworkspace.DataAzurermDatabricksWorkspaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermDatabricksWorkspace.DataAzurermDatabricksWorkspaceTimeouts,
}
```
