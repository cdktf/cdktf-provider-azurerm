...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsharedimageversion"
...
&dataazurermsharedimageversion.DataAzurermSharedImageVersionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSharedImageVersion.DataAzurermSharedImageVersionTimeouts,
}
```
