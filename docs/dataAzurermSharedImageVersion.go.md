...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsharedimageversion"
...
&dataazurermsharedimageversion.DataAzurermSharedImageVersionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSharedImageVersion.DataAzurermSharedImageVersionTimeouts,
}
```
