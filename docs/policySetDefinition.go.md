...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/policysetdefinition"
...
&policysetdefinition.PolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.policySetDefinition.PolicySetDefinitionTimeouts,
}
```
