...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/policysetdefinition"
...
&policysetdefinition.PolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.policySetDefinition.PolicySetDefinitionTimeouts,
}
```
