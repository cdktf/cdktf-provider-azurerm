...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/policysetdefinition"
...
&policysetdefinition.PolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.policySetDefinition.PolicySetDefinitionTimeouts,
}
```
