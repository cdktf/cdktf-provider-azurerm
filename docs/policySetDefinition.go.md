...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/policysetdefinition"
...
&policysetdefinition.PolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.policySetDefinition.PolicySetDefinitionTimeouts,
}
```
