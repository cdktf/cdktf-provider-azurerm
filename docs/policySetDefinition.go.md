...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/policysetdefinition"
...
&policysetdefinition.PolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.policySetDefinition.PolicySetDefinitionTimeouts,
}
```
