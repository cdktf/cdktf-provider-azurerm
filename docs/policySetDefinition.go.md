...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/policysetdefinition"
...
| <code><a href="#@cdktf/provider-azurerm.policySetDefinition.PolicySetDefinition.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&policysetdefinition.PolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.policySetDefinition.PolicySetDefinitionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.policySetDefinition.PolicySetDefinitionConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
