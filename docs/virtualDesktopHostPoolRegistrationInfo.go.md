...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualdesktophostpoolregistrationinfo"
...
&virtualdesktophostpoolregistrationinfo.VirtualDesktopHostPoolRegistrationInfoConfig {
	...
	HostpoolId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualDesktopHostPoolRegistrationInfo.VirtualDesktopHostPoolRegistrationInfoTimeouts,
}
```
