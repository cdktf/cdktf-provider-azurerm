...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/blueprintassignment"
...
| <code><a href="#@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignment.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&blueprintassignment.BlueprintAssignmentConfig {
	...
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.blueprintAssignment.BlueprintAssignmentIdentity,
	Location: *string,
	Name: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.blueprintAssignment.BlueprintAssignmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.blueprintAssignment.BlueprintAssignmentConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
