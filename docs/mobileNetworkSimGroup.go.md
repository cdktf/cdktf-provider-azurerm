...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mobilenetworksimgroup"
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSimGroup.MobileNetworkSimGroup.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&mobilenetworksimgroup.MobileNetworkSimGroupConfig {
	...
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mobileNetworkSimGroup.MobileNetworkSimGroupIdentity,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mobileNetworkSimGroup.MobileNetworkSimGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSimGroup.MobileNetworkSimGroupConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSimGroup.MobileNetworkSimGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/mobile_network_sim_group#tags MobileNetworkSimGroup#tags}. |
