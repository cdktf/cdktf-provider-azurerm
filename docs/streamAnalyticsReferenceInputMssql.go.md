...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/streamanalyticsreferenceinputmssql"
...
&streamanalyticsreferenceinputmssql.StreamAnalyticsReferenceInputMssqlConfig {
	...
	Table: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.streamAnalyticsReferenceInputMssql.StreamAnalyticsReferenceInputMssqlTimeouts,
}
```
