...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/streamanalyticsreferenceinputmssql"
...
&streamanalyticsreferenceinputmssql.StreamAnalyticsReferenceInputMssqlConfig {
	...
	Table: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.streamAnalyticsReferenceInputMssql.StreamAnalyticsReferenceInputMssqlTimeouts,
}
```
