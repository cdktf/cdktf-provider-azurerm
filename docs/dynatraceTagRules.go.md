...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dynatracetagrules"
...
&dynatracetagrules.DynatraceTagRulesConfig {
	...
	Name: *string,
	Id: *string,
	LogRule: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dynatraceTagRules.DynatraceTagRulesLogRule,
	MetricRule: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dynatraceTagRules.DynatraceTagRulesMetricRule,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dynatraceTagRules.DynatraceTagRulesTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dynatraceTagRules.DynatraceTagRulesLogRule.property.sendActivityLogsEnabled">SendActivityLogsEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/dynatrace_tag_rules#send_activity_logs_enabled DynatraceTagRules#send_activity_logs_enabled}. |
| <code><a href="#@cdktf/provider-azurerm.dynatraceTagRules.DynatraceTagRulesLogRule.property.sendAzureActiveDirectoryLogsEnabled">SendAzureActiveDirectoryLogsEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/dynatrace_tag_rules#send_azure_active_directory_logs_enabled DynatraceTagRules#send_azure_active_directory_logs_enabled}. |
| <code><a href="#@cdktf/provider-azurerm.dynatraceTagRules.DynatraceTagRulesLogRule.property.sendSubscriptionLogsEnabled">SendSubscriptionLogsEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/dynatrace_tag_rules#send_subscription_logs_enabled DynatraceTagRules#send_subscription_logs_enabled}. |
...
| <code><a href="#@cdktf/provider-azurerm.dynatraceTagRules.DynatraceTagRulesMetricRule.property.sendingMetricsEnabled">SendingMetricsEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.32.0/docs/resources/dynatrace_tag_rules#sending_metrics_enabled DynatraceTagRules#sending_metrics_enabled}. |
...
```go
func ResetSendingMetricsEnabled()
```
...
| <code><a href="#@cdktf/provider-azurerm.dynatraceTagRules.DynatraceTagRulesMetricRuleOutputReference.property.sendingMetricsEnabledInput">SendingMetricsEnabledInput</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktf/provider-azurerm.dynatraceTagRules.DynatraceTagRulesMetricRuleOutputReference.property.sendingMetricsEnabled">SendingMetricsEnabled</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func SendingMetricsEnabledInput() interface{}
```
...
```go
func SendingMetricsEnabled() interface{}
```
