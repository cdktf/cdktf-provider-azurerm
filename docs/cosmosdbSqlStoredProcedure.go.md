...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbsqlstoredprocedure"
...
&cosmosdbsqlstoredprocedure.CosmosdbSqlStoredProcedureConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbSqlStoredProcedure.CosmosdbSqlStoredProcedureTimeouts,
}
```
