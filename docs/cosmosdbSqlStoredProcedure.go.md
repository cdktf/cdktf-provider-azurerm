...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbsqlstoredprocedure"
...
&cosmosdbsqlstoredprocedure.CosmosdbSqlStoredProcedureConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbSqlStoredProcedure.CosmosdbSqlStoredProcedureTimeouts,
}
```
