...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/streamanalyticsoutputmssql"
...
&streamanalyticsoutputmssql.StreamAnalyticsOutputMssqlConfig {
	...
	MaxWriterCount: *f64,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.streamAnalyticsOutputMssql.StreamAnalyticsOutputMssqlTimeouts,
	User: *string,
}
```
