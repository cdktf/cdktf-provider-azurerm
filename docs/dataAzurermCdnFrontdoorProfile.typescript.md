...
```typescript
public readonly timeoutsInput: DataAzurermCdnFrontdoorProfileTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.dataAzurermCdnFrontdoorProfile.DataAzurermCdnFrontdoorProfileTimeouts">DataAzurermCdnFrontdoorProfileTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: DataAzurermCdnFrontdoorProfileTimeouts | IResolvable;
```
