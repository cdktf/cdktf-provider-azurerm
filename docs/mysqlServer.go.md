...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mysqlserver"
...
&mysqlserver.MysqlServerConfig {
	...
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlServer.MysqlServerIdentity,
	...
	ThreatDetectionPolicy: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlServer.MysqlServerThreatDetectionPolicy,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlServer.MysqlServerTimeouts,
}
```
