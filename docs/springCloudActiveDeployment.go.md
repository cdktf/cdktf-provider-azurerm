...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/springcloudactivedeployment"
...
&springcloudactivedeployment.SpringCloudActiveDeploymentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.springCloudActiveDeployment.SpringCloudActiveDeploymentTimeouts,
}
```
