...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/springcloudactivedeployment"
...
&springcloudactivedeployment.SpringCloudActiveDeploymentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.springCloudActiveDeployment.SpringCloudActiveDeploymentTimeouts,
}
```
