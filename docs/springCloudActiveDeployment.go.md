...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudactivedeployment"
...
&springcloudactivedeployment.SpringCloudActiveDeploymentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudActiveDeployment.SpringCloudActiveDeploymentTimeouts,
}
```
