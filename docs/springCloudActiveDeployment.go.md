...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/springcloudactivedeployment"
...
&springcloudactivedeployment.SpringCloudActiveDeploymentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.springCloudActiveDeployment.SpringCloudActiveDeploymentTimeouts,
}
```
