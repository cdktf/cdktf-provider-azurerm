...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/springcloudactivedeployment"
...
&springcloudactivedeployment.SpringCloudActiveDeploymentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.springCloudActiveDeployment.SpringCloudActiveDeploymentTimeouts,
}
```
