...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/springcloudactivedeployment"
...
&springcloudactivedeployment.SpringCloudActiveDeploymentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.springCloudActiveDeployment.SpringCloudActiveDeploymentTimeouts,
}
```
