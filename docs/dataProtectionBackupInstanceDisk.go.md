...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataprotectionbackupinstancedisk"
...
&dataprotectionbackupinstancedisk.DataProtectionBackupInstanceDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskTimeouts,
}
```
