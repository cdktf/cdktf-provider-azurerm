...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataprotectionbackupinstancedisk"
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDisk.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataprotectionbackupinstancedisk.DataProtectionBackupInstanceDiskConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
