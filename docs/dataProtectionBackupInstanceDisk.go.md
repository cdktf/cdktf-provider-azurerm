...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataprotectionbackupinstancedisk"
...
&dataprotectionbackupinstancedisk.DataProtectionBackupInstanceDiskConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskTimeouts,
}
```
