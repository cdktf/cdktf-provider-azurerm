...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataprotectionbackupinstancedisk"
...
&dataprotectionbackupinstancedisk.DataProtectionBackupInstanceDiskConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataProtectionBackupInstanceDisk.DataProtectionBackupInstanceDiskTimeouts,
}
```
