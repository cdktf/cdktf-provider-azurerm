...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/batchapplication"
...
&batchapplication.BatchApplicationConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.batchApplication.BatchApplicationTimeouts,
}
```
