...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/batchapplication"
...
&batchapplication.BatchApplicationConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.batchApplication.BatchApplicationTimeouts,
}
```
