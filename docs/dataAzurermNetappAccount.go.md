...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermnetappaccount"
...
&dataazurermnetappaccount.DataAzurermNetappAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermNetappAccount.DataAzurermNetappAccountTimeouts,
}
```
