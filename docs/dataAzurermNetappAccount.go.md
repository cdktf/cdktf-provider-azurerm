...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetappaccount"
...
&dataazurermnetappaccount.DataAzurermNetappAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetappAccount.DataAzurermNetappAccountTimeouts,
}
```
