...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/relayhybridconnection"
...
&relayhybridconnection.RelayHybridConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.relayHybridConnection.RelayHybridConnectionTimeouts,
	UserMetadata: *string,
}
```
