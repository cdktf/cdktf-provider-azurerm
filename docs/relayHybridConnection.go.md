...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/relayhybridconnection"
...
&relayhybridconnection.RelayHybridConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.relayHybridConnection.RelayHybridConnectionTimeouts,
	UserMetadata: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.relayHybridConnection.RelayHybridConnectionConfig.property.requiresClientAuthorization">RequiresClientAuthorization</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/relay_hybrid_connection#requires_client_authorization RelayHybridConnection#requires_client_authorization}. |
