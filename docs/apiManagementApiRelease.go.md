...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementapirelease"
...
&apimanagementapirelease.ApiManagementApiReleaseConfig {
	...
	Id: *string,
	Notes: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementApiRelease.ApiManagementApiReleaseTimeouts,
}
```
