...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementapirelease"
...
&apimanagementapirelease.ApiManagementApiReleaseConfig {
	...
	Id: *string,
	Notes: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementApiRelease.ApiManagementApiReleaseTimeouts,
}
```
