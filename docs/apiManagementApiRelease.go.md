...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementapirelease"
...
&apimanagementapirelease.ApiManagementApiReleaseConfig {
	...
	Id: *string,
	Notes: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementApiRelease.ApiManagementApiReleaseTimeouts,
}
```
