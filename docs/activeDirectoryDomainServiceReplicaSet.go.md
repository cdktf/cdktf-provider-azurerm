...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/activedirectorydomainservicereplicaset"
...
| <code><a href="#@cdktf/provider-azurerm.activeDirectoryDomainServiceReplicaSet.ActiveDirectoryDomainServiceReplicaSet.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&activedirectorydomainservicereplicaset.ActiveDirectoryDomainServiceReplicaSetConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.activeDirectoryDomainServiceReplicaSet.ActiveDirectoryDomainServiceReplicaSetTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.activeDirectoryDomainServiceReplicaSet.ActiveDirectoryDomainServiceReplicaSetConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
