...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/appserviceenvironment"
...
&appserviceenvironment.AppServiceEnvironmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.appServiceEnvironment.AppServiceEnvironmentTimeouts,
}
```
