...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermeventgriddomain"
...
&dataazurermeventgriddomain.DataAzurermEventgridDomainConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermEventgridDomain.DataAzurermEventgridDomainTimeouts,
}
```
