...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermeventgriddomain"
...
&dataazurermeventgriddomain.DataAzurermEventgridDomainConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermEventgridDomain.DataAzurermEventgridDomainTimeouts,
}
```
