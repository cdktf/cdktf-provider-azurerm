...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/mssqljobcredential"
...
&mssqljobcredential.MssqlJobCredentialConfig {
	...
	Username: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.mssqlJobCredential.MssqlJobCredentialTimeouts,
}
```
