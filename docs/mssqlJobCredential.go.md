...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mssqljobcredential"
...
&mssqljobcredential.MssqlJobCredentialConfig {
	...
	Username: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mssqlJobCredential.MssqlJobCredentialTimeouts,
}
```
