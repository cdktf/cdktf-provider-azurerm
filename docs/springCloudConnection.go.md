...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/springcloudconnection"
...
| <code><a href="#@cdktf/provider-azurerm.springCloudConnection.SpringCloudConnection.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&springcloudconnection.SpringCloudConnectionConfig {
	...
	Authentication: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudConnection.SpringCloudConnectionAuthentication,
	Name: *string,
	SpringCloudId: *string,
	TargetResourceId: *string,
	ClientType: *string,
	Id: *string,
	SecretStore: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudConnection.SpringCloudConnectionSecretStore,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudConnection.SpringCloudConnectionTimeouts,
	VnetSolution: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.springCloudConnection.SpringCloudConnectionConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
