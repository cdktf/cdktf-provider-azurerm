...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPool.property.coolAccessEnabled">coolAccessEnabled</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
| <code><a href="#@cdktf/provider-azurerm.dataAzurermNetappPool.DataAzurermNetappPool.property.customThroughputMibps">customThroughputMibps</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly coolAccessEnabled: IResolvable;
```
