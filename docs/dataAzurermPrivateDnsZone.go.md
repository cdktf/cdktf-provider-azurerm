...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermprivatednszone"
...
&dataazurermprivatednszone.DataAzurermPrivateDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermPrivateDnsZone.DataAzurermPrivateDnsZoneTimeouts,
}
```
