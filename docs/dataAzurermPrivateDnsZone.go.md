...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermprivatednszone"
...
&dataazurermprivatednszone.DataAzurermPrivateDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPrivateDnsZone.DataAzurermPrivateDnsZoneTimeouts,
}
```
