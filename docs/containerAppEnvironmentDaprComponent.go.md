...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/containerappenvironmentdaprcomponent"
...
&containerappenvironmentdaprcomponent.ContainerAppEnvironmentDaprComponentConfig {
	...
	Scopes: *[]*string,
	Secret: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.containerAppEnvironmentDaprComponent.ContainerAppEnvironmentDaprComponentTimeouts,
}
```
