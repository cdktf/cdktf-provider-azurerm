...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermapimanagementproduct"
...
&dataazurermapimanagementproduct.DataAzurermApiManagementProductConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermApiManagementProduct.DataAzurermApiManagementProductTimeouts,
}
```
