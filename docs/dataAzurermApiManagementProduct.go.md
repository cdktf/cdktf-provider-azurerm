...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapimanagementproduct"
...
&dataazurermapimanagementproduct.DataAzurermApiManagementProductConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApiManagementProduct.DataAzurermApiManagementProductTimeouts,
}
```
