...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/devtestlab"
...
&devtestlab.DevTestLabConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.devTestLab.DevTestLabTimeouts,
}
```
