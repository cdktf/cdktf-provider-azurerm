...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/devtestlab"
...
&devtestlab.DevTestLabConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.devTestLab.DevTestLabTimeouts,
}
```
