...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
