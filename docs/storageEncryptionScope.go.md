...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
