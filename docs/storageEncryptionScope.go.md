...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
