...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
