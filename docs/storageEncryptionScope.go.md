...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
