...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/storageencryptionscope"
...
&storageencryptionscope.StorageEncryptionScopeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.storageEncryptionScope.StorageEncryptionScopeTimeouts,
}
```
