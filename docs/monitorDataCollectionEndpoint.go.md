...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/monitordatacollectionendpoint"
...
&monitordatacollectionendpoint.MonitorDataCollectionEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.monitorDataCollectionEndpoint.MonitorDataCollectionEndpointTimeouts,
}
```
