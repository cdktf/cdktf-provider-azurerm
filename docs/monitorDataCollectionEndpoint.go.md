...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/monitordatacollectionendpoint"
...
&monitordatacollectionendpoint.MonitorDataCollectionEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.monitorDataCollectionEndpoint.MonitorDataCollectionEndpointTimeouts,
}
```
