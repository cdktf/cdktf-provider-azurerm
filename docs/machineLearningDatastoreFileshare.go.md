...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/machinelearningdatastorefileshare"
...
&machinelearningdatastorefileshare.MachineLearningDatastoreFileshareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.machineLearningDatastoreFileshare.MachineLearningDatastoreFileshareTimeouts,
}
```
