...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/postgresqldatabase"
...
&postgresqldatabase.PostgresqlDatabaseConfig {
	...
	ServerName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.postgresqlDatabase.PostgresqlDatabaseTimeouts,
}
```
