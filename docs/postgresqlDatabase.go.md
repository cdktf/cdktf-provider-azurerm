...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/postgresqldatabase"
...
&postgresqldatabase.PostgresqlDatabaseConfig {
	...
	ServerName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.postgresqlDatabase.PostgresqlDatabaseTimeouts,
}
```
