...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dnsmxrecord"
...
&dnsmxrecord.DnsMxRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dnsMxRecord.DnsMxRecordTimeouts,
}
```
