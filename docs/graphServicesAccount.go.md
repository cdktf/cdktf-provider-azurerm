...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/graphservicesaccount"
...
&graphservicesaccount.GraphServicesAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.graphServicesAccount.GraphServicesAccountTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.graphServicesAccount.GraphServicesAccountConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.99.0/docs/resources/graph_services_account#tags GraphServicesAccount#tags}. |
