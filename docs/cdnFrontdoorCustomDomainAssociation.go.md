...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cdnfrontdoorcustomdomainassociation"
...
&cdnfrontdoorcustomdomainassociation.CdnFrontdoorCustomDomainAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cdnFrontdoorCustomDomainAssociation.CdnFrontdoorCustomDomainAssociationTimeouts,
}
```
