...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cdnfrontdoorcustomdomainassociation"
...
&cdnfrontdoorcustomdomainassociation.CdnFrontdoorCustomDomainAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cdnFrontdoorCustomDomainAssociation.CdnFrontdoorCustomDomainAssociationTimeouts,
}
```
