...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/datafactorylinkedservicesftp"
...
&datafactorylinkedservicesftp.DataFactoryLinkedServiceSftpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataFactoryLinkedServiceSftp.DataFactoryLinkedServiceSftpTimeouts,
}
```
