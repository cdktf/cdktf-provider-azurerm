...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/webpubsubsharedprivatelinkresource"
...
&webpubsubsharedprivatelinkresource.WebPubsubSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeouts,
}
```
