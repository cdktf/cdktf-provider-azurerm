...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/webpubsubsharedprivatelinkresource"
...
&webpubsubsharedprivatelinkresource.WebPubsubSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeouts,
}
```
