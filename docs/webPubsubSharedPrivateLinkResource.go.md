...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/webpubsubsharedprivatelinkresource"
...
&webpubsubsharedprivatelinkresource.WebPubsubSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeouts,
}
```
