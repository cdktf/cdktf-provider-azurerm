...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/webpubsubsharedprivatelinkresource"
...
&webpubsubsharedprivatelinkresource.WebPubsubSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.webPubsubSharedPrivateLinkResource.WebPubsubSharedPrivateLinkResourceTimeouts,
}
```
