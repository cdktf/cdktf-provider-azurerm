...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/springcloudappredisassociation"
...
&springcloudappredisassociation.SpringCloudAppRedisAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.springCloudAppRedisAssociation.SpringCloudAppRedisAssociationTimeouts,
}
```
