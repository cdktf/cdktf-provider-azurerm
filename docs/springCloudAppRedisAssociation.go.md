...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudappredisassociation"
...
&springcloudappredisassociation.SpringCloudAppRedisAssociationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudAppRedisAssociation.SpringCloudAppRedisAssociationTimeouts,
}
```
