...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/securitycenterassessment"
...
&securitycenterassessment.SecurityCenterAssessmentConfig {
	...
	Status: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.securityCenterAssessment.SecurityCenterAssessmentStatus,
	TargetResourceId: *string,
	AdditionalData: *map[string]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.securityCenterAssessment.SecurityCenterAssessmentTimeouts,
}
```
