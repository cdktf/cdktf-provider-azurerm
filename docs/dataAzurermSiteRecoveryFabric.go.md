...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsiterecoveryfabric"
...
&dataazurermsiterecoveryfabric.DataAzurermSiteRecoveryFabricConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSiteRecoveryFabric.DataAzurermSiteRecoveryFabricTimeouts,
}
```
