...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualnetworkgatewaynatrule"
...
&virtualnetworkgatewaynatrule.VirtualNetworkGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleTimeouts,
	Type: *string,
}
```
