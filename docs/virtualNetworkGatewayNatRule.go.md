...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/virtualnetworkgatewaynatrule"
...
&virtualnetworkgatewaynatrule.VirtualNetworkGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleTimeouts,
	Type: *string,
}
```
