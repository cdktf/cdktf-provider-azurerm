...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/virtualnetworkgatewaynatrule"
...
&virtualnetworkgatewaynatrule.VirtualNetworkGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleTimeouts,
	Type: *string,
}
```
