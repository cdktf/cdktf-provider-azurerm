...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/virtualnetworkgatewaynatrule"
...
| <code><a href="#@cdktf/provider-azurerm.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&virtualnetworkgatewaynatrule.VirtualNetworkGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleTimeouts,
	Type: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.virtualNetworkGatewayNatRule.VirtualNetworkGatewayNatRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
