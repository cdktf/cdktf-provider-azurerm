...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/videoanalyzer"
...
| <code><a href="#@cdktf/provider-azurerm.videoAnalyzer.VideoAnalyzer.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&videoanalyzer.VideoAnalyzerConfig {
	...
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.videoAnalyzer.VideoAnalyzerIdentity,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	StorageAccount: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.videoAnalyzer.VideoAnalyzerStorageAccount,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.videoAnalyzer.VideoAnalyzerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.videoAnalyzer.VideoAnalyzerConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.videoAnalyzer.VideoAnalyzerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/video_analyzer#tags VideoAnalyzer#tags}. |
