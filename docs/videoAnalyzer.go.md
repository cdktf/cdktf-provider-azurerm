...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/videoanalyzer"
...
&videoanalyzer.VideoAnalyzerConfig {
	...
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.videoAnalyzer.VideoAnalyzerIdentity,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	StorageAccount: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.videoAnalyzer.VideoAnalyzerStorageAccount,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.videoAnalyzer.VideoAnalyzerTimeouts,
}
```
