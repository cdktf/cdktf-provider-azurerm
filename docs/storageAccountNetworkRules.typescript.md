...
storageAccountNetworkRules.StorageAccountNetworkRulesA.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
