...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDevCenterGallery.DataAzurermDevCenterGallery.Initializer.parameter.devCenterId">dev_center_id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/dev_center_gallery#dev_center_id DataAzurermDevCenterGallery#dev_center_id}. |
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDevCenterGallery.DataAzurermDevCenterGallery.Initializer.parameter.name">name</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/dev_center_gallery#name DataAzurermDevCenterGallery#name}. |
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDevCenterGallery.DataAzurermDevCenterGallery.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/dev_center_gallery#id DataAzurermDevCenterGallery#id}. |
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDevCenterGallery.DataAzurermDevCenterGalleryConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/dev_center_gallery#id DataAzurermDevCenterGallery#id}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDevCenterGallery.DataAzurermDevCenterGalleryTimeouts.property.read">read</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.45.0/docs/data-sources/dev_center_gallery#read DataAzurermDevCenterGallery#read}. |
