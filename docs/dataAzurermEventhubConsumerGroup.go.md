...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermeventhubconsumergroup"
...
&dataazurermeventhubconsumergroup.DataAzurermEventhubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermEventhubConsumerGroup.DataAzurermEventhubConsumerGroupTimeouts,
}
```
