...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermeventhubconsumergroup"
...
&dataazurermeventhubconsumergroup.DataAzurermEventhubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermEventhubConsumerGroup.DataAzurermEventhubConsumerGroupTimeouts,
}
```
