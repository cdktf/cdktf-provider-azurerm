...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermstreamanalyticsjob"
...
&dataazurermstreamanalyticsjob.DataAzurermStreamAnalyticsJobConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermStreamAnalyticsJob.DataAzurermStreamAnalyticsJobTimeouts,
}
```
