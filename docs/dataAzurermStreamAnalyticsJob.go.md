...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermstreamanalyticsjob"
...
&dataazurermstreamanalyticsjob.DataAzurermStreamAnalyticsJobConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermStreamAnalyticsJob.DataAzurermStreamAnalyticsJobTimeouts,
}
```
