...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/automationvariableint"
...
&automationvariableint.AutomationVariableIntConfig {
	...
	Encrypted: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.automationVariableInt.AutomationVariableIntTimeouts,
	Value: *f64,
}
```
