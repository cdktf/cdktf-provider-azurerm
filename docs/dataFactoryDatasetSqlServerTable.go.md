...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorydatasetsqlservertable"
...
&datafactorydatasetsqlservertable.DataFactoryDatasetSqlServerTableConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryDatasetSqlServerTable.DataFactoryDatasetSqlServerTableTimeouts,
}
```
