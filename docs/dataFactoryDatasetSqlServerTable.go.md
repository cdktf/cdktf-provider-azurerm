...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorydatasetsqlservertable"
...
&datafactorydatasetsqlservertable.DataFactoryDatasetSqlServerTableConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryDatasetSqlServerTable.DataFactoryDatasetSqlServerTableTimeouts,
}
```
