...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcdnfrontdoorcustomdomain"
...
&dataazurermcdnfrontdoorcustomdomain.DataAzurermCdnFrontdoorCustomDomainConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermCdnFrontdoorCustomDomain.DataAzurermCdnFrontdoorCustomDomainTimeouts,
}
```
