...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermcdnfrontdoorcustomdomain"
...
&dataazurermcdnfrontdoorcustomdomain.DataAzurermCdnFrontdoorCustomDomainConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermCdnFrontdoorCustomDomain.DataAzurermCdnFrontdoorCustomDomainTimeouts,
}
```
