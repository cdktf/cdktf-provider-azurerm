...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/iothubsharedaccesspolicy"
...
&iothubsharedaccesspolicy.IothubSharedAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.iothubSharedAccessPolicy.IothubSharedAccessPolicyTimeouts,
}
```
