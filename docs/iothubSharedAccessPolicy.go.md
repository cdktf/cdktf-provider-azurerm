...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubsharedaccesspolicy"
...
&iothubsharedaccesspolicy.IothubSharedAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubSharedAccessPolicy.IothubSharedAccessPolicyTimeouts,
}
```
