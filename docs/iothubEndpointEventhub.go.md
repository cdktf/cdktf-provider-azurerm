...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/iothubendpointeventhub"
...
&iothubendpointeventhub.IothubEndpointEventhubConfig {
	...
	Id: *string,
	IdentityId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.iothubEndpointEventhub.IothubEndpointEventhubTimeouts,
}
```
