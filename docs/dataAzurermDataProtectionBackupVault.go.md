...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdataprotectionbackupvault"
...
&dataazurermdataprotectionbackupvault.DataAzurermDataProtectionBackupVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDataProtectionBackupVault.DataAzurermDataProtectionBackupVaultTimeouts,
}
```
