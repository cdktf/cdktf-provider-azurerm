...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermdataprotectionbackupvault"
...
&dataazurermdataprotectionbackupvault.DataAzurermDataProtectionBackupVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermDataProtectionBackupVault.DataAzurermDataProtectionBackupVaultTimeouts,
}
```
