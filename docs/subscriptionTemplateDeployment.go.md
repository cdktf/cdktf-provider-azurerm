...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/subscriptiontemplatedeployment"
...
| <code><a href="#@cdktf/provider-azurerm.subscriptionTemplateDeployment.SubscriptionTemplateDeployment.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&subscriptiontemplatedeployment.SubscriptionTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.subscriptionTemplateDeployment.SubscriptionTemplateDeploymentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.subscriptionTemplateDeployment.SubscriptionTemplateDeploymentConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.subscriptionTemplateDeployment.SubscriptionTemplateDeploymentConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/subscription_template_deployment#tags SubscriptionTemplateDeployment#tags}. |
