...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/subscriptiontemplatedeployment"
...
&subscriptiontemplatedeployment.SubscriptionTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.subscriptionTemplateDeployment.SubscriptionTemplateDeploymentTimeouts,
}
```
