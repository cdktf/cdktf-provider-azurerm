...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcontainerregistrytoken"
...
&dataazurermcontainerregistrytoken.DataAzurermContainerRegistryTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermContainerRegistryToken.DataAzurermContainerRegistryTokenTimeouts,
}
```
