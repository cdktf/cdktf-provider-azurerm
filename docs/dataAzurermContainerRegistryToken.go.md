...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermcontainerregistrytoken"
...
&dataazurermcontainerregistrytoken.DataAzurermContainerRegistryTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermContainerRegistryToken.DataAzurermContainerRegistryTokenTimeouts,
}
```
