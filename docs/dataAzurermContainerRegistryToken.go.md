...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermcontainerregistrytoken"
...
&dataazurermcontainerregistrytoken.DataAzurermContainerRegistryTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermContainerRegistryToken.DataAzurermContainerRegistryTokenTimeouts,
}
```
