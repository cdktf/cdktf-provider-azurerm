...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermcontainerregistrytoken"
...
&dataazurermcontainerregistrytoken.DataAzurermContainerRegistryTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermContainerRegistryToken.DataAzurermContainerRegistryTokenTimeouts,
}
```
