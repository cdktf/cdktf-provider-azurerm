...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermhealthcaremedtechservice"
...
&dataazurermhealthcaremedtechservice.DataAzurermHealthcareMedtechServiceConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermHealthcareMedtechService.DataAzurermHealthcareMedtechServiceTimeouts,
}
```
