...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/kustoeventgriddataconnection"
...
&kustoeventgriddataconnection.KustoEventgridDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.kustoEventgridDataConnection.KustoEventgridDataConnectionTimeouts,
}
```
