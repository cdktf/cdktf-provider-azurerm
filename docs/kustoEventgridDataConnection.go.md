...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustoeventgriddataconnection"
...
&kustoeventgriddataconnection.KustoEventgridDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoEventgridDataConnection.KustoEventgridDataConnectionTimeouts,
}
```
