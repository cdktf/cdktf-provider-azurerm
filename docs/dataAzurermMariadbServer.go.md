...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmariadbserver"
...
&dataazurermmariadbserver.DataAzurermMariadbServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMariadbServer.DataAzurermMariadbServerTimeouts,
}
```
