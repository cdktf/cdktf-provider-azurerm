...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermmariadbserver"
...
&dataazurermmariadbserver.DataAzurermMariadbServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermMariadbServer.DataAzurermMariadbServerTimeouts,
}
```
