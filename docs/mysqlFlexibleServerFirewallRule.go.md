...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/mysqlflexibleserverfirewallrule"
...
&mysqlflexibleserverfirewallrule.MysqlFlexibleServerFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.mysqlFlexibleServerFirewallRule.MysqlFlexibleServerFirewallRuleTimeouts,
}
```
