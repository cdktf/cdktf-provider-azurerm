...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mysqlflexibleserverfirewallrule"
...
&mysqlflexibleserverfirewallrule.MysqlFlexibleServerFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlFlexibleServerFirewallRule.MysqlFlexibleServerFirewallRuleTimeouts,
}
```
