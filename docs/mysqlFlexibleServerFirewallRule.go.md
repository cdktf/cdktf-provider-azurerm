...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/mysqlflexibleserverfirewallrule"
...
&mysqlflexibleserverfirewallrule.MysqlFlexibleServerFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.mysqlFlexibleServerFirewallRule.MysqlFlexibleServerFirewallRuleTimeouts,
}
```
