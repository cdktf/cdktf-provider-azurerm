...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mysqlflexibleserverfirewallrule"
...
&mysqlflexibleserverfirewallrule.MysqlFlexibleServerFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mysqlFlexibleServerFirewallRule.MysqlFlexibleServerFirewallRuleTimeouts,
}
```
