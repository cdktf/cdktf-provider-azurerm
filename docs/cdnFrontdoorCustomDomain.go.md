...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/cdnfrontdoorcustomdomain"
...
| <code><a href="#@cdktf/provider-azurerm.cdnFrontdoorCustomDomain.CdnFrontdoorCustomDomain.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&cdnfrontdoorcustomdomain.CdnFrontdoorCustomDomainConfig {
	...
	HostName: *string,
	Name: *string,
	Tls: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.cdnFrontdoorCustomDomain.CdnFrontdoorCustomDomainTls,
	DnsZoneId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.cdnFrontdoorCustomDomain.CdnFrontdoorCustomDomainTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.cdnFrontdoorCustomDomain.CdnFrontdoorCustomDomainConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
