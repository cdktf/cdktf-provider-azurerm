...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/nginxconfiguration"
...
&nginxconfiguration.NginxConfigurationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.nginxConfiguration.NginxConfigurationTimeouts,
}
```
