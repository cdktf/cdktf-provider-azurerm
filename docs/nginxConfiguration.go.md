...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/nginxconfiguration"
...
&nginxconfiguration.NginxConfigurationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.nginxConfiguration.NginxConfigurationTimeouts,
}
```
