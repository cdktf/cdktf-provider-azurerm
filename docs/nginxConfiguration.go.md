...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/nginxconfiguration"
...
&nginxconfiguration.NginxConfigurationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.nginxConfiguration.NginxConfigurationTimeouts,
}
```
