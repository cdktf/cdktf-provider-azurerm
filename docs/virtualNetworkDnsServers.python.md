...
```python
timeouts_input: typing.Union[IResolvable, VirtualNetworkDnsServersTimeouts]
```

- *Type:* typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-azurerm.virtualNetworkDnsServers.VirtualNetworkDnsServersTimeouts">VirtualNetworkDnsServersTimeouts</a>]
...
| <code><a href="#@cdktf/provider-azurerm.virtualNetworkDnsServers.VirtualNetworkDnsServersConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.104.0/docs/resources/virtual_network_dns_servers#id VirtualNetworkDnsServers#id}. |
...
```python
internal_value: typing.Union[IResolvable, VirtualNetworkDnsServersTimeouts]
```
