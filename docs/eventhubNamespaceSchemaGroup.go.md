...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/eventhubnamespaceschemagroup"
...
&eventhubnamespaceschemagroup.EventhubNamespaceSchemaGroupConfig {
	...
	SchemaType: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.eventhubNamespaceSchemaGroup.EventhubNamespaceSchemaGroupTimeouts,
}
```
