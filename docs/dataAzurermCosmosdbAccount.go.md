...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcosmosdbaccount"
...
&dataazurermcosmosdbaccount.DataAzurermCosmosdbAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermCosmosdbAccount.DataAzurermCosmosdbAccountTimeouts,
}
```
