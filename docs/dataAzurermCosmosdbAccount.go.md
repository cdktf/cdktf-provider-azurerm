...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermcosmosdbaccount"
...
&dataazurermcosmosdbaccount.DataAzurermCosmosdbAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermCosmosdbAccount.DataAzurermCosmosdbAccountTimeouts,
}
```
