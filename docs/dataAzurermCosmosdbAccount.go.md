...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermcosmosdbaccount"
...
&dataazurermcosmosdbaccount.DataAzurermCosmosdbAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermCosmosdbAccount.DataAzurermCosmosdbAccountTimeouts,
}
```
