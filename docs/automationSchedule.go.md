...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/automationschedule"
...
&automationschedule.AutomationScheduleConfig {
	...
	StartTime: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.automationSchedule.AutomationScheduleTimeouts,
	Timezone: *string,
	WeekDays: *[]*string,
}
```
