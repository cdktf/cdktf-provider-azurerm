...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mariadbdatabase"
...
&mariadbdatabase.MariadbDatabaseConfig {
	...
	ServerName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mariadbDatabase.MariadbDatabaseTimeouts,
}
```
