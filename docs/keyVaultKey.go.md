...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/keyvaultkey"
...
&keyvaultkey.KeyVaultKeyConfig {
	...
	RotationPolicy: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.keyVaultKey.KeyVaultKeyRotationPolicy,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.keyVaultKey.KeyVaultKeyTimeouts,
}
```
...
&keyvaultkey.KeyVaultKeyRotationPolicy {
	Automatic: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.keyVaultKey.KeyVaultKeyRotationPolicyAutomatic,
	ExpireAfter: *string,
