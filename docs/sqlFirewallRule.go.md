...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/sqlfirewallrule"
...
&sqlfirewallrule.SqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.sqlFirewallRule.SqlFirewallRuleTimeouts,
}
```
