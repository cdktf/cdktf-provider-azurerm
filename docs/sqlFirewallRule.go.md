...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sqlfirewallrule"
...
&sqlfirewallrule.SqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlFirewallRule.SqlFirewallRuleTimeouts,
}
```
