...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/sqlfirewallrule"
...
&sqlfirewallrule.SqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.sqlFirewallRule.SqlFirewallRuleTimeouts,
}
```
