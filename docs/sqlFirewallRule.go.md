...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sqlfirewallrule"
...
| <code><a href="#@cdktf/provider-azurerm.sqlFirewallRule.SqlFirewallRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&sqlfirewallrule.SqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sqlFirewallRule.SqlFirewallRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.sqlFirewallRule.SqlFirewallRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
