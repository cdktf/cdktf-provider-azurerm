...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/automationconnectioncertificate"
...
&automationconnectioncertificate.AutomationConnectionCertificateConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.automationConnectionCertificate.AutomationConnectionCertificateTimeouts,
}
```
