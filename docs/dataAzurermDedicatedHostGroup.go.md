...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdedicatedhostgroup"
...
&dataazurermdedicatedhostgroup.DataAzurermDedicatedHostGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDedicatedHostGroup.DataAzurermDedicatedHostGroupTimeouts,
}
```
