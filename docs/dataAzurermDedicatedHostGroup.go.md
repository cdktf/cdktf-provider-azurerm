...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermdedicatedhostgroup"
...
&dataazurermdedicatedhostgroup.DataAzurermDedicatedHostGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermDedicatedHostGroup.DataAzurermDedicatedHostGroupTimeouts,
}
```
