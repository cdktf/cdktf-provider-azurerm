...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdedicatedhostgroup"
...
&dataazurermdedicatedhostgroup.DataAzurermDedicatedHostGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDedicatedHostGroup.DataAzurermDedicatedHostGroupTimeouts,
}
```
