...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/ipgroup"
...
&ipgroup.IpGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.ipGroup.IpGroupTimeouts,
}
```
