...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubendpointservicebusqueue"
...
&iothubendpointservicebusqueue.IothubEndpointServicebusQueueConfig {
	...
	Id: *string,
	IdentityId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubEndpointServicebusQueue.IothubEndpointServicebusQueueTimeouts,
}
```
