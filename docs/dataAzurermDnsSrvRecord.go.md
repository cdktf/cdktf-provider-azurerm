...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdnssrvrecord"
...
&dataazurermdnssrvrecord.DataAzurermDnsSrvRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDnsSrvRecord.DataAzurermDnsSrvRecordTimeouts,
}
```
