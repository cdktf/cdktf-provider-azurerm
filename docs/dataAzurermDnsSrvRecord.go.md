...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermdnssrvrecord"
...
&dataazurermdnssrvrecord.DataAzurermDnsSrvRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermDnsSrvRecord.DataAzurermDnsSrvRecordTimeouts,
}
```
