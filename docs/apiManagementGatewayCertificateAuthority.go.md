...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementgatewaycertificateauthority"
...
&apimanagementgatewaycertificateauthority.ApiManagementGatewayCertificateAuthorityConfig {
	...
	Id: *string,
	IsTrusted: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementGatewayCertificateAuthority.ApiManagementGatewayCertificateAuthorityTimeouts,
}
```
