...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dnsptrrecord"
...
&dnsptrrecord.DnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dnsPtrRecord.DnsPtrRecordTimeouts,
}
```
