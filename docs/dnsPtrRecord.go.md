...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dnsptrrecord"
...
&dnsptrrecord.DnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dnsPtrRecord.DnsPtrRecordTimeouts,
}
```
