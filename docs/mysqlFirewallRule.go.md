...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mysqlfirewallrule"
...
&mysqlfirewallrule.MysqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mysqlFirewallRule.MysqlFirewallRuleTimeouts,
}
```
