...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mysqlfirewallrule"
...
&mysqlfirewallrule.MysqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlFirewallRule.MysqlFirewallRuleTimeouts,
}
```
