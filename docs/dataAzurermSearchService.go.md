...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsearchservice"
...
&dataazurermsearchservice.DataAzurermSearchServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSearchService.DataAzurermSearchServiceTimeouts,
}
```
