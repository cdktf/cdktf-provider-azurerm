...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsearchservice"
...
&dataazurermsearchservice.DataAzurermSearchServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSearchService.DataAzurermSearchServiceTimeouts,
}
```
