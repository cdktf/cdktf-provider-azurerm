...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mssqlservertransparentdataencryption"
...
&mssqlservertransparentdataencryption.MssqlServerTransparentDataEncryptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mssqlServerTransparentDataEncryption.MssqlServerTransparentDataEncryptionTimeouts,
}
```
