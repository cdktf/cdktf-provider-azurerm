...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/applicationinsightsworkbook"
...
&applicationinsightsworkbook.ApplicationInsightsWorkbookConfig {
	...
	Description: *string,
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.applicationInsightsWorkbook.ApplicationInsightsWorkbookIdentity,
	SourceId: *string,
	StorageContainerId: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.applicationInsightsWorkbook.ApplicationInsightsWorkbookTimeouts,
}
```
