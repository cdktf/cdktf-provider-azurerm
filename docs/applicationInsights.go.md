...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/applicationinsights"
...
&applicationinsights.ApplicationInsightsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.applicationInsights.ApplicationInsightsTimeouts,
	WorkspaceId: *string,
}
```
