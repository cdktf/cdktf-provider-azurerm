...
```typescript
public readonly timeoutsInput: DataAzurermPrivateDnsSoaRecordTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.dataAzurermPrivateDnsSoaRecord.DataAzurermPrivateDnsSoaRecordTimeouts">DataAzurermPrivateDnsSoaRecordTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: DataAzurermPrivateDnsSoaRecordTimeouts | IResolvable;
```
