...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/containerconnectedregistry"
...
&containerconnectedregistry.ContainerConnectedRegistryConfig {
	...
	SyncSchedule: *string,
	SyncWindow: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.containerConnectedRegistry.ContainerConnectedRegistryTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.containerConnectedRegistry.ContainerConnectedRegistryConfig.property.auditLogEnabled">AuditLogEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.62.1/docs/resources/container_connected_registry#audit_log_enabled ContainerConnectedRegistry#audit_log_enabled}. |
