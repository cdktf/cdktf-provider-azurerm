...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorylinkedservicecosmosdbmongoapi"
...
&datafactorylinkedservicecosmosdbmongoapi.DataFactoryLinkedServiceCosmosdbMongoapiConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryLinkedServiceCosmosdbMongoapi.DataFactoryLinkedServiceCosmosdbMongoapiTimeouts,
}
```
