...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/streamanalyticsoutputsynapse"
...
&streamanalyticsoutputsynapse.StreamAnalyticsOutputSynapseConfig {
	...
	User: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.streamAnalyticsOutputSynapse.StreamAnalyticsOutputSynapseTimeouts,
}
```
