...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermlogicappworkflow"
...
&dataazurermlogicappworkflow.DataAzurermLogicAppWorkflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermLogicAppWorkflow.DataAzurermLogicAppWorkflowTimeouts,
}
```
