...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermlogicappworkflow"
...
&dataazurermlogicappworkflow.DataAzurermLogicAppWorkflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermLogicAppWorkflow.DataAzurermLogicAppWorkflowTimeouts,
}
```
