...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermlogicappworkflow"
...
&dataazurermlogicappworkflow.DataAzurermLogicAppWorkflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermLogicAppWorkflow.DataAzurermLogicAppWorkflowTimeouts,
}
```
