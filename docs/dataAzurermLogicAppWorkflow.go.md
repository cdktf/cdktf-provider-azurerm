...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermlogicappworkflow"
...
&dataazurermlogicappworkflow.DataAzurermLogicAppWorkflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermLogicAppWorkflow.DataAzurermLogicAppWorkflowTimeouts,
}
```
