...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpolicydefinition"
...
&dataazurermpolicydefinition.DataAzurermPolicyDefinitionConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPolicyDefinition.DataAzurermPolicyDefinitionTimeouts,
}
```
