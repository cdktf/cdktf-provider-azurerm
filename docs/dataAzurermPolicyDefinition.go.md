...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermpolicydefinition"
...
&dataazurermpolicydefinition.DataAzurermPolicyDefinitionConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermPolicyDefinition.DataAzurermPolicyDefinitionTimeouts,
}
```
