...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermpolicydefinition"
...
&dataazurermpolicydefinition.DataAzurermPolicyDefinitionConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermPolicyDefinition.DataAzurermPolicyDefinitionTimeouts,
}
```
