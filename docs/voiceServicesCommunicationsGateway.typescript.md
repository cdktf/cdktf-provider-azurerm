...
Refer to the Terraform Registory for docs: [`azurerm_voice_services_communications_gateway`](https://registry.terraform.io/providers/hashicorp/azurerm/3.77.0/docs/resources/voice_services_communications_gateway).
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.77.0/docs/resources/voice_services_communications_gateway#import import section} in the documentation of this resource for the id to use
...
```typescript
public readonly internalValue: IResolvable | VoiceServicesCommunicationsGatewayTimeouts;
```
