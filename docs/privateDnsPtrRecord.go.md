...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsptrrecord"
...
&privatednsptrrecord.PrivateDnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsPtrRecord.PrivateDnsPtrRecordTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.privateDnsPtrRecord.PrivateDnsPtrRecordConfig.property.ttl">Ttl</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/private_dns_ptr_record#ttl PrivateDnsPtrRecord#ttl}. |
...
| <code><a href="#@cdktf/provider-azurerm.privateDnsPtrRecord.PrivateDnsPtrRecordConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/private_dns_ptr_record#tags PrivateDnsPtrRecord#tags}. |
