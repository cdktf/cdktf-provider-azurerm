...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednsptrrecord"
...
&privatednsptrrecord.PrivateDnsPtrRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsPtrRecord.PrivateDnsPtrRecordTimeouts,
}
```
