...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapimanagementuser"
...
&dataazurermapimanagementuser.DataAzurermApiManagementUserConfig {
	...
	UserId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApiManagementUser.DataAzurermApiManagementUserTimeouts,
}
```
