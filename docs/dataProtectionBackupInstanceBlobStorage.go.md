...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataprotectionbackupinstanceblobstorage"
...
&dataprotectionbackupinstanceblobstorage.DataProtectionBackupInstanceBlobStorageConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataProtectionBackupInstanceBlobStorage.DataProtectionBackupInstanceBlobStorageTimeouts,
}
```
