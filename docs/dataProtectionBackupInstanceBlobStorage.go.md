...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataprotectionbackupinstanceblobstorage"
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupInstanceBlobStorage.DataProtectionBackupInstanceBlobStorage.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataprotectionbackupinstanceblobstorage.DataProtectionBackupInstanceBlobStorageConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataProtectionBackupInstanceBlobStorage.DataProtectionBackupInstanceBlobStorageTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupInstanceBlobStorage.DataProtectionBackupInstanceBlobStorageConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
