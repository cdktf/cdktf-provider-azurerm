...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermautomationaccount"
...
&dataazurermautomationaccount.DataAzurermAutomationAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAutomationAccount.DataAzurermAutomationAccountTimeouts,
}
```
