...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermautomationaccount"
...
&dataazurermautomationaccount.DataAzurermAutomationAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAutomationAccount.DataAzurermAutomationAccountTimeouts,
}
```
