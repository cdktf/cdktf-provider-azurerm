...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/resourcepolicyremediation"
...
&resourcepolicyremediation.ResourcePolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourcePolicyRemediation.ResourcePolicyRemediationTimeouts,
}
```
