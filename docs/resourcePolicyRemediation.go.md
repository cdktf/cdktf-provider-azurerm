...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/resourcepolicyremediation"
...
&resourcepolicyremediation.ResourcePolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.resourcePolicyRemediation.ResourcePolicyRemediationTimeouts,
}
```
