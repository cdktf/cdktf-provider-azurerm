...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/mongoclusterfirewallrule"
...
&mongoclusterfirewallrule.MongoClusterFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.mongoClusterFirewallRule.MongoClusterFirewallRuleTimeouts,
}
```
