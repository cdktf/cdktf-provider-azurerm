...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mssqlvirtualnetworkrule"
...
&mssqlvirtualnetworkrule.MssqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleTimeouts,
}
```
