...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mssqlvirtualnetworkrule"
...
&mssqlvirtualnetworkrule.MssqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mssqlVirtualNetworkRule.MssqlVirtualNetworkRuleTimeouts,
}
```
