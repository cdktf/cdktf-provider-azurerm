...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmobilenetworksite"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermMobileNetworkSite.DataAzurermMobileNetworkSite.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermmobilenetworksite.DataAzurermMobileNetworkSiteConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMobileNetworkSite.DataAzurermMobileNetworkSiteTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermMobileNetworkSite.DataAzurermMobileNetworkSiteConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
