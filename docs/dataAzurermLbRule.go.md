...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermlbrule"
...
&dataazurermlbrule.DataAzurermLbRuleConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermLbRule.DataAzurermLbRuleTimeouts,
}
```
