...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/managementgroupsubscriptionassociation"
...
&managementgroupsubscriptionassociation.ManagementGroupSubscriptionAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.managementGroupSubscriptionAssociation.ManagementGroupSubscriptionAssociationTimeouts,
}
```
