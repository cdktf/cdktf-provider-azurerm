...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/managementgroupsubscriptionassociation"
...
&managementgroupsubscriptionassociation.ManagementGroupSubscriptionAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managementGroupSubscriptionAssociation.ManagementGroupSubscriptionAssociationTimeouts,
}
```
