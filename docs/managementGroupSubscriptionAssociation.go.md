...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/managementgroupsubscriptionassociation"
...
&managementgroupsubscriptionassociation.ManagementGroupSubscriptionAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.managementGroupSubscriptionAssociation.ManagementGroupSubscriptionAssociationTimeouts,
}
```
