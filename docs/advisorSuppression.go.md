...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/advisorsuppression"
...
&advisorsuppression.AdvisorSuppressionConfig {
	...
	ResourceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.advisorSuppression.AdvisorSuppressionTimeouts,
	Ttl: *string,
}
```
