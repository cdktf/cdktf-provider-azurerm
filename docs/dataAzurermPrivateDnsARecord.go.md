...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermprivatednsarecord"
...
&dataazurermprivatednsarecord.DataAzurermPrivateDnsARecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermPrivateDnsARecord.DataAzurermPrivateDnsARecordTimeouts,
}
```
