...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermprivatednsarecord"
...
&dataazurermprivatednsarecord.DataAzurermPrivateDnsARecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermPrivateDnsARecord.DataAzurermPrivateDnsARecordTimeouts,
}
```
