...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermprivatednsarecord"
...
&dataazurermprivatednsarecord.DataAzurermPrivateDnsARecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPrivateDnsARecord.DataAzurermPrivateDnsARecordTimeouts,
}
```
