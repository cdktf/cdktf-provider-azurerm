...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/managementgrouppolicyremediation"
...
&managementgrouppolicyremediation.ManagementGroupPolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managementGroupPolicyRemediation.ManagementGroupPolicyRemediationTimeouts,
}
```
