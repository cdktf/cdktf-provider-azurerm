...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/managementgrouppolicyremediation"
...
&managementgrouppolicyremediation.ManagementGroupPolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.managementGroupPolicyRemediation.ManagementGroupPolicyRemediationTimeouts,
}
```
