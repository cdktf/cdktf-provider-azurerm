...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermstoragemanagementpolicy"
...
&dataazurermstoragemanagementpolicy.DataAzurermStorageManagementPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermStorageManagementPolicy.DataAzurermStorageManagementPolicyTimeouts,
}
```
