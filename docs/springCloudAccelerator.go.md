...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudaccelerator"
...
&springcloudaccelerator.SpringCloudAcceleratorConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudAccelerator.SpringCloudAcceleratorTimeouts,
}
```
