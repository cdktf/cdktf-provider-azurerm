...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/springcloudaccelerator"
...
&springcloudaccelerator.SpringCloudAcceleratorConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.springCloudAccelerator.SpringCloudAcceleratorTimeouts,
}
```
