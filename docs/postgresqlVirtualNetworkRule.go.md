...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/postgresqlvirtualnetworkrule"
...
&postgresqlvirtualnetworkrule.PostgresqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeouts,
}
```
