...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/postgresqlvirtualnetworkrule"
...
| <code><a href="#@cdktf/provider-azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRule.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&postgresqlvirtualnetworkrule.PostgresqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
