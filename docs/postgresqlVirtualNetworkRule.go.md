...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/postgresqlvirtualnetworkrule"
...
&postgresqlvirtualnetworkrule.PostgresqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeouts,
}
```
