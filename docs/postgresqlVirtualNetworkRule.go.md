...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/postgresqlvirtualnetworkrule"
...
&postgresqlvirtualnetworkrule.PostgresqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.postgresqlVirtualNetworkRule.PostgresqlVirtualNetworkRuleTimeouts,
}
```
