...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/appservicesourcecontroltoken"
...
&appservicesourcecontroltoken.AppServiceSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.appServiceSourceControlToken.AppServiceSourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
