...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/appservicesourcecontroltoken"
...
&appservicesourcecontroltoken.AppServiceSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.appServiceSourceControlToken.AppServiceSourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
