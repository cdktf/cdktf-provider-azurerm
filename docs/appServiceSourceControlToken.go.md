...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/appservicesourcecontroltoken"
...
&appservicesourcecontroltoken.AppServiceSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.appServiceSourceControlToken.AppServiceSourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
