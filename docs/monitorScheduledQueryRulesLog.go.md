...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/monitorscheduledqueryruleslog"
...
&monitorscheduledqueryruleslog.MonitorScheduledQueryRulesLogConfig {
	...
	Criteria: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.monitorScheduledQueryRulesLog.MonitorScheduledQueryRulesLogCriteria,
	DataSourceId: *string,
	Location: *string,
	Name: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.monitorScheduledQueryRulesLog.MonitorScheduledQueryRulesLogTimeouts,
}
```
