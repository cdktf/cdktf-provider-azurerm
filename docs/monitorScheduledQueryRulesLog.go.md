...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/monitorscheduledqueryruleslog"
...
&monitorscheduledqueryruleslog.MonitorScheduledQueryRulesLogConfig {
	...
	Criteria: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.monitorScheduledQueryRulesLog.MonitorScheduledQueryRulesLogCriteria,
	DataSourceId: *string,
	Location: *string,
	Name: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.monitorScheduledQueryRulesLog.MonitorScheduledQueryRulesLogTimeouts,
}
```
