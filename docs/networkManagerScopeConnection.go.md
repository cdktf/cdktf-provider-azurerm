...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/networkmanagerscopeconnection"
...
&networkmanagerscopeconnection.NetworkManagerScopeConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkManagerScopeConnection.NetworkManagerScopeConnectionTimeouts,
}
```
