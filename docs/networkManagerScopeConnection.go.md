...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/networkmanagerscopeconnection"
...
&networkmanagerscopeconnection.NetworkManagerScopeConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.networkManagerScopeConnection.NetworkManagerScopeConnectionTimeouts,
}
```
