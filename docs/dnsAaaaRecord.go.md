...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dnsaaaarecord"
...
&dnsaaaarecord.DnsAaaaRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dnsAaaaRecord.DnsAaaaRecordTimeouts,
}
```
