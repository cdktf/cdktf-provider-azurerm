...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermcontainerregistry"
...
```go
func DataEndpointHostNames() *[]*string
```
...
&dataazurermcontainerregistry.DataAzurermContainerRegistryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dataAzurermContainerRegistry.DataAzurermContainerRegistryTimeouts,
}
```
