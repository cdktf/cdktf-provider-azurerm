...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermcontainerregistry"
...
&dataazurermcontainerregistry.DataAzurermContainerRegistryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermContainerRegistry.DataAzurermContainerRegistryTimeouts,
}
```
