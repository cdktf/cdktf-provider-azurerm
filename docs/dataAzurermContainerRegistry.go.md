...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcontainerregistry"
...
&dataazurermcontainerregistry.DataAzurermContainerRegistryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermContainerRegistry.DataAzurermContainerRegistryTimeouts,
}
```
