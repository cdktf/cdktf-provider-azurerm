...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/kustoclustermanagedprivateendpoint"
...
&kustoclustermanagedprivateendpoint.KustoClusterManagedPrivateEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.kustoClusterManagedPrivateEndpoint.KustoClusterManagedPrivateEndpointTimeouts,
}
```
