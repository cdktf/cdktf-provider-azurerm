...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/kustoclustermanagedprivateendpoint"
...
&kustoclustermanagedprivateendpoint.KustoClusterManagedPrivateEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.kustoClusterManagedPrivateEndpoint.KustoClusterManagedPrivateEndpointTimeouts,
}
```
