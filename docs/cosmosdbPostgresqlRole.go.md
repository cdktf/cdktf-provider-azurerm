...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbpostgresqlrole"
...
&cosmosdbpostgresqlrole.CosmosdbPostgresqlRoleConfig {
	...
	Password: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbPostgresqlRole.CosmosdbPostgresqlRoleTimeouts,
}
```
