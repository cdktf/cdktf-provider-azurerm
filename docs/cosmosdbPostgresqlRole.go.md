...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cosmosdbpostgresqlrole"
...
&cosmosdbpostgresqlrole.CosmosdbPostgresqlRoleConfig {
	...
	Password: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cosmosdbPostgresqlRole.CosmosdbPostgresqlRoleTimeouts,
}
```
