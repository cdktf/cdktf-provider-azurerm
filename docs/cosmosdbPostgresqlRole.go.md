...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbpostgresqlrole"
...
&cosmosdbpostgresqlrole.CosmosdbPostgresqlRoleConfig {
	...
	Password: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbPostgresqlRole.CosmosdbPostgresqlRoleTimeouts,
}
```
