...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/postgresqlflexibleserverfirewallrule"
...
&postgresqlflexibleserverfirewallrule.PostgresqlFlexibleServerFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.postgresqlFlexibleServerFirewallRule.PostgresqlFlexibleServerFirewallRuleTimeouts,
}
```
