...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/postgresqlflexibleserverfirewallrule"
...
&postgresqlflexibleserverfirewallrule.PostgresqlFlexibleServerFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.postgresqlFlexibleServerFirewallRule.PostgresqlFlexibleServerFirewallRuleTimeouts,
}
```
