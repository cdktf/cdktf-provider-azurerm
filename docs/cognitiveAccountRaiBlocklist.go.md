...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/cognitiveaccountraiblocklist"
...
&cognitiveaccountraiblocklist.CognitiveAccountRaiBlocklistConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.cognitiveAccountRaiBlocklist.CognitiveAccountRaiBlocklistTimeouts,
}
```
