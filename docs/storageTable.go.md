...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagetable"
...
&storagetable.StorageTableConfig {
	...
	Acl: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageTable.StorageTableTimeouts,
}
```
