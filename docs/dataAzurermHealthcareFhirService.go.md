...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermhealthcarefhirservice"
...
&dataazurermhealthcarefhirservice.DataAzurermHealthcareFhirServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermHealthcareFhirService.DataAzurermHealthcareFhirServiceTimeouts,
}
```
