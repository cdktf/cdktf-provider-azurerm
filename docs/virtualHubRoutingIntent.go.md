...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/virtualhubroutingintent"
...
&virtualhubroutingintent.VirtualHubRoutingIntentConfig {
	...
	VirtualHubId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.virtualHubRoutingIntent.VirtualHubRoutingIntentTimeouts,
}
```
