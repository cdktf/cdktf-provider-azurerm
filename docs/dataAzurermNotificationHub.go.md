...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnotificationhub"
...
&dataazurermnotificationhub.DataAzurermNotificationHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNotificationHub.DataAzurermNotificationHubTimeouts,
}
```
