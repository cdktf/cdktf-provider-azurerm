...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermnotificationhub"
...
&dataazurermnotificationhub.DataAzurermNotificationHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermNotificationHub.DataAzurermNotificationHubTimeouts,
}
```
