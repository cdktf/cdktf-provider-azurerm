...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualnetwork"
...
&dataazurermvirtualnetwork.DataAzurermVirtualNetworkConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualNetwork.DataAzurermVirtualNetworkTimeouts,
}
```
