...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkmanager"
...
&networkmanager.NetworkManagerConfig {
	...
	Scope: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkManager.NetworkManagerScope,
	ScopeAccesses: *[]*string,
	Description: *string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkManager.NetworkManagerTimeouts,
}
```
