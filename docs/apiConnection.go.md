...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apiconnection"
...
&apiconnection.ApiConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiConnection.ApiConnectionTimeouts,
}
```
