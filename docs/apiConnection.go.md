...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apiconnection"
...
&apiconnection.ApiConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiConnection.ApiConnectionTimeouts,
}
```
