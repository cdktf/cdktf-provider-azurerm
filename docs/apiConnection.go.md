...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apiconnection"
...
&apiconnection.ApiConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiConnection.ApiConnectionTimeouts,
}
```
