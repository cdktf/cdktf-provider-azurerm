...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/nginxapikey"
...
&nginxapikey.NginxApiKeyConfig {
	...
	SecretText: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.nginxApiKey.NginxApiKeyTimeouts,
}
```
