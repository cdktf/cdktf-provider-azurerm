...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/nginxapikey"
...
&nginxapikey.NginxApiKeyConfig {
	...
	SecretText: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.nginxApiKey.NginxApiKeyTimeouts,
}
```
