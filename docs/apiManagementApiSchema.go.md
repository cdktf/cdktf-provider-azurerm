...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementapischema"
...
&apimanagementapischema.ApiManagementApiSchemaConfig {
	...
	Definitions: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementApiSchema.ApiManagementApiSchemaTimeouts,
	Value: *string,
}
```
