...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementapischema"
...
&apimanagementapischema.ApiManagementApiSchemaConfig {
	...
	Definitions: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementApiSchema.ApiManagementApiSchemaTimeouts,
	Value: *string,
}
```
