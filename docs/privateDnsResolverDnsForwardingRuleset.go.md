...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednsresolverdnsforwardingruleset"
...
&privatednsresolverdnsforwardingruleset.PrivateDnsResolverDnsForwardingRulesetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsResolverDnsForwardingRuleset.PrivateDnsResolverDnsForwardingRulesetTimeouts,
}
```
