...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsresolverdnsforwardingruleset"
...
&privatednsresolverdnsforwardingruleset.PrivateDnsResolverDnsForwardingRulesetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsResolverDnsForwardingRuleset.PrivateDnsResolverDnsForwardingRulesetTimeouts,
}
```
