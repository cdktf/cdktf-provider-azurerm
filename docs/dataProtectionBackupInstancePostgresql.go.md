...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataprotectionbackupinstancepostgresql"
...
&dataprotectionbackupinstancepostgresql.DataProtectionBackupInstancePostgresqlConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataProtectionBackupInstancePostgresql.DataProtectionBackupInstancePostgresqlTimeouts,
}
```
