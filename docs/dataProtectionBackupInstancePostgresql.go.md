...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataprotectionbackupinstancepostgresql"
...
&dataprotectionbackupinstancepostgresql.DataProtectionBackupInstancePostgresqlConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataProtectionBackupInstancePostgresql.DataProtectionBackupInstancePostgresqlTimeouts,
}
```
