...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataprotectionbackupinstancepostgresql"
...
&dataprotectionbackupinstancepostgresql.DataProtectionBackupInstancePostgresqlConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataProtectionBackupInstancePostgresql.DataProtectionBackupInstancePostgresqlTimeouts,
}
```
