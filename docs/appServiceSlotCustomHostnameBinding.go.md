...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/appserviceslotcustomhostnamebinding"
...
&appserviceslotcustomhostnamebinding.AppServiceSlotCustomHostnameBindingConfig {
	...
	SslState: *string,
	Thumbprint: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.appServiceSlotCustomHostnameBinding.AppServiceSlotCustomHostnameBindingTimeouts,
}
```
