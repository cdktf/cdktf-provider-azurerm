...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/appserviceslotcustomhostnamebinding"
...
&appserviceslotcustomhostnamebinding.AppServiceSlotCustomHostnameBindingConfig {
	...
	SslState: *string,
	Thumbprint: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.appServiceSlotCustomHostnameBinding.AppServiceSlotCustomHostnameBindingTimeouts,
}
```
