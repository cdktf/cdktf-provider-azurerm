...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationjobschedule"
...
&automationjobschedule.AutomationJobScheduleConfig {
	...
	RunOn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationJobSchedule.AutomationJobScheduleTimeouts,
}
```
