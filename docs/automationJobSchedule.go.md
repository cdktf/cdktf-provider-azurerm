...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/automationjobschedule"
...
&automationjobschedule.AutomationJobScheduleConfig {
	...
	RunOn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.automationJobSchedule.AutomationJobScheduleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.automationJobSchedule.AutomationJobScheduleConfig.property.parameters">Parameters</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.46.0/docs/resources/automation_job_schedule#parameters AutomationJobSchedule#parameters}. |
