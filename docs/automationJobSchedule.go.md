...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/automationjobschedule"
...
&automationjobschedule.AutomationJobScheduleConfig {
	...
	RunOn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.automationJobSchedule.AutomationJobScheduleTimeouts,
}
```
