...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/automationjobschedule"
...
&automationjobschedule.AutomationJobScheduleConfig {
	...
	RunOn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.automationJobSchedule.AutomationJobScheduleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.automationJobSchedule.AutomationJobScheduleConfig.property.parameters">Parameters</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.65.0/docs/resources/automation_job_schedule#parameters AutomationJobSchedule#parameters}. |
