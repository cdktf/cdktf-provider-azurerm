...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/appservicecertificate"
...
&appservicecertificate.AppServiceCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.appServiceCertificate.AppServiceCertificateTimeouts,
}
```
