...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/appservicecertificate"
...
&appservicecertificate.AppServiceCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.appServiceCertificate.AppServiceCertificateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.appServiceCertificate.AppServiceCertificateConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.58.0/docs/resources/app_service_certificate#tags AppServiceCertificate#tags}. |
