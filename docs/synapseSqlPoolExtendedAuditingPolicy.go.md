...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/synapsesqlpoolextendedauditingpolicy"
...
&synapsesqlpoolextendedauditingpolicy.SynapseSqlPoolExtendedAuditingPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.synapseSqlPoolExtendedAuditingPolicy.SynapseSqlPoolExtendedAuditingPolicyTimeouts,
}
```
