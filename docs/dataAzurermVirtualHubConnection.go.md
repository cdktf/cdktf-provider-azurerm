...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualhubconnection"
...
&dataazurermvirtualhubconnection.DataAzurermVirtualHubConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualHubConnection.DataAzurermVirtualHubConnectionTimeouts,
}
```
