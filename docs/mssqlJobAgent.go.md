...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mssqljobagent"
...
&mssqljobagent.MssqlJobAgentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mssqlJobAgent.MssqlJobAgentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mssqlJobAgent.MssqlJobAgentConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/mssql_job_agent#tags MssqlJobAgent#tags}. |
