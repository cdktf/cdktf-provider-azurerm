...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mssqljobagent"
...
&mssqljobagent.MssqlJobAgentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mssqlJobAgent.MssqlJobAgentTimeouts,
}
```
