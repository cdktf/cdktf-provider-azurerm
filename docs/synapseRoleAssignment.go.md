...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/synapseroleassignment"
...
&synapseroleassignment.SynapseRoleAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.synapseRoleAssignment.SynapseRoleAssignmentTimeouts,
}
```
