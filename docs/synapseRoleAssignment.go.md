...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/synapseroleassignment"
...
&synapseroleassignment.SynapseRoleAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.synapseRoleAssignment.SynapseRoleAssignmentTimeouts,
}
```
