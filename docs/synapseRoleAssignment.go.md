...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapseroleassignment"
...
&synapseroleassignment.SynapseRoleAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseRoleAssignment.SynapseRoleAssignmentTimeouts,
}
```
