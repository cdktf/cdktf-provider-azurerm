...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/synapseroleassignment"
...
&synapseroleassignment.SynapseRoleAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.synapseRoleAssignment.SynapseRoleAssignmentTimeouts,
}
```
