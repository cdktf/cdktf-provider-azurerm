...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/managementgrouptemplatedeployment"
...
&managementgrouptemplatedeployment.ManagementGroupTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.managementGroupTemplateDeployment.ManagementGroupTemplateDeploymentTimeouts,
}
```
