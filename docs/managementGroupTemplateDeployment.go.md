...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/managementgrouptemplatedeployment"
...
&managementgrouptemplatedeployment.ManagementGroupTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.managementGroupTemplateDeployment.ManagementGroupTemplateDeploymentTimeouts,
}
```
