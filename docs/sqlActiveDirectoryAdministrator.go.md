...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sqlactivedirectoryadministrator"
...
&sqlactivedirectoryadministrator.SqlActiveDirectoryAdministratorConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlActiveDirectoryAdministrator.SqlActiveDirectoryAdministratorTimeouts,
}
```
