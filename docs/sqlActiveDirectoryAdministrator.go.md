...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sqlactivedirectoryadministrator"
...
&sqlactivedirectoryadministrator.SqlActiveDirectoryAdministratorConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sqlActiveDirectoryAdministrator.SqlActiveDirectoryAdministratorTimeouts,
}
```
