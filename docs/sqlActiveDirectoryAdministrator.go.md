...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/sqlactivedirectoryadministrator"
...
| <code><a href="#@cdktf/provider-azurerm.sqlActiveDirectoryAdministrator.SqlActiveDirectoryAdministrator.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&sqlactivedirectoryadministrator.SqlActiveDirectoryAdministratorConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.sqlActiveDirectoryAdministrator.SqlActiveDirectoryAdministratorTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.sqlActiveDirectoryAdministrator.SqlActiveDirectoryAdministratorConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.sqlActiveDirectoryAdministrator.SqlActiveDirectoryAdministratorConfig.property.azureadAuthenticationOnly">AzureadAuthenticationOnly</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/sql_active_directory_administrator#azuread_authentication_only SqlActiveDirectoryAdministrator#azuread_authentication_only}. |
