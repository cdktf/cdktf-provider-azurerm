...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/containerappenvironment"
...
&containerappenvironment.ContainerAppEnvironmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.containerAppEnvironment.ContainerAppEnvironmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.containerAppEnvironment.ContainerAppEnvironmentConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/container_app_environment#tags ContainerAppEnvironment#tags}. |
