...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/containerappenvironment"
...
&containerappenvironment.ContainerAppEnvironmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.containerAppEnvironment.ContainerAppEnvironmentTimeouts,
}
```
