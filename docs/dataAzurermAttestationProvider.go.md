...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermattestationprovider"
...
&dataazurermattestationprovider.DataAzurermAttestationProviderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAttestationProvider.DataAzurermAttestationProviderTimeouts,
}
```
