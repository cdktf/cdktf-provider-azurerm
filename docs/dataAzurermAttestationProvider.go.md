...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermattestationprovider"
...
&dataazurermattestationprovider.DataAzurermAttestationProviderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAttestationProvider.DataAzurermAttestationProviderTimeouts,
}
```
