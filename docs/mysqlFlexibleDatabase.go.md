...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mysqlflexibledatabase"
...
&mysqlflexibledatabase.MysqlFlexibleDatabaseConfig {
	...
	ServerName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mysqlFlexibleDatabase.MysqlFlexibleDatabaseTimeouts,
}
```
