...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/botserviceazurebot"
...
&botserviceazurebot.BotServiceAzureBotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.botServiceAzureBot.BotServiceAzureBotTimeouts,
}
```
