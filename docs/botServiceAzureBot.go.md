...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botserviceazurebot"
...
&botserviceazurebot.BotServiceAzureBotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botServiceAzureBot.BotServiceAzureBotTimeouts,
}
```
