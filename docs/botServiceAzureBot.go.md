...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/botserviceazurebot"
...
&botserviceazurebot.BotServiceAzureBotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.botServiceAzureBot.BotServiceAzureBotTimeouts,
}
```
