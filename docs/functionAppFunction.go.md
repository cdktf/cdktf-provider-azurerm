...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/functionappfunction"
...
&functionappfunction.FunctionAppFunctionConfig {
	...
	Language: *string,
	TestData: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.functionAppFunction.FunctionAppFunctionTimeouts,
}
```
