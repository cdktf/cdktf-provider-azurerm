...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/functionappfunction"
...
| <code><a href="#@cdktf/provider-azurerm.functionAppFunction.FunctionAppFunction.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&functionappfunction.FunctionAppFunctionConfig {
	...
	Language: *string,
	TestData: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.functionAppFunction.FunctionAppFunctionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.functionAppFunction.FunctionAppFunctionConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
