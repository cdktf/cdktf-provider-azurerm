...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/functionappfunction"
...
&functionappfunction.FunctionAppFunctionConfig {
	...
	Language: *string,
	TestData: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.functionAppFunction.FunctionAppFunctionTimeouts,
}
```
