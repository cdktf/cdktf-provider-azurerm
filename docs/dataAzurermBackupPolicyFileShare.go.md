...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermbackuppolicyfileshare"
...
&dataazurermbackuppolicyfileshare.DataAzurermBackupPolicyFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermBackupPolicyFileShare.DataAzurermBackupPolicyFileShareTimeouts,
}
```
