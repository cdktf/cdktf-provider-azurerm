...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermbackuppolicyfileshare"
...
&dataazurermbackuppolicyfileshare.DataAzurermBackupPolicyFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermBackupPolicyFileShare.DataAzurermBackupPolicyFileShareTimeouts,
}
```
