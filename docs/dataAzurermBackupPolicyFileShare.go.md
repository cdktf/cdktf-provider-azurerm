...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermbackuppolicyfileshare"
...
&dataazurermbackuppolicyfileshare.DataAzurermBackupPolicyFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermBackupPolicyFileShare.DataAzurermBackupPolicyFileShareTimeouts,
}
```
