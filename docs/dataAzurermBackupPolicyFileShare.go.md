...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermbackuppolicyfileshare"
...
&dataazurermbackuppolicyfileshare.DataAzurermBackupPolicyFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermBackupPolicyFileShare.DataAzurermBackupPolicyFileShareTimeouts,
}
```
