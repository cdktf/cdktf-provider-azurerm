...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/systemcentervirtualmachinemanagervirtualmachineinstanceguestagent"
...
&systemcentervirtualmachinemanagervirtualmachineinstanceguestagent.SystemCenterVirtualMachineManagerVirtualMachineInstanceGuestAgentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.systemCenterVirtualMachineManagerVirtualMachineInstanceGuestAgent.SystemCenterVirtualMachineManagerVirtualMachineInstanceGuestAgentTimeouts,
}
```
