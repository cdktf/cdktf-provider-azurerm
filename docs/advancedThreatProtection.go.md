...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/advancedthreatprotection"
...
&advancedthreatprotection.AdvancedThreatProtectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.advancedThreatProtection.AdvancedThreatProtectionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.advancedThreatProtection.AdvancedThreatProtectionConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/advanced_threat_protection#enabled AdvancedThreatProtection#enabled}. |
