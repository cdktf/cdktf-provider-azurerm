...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/advancedthreatprotection"
...
&advancedthreatprotection.AdvancedThreatProtectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.advancedThreatProtection.AdvancedThreatProtectionTimeouts,
}
```
