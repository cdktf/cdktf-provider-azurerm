...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbmongocollection"
...
&cosmosdbmongocollection.CosmosdbMongoCollectionConfig {
	...
	AutoscaleSettings: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbMongoCollection.CosmosdbMongoCollectionAutoscaleSettings,
	DefaultTtlSeconds: *f64,
	Id: *string,
	Index: interface{},
	ShardKey: *string,
	Throughput: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbMongoCollection.CosmosdbMongoCollectionTimeouts,
}
```
