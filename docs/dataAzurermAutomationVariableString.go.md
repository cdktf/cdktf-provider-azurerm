...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermautomationvariablestring"
...
&dataazurermautomationvariablestring.DataAzurermAutomationVariableStringConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAutomationVariableString.DataAzurermAutomationVariableStringTimeouts,
}
```
