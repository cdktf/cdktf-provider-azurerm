...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/cosmosdbtable"
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azurerm.cosmosdbTable.CosmosdbTableAutoscaleSettings.property.maxThroughput">MaxThroughput</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/cosmosdb_table#max_throughput CosmosdbTable#max_throughput}. |
...
&cosmosdbtable.CosmosdbTableConfig {
	...
	AutoscaleSettings: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.cosmosdbTable.CosmosdbTableAutoscaleSettings,
	Id: *string,
	Throughput: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.cosmosdbTable.CosmosdbTableTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.cosmosdbTable.CosmosdbTableConfig.property.throughput">Throughput</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/cosmosdb_table#throughput CosmosdbTable#throughput}. |
