...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationdscnodeconfiguration"
...
&automationdscnodeconfiguration.AutomationDscNodeconfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationDscNodeconfiguration.AutomationDscNodeconfigurationTimeouts,
}
```
