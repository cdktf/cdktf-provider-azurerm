...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/federatedidentitycredential"
...
&federatedidentitycredential.FederatedIdentityCredentialConfig {
	...
	Subject: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.federatedIdentityCredential.FederatedIdentityCredentialTimeouts,
}
```
