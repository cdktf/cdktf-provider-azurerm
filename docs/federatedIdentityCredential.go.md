...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/federatedidentitycredential"
...
&federatedidentitycredential.FederatedIdentityCredentialConfig {
	...
	Subject: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.federatedIdentityCredential.FederatedIdentityCredentialTimeouts,
}
```
