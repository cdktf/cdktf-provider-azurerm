...
```python
timeouts_input: typing.Union[IResolvable, DataFactoryLinkedServiceAzureFunctionTimeouts]
```

- *Type:* typing.Union[cdktf.IResolvable, <a href="#@cdktf/provider-azurerm.dataFactoryLinkedServiceAzureFunction.DataFactoryLinkedServiceAzureFunctionTimeouts">DataFactoryLinkedServiceAzureFunctionTimeouts</a>]
...
```python
internal_value: typing.Union[IResolvable, DataFactoryLinkedServiceAzureFunctionTimeouts]
```
