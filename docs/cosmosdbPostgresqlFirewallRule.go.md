...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbpostgresqlfirewallrule"
...
&cosmosdbpostgresqlfirewallrule.CosmosdbPostgresqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbPostgresqlFirewallRule.CosmosdbPostgresqlFirewallRuleTimeouts,
}
```
