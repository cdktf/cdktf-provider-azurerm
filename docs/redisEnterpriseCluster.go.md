...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/redisenterprisecluster"
...
&redisenterprisecluster.RedisEnterpriseClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.redisEnterpriseCluster.RedisEnterpriseClusterTimeouts,
	Zones: *[]*string,
}
```
