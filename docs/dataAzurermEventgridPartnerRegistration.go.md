...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermeventgridpartnerregistration"
...
&dataazurermeventgridpartnerregistration.DataAzurermEventgridPartnerRegistrationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermEventgridPartnerRegistration.DataAzurermEventgridPartnerRegistrationTimeouts,
}
```
