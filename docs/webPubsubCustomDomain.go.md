...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/webpubsubcustomdomain"
...
&webpubsubcustomdomain.WebPubsubCustomDomainConfig {
	...
	WebPubsubId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.webPubsubCustomDomain.WebPubsubCustomDomainTimeouts,
}
```
