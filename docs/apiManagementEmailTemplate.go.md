...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementemailtemplate"
...
&apimanagementemailtemplate.ApiManagementEmailTemplateConfig {
	...
	TemplateName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementEmailTemplate.ApiManagementEmailTemplateTimeouts,
}
```
