...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementemailtemplate"
...
&apimanagementemailtemplate.ApiManagementEmailTemplateConfig {
	...
	TemplateName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementEmailTemplate.ApiManagementEmailTemplateTimeouts,
}
```
