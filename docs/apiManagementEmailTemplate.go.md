...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementemailtemplate"
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplate.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&apimanagementemailtemplate.ApiManagementEmailTemplateConfig {
	...
	TemplateName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementEmailTemplate.ApiManagementEmailTemplateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementEmailTemplate.ApiManagementEmailTemplateConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
