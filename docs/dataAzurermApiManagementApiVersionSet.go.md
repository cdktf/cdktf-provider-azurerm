...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapimanagementapiversionset"
...
&dataazurermapimanagementapiversionset.DataAzurermApiManagementApiVersionSetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApiManagementApiVersionSet.DataAzurermApiManagementApiVersionSetTimeouts,
}
```
