...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermapimanagementapiversionset"
...
&dataazurermapimanagementapiversionset.DataAzurermApiManagementApiVersionSetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermApiManagementApiVersionSet.DataAzurermApiManagementApiVersionSetTimeouts,
}
```
