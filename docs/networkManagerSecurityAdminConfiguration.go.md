...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkmanagersecurityadminconfiguration"
...
&networkmanagersecurityadminconfiguration.NetworkManagerSecurityAdminConfigurationConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkManagerSecurityAdminConfiguration.NetworkManagerSecurityAdminConfigurationTimeouts,
}
```
