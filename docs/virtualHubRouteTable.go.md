...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/virtualhubroutetable"
...
&virtualhubroutetable.VirtualHubRouteTableConfig {
	...
	Labels: *[]*string,
	Route: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.virtualHubRouteTable.VirtualHubRouteTableTimeouts,
}
```
