...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/virtualhubroutetable"
...
&virtualhubroutetable.VirtualHubRouteTableConfig {
	...
	Labels: *[]*string,
	Route: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.virtualHubRouteTable.VirtualHubRouteTableTimeouts,
}
```
