...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/virtualhubroutetable"
...
&virtualhubroutetable.VirtualHubRouteTableConfig {
	...
	Labels: *[]*string,
	Route: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.virtualHubRouteTable.VirtualHubRouteTableTimeouts,
}
```
