...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/diskpool"
...
| <code><a href="#@cdktf/provider-azurerm.diskPool.DiskPool.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&diskpool.DiskPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.diskPool.DiskPoolTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.diskPool.DiskPoolConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.diskPool.DiskPoolConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_pool#tags DiskPool#tags}. |
