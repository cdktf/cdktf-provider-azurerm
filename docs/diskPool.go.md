...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/diskpool"
...
&diskpool.DiskPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.diskPool.DiskPoolTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.diskPool.DiskPoolConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.62.1/docs/resources/disk_pool#tags DiskPool#tags}. |
