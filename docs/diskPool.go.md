...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/diskpool"
...
&diskpool.DiskPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.diskPool.DiskPoolTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.diskPool.DiskPoolConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.72.0/docs/resources/disk_pool#tags DiskPool#tags}. |
