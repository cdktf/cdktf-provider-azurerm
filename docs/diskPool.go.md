...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/diskpool"
...
&diskpool.DiskPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.diskPool.DiskPoolTimeouts,
}
```
