...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermhybridcomputemachine"
...
&dataazurermhybridcomputemachine.DataAzurermHybridComputeMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermHybridComputeMachine.DataAzurermHybridComputeMachineTimeouts,
}
```
