...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermhybridcomputemachine"
...
&dataazurermhybridcomputemachine.DataAzurermHybridComputeMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermHybridComputeMachine.DataAzurermHybridComputeMachineTimeouts,
}
```
