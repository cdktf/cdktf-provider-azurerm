...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermspatialanchorsaccount"
...
&dataazurermspatialanchorsaccount.DataAzurermSpatialAnchorsAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSpatialAnchorsAccount.DataAzurermSpatialAnchorsAccountTimeouts,
}
```
