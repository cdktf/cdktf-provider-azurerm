...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermspatialanchorsaccount"
...
&dataazurermspatialanchorsaccount.DataAzurermSpatialAnchorsAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSpatialAnchorsAccount.DataAzurermSpatialAnchorsAccountTimeouts,
}
```
