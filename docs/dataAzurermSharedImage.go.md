...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermsharedimage"
...
&dataazurermsharedimage.DataAzurermSharedImageConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSharedImage.DataAzurermSharedImageTimeouts,
}
```
