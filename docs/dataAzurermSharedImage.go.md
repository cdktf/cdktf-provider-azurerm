...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsharedimage"
...
&dataazurermsharedimage.DataAzurermSharedImageConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSharedImage.DataAzurermSharedImageTimeouts,
}
```
