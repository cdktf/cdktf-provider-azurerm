...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsharedimage"
...
&dataazurermsharedimage.DataAzurermSharedImageConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSharedImage.DataAzurermSharedImageTimeouts,
}
```
