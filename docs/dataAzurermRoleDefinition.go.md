...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermroledefinition"
...
&dataazurermroledefinition.DataAzurermRoleDefinitionConfig {
	...
	Scope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermRoleDefinition.DataAzurermRoleDefinitionTimeouts,
}
```
