...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermroledefinition"
...
&dataazurermroledefinition.DataAzurermRoleDefinitionConfig {
	...
	Scope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermRoleDefinition.DataAzurermRoleDefinitionTimeouts,
}
```
