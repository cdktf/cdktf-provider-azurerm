...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermroledefinition"
...
&dataazurermroledefinition.DataAzurermRoleDefinitionConfig {
	...
	Scope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermRoleDefinition.DataAzurermRoleDefinitionTimeouts,
}
```
