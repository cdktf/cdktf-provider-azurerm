...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermroledefinition"
...
&dataazurermroledefinition.DataAzurermRoleDefinitionConfig {
	...
	Scope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermRoleDefinition.DataAzurermRoleDefinitionTimeouts,
}
```
