...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermapplicationsecuritygroup"
...
&dataazurermapplicationsecuritygroup.DataAzurermApplicationSecurityGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermApplicationSecurityGroup.DataAzurermApplicationSecurityGroupTimeouts,
}
```
