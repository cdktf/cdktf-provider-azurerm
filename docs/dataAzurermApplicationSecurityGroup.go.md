...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermapplicationsecuritygroup"
...
&dataazurermapplicationsecuritygroup.DataAzurermApplicationSecurityGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermApplicationSecurityGroup.DataAzurermApplicationSecurityGroupTimeouts,
}
```
