...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermdnstxtrecord"
...
&dataazurermdnstxtrecord.DataAzurermDnsTxtRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermDnsTxtRecord.DataAzurermDnsTxtRecordTimeouts,
}
```
