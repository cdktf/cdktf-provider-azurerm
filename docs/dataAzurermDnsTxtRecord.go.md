...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdnstxtrecord"
...
&dataazurermdnstxtrecord.DataAzurermDnsTxtRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDnsTxtRecord.DataAzurermDnsTxtRecordTimeouts,
}
```
