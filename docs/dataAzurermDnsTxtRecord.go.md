...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdnstxtrecord"
...
&dataazurermdnstxtrecord.DataAzurermDnsTxtRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDnsTxtRecord.DataAzurermDnsTxtRecordTimeouts,
}
```
