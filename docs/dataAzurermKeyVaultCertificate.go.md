...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkeyvaultcertificate"
...
&dataazurermkeyvaultcertificate.DataAzurermKeyVaultCertificateConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateTimeouts,
	Version: *string,
}
```
