...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermkeyvaultcertificate"
...
&dataazurermkeyvaultcertificate.DataAzurermKeyVaultCertificateConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateTimeouts,
	Version: *string,
}
```
