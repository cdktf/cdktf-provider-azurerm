...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermkeyvaultcertificate"
...
&dataazurermkeyvaultcertificate.DataAzurermKeyVaultCertificateConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermKeyVaultCertificate.DataAzurermKeyVaultCertificateTimeouts,
	Version: *string,
}
```
