...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/routefilter"
...
&routefilter.RouteFilterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.routeFilter.RouteFilterTimeouts,
}
```
