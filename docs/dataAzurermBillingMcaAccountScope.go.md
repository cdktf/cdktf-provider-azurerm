...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermbillingmcaaccountscope"
...
&dataazurermbillingmcaaccountscope.DataAzurermBillingMcaAccountScopeConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermBillingMcaAccountScope.DataAzurermBillingMcaAccountScopeTimeouts,
}
```
