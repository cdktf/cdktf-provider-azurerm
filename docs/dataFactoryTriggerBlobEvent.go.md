...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorytriggerblobevent"
...
&datafactorytriggerblobevent.DataFactoryTriggerBlobEventConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryTriggerBlobEvent.DataFactoryTriggerBlobEventTimeouts,
}
```
