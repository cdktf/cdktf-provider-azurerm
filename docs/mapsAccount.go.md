...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mapsaccount"
...
&mapsaccount.MapsAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mapsAccount.MapsAccountTimeouts,
}
```
