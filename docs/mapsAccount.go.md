...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mapsaccount"
...
&mapsaccount.MapsAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mapsAccount.MapsAccountTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mapsAccount.MapsAccountConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.52.0/docs/resources/maps_account#tags MapsAccount#tags}. |
