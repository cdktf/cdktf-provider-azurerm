...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/roleassignment"
...
&roleassignment.RoleAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.roleAssignment.RoleAssignmentTimeouts,
}
```
