...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/healthbot"
...
| <code><a href="#@cdktf/provider-azurerm.healthbot.Healthbot.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&healthbot.HealthbotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.healthbot.HealthbotTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.healthbot.HealthbotConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.healthbot.HealthbotConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/healthbot#tags Healthbot#tags}. |
