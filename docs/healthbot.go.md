...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/healthbot"
...
&healthbot.HealthbotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.healthbot.HealthbotTimeouts,
}
```
