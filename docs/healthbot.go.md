...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/healthbot"
...
&healthbot.HealthbotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.healthbot.HealthbotTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.healthbot.HealthbotConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.62.0/docs/resources/healthbot#tags Healthbot#tags}. |
