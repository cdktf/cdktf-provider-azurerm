...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/healthbot"
...
| <code><a href="#@cdktf/provider-azurerm.healthbot.HealthbotConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.24.0/docs/resources/healthbot#tags Healthbot#tags}. |
