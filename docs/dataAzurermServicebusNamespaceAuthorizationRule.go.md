...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermservicebusnamespaceauthorizationrule"
...
&dataazurermservicebusnamespaceauthorizationrule.DataAzurermServicebusNamespaceAuthorizationRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermServicebusNamespaceAuthorizationRule.DataAzurermServicebusNamespaceAuthorizationRuleTimeouts,
}
```
