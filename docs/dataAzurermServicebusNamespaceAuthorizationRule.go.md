...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermservicebusnamespaceauthorizationrule"
...
&dataazurermservicebusnamespaceauthorizationrule.DataAzurermServicebusNamespaceAuthorizationRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermServicebusNamespaceAuthorizationRule.DataAzurermServicebusNamespaceAuthorizationRuleTimeouts,
}
```
