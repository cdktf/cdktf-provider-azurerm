...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/routeserverbgpconnection"
...
&routeserverbgpconnection.RouteServerBgpConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.routeServerBgpConnection.RouteServerBgpConnectionTimeouts,
}
```
