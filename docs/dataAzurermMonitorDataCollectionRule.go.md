...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmonitordatacollectionrule"
...
&dataazurermmonitordatacollectionrule.DataAzurermMonitorDataCollectionRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMonitorDataCollectionRule.DataAzurermMonitorDataCollectionRuleTimeouts,
}
```
