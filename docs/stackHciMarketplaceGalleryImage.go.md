...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/stackhcimarketplacegalleryimage"
...
&stackhcimarketplacegalleryimage.StackHciMarketplaceGalleryImageConfig {
	...
	Identifier: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.stackHciMarketplaceGalleryImage.StackHciMarketplaceGalleryImageIdentifier,
	Location: *string,
	Name: *string,
	OsType: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.stackHciMarketplaceGalleryImage.StackHciMarketplaceGalleryImageTimeouts,
}
```
