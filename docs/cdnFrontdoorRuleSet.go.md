...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cdnfrontdoorruleset"
...
&cdnfrontdoorruleset.CdnFrontdoorRuleSetConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cdnFrontdoorRuleSet.CdnFrontdoorRuleSetTimeouts,
}
```
