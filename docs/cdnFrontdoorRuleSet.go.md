...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/cdnfrontdoorruleset"
...
&cdnfrontdoorruleset.CdnFrontdoorRuleSetConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.cdnFrontdoorRuleSet.CdnFrontdoorRuleSetTimeouts,
}
```
