...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermhealthcareworkspace"
...
&dataazurermhealthcareworkspace.DataAzurermHealthcareWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermHealthcareWorkspace.DataAzurermHealthcareWorkspaceTimeouts,
}
```
