...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermhealthcareworkspace"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermHealthcareWorkspace.DataAzurermHealthcareWorkspace.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermhealthcareworkspace.DataAzurermHealthcareWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermHealthcareWorkspace.DataAzurermHealthcareWorkspaceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermHealthcareWorkspace.DataAzurermHealthcareWorkspaceConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
