...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermhealthcareworkspace"
...
&dataazurermhealthcareworkspace.DataAzurermHealthcareWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermHealthcareWorkspace.DataAzurermHealthcareWorkspaceTimeouts,
}
```
