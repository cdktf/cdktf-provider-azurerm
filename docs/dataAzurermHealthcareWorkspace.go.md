...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermhealthcareworkspace"
...
&dataazurermhealthcareworkspace.DataAzurermHealthcareWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermHealthcareWorkspace.DataAzurermHealthcareWorkspaceTimeouts,
}
```
