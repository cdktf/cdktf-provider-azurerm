...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/lbnatpool"
...
&lbnatpool.LbNatPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.lbNatPool.LbNatPoolTimeouts,
}
```
