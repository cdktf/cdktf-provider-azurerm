...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/lbnatpool"
...
&lbnatpool.LbNatPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.lbNatPool.LbNatPoolTimeouts,
}
```
