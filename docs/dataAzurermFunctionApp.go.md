...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermfunctionapp"
...
&dataazurermfunctionapp.DataAzurermFunctionAppConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermFunctionApp.DataAzurermFunctionAppTimeouts,
}
```
