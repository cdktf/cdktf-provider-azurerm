...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermfunctionapp"
...
&dataazurermfunctionapp.DataAzurermFunctionAppConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dataAzurermFunctionApp.DataAzurermFunctionAppTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermFunctionApp.DataAzurermFunctionAppConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.43.0/docs/data-sources/function_app#tags DataAzurermFunctionApp#tags}. |
