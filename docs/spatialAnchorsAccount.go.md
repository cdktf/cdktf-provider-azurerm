...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/spatialanchorsaccount"
...
| <code><a href="#@cdktf/provider-azurerm.spatialAnchorsAccount.SpatialAnchorsAccount.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&spatialanchorsaccount.SpatialAnchorsAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.spatialAnchorsAccount.SpatialAnchorsAccountTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.spatialAnchorsAccount.SpatialAnchorsAccountConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.spatialAnchorsAccount.SpatialAnchorsAccountConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/spatial_anchors_account#tags SpatialAnchorsAccount#tags}. |
