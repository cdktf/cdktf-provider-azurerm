...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/postgresqlactivedirectoryadministrator"
...
&postgresqlactivedirectoryadministrator.PostgresqlActiveDirectoryAdministratorConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.postgresqlActiveDirectoryAdministrator.PostgresqlActiveDirectoryAdministratorTimeouts,
}
```
