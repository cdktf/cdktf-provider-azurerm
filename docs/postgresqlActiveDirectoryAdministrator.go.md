...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/postgresqlactivedirectoryadministrator"
...
&postgresqlactivedirectoryadministrator.PostgresqlActiveDirectoryAdministratorConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.postgresqlActiveDirectoryAdministrator.PostgresqlActiveDirectoryAdministratorTimeouts,
}
```
