...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermeventgridsystemtopic"
...
&dataazurermeventgridsystemtopic.DataAzurermEventgridSystemTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermEventgridSystemTopic.DataAzurermEventgridSystemTopicTimeouts,
}
```
