...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermeventgridsystemtopic"
...
&dataazurermeventgridsystemtopic.DataAzurermEventgridSystemTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermEventgridSystemTopic.DataAzurermEventgridSystemTopicTimeouts,
}
```
