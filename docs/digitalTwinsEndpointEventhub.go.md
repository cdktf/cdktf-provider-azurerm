...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/digitaltwinsendpointeventhub"
...
&digitaltwinsendpointeventhub.DigitalTwinsEndpointEventhubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.digitalTwinsEndpointEventhub.DigitalTwinsEndpointEventhubTimeouts,
}
```
