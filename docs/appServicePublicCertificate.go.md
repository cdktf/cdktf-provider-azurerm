...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/appservicepubliccertificate"
...
&appservicepubliccertificate.AppServicePublicCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.appServicePublicCertificate.AppServicePublicCertificateTimeouts,
}
```
