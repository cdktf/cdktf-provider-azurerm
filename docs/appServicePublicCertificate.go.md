...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/appservicepubliccertificate"
...
&appservicepubliccertificate.AppServicePublicCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.appServicePublicCertificate.AppServicePublicCertificateTimeouts,
}
```
