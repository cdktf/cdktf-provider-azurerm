...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermblueprintdefinition"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBlueprintDefinition.DataAzurermBlueprintDefinition.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermblueprintdefinition.DataAzurermBlueprintDefinitionConfig {
	...
	ScopeId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermBlueprintDefinition.DataAzurermBlueprintDefinitionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBlueprintDefinition.DataAzurermBlueprintDefinitionConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
