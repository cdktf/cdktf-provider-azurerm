...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermblueprintdefinition"
...
&dataazurermblueprintdefinition.DataAzurermBlueprintDefinitionConfig {
	...
	ScopeId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermBlueprintDefinition.DataAzurermBlueprintDefinitionTimeouts,
}
```
