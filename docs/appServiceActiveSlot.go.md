...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/appserviceactiveslot"
...
&appserviceactiveslot.AppServiceActiveSlotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.appServiceActiveSlot.AppServiceActiveSlotTimeouts,
}
```
