...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/appserviceactiveslot"
...
&appserviceactiveslot.AppServiceActiveSlotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.appServiceActiveSlot.AppServiceActiveSlotTimeouts,
}
```
