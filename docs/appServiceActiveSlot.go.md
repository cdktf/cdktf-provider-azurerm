...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/appserviceactiveslot"
...
&appserviceactiveslot.AppServiceActiveSlotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.appServiceActiveSlot.AppServiceActiveSlotTimeouts,
}
```
