...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/dataazurermstoragetable"
...
&dataazurermstoragetable.DataAzurermStorageTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.dataAzurermStorageTable.DataAzurermStorageTableTimeouts,
}
```
