...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermstoragetable"
...
&dataazurermstoragetable.DataAzurermStorageTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dataAzurermStorageTable.DataAzurermStorageTableTimeouts,
}
```
