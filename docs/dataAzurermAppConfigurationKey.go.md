...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermappconfigurationkey"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermAppConfigurationKey.DataAzurermAppConfigurationKey.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermappconfigurationkey.DataAzurermAppConfigurationKeyConfig {
	...
	Id: *string,
	Label: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAppConfigurationKey.DataAzurermAppConfigurationKeyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermAppConfigurationKey.DataAzurermAppConfigurationKeyConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
