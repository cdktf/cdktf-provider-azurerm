...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/natgatewaypublicipassociation"
...
&natgatewaypublicipassociation.NatGatewayPublicIpAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeouts,
}
```
