...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/natgatewaypublicipassociation"
...
&natgatewaypublicipassociation.NatGatewayPublicIpAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeouts,
}
```
