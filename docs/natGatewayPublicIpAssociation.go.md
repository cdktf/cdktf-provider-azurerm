...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/natgatewaypublicipassociation"
...
&natgatewaypublicipassociation.NatGatewayPublicIpAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeouts,
}
```
