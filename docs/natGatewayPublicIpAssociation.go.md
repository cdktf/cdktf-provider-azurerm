...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/natgatewaypublicipassociation"
...
&natgatewaypublicipassociation.NatGatewayPublicIpAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.natGatewayPublicIpAssociation.NatGatewayPublicIpAssociationTimeouts,
}
```
