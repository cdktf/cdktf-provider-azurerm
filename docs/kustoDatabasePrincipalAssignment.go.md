...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustodatabaseprincipalassignment"
...
&kustodatabaseprincipalassignment.KustoDatabasePrincipalAssignmentConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoDatabasePrincipalAssignment.KustoDatabasePrincipalAssignmentTimeouts,
}
```
