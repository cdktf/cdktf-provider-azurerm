...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapsesqlpoolsecurityalertpolicy"
...
&synapsesqlpoolsecurityalertpolicy.SynapseSqlPoolSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseSqlPoolSecurityAlertPolicy.SynapseSqlPoolSecurityAlertPolicyTimeouts,
}
```
