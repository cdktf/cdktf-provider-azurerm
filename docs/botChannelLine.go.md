...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/botchannelline"
...
&botchannelline.BotChannelLineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.botChannelLine.BotChannelLineTimeouts,
}
```
