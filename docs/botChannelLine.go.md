...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/botchannelline"
...
&botchannelline.BotChannelLineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.botChannelLine.BotChannelLineTimeouts,
}
```
