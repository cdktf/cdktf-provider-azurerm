...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchannelline"
...
&botchannelline.BotChannelLineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelLine.BotChannelLineTimeouts,
}
```
