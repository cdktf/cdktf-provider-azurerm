...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/datafactorylinkedservicemysql"
...
&datafactorylinkedservicemysql.DataFactoryLinkedServiceMysqlConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataFactoryLinkedServiceMysql.DataFactoryLinkedServiceMysqlTimeouts,
}
```
