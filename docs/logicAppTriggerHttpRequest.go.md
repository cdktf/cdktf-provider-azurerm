...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/logicapptriggerhttprequest"
...
&logicapptriggerhttprequest.LogicAppTriggerHttpRequestConfig {
	...
	Method: *string,
	RelativePath: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.logicAppTriggerHttpRequest.LogicAppTriggerHttpRequestTimeouts,
}
```
