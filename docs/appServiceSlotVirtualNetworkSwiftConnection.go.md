...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/appserviceslotvirtualnetworkswiftconnection"
...
&appserviceslotvirtualnetworkswiftconnection.AppServiceSlotVirtualNetworkSwiftConnectionConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.appServiceSlotVirtualNetworkSwiftConnection.AppServiceSlotVirtualNetworkSwiftConnectionTimeouts,
}
```
