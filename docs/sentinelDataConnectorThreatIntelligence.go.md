...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sentineldataconnectorthreatintelligence"
...
&sentineldataconnectorthreatintelligence.SentinelDataConnectorThreatIntelligenceConfig {
	...
	LookbackDate: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sentinelDataConnectorThreatIntelligence.SentinelDataConnectorThreatIntelligenceTimeouts,
}
```
