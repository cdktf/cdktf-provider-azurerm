...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/cdnprofile"
...
&cdnprofile.CdnProfileConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.cdnProfile.CdnProfileTimeouts,
}
```
