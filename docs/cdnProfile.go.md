...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cdnprofile"
...
&cdnprofile.CdnProfileConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cdnProfile.CdnProfileTimeouts,
}
```
