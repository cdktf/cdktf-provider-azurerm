...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/cdnprofile"
...
| <code><a href="#@cdktf/provider-azurerm.cdnProfile.CdnProfile.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&cdnprofile.CdnProfileConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.cdnProfile.CdnProfileTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.cdnProfile.CdnProfileConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.cdnProfile.CdnProfileConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/cdn_profile#tags CdnProfile#tags}. |
