...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/securitycenterautomation"
...
&securitycenterautomation.SecurityCenterAutomationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.securityCenterAutomation.SecurityCenterAutomationTimeouts,
}
```
