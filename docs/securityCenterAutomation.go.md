...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/securitycenterautomation"
...
&securitycenterautomation.SecurityCenterAutomationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.securityCenterAutomation.SecurityCenterAutomationTimeouts,
}
```
