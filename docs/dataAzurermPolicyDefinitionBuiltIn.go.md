...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpolicydefinitionbuiltin"
...
&dataazurermpolicydefinitionbuiltin.DataAzurermPolicyDefinitionBuiltInConfig {
	...
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPolicyDefinitionBuiltIn.DataAzurermPolicyDefinitionBuiltInTimeouts,
}
```
