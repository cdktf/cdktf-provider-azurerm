...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/keyvaultcertificateissuer"
...
&keyvaultcertificateissuer.KeyVaultCertificateIssuerConfig {
	...
	OrgId: *string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.keyVaultCertificateIssuer.KeyVaultCertificateIssuerTimeouts,
}
```
