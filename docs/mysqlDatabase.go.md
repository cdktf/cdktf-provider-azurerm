...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/mysqldatabase"
...
&mysqldatabase.MysqlDatabaseConfig {
	...
	ServerName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.mysqlDatabase.MysqlDatabaseTimeouts,
}
```
