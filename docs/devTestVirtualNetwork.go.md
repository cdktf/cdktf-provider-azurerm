...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/devtestvirtualnetwork"
...
&devtestvirtualnetwork.DevTestVirtualNetworkConfig {
	...
	Description: *string,
	Id: *string,
	Subnet: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.devTestVirtualNetwork.DevTestVirtualNetworkSubnet,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.devTestVirtualNetwork.DevTestVirtualNetworkTimeouts,
}
```
