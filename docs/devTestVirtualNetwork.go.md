...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/devtestvirtualnetwork"
...
| <code><a href="#@cdktf/provider-azurerm.devTestVirtualNetwork.DevTestVirtualNetwork.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&devtestvirtualnetwork.DevTestVirtualNetworkConfig {
	...
	Description: *string,
	Id: *string,
	Subnet: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.devTestVirtualNetwork.DevTestVirtualNetworkSubnet,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.devTestVirtualNetwork.DevTestVirtualNetworkTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.devTestVirtualNetwork.DevTestVirtualNetworkConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.devTestVirtualNetwork.DevTestVirtualNetworkConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dev_test_virtual_network#tags DevTestVirtualNetwork#tags}. |
