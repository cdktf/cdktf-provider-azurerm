...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/devtestvirtualnetwork"
...
&devtestvirtualnetwork.DevTestVirtualNetworkConfig {
	...
	Description: *string,
	Id: *string,
	Subnet: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.devTestVirtualNetwork.DevTestVirtualNetworkSubnet,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.devTestVirtualNetwork.DevTestVirtualNetworkTimeouts,
}
```
