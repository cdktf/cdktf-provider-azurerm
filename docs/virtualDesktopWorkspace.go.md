...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/virtualdesktopworkspace"
...
&virtualdesktopworkspace.VirtualDesktopWorkspaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.virtualDesktopWorkspace.VirtualDesktopWorkspaceTimeouts,
}
```
