...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermAppConfiguration.DataAzurermAppConfiguration.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly timeoutsInput: DataAzurermAppConfigurationTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.dataAzurermAppConfiguration.DataAzurermAppConfigurationTimeouts">DataAzurermAppConfigurationTimeouts</a> | cdktf.IResolvable
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermAppConfiguration.DataAzurermAppConfigurationConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly internalValue: DataAzurermAppConfigurationTimeouts | IResolvable;
```
