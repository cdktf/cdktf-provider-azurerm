...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermrediscache"
...
&dataazurermrediscache.DataAzurermRedisCacheConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermRedisCache.DataAzurermRedisCacheTimeouts,
}
```
