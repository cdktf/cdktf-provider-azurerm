...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/botchannelalexa"
...
&botchannelalexa.BotChannelAlexaConfig {
	...
	SkillId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.botChannelAlexa.BotChannelAlexaTimeouts,
}
```
