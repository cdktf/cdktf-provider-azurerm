...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/botchannelalexa"
...
| <code><a href="#@cdktf/provider-azurerm.botChannelAlexa.BotChannelAlexa.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&botchannelalexa.BotChannelAlexaConfig {
	...
	SkillId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.botChannelAlexa.BotChannelAlexaTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.botChannelAlexa.BotChannelAlexaConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
