...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sshpublickey"
...
&sshpublickey.SshPublicKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sshPublicKey.SshPublicKeyTimeouts,
}
```
