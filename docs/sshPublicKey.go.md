...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sshpublickey"
...
&sshpublickey.SshPublicKeyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sshPublicKey.SshPublicKeyTimeouts,
}
```
