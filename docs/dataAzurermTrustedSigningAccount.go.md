...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermtrustedsigningaccount"
...
&dataazurermtrustedsigningaccount.DataAzurermTrustedSigningAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermTrustedSigningAccount.DataAzurermTrustedSigningAccountTimeouts,
}
```
