...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednsarecord"
...
&privatednsarecord.PrivateDnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsARecord.PrivateDnsARecordTimeouts,
}
```
