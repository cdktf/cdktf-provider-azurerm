...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsarecord"
...
&privatednsarecord.PrivateDnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsARecord.PrivateDnsARecordTimeouts,
}
```
