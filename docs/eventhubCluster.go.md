...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/eventhubcluster"
...
&eventhubcluster.EventhubClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.eventhubCluster.EventhubClusterTimeouts,
}
```
