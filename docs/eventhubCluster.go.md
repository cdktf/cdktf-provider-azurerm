...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/eventhubcluster"
...
&eventhubcluster.EventhubClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.eventhubCluster.EventhubClusterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.eventhubCluster.EventhubClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.56.0/docs/resources/eventhub_cluster#tags EventhubCluster#tags}. |
