...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/eventhubcluster"
...
&eventhubcluster.EventhubClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.eventhubCluster.EventhubClusterTimeouts,
}
```
