...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/eventhubcluster"
...
&eventhubcluster.EventhubClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.eventhubCluster.EventhubClusterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.eventhubCluster.EventhubClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.66.0/docs/resources/eventhub_cluster#tags EventhubCluster#tags}. |
