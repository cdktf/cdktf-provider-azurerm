...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/cosmosdbsqltrigger"
...
| <code><a href="#@cdktf/provider-azurerm.cosmosdbSqlTrigger.CosmosdbSqlTrigger.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&cosmosdbsqltrigger.CosmosdbSqlTriggerConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.cosmosdbSqlTrigger.CosmosdbSqlTriggerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.cosmosdbSqlTrigger.CosmosdbSqlTriggerConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
