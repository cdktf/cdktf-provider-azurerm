...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cosmosdbsqltrigger"
...
&cosmosdbsqltrigger.CosmosdbSqlTriggerConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cosmosdbSqlTrigger.CosmosdbSqlTriggerTimeouts,
}
```
