...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbsqltrigger"
...
&cosmosdbsqltrigger.CosmosdbSqlTriggerConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbSqlTrigger.CosmosdbSqlTriggerTimeouts,
}
```
