...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbsqltrigger"
...
&cosmosdbsqltrigger.CosmosdbSqlTriggerConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbSqlTrigger.CosmosdbSqlTriggerTimeouts,
}
```
