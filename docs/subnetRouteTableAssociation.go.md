...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/subnetroutetableassociation"
...
&subnetroutetableassociation.SubnetRouteTableAssociationConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.subnetRouteTableAssociation.SubnetRouteTableAssociationTimeouts,
}
```
