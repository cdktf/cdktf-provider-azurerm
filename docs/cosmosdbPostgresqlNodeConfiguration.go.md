...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbpostgresqlnodeconfiguration"
...
&cosmosdbpostgresqlnodeconfiguration.CosmosdbPostgresqlNodeConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbPostgresqlNodeConfiguration.CosmosdbPostgresqlNodeConfigurationTimeouts,
}
```
