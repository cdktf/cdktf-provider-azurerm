...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsqldatabase"
...
&dataazurermsqldatabase.DataAzurermSqlDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSqlDatabase.DataAzurermSqlDatabaseTimeouts,
}
```
