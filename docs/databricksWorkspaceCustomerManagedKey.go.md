...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/databricksworkspacecustomermanagedkey"
...
&databricksworkspacecustomermanagedkey.DatabricksWorkspaceCustomerManagedKeyConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.databricksWorkspaceCustomerManagedKey.DatabricksWorkspaceCustomerManagedKeyTimeouts,
}
```
