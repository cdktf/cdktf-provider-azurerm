...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/securitycentersetting"
...
&securitycentersetting.SecurityCenterSettingConfig {
	...
	SettingName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.securityCenterSetting.SecurityCenterSettingTimeouts,
}
```
