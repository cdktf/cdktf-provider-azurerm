...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/securitycentersetting"
...
&securitycentersetting.SecurityCenterSettingConfig {
	...
	SettingName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.securityCenterSetting.SecurityCenterSettingTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.securityCenterSetting.SecurityCenterSettingConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/security_center_setting#enabled SecurityCenterSetting#enabled}. |
