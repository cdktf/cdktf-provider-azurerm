...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/dataazurermvirtualdesktophostpool"
...
&dataazurermvirtualdesktophostpool.DataAzurermVirtualDesktopHostPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.dataAzurermVirtualDesktopHostPool.DataAzurermVirtualDesktopHostPoolTimeouts,
}
```
