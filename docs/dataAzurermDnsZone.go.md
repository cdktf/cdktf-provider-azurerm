...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdnszone"
...
&dataazurermdnszone.DataAzurermDnsZoneConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDnsZone.DataAzurermDnsZoneTimeouts,
}
```
