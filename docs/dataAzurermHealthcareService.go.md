...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermhealthcareservice"
...
&dataazurermhealthcareservice.DataAzurermHealthcareServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermHealthcareService.DataAzurermHealthcareServiceTimeouts,
}
```
