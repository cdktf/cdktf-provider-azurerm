...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermhealthcareservice"
...
&dataazurermhealthcareservice.DataAzurermHealthcareServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermHealthcareService.DataAzurermHealthcareServiceTimeouts,
}
```
