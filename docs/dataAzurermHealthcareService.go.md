...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermhealthcareservice"
...
&dataazurermhealthcareservice.DataAzurermHealthcareServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermHealthcareService.DataAzurermHealthcareServiceTimeouts,
}
```
