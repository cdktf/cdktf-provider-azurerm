...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/loganalyticsclustercustomermanagedkey"
...
&loganalyticsclustercustomermanagedkey.LogAnalyticsClusterCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.logAnalyticsClusterCustomerManagedKey.LogAnalyticsClusterCustomerManagedKeyTimeouts,
}
```
