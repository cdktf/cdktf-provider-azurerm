...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/loganalyticsclustercustomermanagedkey"
...
&loganalyticsclustercustomermanagedkey.LogAnalyticsClusterCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logAnalyticsClusterCustomerManagedKey.LogAnalyticsClusterCustomerManagedKeyTimeouts,
}
```
