...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/loganalyticsclustercustomermanagedkey"
...
&loganalyticsclustercustomermanagedkey.LogAnalyticsClusterCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logAnalyticsClusterCustomerManagedKey.LogAnalyticsClusterCustomerManagedKeyTimeouts,
}
```
