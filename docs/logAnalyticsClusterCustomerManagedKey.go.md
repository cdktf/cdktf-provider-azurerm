...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/loganalyticsclustercustomermanagedkey"
...
&loganalyticsclustercustomermanagedkey.LogAnalyticsClusterCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.logAnalyticsClusterCustomerManagedKey.LogAnalyticsClusterCustomerManagedKeyTimeouts,
}
```
