...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermmanagedapi"
...
&dataazurermmanagedapi.DataAzurermManagedApiConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermManagedApi.DataAzurermManagedApiTimeouts,
}
```
