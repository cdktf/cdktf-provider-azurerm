...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmanagedapi"
...
&dataazurermmanagedapi.DataAzurermManagedApiConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermManagedApi.DataAzurermManagedApiTimeouts,
}
```
