...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentineldataconnectorofficeirm"
...
&sentineldataconnectorofficeirm.SentinelDataConnectorOfficeIrmConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelDataConnectorOfficeIrm.SentinelDataConnectorOfficeIrmTimeouts,
}
```
