...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/loganalyticsquerypack"
...
| <code><a href="#@cdktf/provider-azurerm.logAnalyticsQueryPack.LogAnalyticsQueryPack.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&loganalyticsquerypack.LogAnalyticsQueryPackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.logAnalyticsQueryPack.LogAnalyticsQueryPackTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.logAnalyticsQueryPack.LogAnalyticsQueryPackConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.logAnalyticsQueryPack.LogAnalyticsQueryPackConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/log_analytics_query_pack#tags LogAnalyticsQueryPack#tags}. |
