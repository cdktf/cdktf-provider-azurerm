...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/loganalyticsquerypack"
...
&loganalyticsquerypack.LogAnalyticsQueryPackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logAnalyticsQueryPack.LogAnalyticsQueryPackTimeouts,
}
```
