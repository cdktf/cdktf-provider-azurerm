...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/loganalyticsquerypack"
...
&loganalyticsquerypack.LogAnalyticsQueryPackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logAnalyticsQueryPack.LogAnalyticsQueryPackTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.logAnalyticsQueryPack.LogAnalyticsQueryPackConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/log_analytics_query_pack#tags LogAnalyticsQueryPack#tags}. |
