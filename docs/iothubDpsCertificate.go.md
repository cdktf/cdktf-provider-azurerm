...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/iothubdpscertificate"
...
&iothubdpscertificate.IothubDpsCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.iothubDpsCertificate.IothubDpsCertificateTimeouts,
}
```
