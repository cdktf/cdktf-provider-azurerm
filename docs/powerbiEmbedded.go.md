...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/powerbiembedded"
...
&powerbiembedded.PowerbiEmbeddedConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.powerbiEmbedded.PowerbiEmbeddedTimeouts,
}
```
