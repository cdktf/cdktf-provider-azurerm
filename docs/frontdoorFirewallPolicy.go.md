...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/frontdoorfirewallpolicy"
...
&frontdoorfirewallpolicy.FrontdoorFirewallPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.frontdoorFirewallPolicy.FrontdoorFirewallPolicyTimeouts,
}
```
