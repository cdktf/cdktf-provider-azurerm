...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermnetworkservicetags"
...
&dataazurermnetworkservicetags.DataAzurermNetworkServiceTagsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermNetworkServiceTags.DataAzurermNetworkServiceTagsTimeouts,
}
```
