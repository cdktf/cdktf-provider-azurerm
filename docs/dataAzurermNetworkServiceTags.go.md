...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetworkservicetags"
...
&dataazurermnetworkservicetags.DataAzurermNetworkServiceTagsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetworkServiceTags.DataAzurermNetworkServiceTagsTimeouts,
}
```
