...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/kustoclusterprincipalassignment"
...
&kustoclusterprincipalassignment.KustoClusterPrincipalAssignmentConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
