...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustoclusterprincipalassignment"
...
&kustoclusterprincipalassignment.KustoClusterPrincipalAssignmentConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoClusterPrincipalAssignment.KustoClusterPrincipalAssignmentTimeouts,
}
```
