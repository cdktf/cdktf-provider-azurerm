...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/diskpooliscsitargetlun"
...
&diskpooliscsitargetlun.DiskPoolIscsiTargetLunConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.diskPoolIscsiTargetLun.DiskPoolIscsiTargetLunTimeouts,
}
```
