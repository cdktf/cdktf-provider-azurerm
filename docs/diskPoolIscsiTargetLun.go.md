...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/diskpooliscsitargetlun"
...
&diskpooliscsitargetlun.DiskPoolIscsiTargetLunConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.diskPoolIscsiTargetLun.DiskPoolIscsiTargetLunTimeouts,
}
```
