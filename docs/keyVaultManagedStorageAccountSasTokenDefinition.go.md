...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/keyvaultmanagedstorageaccountsastokendefinition"
...
&keyvaultmanagedstorageaccountsastokendefinition.KeyVaultManagedStorageAccountSasTokenDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.keyVaultManagedStorageAccountSasTokenDefinition.KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts,
}
```
