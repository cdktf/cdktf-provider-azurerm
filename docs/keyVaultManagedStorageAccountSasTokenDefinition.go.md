...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/keyvaultmanagedstorageaccountsastokendefinition"
...
&keyvaultmanagedstorageaccountsastokendefinition.KeyVaultManagedStorageAccountSasTokenDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.keyVaultManagedStorageAccountSasTokenDefinition.KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts,
}
```
