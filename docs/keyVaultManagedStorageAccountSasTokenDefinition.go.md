...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/keyvaultmanagedstorageaccountsastokendefinition"
...
&keyvaultmanagedstorageaccountsastokendefinition.KeyVaultManagedStorageAccountSasTokenDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.keyVaultManagedStorageAccountSasTokenDefinition.KeyVaultManagedStorageAccountSasTokenDefinitionTimeouts,
}
```
