...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/emailcommunicationservice"
...
&emailcommunicationservice.EmailCommunicationServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.emailCommunicationService.EmailCommunicationServiceTimeouts,
}
```
