...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapseintegrationruntimeselfhosted"
...
&synapseintegrationruntimeselfhosted.SynapseIntegrationRuntimeSelfHostedConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseIntegrationRuntimeSelfHosted.SynapseIntegrationRuntimeSelfHostedTimeouts,
}
```
