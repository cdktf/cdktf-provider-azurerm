...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/networkddosprotectionplan"
...
&networkddosprotectionplan.NetworkDdosProtectionPlanConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.networkDdosProtectionPlan.NetworkDdosProtectionPlanTimeouts,
}
```
