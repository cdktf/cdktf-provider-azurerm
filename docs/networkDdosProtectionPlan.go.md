...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkddosprotectionplan"
...
&networkddosprotectionplan.NetworkDdosProtectionPlanConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkDdosProtectionPlan.NetworkDdosProtectionPlanTimeouts,
}
```
