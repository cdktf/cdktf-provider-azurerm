...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/stackhcicluster"
...
&stackhcicluster.StackHciClusterConfig {
	...
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.stackHciCluster.StackHciClusterTimeouts,
}
```
