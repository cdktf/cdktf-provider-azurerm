...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/stackhcicluster"
...
&stackhcicluster.StackHciClusterConfig {
	...
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.stackHciCluster.StackHciClusterTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.stackHciCluster.StackHciClusterConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/stack_hci_cluster#tags StackHciCluster#tags}. |
