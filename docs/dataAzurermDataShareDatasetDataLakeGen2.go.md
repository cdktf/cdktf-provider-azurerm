...
Refer to the Terraform Registory for docs: [`data_azurerm_data_share_dataset_data_lake_gen2`](https://www.terraform.io/docs/providers/azurerm/d/data_share_dataset_data_lake_gen2).
...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermdatasharedatasetdatalakegen2"
...
&dataazurermdatasharedatasetdatalakegen2.DataAzurermDataShareDatasetDataLakeGen2Config {
	...
	ShareId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermDataShareDatasetDataLakeGen2.DataAzurermDataShareDatasetDataLakeGen2Timeouts,
}
```
