...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mssqloutboundfirewallrule"
...
| <code><a href="#@cdktf/provider-azurerm.mssqlOutboundFirewallRule.MssqlOutboundFirewallRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&mssqloutboundfirewallrule.MssqlOutboundFirewallRuleConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mssqlOutboundFirewallRule.MssqlOutboundFirewallRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mssqlOutboundFirewallRule.MssqlOutboundFirewallRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
