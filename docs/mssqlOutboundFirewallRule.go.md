...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mssqloutboundfirewallrule"
...
&mssqloutboundfirewallrule.MssqlOutboundFirewallRuleConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mssqlOutboundFirewallRule.MssqlOutboundFirewallRuleTimeouts,
}
```
