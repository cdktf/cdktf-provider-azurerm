...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermkubernetescluster"
...
&dataazurermkubernetescluster.DataAzurermKubernetesClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterTimeouts,
}
```
