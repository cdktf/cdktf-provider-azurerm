...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkubernetescluster"
...
&dataazurermkubernetescluster.DataAzurermKubernetesClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterTimeouts,
}
```
