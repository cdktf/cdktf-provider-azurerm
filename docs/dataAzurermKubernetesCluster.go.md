...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermkubernetescluster"
...
&dataazurermkubernetescluster.DataAzurermKubernetesClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermKubernetesCluster.DataAzurermKubernetesClusterTimeouts,
}
```
