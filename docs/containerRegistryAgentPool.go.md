...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/containerregistryagentpool"
...
| <code><a href="#@cdktf/provider-azurerm.containerRegistryAgentPool.ContainerRegistryAgentPool.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&containerregistryagentpool.ContainerRegistryAgentPoolConfig {
	...
	Tier: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.containerRegistryAgentPool.ContainerRegistryAgentPoolTimeouts,
...
| <code><a href="#@cdktf/provider-azurerm.containerRegistryAgentPool.ContainerRegistryAgentPoolConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.containerRegistryAgentPool.ContainerRegistryAgentPoolConfig.property.instanceCount">InstanceCount</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/container_registry_agent_pool#instance_count ContainerRegistryAgentPool#instance_count}. |
| <code><a href="#@cdktf/provider-azurerm.containerRegistryAgentPool.ContainerRegistryAgentPoolConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/container_registry_agent_pool#tags ContainerRegistryAgentPool#tags}. |
