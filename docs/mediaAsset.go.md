...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/mediaasset"
...
&mediaasset.MediaAssetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.mediaAsset.MediaAssetTimeouts,
}
```
