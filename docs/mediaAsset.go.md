...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mediaasset"
...
&mediaasset.MediaAssetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mediaAsset.MediaAssetTimeouts,
}
```
