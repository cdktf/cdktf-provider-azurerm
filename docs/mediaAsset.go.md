...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mediaasset"
...
&mediaasset.MediaAssetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mediaAsset.MediaAssetTimeouts,
}
```
