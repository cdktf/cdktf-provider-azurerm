...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/firewallpolicyrulecollectiongroup"
...
&firewallpolicyrulecollectiongroup.FirewallPolicyRuleCollectionGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.firewallPolicyRuleCollectionGroup.FirewallPolicyRuleCollectionGroupTimeouts,
}
```
