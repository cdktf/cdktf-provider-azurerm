...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermappserviceplan"
...
&dataazurermappserviceplan.DataAzurermAppServicePlanConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAppServicePlan.DataAzurermAppServicePlanTimeouts,
}
```
