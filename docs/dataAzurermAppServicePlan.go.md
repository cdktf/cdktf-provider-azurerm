...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermappserviceplan"
...
&dataazurermappserviceplan.DataAzurermAppServicePlanConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAppServicePlan.DataAzurermAppServicePlanTimeouts,
}
```
