...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/devtestpolicy"
...
&devtestpolicy.DevTestPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.devTestPolicy.DevTestPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.devTestPolicy.DevTestPolicyConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.65.0/docs/resources/dev_test_policy#tags DevTestPolicy#tags}. |
