...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/automationconnectionserviceprincipal"
...
&automationconnectionserviceprincipal.AutomationConnectionServicePrincipalConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.automationConnectionServicePrincipal.AutomationConnectionServicePrincipalTimeouts,
}
```
