...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sharedimageversion"
...
&sharedimageversion.SharedImageVersionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sharedImageVersion.SharedImageVersionTimeouts,
}
```
