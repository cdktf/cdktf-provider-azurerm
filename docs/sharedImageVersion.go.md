...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/sharedimageversion"
...
&sharedimageversion.SharedImageVersionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.sharedImageVersion.SharedImageVersionTimeouts,
}
```
