...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mssqlserverdnsalias"
...
| <code><a href="#@cdktf/provider-azurerm.mssqlServerDnsAlias.MssqlServerDnsAlias.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&mssqlserverdnsalias.MssqlServerDnsAliasConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mssqlServerDnsAlias.MssqlServerDnsAliasTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mssqlServerDnsAlias.MssqlServerDnsAliasConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
