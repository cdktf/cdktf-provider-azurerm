...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mssqlserverdnsalias"
...
&mssqlserverdnsalias.MssqlServerDnsAliasConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mssqlServerDnsAlias.MssqlServerDnsAliasTimeouts,
}
```
