...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermhdinsightcluster"
...
&dataazurermhdinsightcluster.DataAzurermHdinsightClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermHdinsightCluster.DataAzurermHdinsightClusterTimeouts,
}
```
