...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermhdinsightcluster"
...
&dataazurermhdinsightcluster.DataAzurermHdinsightClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermHdinsightCluster.DataAzurermHdinsightClusterTimeouts,
}
```
