...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/siterecoveryreplicatedvm"
...
&siterecoveryreplicatedvm.SiteRecoveryReplicatedVmConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmTimeouts,
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmConfig.property.name">Name</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/site_recovery_replicated_vm#name SiteRecoveryReplicatedVm#name}. |
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/site_recovery_replicated_vm#id SiteRecoveryReplicatedVm#id}. |
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmConfig.property.managedDisk">ManagedDisk</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/site_recovery_replicated_vm#managed_disk SiteRecoveryReplicatedVm#managed_disk}. |
...
##### `TargetVirtualMachineSize`<sup>Optional</sup> <a name="TargetVirtualMachineSize" id="@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmConfig.property.targetVirtualMachineSize"></a>
...
##### `RecoveryLoadBalancerBackendAddressPoolIds`<sup>Optional</sup> <a name="RecoveryLoadBalancerBackendAddressPoolIds" id="@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterface.property.recoveryLoadBalancerBackendAddressPoolIds"></a>
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceOutputReference.resetRecoveryLoadBalancerBackendAddressPoolIds">ResetRecoveryLoadBalancerBackendAddressPoolIds</a></code> | *No description.* |
...
##### `ResetRecoveryLoadBalancerBackendAddressPoolIds` <a name="ResetRecoveryLoadBalancerBackendAddressPoolIds" id="@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceOutputReference.resetRecoveryLoadBalancerBackendAddressPoolIds"></a>

```go
func ResetRecoveryLoadBalancerBackendAddressPoolIds()
```
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceOutputReference.property.recoveryLoadBalancerBackendAddressPoolIdsInput">RecoveryLoadBalancerBackendAddressPoolIdsInput</a></code> | <code>*[]*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceOutputReference.property.recoveryLoadBalancerBackendAddressPoolIds">RecoveryLoadBalancerBackendAddressPoolIds</a></code> | <code>*[]*string</code> | *No description.* |
...
##### `RecoveryLoadBalancerBackendAddressPoolIdsInput`<sup>Optional</sup> <a name="RecoveryLoadBalancerBackendAddressPoolIdsInput" id="@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceOutputReference.property.recoveryLoadBalancerBackendAddressPoolIdsInput"></a>

```go
func RecoveryLoadBalancerBackendAddressPoolIdsInput() *[]*string
```
...
##### `RecoveryLoadBalancerBackendAddressPoolIds`<sup>Required</sup> <a name="RecoveryLoadBalancerBackendAddressPoolIds" id="@cdktf/provider-azurerm.siteRecoveryReplicatedVm.SiteRecoveryReplicatedVmNetworkInterfaceOutputReference.property.recoveryLoadBalancerBackendAddressPoolIds"></a>

```go
func RecoveryLoadBalancerBackendAddressPoolIds() *[]*string
```
