...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/appservicecertificatebinding"
...
&appservicecertificatebinding.AppServiceCertificateBindingConfig {
	...
	SslState: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.appServiceCertificateBinding.AppServiceCertificateBindingTimeouts,
}
```
