...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/databoxedgedevice"
...
&databoxedgedevice.DataboxEdgeDeviceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.databoxEdgeDevice.DataboxEdgeDeviceTimeouts,
}
```
