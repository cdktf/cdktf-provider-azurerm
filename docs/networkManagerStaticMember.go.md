...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/networkmanagerstaticmember"
...
&networkmanagerstaticmember.NetworkManagerStaticMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.networkManagerStaticMember.NetworkManagerStaticMemberTimeouts,
}
```
