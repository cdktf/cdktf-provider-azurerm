...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/networkmanagerstaticmember"
...
&networkmanagerstaticmember.NetworkManagerStaticMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkManagerStaticMember.NetworkManagerStaticMemberTimeouts,
}
```
