...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkmanagerstaticmember"
...
&networkmanagerstaticmember.NetworkManagerStaticMemberConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkManagerStaticMember.NetworkManagerStaticMemberTimeouts,
}
```
