...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/storagedatalakegen2path"
...
&storagedatalakegen2path.StorageDataLakeGen2PathConfig {
	...
	Id: *string,
	Owner: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.storageDataLakeGen2Path.StorageDataLakeGen2PathTimeouts,
}
```
