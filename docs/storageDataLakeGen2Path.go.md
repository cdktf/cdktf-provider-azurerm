...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/storagedatalakegen2path"
...
| <code><a href="#@cdktf/provider-azurerm.storageDataLakeGen2Path.StorageDataLakeGen2Path.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&storagedatalakegen2path.StorageDataLakeGen2PathConfig {
	...
	Id: *string,
	Owner: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.storageDataLakeGen2Path.StorageDataLakeGen2PathTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageDataLakeGen2Path.StorageDataLakeGen2PathConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
