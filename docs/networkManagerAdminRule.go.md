...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkmanageradminrule"
...
&networkmanageradminrule.NetworkManagerAdminRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkManagerAdminRule.NetworkManagerAdminRuleTimeouts,
}
```
