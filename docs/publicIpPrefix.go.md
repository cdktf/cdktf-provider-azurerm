...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/publicipprefix"
...
&publicipprefix.PublicIpPrefixConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.publicIpPrefix.PublicIpPrefixTimeouts,
	Zones: *[]*string,
}
```
