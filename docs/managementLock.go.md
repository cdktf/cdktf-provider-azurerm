...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/managementlock"
...
&managementlock.ManagementLockConfig {
	...
	Id: *string,
	Notes: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managementLock.ManagementLockTimeouts,
}
```
