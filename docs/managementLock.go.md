...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/managementlock"
...
&managementlock.ManagementLockConfig {
	...
	Id: *string,
	Notes: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.managementLock.ManagementLockTimeouts,
}
```
