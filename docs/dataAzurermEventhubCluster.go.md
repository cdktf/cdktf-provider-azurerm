...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermeventhubcluster"
...
&dataazurermeventhubcluster.DataAzurermEventhubClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermEventhubCluster.DataAzurermEventhubClusterTimeouts,
}
```
