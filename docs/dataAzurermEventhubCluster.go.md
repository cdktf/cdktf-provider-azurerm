...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermeventhubcluster"
...
&dataazurermeventhubcluster.DataAzurermEventhubClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermEventhubCluster.DataAzurermEventhubClusterTimeouts,
}
```
