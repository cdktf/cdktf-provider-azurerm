...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermeventhubcluster"
...
&dataazurermeventhubcluster.DataAzurermEventhubClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermEventhubCluster.DataAzurermEventhubClusterTimeouts,
}
```
