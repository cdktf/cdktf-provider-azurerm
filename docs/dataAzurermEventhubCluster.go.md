...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermeventhubcluster"
...
&dataazurermeventhubcluster.DataAzurermEventhubClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermEventhubCluster.DataAzurermEventhubClusterTimeouts,
}
```
