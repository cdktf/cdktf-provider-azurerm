...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudgatewaycustomdomain"
...
&springcloudgatewaycustomdomain.SpringCloudGatewayCustomDomainConfig {
	...
	Id: *string,
	Thumbprint: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudGatewayCustomDomain.SpringCloudGatewayCustomDomainTimeouts,
}
```
