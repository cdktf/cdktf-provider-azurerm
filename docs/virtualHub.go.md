...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualhub"
...
&virtualhub.VirtualHubConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualHub.VirtualHubTimeouts,
	VirtualWanId: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.virtualHub.VirtualHubConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/virtual_hub#tags VirtualHub#tags}. |
