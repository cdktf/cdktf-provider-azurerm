...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/containerregistrytaskschedulerunnow"
...
&containerregistrytaskschedulerunnow.ContainerRegistryTaskScheduleRunNowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.containerRegistryTaskScheduleRunNow.ContainerRegistryTaskScheduleRunNowTimeouts,
}
```
