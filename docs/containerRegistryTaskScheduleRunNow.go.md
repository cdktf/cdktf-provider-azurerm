...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/containerregistrytaskschedulerunnow"
...
&containerregistrytaskschedulerunnow.ContainerRegistryTaskScheduleRunNowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.containerRegistryTaskScheduleRunNow.ContainerRegistryTaskScheduleRunNowTimeouts,
}
```
