...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/containerregistrytaskschedulerunnow"
...
&containerregistrytaskschedulerunnow.ContainerRegistryTaskScheduleRunNowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.containerRegistryTaskScheduleRunNow.ContainerRegistryTaskScheduleRunNowTimeouts,
}
```
