...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/containerregistrytaskschedulerunnow"
...
&containerregistrytaskschedulerunnow.ContainerRegistryTaskScheduleRunNowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.containerRegistryTaskScheduleRunNow.ContainerRegistryTaskScheduleRunNowTimeouts,
}
```
