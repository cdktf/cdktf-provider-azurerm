...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermserviceplan"
...
&dataazurermserviceplan.DataAzurermServicePlanConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermServicePlan.DataAzurermServicePlanTimeouts,
}
```
