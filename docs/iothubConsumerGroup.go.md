...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/iothubconsumergroup"
...
&iothubconsumergroup.IothubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.iothubConsumerGroup.IothubConsumerGroupTimeouts,
}
```
