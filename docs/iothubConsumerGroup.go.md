...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/iothubconsumergroup"
...
&iothubconsumergroup.IothubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.iothubConsumerGroup.IothubConsumerGroupTimeouts,
}
```
