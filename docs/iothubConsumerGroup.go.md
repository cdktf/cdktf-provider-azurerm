...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubconsumergroup"
...
&iothubconsumergroup.IothubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubConsumerGroup.IothubConsumerGroupTimeouts,
}
```
