...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/iothubconsumergroup"
...
&iothubconsumergroup.IothubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.iothubConsumerGroup.IothubConsumerGroupTimeouts,
}
```
