...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/loganalyticslinkedstorageaccount"
...
&loganalyticslinkedstorageaccount.LogAnalyticsLinkedStorageAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.logAnalyticsLinkedStorageAccount.LogAnalyticsLinkedStorageAccountTimeouts,
}
```
