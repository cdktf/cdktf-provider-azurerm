...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/lbprobe"
...
&lbprobe.LbProbeConfig {
	...
	Protocol: *string,
	RequestPath: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.lbProbe.LbProbeTimeouts,
}
```
