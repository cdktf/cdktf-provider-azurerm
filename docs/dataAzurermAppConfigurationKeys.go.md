...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermappconfigurationkeys"
...
&dataazurermappconfigurationkeys.DataAzurermAppConfigurationKeysConfig {
	...
	Key: *string,
	Label: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermAppConfigurationKeys.DataAzurermAppConfigurationKeysTimeouts,
}
```
