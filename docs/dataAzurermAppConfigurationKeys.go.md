...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermappconfigurationkeys"
...
&dataazurermappconfigurationkeys.DataAzurermAppConfigurationKeysConfig {
	...
	Key: *string,
	Label: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAppConfigurationKeys.DataAzurermAppConfigurationKeysTimeouts,
}
```
