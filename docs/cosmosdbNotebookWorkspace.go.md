...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbnotebookworkspace"
...
&cosmosdbnotebookworkspace.CosmosdbNotebookWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbNotebookWorkspace.CosmosdbNotebookWorkspaceTimeouts,
}
```
