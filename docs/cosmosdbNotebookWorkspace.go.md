...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/cosmosdbnotebookworkspace"
...
| <code><a href="#@cdktf/provider-azurerm.cosmosdbNotebookWorkspace.CosmosdbNotebookWorkspace.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&cosmosdbnotebookworkspace.CosmosdbNotebookWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.cosmosdbNotebookWorkspace.CosmosdbNotebookWorkspaceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.cosmosdbNotebookWorkspace.CosmosdbNotebookWorkspaceConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
