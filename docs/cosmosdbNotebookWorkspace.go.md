...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbnotebookworkspace"
...
&cosmosdbnotebookworkspace.CosmosdbNotebookWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbNotebookWorkspace.CosmosdbNotebookWorkspaceTimeouts,
}
```
