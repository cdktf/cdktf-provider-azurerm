...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cosmosdbnotebookworkspace"
...
&cosmosdbnotebookworkspace.CosmosdbNotebookWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cosmosdbNotebookWorkspace.CosmosdbNotebookWorkspaceTimeouts,
}
```
