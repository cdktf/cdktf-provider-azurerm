...
```typescript
public readonly timeoutsInput: CosmosdbPostgresqlCoordinatorConfigurationTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.cosmosdbPostgresqlCoordinatorConfiguration.CosmosdbPostgresqlCoordinatorConfigurationTimeouts">CosmosdbPostgresqlCoordinatorConfigurationTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: CosmosdbPostgresqlCoordinatorConfigurationTimeouts | IResolvable;
```
