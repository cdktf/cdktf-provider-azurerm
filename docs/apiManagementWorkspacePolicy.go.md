...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/apimanagementworkspacepolicy"
...
&apimanagementworkspacepolicy.ApiManagementWorkspacePolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.apiManagementWorkspacePolicy.ApiManagementWorkspacePolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
