...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/hpccacheblobtarget"
...
&hpccacheblobtarget.HpcCacheBlobTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.hpcCacheBlobTarget.HpcCacheBlobTargetTimeouts,
}
```
