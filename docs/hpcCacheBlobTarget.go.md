...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/hpccacheblobtarget"
...
&hpccacheblobtarget.HpcCacheBlobTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.hpcCacheBlobTarget.HpcCacheBlobTargetTimeouts,
}
```
