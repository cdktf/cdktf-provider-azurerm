...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/hpccacheblobtarget"
...
| <code><a href="#@cdktf/provider-azurerm.hpcCacheBlobTarget.HpcCacheBlobTarget.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&hpccacheblobtarget.HpcCacheBlobTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.hpcCacheBlobTarget.HpcCacheBlobTargetTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.hpcCacheBlobTarget.HpcCacheBlobTargetConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
