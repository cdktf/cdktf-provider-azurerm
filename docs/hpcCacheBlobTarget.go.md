...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/hpccacheblobtarget"
...
&hpccacheblobtarget.HpcCacheBlobTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.hpcCacheBlobTarget.HpcCacheBlobTargetTimeouts,
}
```
