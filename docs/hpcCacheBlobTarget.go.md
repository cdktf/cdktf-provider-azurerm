...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/hpccacheblobtarget"
...
&hpccacheblobtarget.HpcCacheBlobTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.hpcCacheBlobTarget.HpcCacheBlobTargetTimeouts,
}
```
