...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/hpccacheblobtarget"
...
&hpccacheblobtarget.HpcCacheBlobTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.hpcCacheBlobTarget.HpcCacheBlobTargetTimeouts,
}
```
