...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/oracleautonomousdatabasebackup"
...
&oracleautonomousdatabasebackup.OracleAutonomousDatabaseBackupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.oracleAutonomousDatabaseBackup.OracleAutonomousDatabaseBackupTimeouts,
	Type: *string,
}
```
