...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/kubernetesclustertrustedaccessrolebinding"
...
&kubernetesclustertrustedaccessrolebinding.KubernetesClusterTrustedAccessRoleBindingConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.kubernetesClusterTrustedAccessRoleBinding.KubernetesClusterTrustedAccessRoleBindingTimeouts,
}
```
