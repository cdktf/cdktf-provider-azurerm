...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/servicebustopic"
...
&servicebustopic.ServicebusTopicConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.servicebusTopic.ServicebusTopicTimeouts,
}
```
