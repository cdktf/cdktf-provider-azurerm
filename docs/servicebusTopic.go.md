...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/servicebustopic"
...
&servicebustopic.ServicebusTopicConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.servicebusTopic.ServicebusTopicTimeouts,
}
```
