...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermadvisorrecommendations"
...
&dataazurermadvisorrecommendations.DataAzurermAdvisorRecommendationsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAdvisorRecommendations.DataAzurermAdvisorRecommendationsTimeouts,
}
```
