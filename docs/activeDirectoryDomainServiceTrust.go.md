...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/activedirectorydomainservicetrust"
...
&activedirectorydomainservicetrust.ActiveDirectoryDomainServiceTrustConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.activeDirectoryDomainServiceTrust.ActiveDirectoryDomainServiceTrustTimeouts,
}
```
