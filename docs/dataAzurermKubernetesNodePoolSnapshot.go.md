...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkubernetesnodepoolsnapshot"
...
&dataazurermkubernetesnodepoolsnapshot.DataAzurermKubernetesNodePoolSnapshotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKubernetesNodePoolSnapshot.DataAzurermKubernetesNodePoolSnapshotTimeouts,
}
```
