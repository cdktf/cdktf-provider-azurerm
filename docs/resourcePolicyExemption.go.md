...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/resourcepolicyexemption"
...
&resourcepolicyexemption.ResourcePolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourcePolicyExemption.ResourcePolicyExemptionTimeouts,
}
```
