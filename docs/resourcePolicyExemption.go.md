...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/resourcepolicyexemption"
...
&resourcepolicyexemption.ResourcePolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.resourcePolicyExemption.ResourcePolicyExemptionTimeouts,
}
```
