...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/resourcepolicyexemption"
...
&resourcepolicyexemption.ResourcePolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.resourcePolicyExemption.ResourcePolicyExemptionTimeouts,
}
```
