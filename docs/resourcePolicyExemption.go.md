...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/resourcepolicyexemption"
...
&resourcepolicyexemption.ResourcePolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.resourcePolicyExemption.ResourcePolicyExemptionTimeouts,
}
```
