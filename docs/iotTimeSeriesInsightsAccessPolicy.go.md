...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/iottimeseriesinsightsaccesspolicy"
...
&iottimeseriesinsightsaccesspolicy.IotTimeSeriesInsightsAccessPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.iotTimeSeriesInsightsAccessPolicy.IotTimeSeriesInsightsAccessPolicyTimeouts,
}
```
