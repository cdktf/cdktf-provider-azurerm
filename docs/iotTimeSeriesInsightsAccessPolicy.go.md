...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/iottimeseriesinsightsaccesspolicy"
...
| <code><a href="#@cdktf/provider-azurerm.iotTimeSeriesInsightsAccessPolicy.IotTimeSeriesInsightsAccessPolicy.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&iottimeseriesinsightsaccesspolicy.IotTimeSeriesInsightsAccessPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.iotTimeSeriesInsightsAccessPolicy.IotTimeSeriesInsightsAccessPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iotTimeSeriesInsightsAccessPolicy.IotTimeSeriesInsightsAccessPolicyConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
