...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iottimeseriesinsightsaccesspolicy"
...
&iottimeseriesinsightsaccesspolicy.IotTimeSeriesInsightsAccessPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iotTimeSeriesInsightsAccessPolicy.IotTimeSeriesInsightsAccessPolicyTimeouts,
}
```
