...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/iottimeseriesinsightsaccesspolicy"
...
&iottimeseriesinsightsaccesspolicy.IotTimeSeriesInsightsAccessPolicyConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.iotTimeSeriesInsightsAccessPolicy.IotTimeSeriesInsightsAccessPolicyTimeouts,
}
```
