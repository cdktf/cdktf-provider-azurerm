...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/machinelearningdatastoredatalakegen2"
...
&machinelearningdatastoredatalakegen2.MachineLearningDatastoreDatalakeGen2Config {
	...
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.machineLearningDatastoreDatalakeGen2.MachineLearningDatastoreDatalakeGen2Timeouts,
}
```
