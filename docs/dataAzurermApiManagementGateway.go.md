...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/dataazurermapimanagementgateway"
...
&dataazurermapimanagementgateway.DataAzurermApiManagementGatewayConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.dataAzurermApiManagementGateway.DataAzurermApiManagementGatewayTimeouts,
}
```
