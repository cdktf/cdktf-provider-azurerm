...
Refer to the Terraform Registory for docs: [`data_azurerm_api_management_gateway`](https://registry.terraform.io/providers/hashicorp/azurerm/3.62.1/docs/data-sources/api_management_gateway).
...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermapimanagementgateway"
...
&dataazurermapimanagementgateway.DataAzurermApiManagementGatewayConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermApiManagementGateway.DataAzurermApiManagementGatewayTimeouts,
}
```
