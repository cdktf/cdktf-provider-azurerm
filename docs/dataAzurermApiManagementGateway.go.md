...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapimanagementgateway"
...
&dataazurermapimanagementgateway.DataAzurermApiManagementGatewayConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApiManagementGateway.DataAzurermApiManagementGatewayTimeouts,
}
```
