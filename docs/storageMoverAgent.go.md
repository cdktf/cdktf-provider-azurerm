...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storagemoveragent"
...
&storagemoveragent.StorageMoverAgentConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageMoverAgent.StorageMoverAgentTimeouts,
}
```
