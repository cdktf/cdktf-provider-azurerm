...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermnetappsnapshot"
...
&dataazurermnetappsnapshot.DataAzurermNetappSnapshotConfig {
	...
	VolumeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermNetappSnapshot.DataAzurermNetappSnapshotTimeouts,
}
```
