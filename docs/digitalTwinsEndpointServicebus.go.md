...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/digitaltwinsendpointservicebus"
...
&digitaltwinsendpointservicebus.DigitalTwinsEndpointServicebusConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.digitalTwinsEndpointServicebus.DigitalTwinsEndpointServicebusTimeouts,
}
```
