...
Refer to the Terraform Registory for docs: [`data_azurerm_servicebus_namespace_authorization_rule`](https://registry.terraform.io/providers/hashicorp/azurerm/3.68.0/docs/data-sources/servicebus_namespace_authorization_rule).
