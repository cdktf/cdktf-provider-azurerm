...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/signalrservicecustomcertificate"
...
&signalrservicecustomcertificate.SignalrServiceCustomCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.signalrServiceCustomCertificate.SignalrServiceCustomCertificateTimeouts,
}
```
