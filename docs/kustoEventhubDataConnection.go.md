...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustoeventhubdataconnection"
...
&kustoeventhubdataconnection.KustoEventhubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoEventhubDataConnection.KustoEventhubDataConnectionTimeouts,
}
```
