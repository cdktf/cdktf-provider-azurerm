...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/kustoeventhubdataconnection"
...
&kustoeventhubdataconnection.KustoEventhubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.kustoEventhubDataConnection.KustoEventhubDataConnectionTimeouts,
}
```
