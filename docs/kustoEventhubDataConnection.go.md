...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/kustoeventhubdataconnection"
...
&kustoeventhubdataconnection.KustoEventhubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.kustoEventhubDataConnection.KustoEventhubDataConnectionTimeouts,
}
```
