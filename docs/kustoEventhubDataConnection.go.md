...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/kustoeventhubdataconnection"
...
&kustoeventhubdataconnection.KustoEventhubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.kustoEventhubDataConnection.KustoEventhubDataConnectionTimeouts,
}
```
