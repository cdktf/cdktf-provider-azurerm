...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mysqlflexibleserverconfiguration"
...
&mysqlflexibleserverconfiguration.MysqlFlexibleServerConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mysqlFlexibleServerConfiguration.MysqlFlexibleServerConfigurationTimeouts,
}
```
