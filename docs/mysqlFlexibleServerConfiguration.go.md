...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mysqlflexibleserverconfiguration"
...
| <code><a href="#@cdktf/provider-azurerm.mysqlFlexibleServerConfiguration.MysqlFlexibleServerConfiguration.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&mysqlflexibleserverconfiguration.MysqlFlexibleServerConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mysqlFlexibleServerConfiguration.MysqlFlexibleServerConfigurationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mysqlFlexibleServerConfiguration.MysqlFlexibleServerConfigurationConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
