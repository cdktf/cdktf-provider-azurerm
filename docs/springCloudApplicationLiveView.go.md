...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/springcloudapplicationliveview"
...
&springcloudapplicationliveview.SpringCloudApplicationLiveViewConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.springCloudApplicationLiveView.SpringCloudApplicationLiveViewTimeouts,
}
```
