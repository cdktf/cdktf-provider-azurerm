...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/springcloudapplicationliveview"
...
&springcloudapplicationliveview.SpringCloudApplicationLiveViewConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.springCloudApplicationLiveView.SpringCloudApplicationLiveViewTimeouts,
}
```
