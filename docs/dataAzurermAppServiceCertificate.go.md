...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermappservicecertificate"
...
&dataazurermappservicecertificate.DataAzurermAppServiceCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAppServiceCertificate.DataAzurermAppServiceCertificateTimeouts,
}
```
