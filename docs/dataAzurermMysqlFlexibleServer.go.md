...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmysqlflexibleserver"
...
&dataazurermmysqlflexibleserver.DataAzurermMysqlFlexibleServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMysqlFlexibleServer.DataAzurermMysqlFlexibleServerTimeouts,
}
```
