...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmysqlflexibleserver"
...
&dataazurermmysqlflexibleserver.DataAzurermMysqlFlexibleServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMysqlFlexibleServer.DataAzurermMysqlFlexibleServerTimeouts,
}
```
