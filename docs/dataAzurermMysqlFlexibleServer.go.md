...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermmysqlflexibleserver"
...
&dataazurermmysqlflexibleserver.DataAzurermMysqlFlexibleServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermMysqlFlexibleServer.DataAzurermMysqlFlexibleServerTimeouts,
}
```
