...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/resourcegrouppolicyexemption"
...
&resourcegrouppolicyexemption.ResourceGroupPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.resourceGroupPolicyExemption.ResourceGroupPolicyExemptionTimeouts,
}
```
