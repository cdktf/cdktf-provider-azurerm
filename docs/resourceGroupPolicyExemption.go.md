...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/resourcegrouppolicyexemption"
...
&resourcegrouppolicyexemption.ResourceGroupPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.resourceGroupPolicyExemption.ResourceGroupPolicyExemptionTimeouts,
}
```
