...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsqlserver"
...
&dataazurermsqlserver.DataAzurermSqlServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSqlServer.DataAzurermSqlServerTimeouts,
}
```
