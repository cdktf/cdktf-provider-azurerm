...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsqlserver"
...
&dataazurermsqlserver.DataAzurermSqlServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSqlServer.DataAzurermSqlServerTimeouts,
}
```
