...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/networkmanagernetworkgroup"
...
&networkmanagernetworkgroup.NetworkManagerNetworkGroupConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.networkManagerNetworkGroup.NetworkManagerNetworkGroupTimeouts,
}
```
