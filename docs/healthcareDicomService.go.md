...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/healthcaredicomservice"
...
&healthcaredicomservice.HealthcareDicomServiceConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.healthcareDicomService.HealthcareDicomServiceIdentity,
	PublicNetworkAccessEnabled: interface{},
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.healthcareDicomService.HealthcareDicomServiceTimeouts,
}
```
