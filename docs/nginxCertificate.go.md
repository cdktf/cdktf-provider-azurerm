...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/nginxcertificate"
...
&nginxcertificate.NginxCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.nginxCertificate.NginxCertificateTimeouts,
}
```
