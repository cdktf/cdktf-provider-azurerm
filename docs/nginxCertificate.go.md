...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/nginxcertificate"
...
&nginxcertificate.NginxCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.nginxCertificate.NginxCertificateTimeouts,
}
```
