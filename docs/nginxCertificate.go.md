...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/nginxcertificate"
...
&nginxcertificate.NginxCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.nginxCertificate.NginxCertificateTimeouts,
}
```
