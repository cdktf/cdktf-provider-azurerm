...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/nginxcertificate"
...
&nginxcertificate.NginxCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.nginxCertificate.NginxCertificateTimeouts,
}
```
