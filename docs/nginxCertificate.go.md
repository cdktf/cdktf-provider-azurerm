...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/nginxcertificate"
...
&nginxcertificate.NginxCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.nginxCertificate.NginxCertificateTimeouts,
}
```
