...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagesynccloudendpoint"
...
&storagesynccloudendpoint.StorageSyncCloudEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageSyncCloudEndpoint.StorageSyncCloudEndpointTimeouts,
}
```
