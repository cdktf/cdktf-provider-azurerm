...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storagesynccloudendpoint"
...
&storagesynccloudendpoint.StorageSyncCloudEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageSyncCloudEndpoint.StorageSyncCloudEndpointTimeouts,
}
```
