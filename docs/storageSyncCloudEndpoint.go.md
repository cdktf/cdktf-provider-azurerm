...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagesynccloudendpoint"
...
&storagesynccloudendpoint.StorageSyncCloudEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageSyncCloudEndpoint.StorageSyncCloudEndpointTimeouts,
}
```
