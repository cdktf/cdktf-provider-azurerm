...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/route"
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.route.RouteTimeouts,
}
```
