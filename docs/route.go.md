...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/route"
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.route.RouteTimeouts,
}
```
