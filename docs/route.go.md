...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/route"
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.route.RouteTimeouts,
}
```
