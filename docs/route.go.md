...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/route"
...
&route.RouteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.route.RouteTimeouts,
}
```
