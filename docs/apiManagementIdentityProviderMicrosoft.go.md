...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementidentityprovidermicrosoft"
...
&apimanagementidentityprovidermicrosoft.ApiManagementIdentityProviderMicrosoftConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementIdentityProviderMicrosoft.ApiManagementIdentityProviderMicrosoftTimeouts,
}
```
