...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/eventhubconsumergroup"
...
&eventhubconsumergroup.EventhubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.eventhubConsumerGroup.EventhubConsumerGroupTimeouts,
	UserMetadata: *string,
}
```
