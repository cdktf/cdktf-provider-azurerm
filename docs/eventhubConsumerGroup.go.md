...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/eventhubconsumergroup"
...
&eventhubconsumergroup.EventhubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.eventhubConsumerGroup.EventhubConsumerGroupTimeouts,
	UserMetadata: *string,
}
```
