...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/eventhubconsumergroup"
...
&eventhubconsumergroup.EventhubConsumerGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.eventhubConsumerGroup.EventhubConsumerGroupTimeouts,
	UserMetadata: *string,
}
```
