...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/keyvaultaccesspolicy"
...
&keyvaultaccesspolicy.KeyVaultAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.keyVaultAccessPolicy.KeyVaultAccessPolicyTimeouts,
}
```
