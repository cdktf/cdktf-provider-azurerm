...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/keyvaultaccesspolicy"
...
&keyvaultaccesspolicy.KeyVaultAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.keyVaultAccessPolicy.KeyVaultAccessPolicyTimeouts,
}
```
