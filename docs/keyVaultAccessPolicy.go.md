...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/keyvaultaccesspolicy"
...
&keyvaultaccesspolicy.KeyVaultAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.keyVaultAccessPolicy.KeyVaultAccessPolicyTimeouts,
}
```
