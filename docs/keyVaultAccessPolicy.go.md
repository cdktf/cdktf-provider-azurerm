...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/keyvaultaccesspolicy"
...
&keyvaultaccesspolicy.KeyVaultAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.keyVaultAccessPolicy.KeyVaultAccessPolicyTimeouts,
}
```
