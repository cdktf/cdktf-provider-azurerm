...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/keyvaultaccesspolicy"
...
| <code><a href="#@cdktf/provider-azurerm.keyVaultAccessPolicy.KeyVaultAccessPolicyA.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&keyvaultaccesspolicy.KeyVaultAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.keyVaultAccessPolicy.KeyVaultAccessPolicyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.keyVaultAccessPolicy.KeyVaultAccessPolicyAConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
