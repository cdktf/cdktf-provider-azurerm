...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/keyvaultaccesspolicy"
...
&keyvaultaccesspolicy.KeyVaultAccessPolicyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.keyVaultAccessPolicy.KeyVaultAccessPolicyTimeouts,
}
```
