...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermstorageaccount"
...
&dataazurermstorageaccount.DataAzurermStorageAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermStorageAccount.DataAzurermStorageAccountTimeouts,
}
```
