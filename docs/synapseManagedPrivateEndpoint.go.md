...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/synapsemanagedprivateendpoint"
...
&synapsemanagedprivateendpoint.SynapseManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.synapseManagedPrivateEndpoint.SynapseManagedPrivateEndpointTimeouts,
}
```
