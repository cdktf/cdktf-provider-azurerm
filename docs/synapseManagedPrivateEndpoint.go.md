...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/synapsemanagedprivateendpoint"
...
&synapsemanagedprivateendpoint.SynapseManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.synapseManagedPrivateEndpoint.SynapseManagedPrivateEndpointTimeouts,
}
```
