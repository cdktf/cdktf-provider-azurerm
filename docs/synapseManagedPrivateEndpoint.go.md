...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapsemanagedprivateendpoint"
...
&synapsemanagedprivateendpoint.SynapseManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseManagedPrivateEndpoint.SynapseManagedPrivateEndpointTimeouts,
}
```
