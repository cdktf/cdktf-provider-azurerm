...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/synapsemanagedprivateendpoint"
...
| <code><a href="#@cdktf/provider-azurerm.synapseManagedPrivateEndpoint.SynapseManagedPrivateEndpoint.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&synapsemanagedprivateendpoint.SynapseManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.synapseManagedPrivateEndpoint.SynapseManagedPrivateEndpointTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.synapseManagedPrivateEndpoint.SynapseManagedPrivateEndpointConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
