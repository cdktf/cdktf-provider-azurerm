...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mysqlactivedirectoryadministrator"
...
&mysqlactivedirectoryadministrator.MysqlActiveDirectoryAdministratorConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlActiveDirectoryAdministrator.MysqlActiveDirectoryAdministratorTimeouts,
}
```
