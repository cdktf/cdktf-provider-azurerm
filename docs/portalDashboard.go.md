...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/portaldashboard"
...
| <code><a href="#@cdktf/provider-azurerm.portalDashboard.PortalDashboardConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.0/docs/resources/portal_dashboard#tags PortalDashboard#tags}. |
