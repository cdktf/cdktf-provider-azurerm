...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnatgateway"
...
&dataazurermnatgateway.DataAzurermNatGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNatGateway.DataAzurermNatGatewayTimeouts,
}
```
