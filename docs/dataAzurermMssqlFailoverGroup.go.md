...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermmssqlfailovergroup"
...
&dataazurermmssqlfailovergroup.DataAzurermMssqlFailoverGroupConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermMssqlFailoverGroup.DataAzurermMssqlFailoverGroupTimeouts,
}
```
