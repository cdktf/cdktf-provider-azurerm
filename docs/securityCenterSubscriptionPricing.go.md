...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/securitycentersubscriptionpricing"
...
&securitycentersubscriptionpricing.SecurityCenterSubscriptionPricingConfig {
	...
	ResourceType: *string,
	Subplan: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.securityCenterSubscriptionPricing.SecurityCenterSubscriptionPricingTimeouts,
}
```
