...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/securitycentersubscriptionpricing"
...
&securitycentersubscriptionpricing.SecurityCenterSubscriptionPricingConfig {
	...
	ResourceType: *string,
	Subplan: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.securityCenterSubscriptionPricing.SecurityCenterSubscriptionPricingTimeouts,
}
```
