...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/portaltenantconfiguration"
...
&portaltenantconfiguration.PortalTenantConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.portalTenantConfiguration.PortalTenantConfigurationTimeouts,
}
```
