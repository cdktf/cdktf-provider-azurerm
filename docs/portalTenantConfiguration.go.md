...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/portaltenantconfiguration"
...
&portaltenantconfiguration.PortalTenantConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.portalTenantConfiguration.PortalTenantConfigurationTimeouts,
}
```
