...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/portaltenantconfiguration"
...
&portaltenantconfiguration.PortalTenantConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.portalTenantConfiguration.PortalTenantConfigurationTimeouts,
}
```
