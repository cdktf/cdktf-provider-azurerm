...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/portaltenantconfiguration"
...
&portaltenantconfiguration.PortalTenantConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.portalTenantConfiguration.PortalTenantConfigurationTimeouts,
}
```
