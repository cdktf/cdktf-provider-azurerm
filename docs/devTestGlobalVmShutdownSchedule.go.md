...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/devtestglobalvmshutdownschedule"
...
&devtestglobalvmshutdownschedule.DevTestGlobalVmShutdownScheduleConfig {
	...
	Location: *string,
	NotificationSettings: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.devTestGlobalVmShutdownSchedule.DevTestGlobalVmShutdownScheduleNotificationSettings,
	Timezone: *string,
	VirtualMachineId: *string,
	Enabled: interface{},
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.devTestGlobalVmShutdownSchedule.DevTestGlobalVmShutdownScheduleTimeouts,
}
```
