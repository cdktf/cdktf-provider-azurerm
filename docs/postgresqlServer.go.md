...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/postgresqlserver"
...
&postgresqlserver.PostgresqlServerConfig {
	...
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.postgresqlServer.PostgresqlServerIdentity,
	...
	ThreatDetectionPolicy: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.postgresqlServer.PostgresqlServerThreatDetectionPolicy,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.postgresqlServer.PostgresqlServerTimeouts,
}
```
