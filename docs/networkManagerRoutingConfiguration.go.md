...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/networkmanagerroutingconfiguration"
...
&networkmanagerroutingconfiguration.NetworkManagerRoutingConfigurationConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.networkManagerRoutingConfiguration.NetworkManagerRoutingConfigurationTimeouts,
}
```
