...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmobilenetworkservice"
...
&dataazurermmobilenetworkservice.DataAzurermMobileNetworkServiceConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMobileNetworkService.DataAzurermMobileNetworkServiceTimeouts,
}
```
