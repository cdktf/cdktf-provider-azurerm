...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmobilenetworkservice"
...
&dataazurermmobilenetworkservice.DataAzurermMobileNetworkServiceConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMobileNetworkService.DataAzurermMobileNetworkServiceTimeouts,
}
```
