...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermmobilenetworkservice"
...
&dataazurermmobilenetworkservice.DataAzurermMobileNetworkServiceConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermMobileNetworkService.DataAzurermMobileNetworkServiceTimeouts,
}
```
