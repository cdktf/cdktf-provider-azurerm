...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/synapsefirewallrule"
...
&synapsefirewallrule.SynapseFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.synapseFirewallRule.SynapseFirewallRuleTimeouts,
}
```
