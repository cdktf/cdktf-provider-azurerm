...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/synapsefirewallrule"
...
| <code><a href="#@cdktf/provider-azurerm.synapseFirewallRule.SynapseFirewallRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&synapsefirewallrule.SynapseFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.synapseFirewallRule.SynapseFirewallRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.synapseFirewallRule.SynapseFirewallRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
