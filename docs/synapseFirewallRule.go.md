...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/synapsefirewallrule"
...
&synapsefirewallrule.SynapseFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.synapseFirewallRule.SynapseFirewallRuleTimeouts,
}
```
