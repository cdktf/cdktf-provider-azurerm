...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapsefirewallrule"
...
&synapsefirewallrule.SynapseFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseFirewallRule.SynapseFirewallRuleTimeouts,
}
```
