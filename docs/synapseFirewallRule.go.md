...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/synapsefirewallrule"
...
&synapsefirewallrule.SynapseFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.synapseFirewallRule.SynapseFirewallRuleTimeouts,
}
```
