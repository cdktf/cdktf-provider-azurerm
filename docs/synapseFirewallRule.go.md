...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/synapsefirewallrule"
...
&synapsefirewallrule.SynapseFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.synapseFirewallRule.SynapseFirewallRuleTimeouts,
}
```
