...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmssqlserver"
...
&dataazurermmssqlserver.DataAzurermMssqlServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMssqlServer.DataAzurermMssqlServerTimeouts,
}
```
