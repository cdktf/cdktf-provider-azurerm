...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermmssqlserver"
...
&dataazurermmssqlserver.DataAzurermMssqlServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermMssqlServer.DataAzurermMssqlServerTimeouts,
}
```
