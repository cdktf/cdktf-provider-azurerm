...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorylinkedserviceweb"
...
&datafactorylinkedserviceweb.DataFactoryLinkedServiceWebConfig {
	...
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryLinkedServiceWeb.DataFactoryLinkedServiceWebTimeouts,
	Username: *string,
}
```
