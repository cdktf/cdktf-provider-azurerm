...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermarcmachine"
...
&dataazurermarcmachine.DataAzurermArcMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermArcMachine.DataAzurermArcMachineTimeouts,
}
```
