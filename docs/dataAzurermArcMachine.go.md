...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermarcmachine"
...
&dataazurermarcmachine.DataAzurermArcMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermArcMachine.DataAzurermArcMachineTimeouts,
}
```
