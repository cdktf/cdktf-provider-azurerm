...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/dataazurermarcmachine"
...
&dataazurermarcmachine.DataAzurermArcMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.dataAzurermArcMachine.DataAzurermArcMachineTimeouts,
}
```
