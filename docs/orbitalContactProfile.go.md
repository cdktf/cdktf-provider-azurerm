...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/orbitalcontactprofile"
...
&orbitalcontactprofile.OrbitalContactProfileConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.orbitalContactProfile.OrbitalContactProfileTimeouts,
}
```
