...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagetableentity"
...
&storagetableentity.StorageTableEntityConfig {
	...
	TableName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageTableEntity.StorageTableEntityTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageTableEntity.StorageTableEntityConfig.property.entity">Entity</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/storage_table_entity#entity StorageTableEntity#entity}. |
