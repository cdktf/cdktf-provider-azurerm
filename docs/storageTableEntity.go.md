...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/storagetableentity"
...
&storagetableentity.StorageTableEntityConfig {
	...
	TableName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.storageTableEntity.StorageTableEntityTimeouts,
}
```
