...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagetableentity"
...
&storagetableentity.StorageTableEntityConfig {
	...
	TableName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageTableEntity.StorageTableEntityTimeouts,
}
```
