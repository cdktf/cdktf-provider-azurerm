...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/streamanalyticsoutputcosmosdb"
...
&streamanalyticsoutputcosmosdb.StreamAnalyticsOutputCosmosdbConfig {
	...
	Id: *string,
	PartitionKey: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.streamAnalyticsOutputCosmosdb.StreamAnalyticsOutputCosmosdbTimeouts,
}
```
