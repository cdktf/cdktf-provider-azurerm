...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/keyvaultmanagedstorageaccount"
...
| <code><a href="#@cdktf/provider-azurerm.keyVaultManagedStorageAccount.KeyVaultManagedStorageAccount.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&keyvaultmanagedstorageaccount.KeyVaultManagedStorageAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.keyVaultManagedStorageAccount.KeyVaultManagedStorageAccountTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.keyVaultManagedStorageAccount.KeyVaultManagedStorageAccountConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.keyVaultManagedStorageAccount.KeyVaultManagedStorageAccountConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/key_vault_managed_storage_account#tags KeyVaultManagedStorageAccount#tags}. |
