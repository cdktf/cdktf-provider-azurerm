...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkmanagermanagementgroupconnection"
...
&networkmanagermanagementgroupconnection.NetworkManagerManagementGroupConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkManagerManagementGroupConnection.NetworkManagerManagementGroupConnectionTimeouts,
}
```
