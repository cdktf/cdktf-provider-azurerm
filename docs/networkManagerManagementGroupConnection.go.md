...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/networkmanagermanagementgroupconnection"
...
&networkmanagermanagementgroupconnection.NetworkManagerManagementGroupConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkManagerManagementGroupConnection.NetworkManagerManagementGroupConnectionTimeouts,
}
```
