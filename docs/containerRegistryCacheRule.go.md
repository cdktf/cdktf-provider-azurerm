...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/containerregistrycacherule"
...
&containerregistrycacherule.ContainerRegistryCacheRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.containerRegistryCacheRule.ContainerRegistryCacheRuleTimeouts,
}
```
