...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/postgresqlflexibleserverbackup"
...
&postgresqlflexibleserverbackup.PostgresqlFlexibleServerBackupConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.postgresqlFlexibleServerBackup.PostgresqlFlexibleServerBackupTimeouts,
}
```
