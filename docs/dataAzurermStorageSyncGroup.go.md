...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermstoragesyncgroup"
...
&dataazurermstoragesyncgroup.DataAzurermStorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermStorageSyncGroup.DataAzurermStorageSyncGroupTimeouts,
}
```
