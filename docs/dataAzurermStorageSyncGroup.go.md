...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermstoragesyncgroup"
...
&dataazurermstoragesyncgroup.DataAzurermStorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermStorageSyncGroup.DataAzurermStorageSyncGroupTimeouts,
}
```
