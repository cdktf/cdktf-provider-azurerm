...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermstoragesyncgroup"
...
&dataazurermstoragesyncgroup.DataAzurermStorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermStorageSyncGroup.DataAzurermStorageSyncGroupTimeouts,
}
```
