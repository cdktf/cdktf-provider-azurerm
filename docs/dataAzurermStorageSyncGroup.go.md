...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermstoragesyncgroup"
...
&dataazurermstoragesyncgroup.DataAzurermStorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermStorageSyncGroup.DataAzurermStorageSyncGroupTimeouts,
}
```
