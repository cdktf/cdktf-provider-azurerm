...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermproximityplacementgroup"
...
&dataazurermproximityplacementgroup.DataAzurermProximityPlacementGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermProximityPlacementGroup.DataAzurermProximityPlacementGroupTimeouts,
}
```
