...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappintegrationaccountmap"
...
&logicappintegrationaccountmap.LogicAppIntegrationAccountMapConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppIntegrationAccountMap.LogicAppIntegrationAccountMapTimeouts,
}
```
