...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/logicappintegrationaccountmap"
...
| <code><a href="#@cdktf/provider-azurerm.logicAppIntegrationAccountMap.LogicAppIntegrationAccountMap.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&logicappintegrationaccountmap.LogicAppIntegrationAccountMapConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.logicAppIntegrationAccountMap.LogicAppIntegrationAccountMapTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.logicAppIntegrationAccountMap.LogicAppIntegrationAccountMapConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.logicAppIntegrationAccountMap.LogicAppIntegrationAccountMapConfig.property.metadata">Metadata</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/logic_app_integration_account_map#metadata LogicAppIntegrationAccountMap#metadata}. |
