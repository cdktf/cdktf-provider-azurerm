...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/logicappintegrationaccountmap"
...
&logicappintegrationaccountmap.LogicAppIntegrationAccountMapConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logicAppIntegrationAccountMap.LogicAppIntegrationAccountMapTimeouts,
}
```
