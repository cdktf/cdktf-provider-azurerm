...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/springcloudappmysqlassociation"
...
&springcloudappmysqlassociation.SpringCloudAppMysqlAssociationConfig {
	...
	Username: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.springCloudAppMysqlAssociation.SpringCloudAppMysqlAssociationTimeouts,
}
```
