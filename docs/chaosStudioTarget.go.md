...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/chaosstudiotarget"
...
&chaosstudiotarget.ChaosStudioTargetConfig {
	...
	TargetType: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.chaosStudioTarget.ChaosStudioTargetTimeouts,
}
```
