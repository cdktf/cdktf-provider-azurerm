...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/chaosstudiotarget"
...
&chaosstudiotarget.ChaosStudioTargetConfig {
	...
	TargetType: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.chaosStudioTarget.ChaosStudioTargetTimeouts,
}
```
