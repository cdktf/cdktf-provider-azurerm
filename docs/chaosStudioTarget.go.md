...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/chaosstudiotarget"
...
&chaosstudiotarget.ChaosStudioTargetConfig {
	...
	TargetType: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.chaosStudioTarget.ChaosStudioTargetTimeouts,
}
```
