...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/appservicevirtualnetworkswiftconnection"
...
&appservicevirtualnetworkswiftconnection.AppServiceVirtualNetworkSwiftConnectionConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.appServiceVirtualNetworkSwiftConnection.AppServiceVirtualNetworkSwiftConnectionTimeouts,
}
```
