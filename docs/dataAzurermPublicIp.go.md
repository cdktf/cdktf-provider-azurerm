...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpublicip"
...
&dataazurermpublicip.DataAzurermPublicIpConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPublicIp.DataAzurermPublicIpTimeouts,
}
```
