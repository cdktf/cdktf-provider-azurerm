...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermpublicip"
...
&dataazurermpublicip.DataAzurermPublicIpConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermPublicIp.DataAzurermPublicIpTimeouts,
}
```
