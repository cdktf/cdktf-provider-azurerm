...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermkustocluster"
...
&dataazurermkustocluster.DataAzurermKustoClusterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermKustoCluster.DataAzurermKustoClusterTimeouts,
}
```
