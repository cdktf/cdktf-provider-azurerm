...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mysqlvirtualnetworkrule"
...
&mysqlvirtualnetworkrule.MysqlVirtualNetworkRuleConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlVirtualNetworkRule.MysqlVirtualNetworkRuleTimeouts,
}
```
