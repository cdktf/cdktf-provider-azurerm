...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/streamanalyticsjobschedule"
...
&streamanalyticsjobschedule.StreamAnalyticsJobScheduleConfig {
	...
	Id: *string,
	StartTime: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.streamAnalyticsJobSchedule.StreamAnalyticsJobScheduleTimeouts,
}
```
