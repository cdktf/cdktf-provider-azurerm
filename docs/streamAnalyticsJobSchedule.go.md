...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/streamanalyticsjobschedule"
...
&streamanalyticsjobschedule.StreamAnalyticsJobScheduleConfig {
	...
	Id: *string,
	StartTime: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.streamAnalyticsJobSchedule.StreamAnalyticsJobScheduleTimeouts,
}
```
