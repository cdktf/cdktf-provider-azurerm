...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/botchannelfacebook"
...
&botchannelfacebook.BotChannelFacebookConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.botChannelFacebook.BotChannelFacebookTimeouts,
}
```
