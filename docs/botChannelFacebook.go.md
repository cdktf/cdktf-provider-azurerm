...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/botchannelfacebook"
...
&botchannelfacebook.BotChannelFacebookConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.botChannelFacebook.BotChannelFacebookTimeouts,
}
```
