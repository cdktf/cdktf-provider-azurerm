...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/virtualmachinerestorepointcollection"
...
&virtualmachinerestorepointcollection.VirtualMachineRestorePointCollectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.virtualMachineRestorePointCollection.VirtualMachineRestorePointCollectionTimeouts,
}
```
