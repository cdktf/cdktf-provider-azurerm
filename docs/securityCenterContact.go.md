...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/securitycentercontact"
...
| <code><a href="#@cdktf/provider-azurerm.securityCenterContact.SecurityCenterContact.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&securitycentercontact.SecurityCenterContactConfig {
	...
	Name: *string,
	Phone: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.securityCenterContact.SecurityCenterContactTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.securityCenterContact.SecurityCenterContactConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
