...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/securitycentercontact"
...
&securitycentercontact.SecurityCenterContactConfig {
	...
	Name: *string,
	Phone: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.securityCenterContact.SecurityCenterContactTimeouts,
}
```
