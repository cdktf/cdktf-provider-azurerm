...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/managedapplicationdefinition"
...
&managedapplicationdefinition.ManagedApplicationDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.managedApplicationDefinition.ManagedApplicationDefinitionTimeouts,
}
```
