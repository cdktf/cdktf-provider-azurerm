...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/managedapplicationdefinition"
...
&managedapplicationdefinition.ManagedApplicationDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managedApplicationDefinition.ManagedApplicationDefinitionTimeouts,
}
```
