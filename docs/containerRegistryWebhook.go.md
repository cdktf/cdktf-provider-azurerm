...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/containerregistrywebhook"
...
&containerregistrywebhook.ContainerRegistryWebhookConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.containerRegistryWebhook.ContainerRegistryWebhookTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.containerRegistryWebhook.ContainerRegistryWebhookConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.62.0/docs/resources/container_registry_webhook#tags ContainerRegistryWebhook#tags}. |
