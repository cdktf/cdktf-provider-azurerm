...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/containerregistrywebhook"
...
&containerregistrywebhook.ContainerRegistryWebhookConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.containerRegistryWebhook.ContainerRegistryWebhookTimeouts,
}
```
