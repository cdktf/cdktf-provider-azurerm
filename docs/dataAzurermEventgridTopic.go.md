...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermeventgridtopic"
...
&dataazurermeventgridtopic.DataAzurermEventgridTopicConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermEventgridTopic.DataAzurermEventgridTopicTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermEventgridTopic.DataAzurermEventgridTopicConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/data-sources/eventgrid_topic#tags DataAzurermEventgridTopic#tags}. |
