...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermeventgridtopic"
...
&dataazurermeventgridtopic.DataAzurermEventgridTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermEventgridTopic.DataAzurermEventgridTopicTimeouts,
}
```
