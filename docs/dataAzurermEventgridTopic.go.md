...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/dataazurermeventgridtopic"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermEventgridTopic.DataAzurermEventgridTopic.property.tags">Tags</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.StringMap</code> | *No description.* |
...
&dataazurermeventgridtopic.DataAzurermEventgridTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.dataAzurermEventgridTopic.DataAzurermEventgridTopicTimeouts,
}
```
