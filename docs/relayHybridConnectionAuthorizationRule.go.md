...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/relayhybridconnectionauthorizationrule"
...
&relayhybridconnectionauthorizationrule.RelayHybridConnectionAuthorizationRuleConfig {
	...
	Manage: interface{},
	Send: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.relayHybridConnectionAuthorizationRule.RelayHybridConnectionAuthorizationRuleTimeouts,
}
```
