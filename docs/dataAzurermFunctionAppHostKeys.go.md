...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermfunctionapphostkeys"
...
&dataazurermfunctionapphostkeys.DataAzurermFunctionAppHostKeysConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermFunctionAppHostKeys.DataAzurermFunctionAppHostKeysTimeouts,
}
```
