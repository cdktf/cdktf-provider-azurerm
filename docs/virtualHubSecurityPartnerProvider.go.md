...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/virtualhubsecuritypartnerprovider"
...
| <code><a href="#@cdktf/provider-azurerm.virtualHubSecurityPartnerProvider.VirtualHubSecurityPartnerProvider.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&virtualhubsecuritypartnerprovider.VirtualHubSecurityPartnerProviderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.virtualHubSecurityPartnerProvider.VirtualHubSecurityPartnerProviderTimeouts,
	VirtualHubId: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.virtualHubSecurityPartnerProvider.VirtualHubSecurityPartnerProviderConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.virtualHubSecurityPartnerProvider.VirtualHubSecurityPartnerProviderConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/virtual_hub_security_partner_provider#tags VirtualHubSecurityPartnerProvider#tags}. |
