...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/maintenanceassignmentvirtualmachine"
...
&maintenanceassignmentvirtualmachine.MaintenanceAssignmentVirtualMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.maintenanceAssignmentVirtualMachine.MaintenanceAssignmentVirtualMachineTimeouts,
}
```
