...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/maintenanceassignmentvirtualmachine"
...
&maintenanceassignmentvirtualmachine.MaintenanceAssignmentVirtualMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.maintenanceAssignmentVirtualMachine.MaintenanceAssignmentVirtualMachineTimeouts,
}
```
