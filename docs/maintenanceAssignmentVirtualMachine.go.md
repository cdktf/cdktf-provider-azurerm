...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/maintenanceassignmentvirtualmachine"
...
&maintenanceassignmentvirtualmachine.MaintenanceAssignmentVirtualMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.maintenanceAssignmentVirtualMachine.MaintenanceAssignmentVirtualMachineTimeouts,
}
```
