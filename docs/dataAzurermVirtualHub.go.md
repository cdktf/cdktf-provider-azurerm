...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualhub"
...
&dataazurermvirtualhub.DataAzurermVirtualHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualHub.DataAzurermVirtualHubTimeouts,
}
```
