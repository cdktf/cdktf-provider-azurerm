...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermvirtualhub"
...
&dataazurermvirtualhub.DataAzurermVirtualHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermVirtualHub.DataAzurermVirtualHubTimeouts,
}
```
