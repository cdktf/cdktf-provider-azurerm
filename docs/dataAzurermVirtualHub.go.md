...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermvirtualhub"
...
&dataazurermvirtualhub.DataAzurermVirtualHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermVirtualHub.DataAzurermVirtualHubTimeouts,
}
```
