...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermvirtualhub"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermVirtualHub.DataAzurermVirtualHub.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermvirtualhub.DataAzurermVirtualHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermVirtualHub.DataAzurermVirtualHubTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermVirtualHub.DataAzurermVirtualHubConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
