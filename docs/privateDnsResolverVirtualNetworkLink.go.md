...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsresolvervirtualnetworklink"
...
&privatednsresolvervirtualnetworklink.PrivateDnsResolverVirtualNetworkLinkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsResolverVirtualNetworkLink.PrivateDnsResolverVirtualNetworkLinkTimeouts,
}
```
