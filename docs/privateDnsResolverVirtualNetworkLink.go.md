...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/privatednsresolvervirtualnetworklink"
...
&privatednsresolvervirtualnetworklink.PrivateDnsResolverVirtualNetworkLinkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.privateDnsResolverVirtualNetworkLink.PrivateDnsResolverVirtualNetworkLinkTimeouts,
}
```
