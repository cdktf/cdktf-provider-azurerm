...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermautomationvariableint"
...
&dataazurermautomationvariableint.DataAzurermAutomationVariableIntConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAutomationVariableInt.DataAzurermAutomationVariableIntTimeouts,
}
```
