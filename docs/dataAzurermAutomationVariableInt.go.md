...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermautomationvariableint"
...
&dataazurermautomationvariableint.DataAzurermAutomationVariableIntConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAutomationVariableInt.DataAzurermAutomationVariableIntTimeouts,
}
```
