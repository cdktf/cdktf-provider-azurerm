...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermbastionhost"
...
&dataazurermbastionhost.DataAzurermBastionHostConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermBastionHost.DataAzurermBastionHostTimeouts,
}
```
