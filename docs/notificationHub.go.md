...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/notificationhub"
...
| <code><a href="#@cdktf/provider-azurerm.notificationHub.NotificationHub.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&notificationhub.NotificationHubConfig {
	...
	ApnsCredential: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.notificationHub.NotificationHubApnsCredential,
	GcmCredential: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.notificationHub.NotificationHubGcmCredential,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.notificationHub.NotificationHubTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.notificationHub.NotificationHubConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.notificationHub.NotificationHubConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/notification_hub#tags NotificationHub#tags}. |
