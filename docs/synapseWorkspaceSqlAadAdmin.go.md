...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/synapseworkspacesqlaadadmin"
...
&synapseworkspacesqlaadadmin.SynapseWorkspaceSqlAadAdminAConfig {
	...
	TenantId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.synapseWorkspaceSqlAadAdmin.SynapseWorkspaceSqlAadAdminTimeouts,
}
```
