...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/managementgrouppolicysetdefinition"
...
&managementgrouppolicysetdefinition.ManagementGroupPolicySetDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.managementGroupPolicySetDefinition.ManagementGroupPolicySetDefinitionTimeouts,
}
```
