...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/lbrule"
...
&lbrule.LbRuleConfig {
	...
	ProbeId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.lbRule.LbRuleTimeouts,
}
```
