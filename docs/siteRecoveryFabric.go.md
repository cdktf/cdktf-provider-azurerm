...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/siterecoveryfabric"
...
&siterecoveryfabric.SiteRecoveryFabricConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.siteRecoveryFabric.SiteRecoveryFabricTimeouts,
}
```
