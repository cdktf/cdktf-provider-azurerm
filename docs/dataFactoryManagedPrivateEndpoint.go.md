...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorymanagedprivateendpoint"
...
&datafactorymanagedprivateendpoint.DataFactoryManagedPrivateEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryManagedPrivateEndpoint.DataFactoryManagedPrivateEndpointTimeouts,
}
```
