...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/networkprofile"
...
&networkprofile.NetworkProfileConfig {
	...
	ContainerNetworkInterface: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.networkProfile.NetworkProfileContainerNetworkInterface,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.networkProfile.NetworkProfileTimeouts,
}
```
