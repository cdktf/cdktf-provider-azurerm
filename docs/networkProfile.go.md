...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/networkprofile"
...
&networkprofile.NetworkProfileConfig {
	...
	ContainerNetworkInterface: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkProfile.NetworkProfileContainerNetworkInterface,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkProfile.NetworkProfileTimeouts,
}
```
