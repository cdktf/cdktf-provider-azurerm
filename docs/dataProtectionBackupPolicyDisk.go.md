...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/dataprotectionbackuppolicydisk"
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskTimeouts,
	TimeZone: *string,
}
```
