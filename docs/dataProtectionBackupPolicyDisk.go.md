...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataprotectionbackuppolicydisk"
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskTimeouts,
}
```
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskRetentionRule {
	Criteria: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskRetentionRuleCriteria,
	Duration: *string,
	Name: *string,
	Priority: *f64,
}
