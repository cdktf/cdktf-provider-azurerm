...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataprotectionbackuppolicydisk"
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDisk.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_protection_backup_policy_disk#id DataProtectionBackupPolicyDisk#id}. |
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskRetentionRule {
	Criteria: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskRetentionRuleCriteria,
	Duration: *string,
	Name: *string,
	Priority: *f64,
}
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskTimeoutsOutputReference.property.updateInput">UpdateInput</a></code> | <code>*string</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskTimeoutsOutputReference.property.update">Update</a></code> | <code>*string</code> | *No description.* |
