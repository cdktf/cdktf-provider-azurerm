...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataprotectionbackuppolicydisk"
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskTimeouts,
}
```
...
&dataprotectionbackuppolicydisk.DataProtectionBackupPolicyDiskRetentionRule {
	Criteria: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataProtectionBackupPolicyDisk.DataProtectionBackupPolicyDiskRetentionRuleCriteria,
	Duration: *string,
	Name: *string,
	Priority: *f64,
}
