...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/eventhubnamespacedisasterrecoveryconfig"
...
&eventhubnamespacedisasterrecoveryconfig.EventhubNamespaceDisasterRecoveryConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.eventhubNamespaceDisasterRecoveryConfig.EventhubNamespaceDisasterRecoveryConfigTimeouts,
}
```
