...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/eventhubnamespacedisasterrecoveryconfig"
...
&eventhubnamespacedisasterrecoveryconfig.EventhubNamespaceDisasterRecoveryConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.eventhubNamespaceDisasterRecoveryConfig.EventhubNamespaceDisasterRecoveryConfigTimeouts,
}
```
