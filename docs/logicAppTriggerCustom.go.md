...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/logicapptriggercustom"
...
&logicapptriggercustom.LogicAppTriggerCustomConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.logicAppTriggerCustom.LogicAppTriggerCustomTimeouts,
}
```
