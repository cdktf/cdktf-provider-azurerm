...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/logicapptriggercustom"
...
| <code><a href="#@cdktf/provider-azurerm.logicAppTriggerCustom.LogicAppTriggerCustom.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&logicapptriggercustom.LogicAppTriggerCustomConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logicAppTriggerCustom.LogicAppTriggerCustomTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.logicAppTriggerCustom.LogicAppTriggerCustomConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
