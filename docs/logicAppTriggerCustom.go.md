...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicapptriggercustom"
...
&logicapptriggercustom.LogicAppTriggerCustomConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppTriggerCustom.LogicAppTriggerCustomTimeouts,
}
```
