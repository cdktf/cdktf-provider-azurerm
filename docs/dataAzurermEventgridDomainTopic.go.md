...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermeventgriddomaintopic"
...
&dataazurermeventgriddomaintopic.DataAzurermEventgridDomainTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermEventgridDomainTopic.DataAzurermEventgridDomainTopicTimeouts,
}
```
