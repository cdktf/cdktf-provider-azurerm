...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/springcloudappcosmosdbassociation"
...
&springcloudappcosmosdbassociation.SpringCloudAppCosmosdbAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.springCloudAppCosmosdbAssociation.SpringCloudAppCosmosdbAssociationTimeouts,
}
```
