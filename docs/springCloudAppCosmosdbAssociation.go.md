...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/springcloudappcosmosdbassociation"
...
&springcloudappcosmosdbassociation.SpringCloudAppCosmosdbAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.springCloudAppCosmosdbAssociation.SpringCloudAppCosmosdbAssociationTimeouts,
}
```
