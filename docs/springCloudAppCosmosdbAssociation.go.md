...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudappcosmosdbassociation"
...
&springcloudappcosmosdbassociation.SpringCloudAppCosmosdbAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudAppCosmosdbAssociation.SpringCloudAppCosmosdbAssociationTimeouts,
}
```
