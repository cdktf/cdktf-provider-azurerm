...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualdesktopapplication"
...
&virtualdesktopapplication.VirtualDesktopApplicationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualDesktopApplication.VirtualDesktopApplicationTimeouts,
}
```
