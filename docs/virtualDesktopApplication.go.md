...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/virtualdesktopapplication"
...
&virtualdesktopapplication.VirtualDesktopApplicationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.virtualDesktopApplication.VirtualDesktopApplicationTimeouts,
}
```
