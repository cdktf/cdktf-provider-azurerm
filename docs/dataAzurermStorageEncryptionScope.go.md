...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermstorageencryptionscope"
...
&dataazurermstorageencryptionscope.DataAzurermStorageEncryptionScopeConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermStorageEncryptionScope.DataAzurermStorageEncryptionScopeTimeouts,
}
```
