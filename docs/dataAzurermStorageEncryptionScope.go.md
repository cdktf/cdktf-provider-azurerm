...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermstorageencryptionscope"
...
&dataazurermstorageencryptionscope.DataAzurermStorageEncryptionScopeConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermStorageEncryptionScope.DataAzurermStorageEncryptionScopeTimeouts,
}
```
