...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networksecurityrule"
...
&networksecurityrule.NetworkSecurityRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkSecurityRule.NetworkSecurityRuleTimeouts,
}
```
