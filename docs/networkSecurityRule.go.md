...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/networksecurityrule"
...
&networksecurityrule.NetworkSecurityRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.networkSecurityRule.NetworkSecurityRuleTimeouts,
}
```
