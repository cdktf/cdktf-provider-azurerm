...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/lighthouseassignment"
...
&lighthouseassignment.LighthouseAssignmentConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.lighthouseAssignment.LighthouseAssignmentTimeouts,
}
```
