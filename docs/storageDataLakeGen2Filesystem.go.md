...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagedatalakegen2filesystem"
...
&storagedatalakegen2filesystem.StorageDataLakeGen2FilesystemConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageDataLakeGen2Filesystem.StorageDataLakeGen2FilesystemTimeouts,
}
```
