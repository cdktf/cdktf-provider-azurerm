...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/subscriptionpolicyassignment"
...
&subscriptionpolicyassignment.SubscriptionPolicyAssignmentConfig {
	...
	Enforce: interface{},
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.subscriptionPolicyAssignment.SubscriptionPolicyAssignmentIdentity,
	Location: *string,
	Metadata: *string,
	NonComplianceMessage: interface{},
	NotScopes: *[]*string,
	Parameters: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.subscriptionPolicyAssignment.SubscriptionPolicyAssignmentTimeouts,
}
```
