...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/subscriptionpolicyassignment"
...
&subscriptionpolicyassignment.SubscriptionPolicyAssignmentConfig {
	...
	Enforce: interface{},
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subscriptionPolicyAssignment.SubscriptionPolicyAssignmentIdentity,
	Location: *string,
	Metadata: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subscriptionPolicyAssignment.SubscriptionPolicyAssignmentTimeouts,
}
```
