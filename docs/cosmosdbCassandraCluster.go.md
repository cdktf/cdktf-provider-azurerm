...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/cosmosdbcassandracluster"
...
&cosmosdbcassandracluster.CosmosdbCassandraClusterConfig {
	...
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.cosmosdbCassandraCluster.CosmosdbCassandraClusterIdentity,
	RepairEnabled: interface{},
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.cosmosdbCassandraCluster.CosmosdbCassandraClusterTimeouts,
	Version: *string,
}
```
