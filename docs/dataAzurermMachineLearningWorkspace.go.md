...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/dataazurermmachinelearningworkspace"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermMachineLearningWorkspace.DataAzurermMachineLearningWorkspace.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&dataazurermmachinelearningworkspace.DataAzurermMachineLearningWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.dataAzurermMachineLearningWorkspace.DataAzurermMachineLearningWorkspaceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermMachineLearningWorkspace.DataAzurermMachineLearningWorkspaceConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
