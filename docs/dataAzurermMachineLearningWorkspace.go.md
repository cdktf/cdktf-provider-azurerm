...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmachinelearningworkspace"
...
&dataazurermmachinelearningworkspace.DataAzurermMachineLearningWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMachineLearningWorkspace.DataAzurermMachineLearningWorkspaceTimeouts,
}
```
