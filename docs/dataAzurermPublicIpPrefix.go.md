...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermpublicipprefix"
...
&dataazurermpublicipprefix.DataAzurermPublicIpPrefixConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermPublicIpPrefix.DataAzurermPublicIpPrefixTimeouts,
}
```
