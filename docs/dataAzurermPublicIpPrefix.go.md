...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpublicipprefix"
...
&dataazurermpublicipprefix.DataAzurermPublicIpPrefixConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPublicIpPrefix.DataAzurermPublicIpPrefixTimeouts,
}
```
