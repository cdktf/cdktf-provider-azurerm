...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermpublicipprefix"
...
&dataazurermpublicipprefix.DataAzurermPublicIpPrefixConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermPublicIpPrefix.DataAzurermPublicIpPrefixTimeouts,
}
```
