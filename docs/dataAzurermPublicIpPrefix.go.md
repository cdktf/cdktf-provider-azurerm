...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermpublicipprefix"
...
&dataazurermpublicipprefix.DataAzurermPublicIpPrefixConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermPublicIpPrefix.DataAzurermPublicIpPrefixTimeouts,
}
```
