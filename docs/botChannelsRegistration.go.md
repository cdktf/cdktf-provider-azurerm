...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/botchannelsregistration"
...
&botchannelsregistration.BotChannelsRegistrationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.botChannelsRegistration.BotChannelsRegistrationTimeouts,
}
```
