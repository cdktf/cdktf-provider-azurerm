...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentineldataconnectorofficepowerbi"
...
&sentineldataconnectorofficepowerbi.SentinelDataConnectorOfficePowerBiConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelDataConnectorOfficePowerBi.SentinelDataConnectorOfficePowerBiTimeouts,
}
```
