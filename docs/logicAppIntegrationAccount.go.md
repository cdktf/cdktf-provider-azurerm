...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappintegrationaccount"
...
&logicappintegrationaccount.LogicAppIntegrationAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppIntegrationAccount.LogicAppIntegrationAccountTimeouts,
}
```
