...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/appservicecertificateorder"
...
&appservicecertificateorder.AppServiceCertificateOrderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.appServiceCertificateOrder.AppServiceCertificateOrderTimeouts,
	ValidityInYears: *f64,
}
```
