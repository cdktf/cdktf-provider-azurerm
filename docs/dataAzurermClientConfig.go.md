...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermclientconfig"
...
&dataazurermclientconfig.DataAzurermClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermClientConfig.DataAzurermClientConfigTimeouts,
}
```
