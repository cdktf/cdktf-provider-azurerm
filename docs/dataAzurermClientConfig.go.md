...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermclientconfig"
...
&dataazurermclientconfig.DataAzurermClientConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermClientConfig.DataAzurermClientConfigTimeouts,
}
```
