...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdnscaarecord"
...
&dataazurermdnscaarecord.DataAzurermDnsCaaRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDnsCaaRecord.DataAzurermDnsCaaRecordTimeouts,
}
```
