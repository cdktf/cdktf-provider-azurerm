...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdnscaarecord"
...
&dataazurermdnscaarecord.DataAzurermDnsCaaRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDnsCaaRecord.DataAzurermDnsCaaRecordTimeouts,
}
```
