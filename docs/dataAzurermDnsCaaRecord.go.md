...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermdnscaarecord"
...
&dataazurermdnscaarecord.DataAzurermDnsCaaRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermDnsCaaRecord.DataAzurermDnsCaaRecordTimeouts,
}
```
