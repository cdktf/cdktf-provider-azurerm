...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappactionhttp"
...
&logicappactionhttp.LogicAppActionHttpConfig {
	...
	RunAfter: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppActionHttp.LogicAppActionHttpTimeouts,
}
```
