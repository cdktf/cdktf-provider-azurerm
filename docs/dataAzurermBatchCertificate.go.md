...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermbatchcertificate"
...
&dataazurermbatchcertificate.DataAzurermBatchCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermBatchCertificate.DataAzurermBatchCertificateTimeouts,
}
```
