...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermbatchcertificate"
...
&dataazurermbatchcertificate.DataAzurermBatchCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermBatchCertificate.DataAzurermBatchCertificateTimeouts,
}
```
