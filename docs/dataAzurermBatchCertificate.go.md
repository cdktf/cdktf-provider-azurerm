...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermbatchcertificate"
...
&dataazurermbatchcertificate.DataAzurermBatchCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermBatchCertificate.DataAzurermBatchCertificateTimeouts,
}
```
