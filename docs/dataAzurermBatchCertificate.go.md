...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermbatchcertificate"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBatchCertificate.DataAzurermBatchCertificate.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermbatchcertificate.DataAzurermBatchCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermBatchCertificate.DataAzurermBatchCertificateTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBatchCertificate.DataAzurermBatchCertificateConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
