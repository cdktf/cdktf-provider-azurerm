...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/automationcertificate"
...
&automationcertificate.AutomationCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.automationCertificate.AutomationCertificateTimeouts,
}
```
