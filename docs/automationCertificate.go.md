...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationcertificate"
...
&automationcertificate.AutomationCertificateConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationCertificate.AutomationCertificateTimeouts,
}
```
