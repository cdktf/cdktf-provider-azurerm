...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermappservicecertificateorder"
...
&dataazurermappservicecertificateorder.DataAzurermAppServiceCertificateOrderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermAppServiceCertificateOrder.DataAzurermAppServiceCertificateOrderTimeouts,
}
```
