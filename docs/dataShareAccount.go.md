...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/datashareaccount"
...
| <code><a href="#@cdktf/provider-azurerm.dataShareAccount.DataShareAccount.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datashareaccount.DataShareAccountConfig {
	...
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataShareAccount.DataShareAccountIdentity,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataShareAccount.DataShareAccountTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataShareAccount.DataShareAccountConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.dataShareAccount.DataShareAccountConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/data_share_account#tags DataShareAccount#tags}. |
