...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datashareaccount"
...
&datashareaccount.DataShareAccountConfig {
	...
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataShareAccount.DataShareAccountIdentity,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataShareAccount.DataShareAccountTimeouts,
}
```
