...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentineldataconnectorazuresecuritycenter"
...
&sentineldataconnectorazuresecuritycenter.SentinelDataConnectorAzureSecurityCenterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelDataConnectorAzureSecurityCenter.SentinelDataConnectorAzureSecurityCenterTimeouts,
}
```
