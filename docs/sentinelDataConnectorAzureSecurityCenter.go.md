...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/sentineldataconnectorazuresecuritycenter"
...
&sentineldataconnectorazuresecuritycenter.SentinelDataConnectorAzureSecurityCenterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.sentinelDataConnectorAzureSecurityCenter.SentinelDataConnectorAzureSecurityCenterTimeouts,
}
```
