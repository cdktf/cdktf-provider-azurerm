...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/loadtest"
...
&loadtest.LoadTestConfig {
	...
	Description: *string,
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.loadTest.LoadTestIdentity,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.loadTest.LoadTestTimeouts,
}
```
