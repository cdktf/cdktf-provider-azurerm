...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/integrationserviceenvironment"
...
&integrationserviceenvironment.IntegrationServiceEnvironmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.integrationServiceEnvironment.IntegrationServiceEnvironmentTimeouts,
}
```
