...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentineldataconnectorazureactivedirectory"
...
&sentineldataconnectorazureactivedirectory.SentinelDataConnectorAzureActiveDirectoryConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelDataConnectorAzureActiveDirectory.SentinelDataConnectorAzureActiveDirectoryTimeouts,
}
```
