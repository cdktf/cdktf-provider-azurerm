...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementlogger"
...
&apimanagementlogger.ApiManagementLoggerConfig {
	...
	ApplicationInsights: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementLogger.ApiManagementLoggerApplicationInsights,
	Buffered: interface{},
	Description: *string,
	Eventhub: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementLogger.ApiManagementLoggerEventhub,
	Id: *string,
	ResourceId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementLogger.ApiManagementLoggerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementLogger.ApiManagementLoggerConfig.property.buffered">Buffered</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.55.0/docs/resources/api_management_logger#buffered ApiManagementLogger#buffered}. |
