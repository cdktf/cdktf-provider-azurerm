...
```typescript
public readonly timeoutsInput: CosmosdbMongoUserDefinitionTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.cosmosdbMongoUserDefinition.CosmosdbMongoUserDefinitionTimeouts">CosmosdbMongoUserDefinitionTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: CosmosdbMongoUserDefinitionTimeouts | IResolvable;
```
