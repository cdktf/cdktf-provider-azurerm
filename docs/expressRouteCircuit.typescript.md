...
```typescript
public resetRateLimitingEnabled(): void
```
...
| <code><a href="#@cdktf/provider-azurerm.expressRouteCircuit.ExpressRouteCircuit.property.rateLimitingEnabledInput">rateLimitingEnabledInput</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.expressRouteCircuit.ExpressRouteCircuit.property.rateLimitingEnabled">rateLimitingEnabled</a></code> | <code>boolean \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly rateLimitingEnabledInput: boolean | IResolvable;
```
...
```typescript
public readonly rateLimitingEnabled: boolean | IResolvable;
```
...
| <code><a href="#@cdktf/provider-azurerm.expressRouteCircuit.ExpressRouteCircuitConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.55.0/docs/resources/express_route_circuit#tags ExpressRouteCircuit#tags}. |
