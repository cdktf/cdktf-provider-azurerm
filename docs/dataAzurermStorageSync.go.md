...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermstoragesync"
...
&dataazurermstoragesync.DataAzurermStorageSyncConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermStorageSync.DataAzurermStorageSyncTimeouts,
}
```
