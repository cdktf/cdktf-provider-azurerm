...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermstoragesync"
...
&dataazurermstoragesync.DataAzurermStorageSyncConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermStorageSync.DataAzurermStorageSyncTimeouts,
}
```
