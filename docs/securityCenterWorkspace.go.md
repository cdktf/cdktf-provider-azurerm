...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/securitycenterworkspace"
...
&securitycenterworkspace.SecurityCenterWorkspaceConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.securityCenterWorkspace.SecurityCenterWorkspaceTimeouts,
}
```
