...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/securitycenterworkspace"
...
&securitycenterworkspace.SecurityCenterWorkspaceConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.securityCenterWorkspace.SecurityCenterWorkspaceTimeouts,
}
```
