...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mariadbconfiguration"
...
&mariadbconfiguration.MariadbConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mariadbConfiguration.MariadbConfigurationTimeouts,
}
```
