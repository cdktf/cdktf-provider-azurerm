...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/machinelearningdatastoreblobstorage"
...
&machinelearningdatastoreblobstorage.MachineLearningDatastoreBlobstorageConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.machineLearningDatastoreBlobstorage.MachineLearningDatastoreBlobstorageTimeouts,
}
```
