...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/botchannelsms"
...
&botchannelsms.BotChannelSmsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.botChannelSms.BotChannelSmsTimeouts,
}
```
