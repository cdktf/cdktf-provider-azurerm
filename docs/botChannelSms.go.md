...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchannelsms"
...
&botchannelsms.BotChannelSmsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelSms.BotChannelSmsTimeouts,
}
```
