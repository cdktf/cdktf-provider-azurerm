...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/iothubfallbackroute"
...
&iothubfallbackroute.IothubFallbackRouteAConfig {
	...
	Id: *string,
	Source: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.iothubFallbackRoute.IothubFallbackRouteTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iothubFallbackRoute.IothubFallbackRouteAConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/iothub_fallback_route#enabled IothubFallbackRouteA#enabled}. |
