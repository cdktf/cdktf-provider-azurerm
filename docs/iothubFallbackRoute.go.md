...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/iothubfallbackroute"
...
| <code><a href="#@cdktf/provider-azurerm.iothubFallbackRoute.IothubFallbackRouteA.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&iothubfallbackroute.IothubFallbackRouteAConfig {
	...
	Id: *string,
	Source: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.iothubFallbackRoute.IothubFallbackRouteTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iothubFallbackRoute.IothubFallbackRouteAConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.iothubFallbackRoute.IothubFallbackRouteAConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/iothub_fallback_route#enabled IothubFallbackRouteA#enabled}. |
