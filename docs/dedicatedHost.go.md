...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dedicatedhost"
...
&dedicatedhost.DedicatedHostConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dedicatedHost.DedicatedHostTimeouts,
}
```
