...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationcredential"
...
&automationcredential.AutomationCredentialConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationCredential.AutomationCredentialTimeouts,
}
```
