...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/resourcegrouptemplatedeployment"
...
&resourcegrouptemplatedeployment.ResourceGroupTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.resourceGroupTemplateDeployment.ResourceGroupTemplateDeploymentTimeouts,
}
```
