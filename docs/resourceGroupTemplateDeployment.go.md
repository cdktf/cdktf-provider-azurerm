...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/resourcegrouptemplatedeployment"
...
&resourcegrouptemplatedeployment.ResourceGroupTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.resourceGroupTemplateDeployment.ResourceGroupTemplateDeploymentTimeouts,
}
```
