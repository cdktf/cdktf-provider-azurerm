...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/resourcegrouptemplatedeployment"
...
&resourcegrouptemplatedeployment.ResourceGroupTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.resourceGroupTemplateDeployment.ResourceGroupTemplateDeploymentTimeouts,
}
```
