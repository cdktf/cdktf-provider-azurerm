...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/resourcegrouptemplatedeployment"
...
&resourcegrouptemplatedeployment.ResourceGroupTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourceGroupTemplateDeployment.ResourceGroupTemplateDeploymentTimeouts,
}
```
