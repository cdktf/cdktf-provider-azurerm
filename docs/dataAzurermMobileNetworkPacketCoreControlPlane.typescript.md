...
dataAzurermMobileNetworkPacketCoreControlPlane.DataAzurermMobileNetworkPacketCoreControlPlane.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
```typescript
public readonly timeoutsInput: IResolvable | DataAzurermMobileNetworkPacketCoreControlPlaneTimeouts;
```
...
```typescript
public readonly internalValue: IResolvable | DataAzurermMobileNetworkPacketCoreControlPlaneTimeouts;
```
