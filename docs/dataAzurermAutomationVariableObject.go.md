...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermautomationvariableobject"
...
&dataazurermautomationvariableobject.DataAzurermAutomationVariableObjectConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAutomationVariableObject.DataAzurermAutomationVariableObjectTimeouts,
}
```
