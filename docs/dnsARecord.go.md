...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dnsARecord.DnsARecordTimeouts,
}
```
