...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dnsARecord.DnsARecordTimeouts,
}
```
