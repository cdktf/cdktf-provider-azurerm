...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dnsarecord"
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dnsARecord.DnsARecordTimeouts,
}
```
