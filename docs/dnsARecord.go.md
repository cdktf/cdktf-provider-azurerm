...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dnsarecord"
...
| <code><a href="#@cdktf/provider-azurerm.dnsARecord.DnsARecord.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dnsarecord.DnsARecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dnsARecord.DnsARecordTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dnsARecord.DnsARecordConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.dnsARecord.DnsARecordConfig.property.ttl">Ttl</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dns_a_record#ttl DnsARecord#ttl}. |
...
| <code><a href="#@cdktf/provider-azurerm.dnsARecord.DnsARecordConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dns_a_record#tags DnsARecord#tags}. |
