...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubcertificate"
...
&iothubcertificate.IothubCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubCertificate.IothubCertificateTimeouts,
}
```
