...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sqlvirtualnetworkrule"
...
&sqlvirtualnetworkrule.SqlVirtualNetworkRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlVirtualNetworkRule.SqlVirtualNetworkRuleTimeouts,
}
```
