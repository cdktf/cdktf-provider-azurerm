...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dedicatedhostgroup"
...
&dedicatedhostgroup.DedicatedHostGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dedicatedHostGroup.DedicatedHostGroupTimeouts,
	Zone: *string,
}
```
