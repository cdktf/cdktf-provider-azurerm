...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementapipolicy"
...
&apimanagementapipolicy.ApiManagementApiPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementApiPolicy.ApiManagementApiPolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
