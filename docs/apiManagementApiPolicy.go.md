...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementapipolicy"
...
&apimanagementapipolicy.ApiManagementApiPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementApiPolicy.ApiManagementApiPolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
