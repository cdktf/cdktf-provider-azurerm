...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementapipolicy"
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementApiPolicy.ApiManagementApiPolicy.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&apimanagementapipolicy.ApiManagementApiPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementApiPolicy.ApiManagementApiPolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementApiPolicy.ApiManagementApiPolicyConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
