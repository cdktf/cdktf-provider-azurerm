...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermeventhub"
...
&dataazurermeventhub.DataAzurermEventhubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermEventhub.DataAzurermEventhubTimeouts,
}
```
