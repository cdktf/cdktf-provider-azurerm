...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storagesyncgroup"
...
&storagesyncgroup.StorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageSyncGroup.StorageSyncGroupTimeouts,
}
```
