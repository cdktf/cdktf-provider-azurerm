...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/storagesyncgroup"
...
&storagesyncgroup.StorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.storageSyncGroup.StorageSyncGroupTimeouts,
}
```
