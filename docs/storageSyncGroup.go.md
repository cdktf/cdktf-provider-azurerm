...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/storagesyncgroup"
...
&storagesyncgroup.StorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.storageSyncGroup.StorageSyncGroupTimeouts,
}
```
