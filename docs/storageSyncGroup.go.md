...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/storagesyncgroup"
...
&storagesyncgroup.StorageSyncGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.storageSyncGroup.StorageSyncGroupTimeouts,
}
```
