...
```typescript
public resetStorageShareId(): void
```
...
```typescript
public resetStorageShareUrl(): void
```
...
```typescript
public readonly storageShareUrlInput: string;
```
...
```typescript
public readonly storageShareUrl: string;
```
