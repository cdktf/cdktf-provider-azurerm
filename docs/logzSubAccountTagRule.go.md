...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logzsubaccounttagrule"
...
&logzsubaccounttagrule.LogzSubAccountTagRuleConfig {
	...
	TagFilter: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logzSubAccountTagRule.LogzSubAccountTagRuleTimeouts,
}
```
