...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/marketplaceagreement"
...
&marketplaceagreement.MarketplaceAgreementConfig {
	...
	Publisher: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.marketplaceAgreement.MarketplaceAgreementTimeouts,
}
```
