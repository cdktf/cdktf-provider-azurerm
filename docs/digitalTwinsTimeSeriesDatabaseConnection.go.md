...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/digitaltwinstimeseriesdatabaseconnection"
...
&digitaltwinstimeseriesdatabaseconnection.DigitalTwinsTimeSeriesDatabaseConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.digitalTwinsTimeSeriesDatabaseConnection.DigitalTwinsTimeSeriesDatabaseConnectionTimeouts,
}
```
