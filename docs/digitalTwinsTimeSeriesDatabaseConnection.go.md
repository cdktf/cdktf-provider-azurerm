...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/digitaltwinstimeseriesdatabaseconnection"
...
&digitaltwinstimeseriesdatabaseconnection.DigitalTwinsTimeSeriesDatabaseConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.digitalTwinsTimeSeriesDatabaseConnection.DigitalTwinsTimeSeriesDatabaseConnectionTimeouts,
}
```
