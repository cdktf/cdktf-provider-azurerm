...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/digitaltwinstimeseriesdatabaseconnection"
...
&digitaltwinstimeseriesdatabaseconnection.DigitalTwinsTimeSeriesDatabaseConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.digitalTwinsTimeSeriesDatabaseConnection.DigitalTwinsTimeSeriesDatabaseConnectionTimeouts,
}
```
