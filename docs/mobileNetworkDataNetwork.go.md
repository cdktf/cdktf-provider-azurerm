...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mobilenetworkdatanetwork"
...
&mobilenetworkdatanetwork.MobileNetworkDataNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mobileNetworkDataNetwork.MobileNetworkDataNetworkTimeouts,
}
```
