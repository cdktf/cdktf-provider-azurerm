...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mobilenetworkdatanetwork"
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkDataNetwork.MobileNetworkDataNetwork.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&mobilenetworkdatanetwork.MobileNetworkDataNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mobileNetworkDataNetwork.MobileNetworkDataNetworkTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkDataNetwork.MobileNetworkDataNetworkConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkDataNetwork.MobileNetworkDataNetworkConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/mobile_network_data_network#tags MobileNetworkDataNetwork#tags}. |
