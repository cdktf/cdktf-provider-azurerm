...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mobilenetworkdatanetwork"
...
&mobilenetworkdatanetwork.MobileNetworkDataNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mobileNetworkDataNetwork.MobileNetworkDataNetworkTimeouts,
}
```
