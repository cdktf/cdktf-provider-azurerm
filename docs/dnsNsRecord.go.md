...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dnsnsrecord"
...
&dnsnsrecord.DnsNsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dnsNsRecord.DnsNsRecordTimeouts,
}
```
