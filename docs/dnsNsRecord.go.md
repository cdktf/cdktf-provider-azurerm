...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dnsnsrecord"
...
&dnsnsrecord.DnsNsRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dnsNsRecord.DnsNsRecordTimeouts,
}
```
