...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/fabriccapacity"
...
&fabriccapacity.FabricCapacityConfig {
	...
	Sku: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.fabricCapacity.FabricCapacitySku,
	AdministrationMembers: *[]*string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.fabricCapacity.FabricCapacityTimeouts,
}
```
