...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/fabriccapacity"
...
&fabriccapacity.FabricCapacityConfig {
	...
	Sku: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.fabricCapacity.FabricCapacitySku,
	AdministrationMembers: *[]*string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.fabricCapacity.FabricCapacityTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.fabricCapacity.FabricCapacityConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.23.0/docs/resources/fabric_capacity#tags FabricCapacity#tags}. |
