...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/managementgroup"
...
&managementgroup.ManagementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.managementGroup.ManagementGroupTimeouts,
}
```
