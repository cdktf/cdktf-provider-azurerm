...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/managementgroup"
...
&managementgroup.ManagementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.managementGroup.ManagementGroupTimeouts,
}
```
