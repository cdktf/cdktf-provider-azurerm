...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/managementgroup"
...
&managementgroup.ManagementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.managementGroup.ManagementGroupTimeouts,
}
```
