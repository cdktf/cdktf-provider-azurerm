...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/managementgroup"
...
&managementgroup.ManagementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.managementGroup.ManagementGroupTimeouts,
}
```
