...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/managementgroup"
...
&managementgroup.ManagementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managementGroup.ManagementGroupTimeouts,
}
```
