...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/serviceplan"
...
&serviceplan.ServicePlanConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.servicePlan.ServicePlanTimeouts,
	WorkerCount: *f64,
