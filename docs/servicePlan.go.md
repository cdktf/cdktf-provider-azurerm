...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/serviceplan"
...
&serviceplan.ServicePlanConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.servicePlan.ServicePlanTimeouts,
	WorkerCount: *f64,
