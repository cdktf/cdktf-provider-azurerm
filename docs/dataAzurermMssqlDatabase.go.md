...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermmssqldatabase"
...
&dataazurermmssqldatabase.DataAzurermMssqlDatabaseConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermMssqlDatabase.DataAzurermMssqlDatabaseTimeouts,
}
```
