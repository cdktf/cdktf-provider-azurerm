...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmssqldatabase"
...
&dataazurermmssqldatabase.DataAzurermMssqlDatabaseConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMssqlDatabase.DataAzurermMssqlDatabaseTimeouts,
}
```
