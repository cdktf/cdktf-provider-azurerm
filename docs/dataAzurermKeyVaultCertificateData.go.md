...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermkeyvaultcertificatedata"
...
&dataazurermkeyvaultcertificatedata.DataAzurermKeyVaultCertificateDataConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermKeyVaultCertificateData.DataAzurermKeyVaultCertificateDataTimeouts,
	Version: *string,
}
```
