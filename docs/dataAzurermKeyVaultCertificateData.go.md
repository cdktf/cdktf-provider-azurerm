...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkeyvaultcertificatedata"
...
&dataazurermkeyvaultcertificatedata.DataAzurermKeyVaultCertificateDataConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKeyVaultCertificateData.DataAzurermKeyVaultCertificateDataTimeouts,
	Version: *string,
}
```
