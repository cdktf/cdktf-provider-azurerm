...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementrediscache"
...
&apimanagementrediscache.ApiManagementRedisCacheConfig {
	...
	Id: *string,
	RedisCacheId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementRedisCache.ApiManagementRedisCacheTimeouts,
}
```
