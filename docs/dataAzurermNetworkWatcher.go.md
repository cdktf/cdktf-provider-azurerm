...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetworkwatcher"
...
&dataazurermnetworkwatcher.DataAzurermNetworkWatcherConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetworkWatcher.DataAzurermNetworkWatcherTimeouts,
}
```
