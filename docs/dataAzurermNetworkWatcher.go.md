...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermnetworkwatcher"
...
&dataazurermnetworkwatcher.DataAzurermNetworkWatcherConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermNetworkWatcher.DataAzurermNetworkWatcherTimeouts,
}
```
