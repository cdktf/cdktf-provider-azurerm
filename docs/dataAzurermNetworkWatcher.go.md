...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermnetworkwatcher"
...
&dataazurermnetworkwatcher.DataAzurermNetworkWatcherConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermNetworkWatcher.DataAzurermNetworkWatcherTimeouts,
}
```
