...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermprivatednsresolver"
...
&dataazurermprivatednsresolver.DataAzurermPrivateDnsResolverConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermPrivateDnsResolver.DataAzurermPrivateDnsResolverTimeouts,
}
```
