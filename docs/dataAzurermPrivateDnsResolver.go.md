...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermprivatednsresolver"
...
&dataazurermprivatednsresolver.DataAzurermPrivateDnsResolverConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPrivateDnsResolver.DataAzurermPrivateDnsResolverTimeouts,
}
```
