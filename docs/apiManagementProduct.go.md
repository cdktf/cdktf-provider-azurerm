...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementproduct"
...
&apimanagementproduct.ApiManagementProductConfig {
	...
	Terms: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementProduct.ApiManagementProductTimeouts,
}
```
