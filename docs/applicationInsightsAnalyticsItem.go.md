...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/applicationinsightsanalyticsitem"
...
&applicationinsightsanalyticsitem.ApplicationInsightsAnalyticsItemConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.applicationInsightsAnalyticsItem.ApplicationInsightsAnalyticsItemTimeouts,
}
```
