...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementpolicy"
...
&apimanagementpolicy.ApiManagementPolicyAConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementPolicy.ApiManagementPolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
