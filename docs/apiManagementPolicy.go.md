...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementpolicy"
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementPolicy.ApiManagementPolicyA.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&apimanagementpolicy.ApiManagementPolicyAConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementPolicy.ApiManagementPolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.apiManagementPolicy.ApiManagementPolicyAConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
