...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementpolicy"
...
&apimanagementpolicy.ApiManagementPolicyAConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementPolicy.ApiManagementPolicyTimeouts,
	XmlContent: *string,
	XmlLink: *string,
}
```
