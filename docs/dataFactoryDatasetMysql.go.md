...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorydatasetmysql"
...
&datafactorydatasetmysql.DataFactoryDatasetMysqlConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryDatasetMysql.DataFactoryDatasetMysqlTimeouts,
}
```
