...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/tenanttemplatedeployment"
...
&tenanttemplatedeployment.TenantTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.tenantTemplateDeployment.TenantTemplateDeploymentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.tenantTemplateDeployment.TenantTemplateDeploymentConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.107.0/docs/resources/tenant_template_deployment#tags TenantTemplateDeployment#tags}. |
