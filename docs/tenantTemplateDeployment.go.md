...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/tenanttemplatedeployment"
...
&tenanttemplatedeployment.TenantTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.tenantTemplateDeployment.TenantTemplateDeploymentTimeouts,
}
```
