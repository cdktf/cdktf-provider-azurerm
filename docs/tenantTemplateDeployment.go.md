...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/tenanttemplatedeployment"
...
&tenanttemplatedeployment.TenantTemplateDeploymentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.tenantTemplateDeployment.TenantTemplateDeploymentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.tenantTemplateDeployment.TenantTemplateDeploymentConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.57.0/docs/resources/tenant_template_deployment#tags TenantTemplateDeployment#tags}. |
