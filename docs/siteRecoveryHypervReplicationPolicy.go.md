...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/siterecoveryhypervreplicationpolicy"
...
&siterecoveryhypervreplicationpolicy.SiteRecoveryHypervReplicationPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.siteRecoveryHypervReplicationPolicy.SiteRecoveryHypervReplicationPolicyTimeouts,
}
```
