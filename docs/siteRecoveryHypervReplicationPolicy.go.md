...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/siterecoveryhypervreplicationpolicy"
...
&siterecoveryhypervreplicationpolicy.SiteRecoveryHypervReplicationPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.siteRecoveryHypervReplicationPolicy.SiteRecoveryHypervReplicationPolicyTimeouts,
}
```
