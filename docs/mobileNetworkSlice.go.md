...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/mobilenetworkslice"
...
```go
func ResetSingleNetworkSliceSelectionAssistanceInformation()
```
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSlice.MobileNetworkSlice.property.sliceServiceTypeInput">SliceServiceTypeInput</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSlice.MobileNetworkSlice.property.sliceServiceType">SliceServiceType</a></code> | <code>*f64</code> | *No description.* |
...
&mobilenetworkslice.MobileNetworkSliceConfig {
	...
	Description: *string,
	Id: *string,
	SingleNetworkSliceSelectionAssistanceInformation: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.mobileNetworkSlice.MobileNetworkSliceSingleNetworkSliceSelectionAssistanceInformation,
	SliceDifferentiator: *string,
	SliceServiceType: *f64,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.mobileNetworkSlice.MobileNetworkSliceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSlice.MobileNetworkSliceConfig.property.sliceServiceType">SliceServiceType</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.47.0/docs/resources/mobile_network_slice#slice_service_type MobileNetworkSlice#slice_service_type}. |
| <code><a href="#@cdktf/provider-azurerm.mobileNetworkSlice.MobileNetworkSliceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.47.0/docs/resources/mobile_network_slice#tags MobileNetworkSlice#tags}. |
