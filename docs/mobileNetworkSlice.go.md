...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mobilenetworkslice"
...
&mobilenetworkslice.MobileNetworkSliceConfig {
	...
	Name: *string,
	SingleNetworkSliceSelectionAssistanceInformation: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mobileNetworkSlice.MobileNetworkSliceSingleNetworkSliceSelectionAssistanceInformation,
	Description: *string,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mobileNetworkSlice.MobileNetworkSliceTimeouts,
}
```
