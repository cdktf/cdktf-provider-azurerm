...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/routetable"
...
&routetable.RouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.routeTable.RouteTableTimeouts,
}
```
