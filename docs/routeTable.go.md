...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/routetable"
...
&routetable.RouteTableConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.routeTable.RouteTableTimeouts,
}
```
