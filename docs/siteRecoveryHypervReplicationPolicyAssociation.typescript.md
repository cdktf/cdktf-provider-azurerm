...
```typescript
public readonly timeoutsInput: SiteRecoveryHypervReplicationPolicyAssociationTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.siteRecoveryHypervReplicationPolicyAssociation.SiteRecoveryHypervReplicationPolicyAssociationTimeouts">SiteRecoveryHypervReplicationPolicyAssociationTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: SiteRecoveryHypervReplicationPolicyAssociationTimeouts | IResolvable;
```
