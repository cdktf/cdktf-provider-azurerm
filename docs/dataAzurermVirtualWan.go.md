...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualwan"
...
&dataazurermvirtualwan.DataAzurermVirtualWanConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualWan.DataAzurermVirtualWanTimeouts,
}
```
