...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/notificationhubnamespace"
...
&notificationhubnamespace.NotificationHubNamespaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.notificationHubNamespace.NotificationHubNamespaceTimeouts,
}
```
