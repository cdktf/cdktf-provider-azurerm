...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdnsarecord"
...
&dataazurermdnsarecord.DataAzurermDnsARecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDnsARecord.DataAzurermDnsARecordTimeouts,
}
```
