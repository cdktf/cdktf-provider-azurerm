...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermservicebusqueue"
...
&dataazurermservicebusqueue.DataAzurermServicebusQueueConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermServicebusQueue.DataAzurermServicebusQueueTimeouts,
}
```
