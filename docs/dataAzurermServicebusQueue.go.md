...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermservicebusqueue"
...
&dataazurermservicebusqueue.DataAzurermServicebusQueueConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermServicebusQueue.DataAzurermServicebusQueueTimeouts,
}
```
