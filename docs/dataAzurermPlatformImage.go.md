...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermplatformimage"
...
&dataazurermplatformimage.DataAzurermPlatformImageConfig {
	...
	Sku: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermPlatformImage.DataAzurermPlatformImageTimeouts,
	Version: *string,
}
```
