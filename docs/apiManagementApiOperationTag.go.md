...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementapioperationtag"
...
&apimanagementapioperationtag.ApiManagementApiOperationTagConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementApiOperationTag.ApiManagementApiOperationTagTimeouts,
}
```
