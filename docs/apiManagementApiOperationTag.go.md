...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementapioperationtag"
...
&apimanagementapioperationtag.ApiManagementApiOperationTagConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementApiOperationTag.ApiManagementApiOperationTagTimeouts,
}
```
