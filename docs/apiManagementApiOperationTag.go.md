...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementapioperationtag"
...
&apimanagementapioperationtag.ApiManagementApiOperationTagConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementApiOperationTag.ApiManagementApiOperationTagTimeouts,
}
```
