...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementapioperationtag"
...
&apimanagementapioperationtag.ApiManagementApiOperationTagConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementApiOperationTag.ApiManagementApiOperationTagTimeouts,
}
```
