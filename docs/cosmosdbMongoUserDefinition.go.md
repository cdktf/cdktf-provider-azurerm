...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbmongouserdefinition"
...
&cosmosdbmongouserdefinition.CosmosdbMongoUserDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbMongoUserDefinition.CosmosdbMongoUserDefinitionTimeouts,
}
```
