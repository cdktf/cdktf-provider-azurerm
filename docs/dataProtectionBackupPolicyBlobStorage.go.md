...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataprotectionbackuppolicyblobstorage"
...
&dataprotectionbackuppolicyblobstorage.DataProtectionBackupPolicyBlobStorageConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorageTimeouts,
}
```
