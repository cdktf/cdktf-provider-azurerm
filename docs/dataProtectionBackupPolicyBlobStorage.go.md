...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataprotectionbackuppolicyblobstorage"
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorage.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataprotectionbackuppolicyblobstorage.DataProtectionBackupPolicyBlobStorageConfig {
	...
	VaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorageTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataProtectionBackupPolicyBlobStorage.DataProtectionBackupPolicyBlobStorageConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
