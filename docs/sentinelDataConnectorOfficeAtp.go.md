...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/sentineldataconnectorofficeatp"
...
| <code><a href="#@cdktf/provider-azurerm.sentinelDataConnectorOfficeAtp.SentinelDataConnectorOfficeAtp.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&sentineldataconnectorofficeatp.SentinelDataConnectorOfficeAtpConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.sentinelDataConnectorOfficeAtp.SentinelDataConnectorOfficeAtpTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.sentinelDataConnectorOfficeAtp.SentinelDataConnectorOfficeAtpConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
