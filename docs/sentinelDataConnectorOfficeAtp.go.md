...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentineldataconnectorofficeatp"
...
&sentineldataconnectorofficeatp.SentinelDataConnectorOfficeAtpConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelDataConnectorOfficeAtp.SentinelDataConnectorOfficeAtpTimeouts,
}
```
