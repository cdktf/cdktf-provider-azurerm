...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/sentineldataconnectorofficeatp"
...
&sentineldataconnectorofficeatp.SentinelDataConnectorOfficeAtpConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.sentinelDataConnectorOfficeAtp.SentinelDataConnectorOfficeAtpTimeouts,
}
```
