...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sentineldataconnectorofficeatp"
...
&sentineldataconnectorofficeatp.SentinelDataConnectorOfficeAtpConfig {
	...
	Id: *string,
	TenantId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sentinelDataConnectorOfficeAtp.SentinelDataConnectorOfficeAtpTimeouts,
}
```
