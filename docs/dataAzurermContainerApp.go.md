...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcontainerapp"
...
&dataazurermcontainerapp.DataAzurermContainerAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermContainerApp.DataAzurermContainerAppTimeouts,
}
```
