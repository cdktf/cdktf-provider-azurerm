...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermcontainerapp"
...
&dataazurermcontainerapp.DataAzurermContainerAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermContainerApp.DataAzurermContainerAppTimeouts,
}
```
