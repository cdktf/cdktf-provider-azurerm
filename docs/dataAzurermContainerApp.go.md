...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermcontainerapp"
...
&dataazurermcontainerapp.DataAzurermContainerAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermContainerApp.DataAzurermContainerAppTimeouts,
}
```
