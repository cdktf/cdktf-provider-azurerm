...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/galleryapplication"
...
&galleryapplication.GalleryApplicationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.galleryApplication.GalleryApplicationTimeouts,
}
```
