...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/sentinelwatchlist"
...
&sentinelwatchlist.SentinelWatchlistConfig {
	...
	Id: *string,
	Labels: *[]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.sentinelWatchlist.SentinelWatchlistTimeouts,
}
```
