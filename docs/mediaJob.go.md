...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mediajob"
...
&mediajob.MediaJobConfig {
	...
	InputAsset: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mediaJob.MediaJobInputAsset,
	...
	Id: *string,
	Priority: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mediaJob.MediaJobTimeouts,
}
```
