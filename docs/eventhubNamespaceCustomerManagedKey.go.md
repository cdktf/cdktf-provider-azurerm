...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/eventhubnamespacecustomermanagedkey"
...
&eventhubnamespacecustomermanagedkey.EventhubNamespaceCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.eventhubNamespaceCustomerManagedKey.EventhubNamespaceCustomerManagedKeyTimeouts,
}
```
