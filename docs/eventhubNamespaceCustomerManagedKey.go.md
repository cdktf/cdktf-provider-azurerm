...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/eventhubnamespacecustomermanagedkey"
...
&eventhubnamespacecustomermanagedkey.EventhubNamespaceCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.eventhubNamespaceCustomerManagedKey.EventhubNamespaceCustomerManagedKeyTimeouts,
}
```
