...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/eventhubnamespacecustomermanagedkey"
...
&eventhubnamespacecustomermanagedkey.EventhubNamespaceCustomerManagedKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.eventhubNamespaceCustomerManagedKey.EventhubNamespaceCustomerManagedKeyTimeouts,
}
```
