...
```typescript
public readonly timeoutsInput: IResolvable | DataAzurermApplicationGatewayTimeouts;
```

- *Type:* cdktf.IResolvable | <a href="#@cdktf/provider-azurerm.dataAzurermApplicationGateway.DataAzurermApplicationGatewayTimeouts">DataAzurermApplicationGatewayTimeouts</a>
...
```typescript
public readonly internalValue: IResolvable | DataAzurermApplicationGatewayTimeouts;
```
