...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/subnetnatgatewayassociation"
...
&subnetnatgatewayassociation.SubnetNatGatewayAssociationConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subnetNatGatewayAssociation.SubnetNatGatewayAssociationTimeouts,
}
```
