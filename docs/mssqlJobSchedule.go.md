...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/mssqljobschedule"
...
&mssqljobschedule.MssqlJobScheduleConfig {
	...
	Interval: *string,
	StartTime: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.mssqlJobSchedule.MssqlJobScheduleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mssqlJobSchedule.MssqlJobScheduleConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.16.0/docs/resources/mssql_job_schedule#enabled MssqlJobSchedule#enabled}. |
