...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/iothubendpointstoragecontainer"
...
&iothubendpointstoragecontainer.IothubEndpointStorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.iothubEndpointStorageContainer.IothubEndpointStorageContainerTimeouts,
}
```
