...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/iothubendpointstoragecontainer"
...
&iothubendpointstoragecontainer.IothubEndpointStorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.iothubEndpointStorageContainer.IothubEndpointStorageContainerTimeouts,
}
```
