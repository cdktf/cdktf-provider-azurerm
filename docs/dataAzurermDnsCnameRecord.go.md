...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdnscnamerecord"
...
&dataazurermdnscnamerecord.DataAzurermDnsCnameRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDnsCnameRecord.DataAzurermDnsCnameRecordTimeouts,
}
```
