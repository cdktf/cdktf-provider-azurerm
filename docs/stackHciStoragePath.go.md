...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/stackhcistoragepath"
...
&stackhcistoragepath.StackHciStoragePathConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.stackHciStoragePath.StackHciStoragePathTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.stackHciStoragePath.StackHciStoragePathConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/stack_hci_storage_path#tags StackHciStoragePath#tags}. |
