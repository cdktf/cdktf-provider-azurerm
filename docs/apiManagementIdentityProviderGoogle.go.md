...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementidentityprovidergoogle"
...
&apimanagementidentityprovidergoogle.ApiManagementIdentityProviderGoogleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementIdentityProviderGoogle.ApiManagementIdentityProviderGoogleTimeouts,
}
```
