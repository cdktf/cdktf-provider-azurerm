...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementidentityprovidergoogle"
...
&apimanagementidentityprovidergoogle.ApiManagementIdentityProviderGoogleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementIdentityProviderGoogle.ApiManagementIdentityProviderGoogleTimeouts,
}
```
