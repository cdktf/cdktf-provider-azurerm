...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/expressrouteport"
...
&expressrouteport.ExpressRoutePortConfig {
	...
	BillingType: *string,
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.expressRoutePort.ExpressRoutePortIdentity,
	Link1: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.expressRoutePort.ExpressRoutePortLink1,
	Link2: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.expressRoutePort.ExpressRoutePortLink2,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.expressRoutePort.ExpressRoutePortTimeouts,
}
```
