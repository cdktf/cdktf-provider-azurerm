...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/datafactorydatasetpostgresql"
...
&datafactorydatasetpostgresql.DataFactoryDatasetPostgresqlConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataFactoryDatasetPostgresql.DataFactoryDatasetPostgresqlTimeouts,
}
```
