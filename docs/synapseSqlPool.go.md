...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapsesqlpool"
...
&synapsesqlpool.SynapseSqlPoolConfig {
	...
	Restore: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseSqlPool.SynapseSqlPoolRestore,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapseSqlPool.SynapseSqlPoolTimeouts,
}
```
