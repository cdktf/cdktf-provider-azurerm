...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/lighthousedefinition"
...
| <code><a href="#@cdktf/provider-azurerm.lighthouseDefinition.LighthouseDefinition.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&lighthousedefinition.LighthouseDefinitionConfig {
	...
	Plan: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.lighthouseDefinition.LighthouseDefinitionPlan,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.lighthouseDefinition.LighthouseDefinitionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.lighthouseDefinition.LighthouseDefinitionConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&lighthousedefinition.LighthouseDefinitionEligibleAuthorization {
	PrincipalId: *string,
	RoleDefinitionId: *string,
	JustInTimeAccessPolicy: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.lighthouseDefinition.LighthouseDefinitionEligibleAuthorizationJustInTimeAccessPolicy,
	PrincipalDisplayName: *string,
}
```
