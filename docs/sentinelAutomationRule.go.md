...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentinelautomationrule"
...
&sentinelautomationrule.SentinelAutomationRuleConfig {
	...
	Expiration: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelAutomationRule.SentinelAutomationRuleTimeouts,
	TriggersOn: *string,
	TriggersWhen: *string,
}
```
