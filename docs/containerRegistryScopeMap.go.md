...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/containerregistryscopemap"
...
&containerregistryscopemap.ContainerRegistryScopeMapConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.containerRegistryScopeMap.ContainerRegistryScopeMapTimeouts,
}
```
