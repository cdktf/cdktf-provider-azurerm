...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermappservice"
...
&dataazurermappservice.DataAzurermAppServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAppService.DataAzurermAppServiceTimeouts,
}
```
