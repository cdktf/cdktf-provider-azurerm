...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermappservice"
...
&dataazurermappservice.DataAzurermAppServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAppService.DataAzurermAppServiceTimeouts,
}
```
