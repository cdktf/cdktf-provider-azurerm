...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermappservice"
...
&dataazurermappservice.DataAzurermAppServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAppService.DataAzurermAppServiceTimeouts,
}
```
