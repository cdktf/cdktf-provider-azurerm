...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermappservice"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermAppService.DataAzurermAppService.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermappservice.DataAzurermAppServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermAppService.DataAzurermAppServiceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermAppService.DataAzurermAppServiceConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
