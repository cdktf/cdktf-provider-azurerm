...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/machinelearningworkspacenetworkoutboundruleprivateendpoint"
...
&machinelearningworkspacenetworkoutboundruleprivateendpoint.MachineLearningWorkspaceNetworkOutboundRulePrivateEndpointConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.machineLearningWorkspaceNetworkOutboundRulePrivateEndpoint.MachineLearningWorkspaceNetworkOutboundRulePrivateEndpointTimeouts,
}
```
