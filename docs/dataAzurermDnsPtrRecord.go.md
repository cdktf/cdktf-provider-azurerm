...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdnsptrrecord"
...
&dataazurermdnsptrrecord.DataAzurermDnsPtrRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDnsPtrRecord.DataAzurermDnsPtrRecordTimeouts,
}
```
