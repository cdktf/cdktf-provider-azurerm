...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermdnsptrrecord"
...
&dataazurermdnsptrrecord.DataAzurermDnsPtrRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermDnsPtrRecord.DataAzurermDnsPtrRecordTimeouts,
}
```
