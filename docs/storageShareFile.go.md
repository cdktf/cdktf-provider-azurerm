...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/storagesharefile"
...
&storagesharefile.StorageShareFileConfig {
	...
	Path: *string,
	Source: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.storageShareFile.StorageShareFileTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageShareFile.StorageShareFileConfig.property.metadata">Metadata</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.38.0/docs/resources/storage_share_file#metadata StorageShareFile#metadata}. |
