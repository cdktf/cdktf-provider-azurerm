...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagesharefile"
...
&storagesharefile.StorageShareFileConfig {
	...
	Path: *string,
	Source: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageShareFile.StorageShareFileTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageShareFile.StorageShareFileConfig.property.metadata">Metadata</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.62.0/docs/resources/storage_share_file#metadata StorageShareFile#metadata}. |
