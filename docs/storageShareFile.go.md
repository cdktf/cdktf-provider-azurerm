...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/storagesharefile"
...
&storagesharefile.StorageShareFileConfig {
	...
	Path: *string,
	Source: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.storageShareFile.StorageShareFileTimeouts,
}
```
