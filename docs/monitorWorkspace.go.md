...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/monitorworkspace"
...
&monitorworkspace.MonitorWorkspaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.monitorWorkspace.MonitorWorkspaceTimeouts,
}
```
