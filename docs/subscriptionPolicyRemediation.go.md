...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/subscriptionpolicyremediation"
...
&subscriptionpolicyremediation.SubscriptionPolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subscriptionPolicyRemediation.SubscriptionPolicyRemediationTimeouts,
}
```
