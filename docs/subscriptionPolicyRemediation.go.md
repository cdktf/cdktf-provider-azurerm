...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/subscriptionpolicyremediation"
...
&subscriptionpolicyremediation.SubscriptionPolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.subscriptionPolicyRemediation.SubscriptionPolicyRemediationTimeouts,
}
```
