...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/subscriptionpolicyremediation"
...
&subscriptionpolicyremediation.SubscriptionPolicyRemediationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.subscriptionPolicyRemediation.SubscriptionPolicyRemediationTimeouts,
}
```
