...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sqlelasticpool"
...
&sqlelasticpool.SqlElasticpoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sqlElasticpool.SqlElasticpoolTimeouts,
}
```
