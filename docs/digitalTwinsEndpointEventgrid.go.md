...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/digitaltwinsendpointeventgrid"
...
&digitaltwinsendpointeventgrid.DigitalTwinsEndpointEventgridConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.digitalTwinsEndpointEventgrid.DigitalTwinsEndpointEventgridTimeouts,
}
```
