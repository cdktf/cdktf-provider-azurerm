...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetappsnapshotpolicy"
...
&dataazurermnetappsnapshotpolicy.DataAzurermNetappSnapshotPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetappSnapshotPolicy.DataAzurermNetappSnapshotPolicyTimeouts,
}
```
