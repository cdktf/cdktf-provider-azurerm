...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datasharedatasetkustodatabase"
...
&datasharedatasetkustodatabase.DataShareDatasetKustoDatabaseConfig {
	...
	ShareId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataShareDatasetKustoDatabase.DataShareDatasetKustoDatabaseTimeouts,
}
```
