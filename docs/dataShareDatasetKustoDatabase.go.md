...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/datasharedatasetkustodatabase"
...
&datasharedatasetkustodatabase.DataShareDatasetKustoDatabaseConfig {
	...
	ShareId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataShareDatasetKustoDatabase.DataShareDatasetKustoDatabaseTimeouts,
}
```
