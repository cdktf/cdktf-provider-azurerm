...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/datasharedatasetkustodatabase"
...
&datasharedatasetkustodatabase.DataShareDatasetKustoDatabaseConfig {
	...
	ShareId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataShareDatasetKustoDatabase.DataShareDatasetKustoDatabaseTimeouts,
}
```
