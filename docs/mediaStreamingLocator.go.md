...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mediastreaminglocator"
...
&mediastreaminglocator.MediaStreamingLocatorConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mediaStreamingLocator.MediaStreamingLocatorTimeouts,
}
```
