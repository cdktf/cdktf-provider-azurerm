...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mediastreaminglocator"
...
&mediastreaminglocator.MediaStreamingLocatorConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mediaStreamingLocator.MediaStreamingLocatorTimeouts,
}
```
