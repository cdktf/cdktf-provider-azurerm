...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermapplicationgateway"
...
&dataazurermapplicationgateway.DataAzurermApplicationGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermApplicationGateway.DataAzurermApplicationGatewayTimeouts,
}
```
