...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermapplicationgateway"
...
&dataazurermapplicationgateway.DataAzurermApplicationGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermApplicationGateway.DataAzurermApplicationGatewayTimeouts,
}
```
