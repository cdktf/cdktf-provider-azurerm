...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapplicationgateway"
...
&dataazurermapplicationgateway.DataAzurermApplicationGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApplicationGateway.DataAzurermApplicationGatewayTimeouts,
}
```
