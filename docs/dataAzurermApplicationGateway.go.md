...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermapplicationgateway"
...
&dataazurermapplicationgateway.DataAzurermApplicationGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermApplicationGateway.DataAzurermApplicationGatewayTimeouts,
}
```
