...
| <code><a href="#@cdktf/provider-azurerm.graphAccount.GraphAccountConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.81.0/docs/resources/graph_account#tags GraphAccount#tags}. |
