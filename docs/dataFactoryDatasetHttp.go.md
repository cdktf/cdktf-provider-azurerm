...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorydatasethttp"
...
&datafactorydatasethttp.DataFactoryDatasetHttpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryDatasetHttp.DataFactoryDatasetHttpTimeouts,
}
```
