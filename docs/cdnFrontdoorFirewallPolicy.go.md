...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/cdnfrontdoorfirewallpolicy"
...
&cdnfrontdoorfirewallpolicy.CdnFrontdoorFirewallPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.cdnFrontdoorFirewallPolicy.CdnFrontdoorFirewallPolicyTimeouts,
}
```
