...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/diskencryptionset"
...
&diskencryptionset.DiskEncryptionSetConfig {
	...
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.diskEncryptionSet.DiskEncryptionSetIdentity,
	Location: *string,
	Name: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.diskEncryptionSet.DiskEncryptionSetTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.diskEncryptionSet.DiskEncryptionSetConfig.property.autoKeyRotationEnabled">AutoKeyRotationEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/disk_encryption_set#auto_key_rotation_enabled DiskEncryptionSet#auto_key_rotation_enabled}. |
...
| <code><a href="#@cdktf/provider-azurerm.diskEncryptionSet.DiskEncryptionSetConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/disk_encryption_set#tags DiskEncryptionSet#tags}. |
