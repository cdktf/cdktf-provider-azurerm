...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/streamanalyticsmanagedprivateendpoint"
...
&streamanalyticsmanagedprivateendpoint.StreamAnalyticsManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.streamAnalyticsManagedPrivateEndpoint.StreamAnalyticsManagedPrivateEndpointTimeouts,
}
```
