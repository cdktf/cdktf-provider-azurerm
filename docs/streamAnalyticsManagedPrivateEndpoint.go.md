...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/streamanalyticsmanagedprivateendpoint"
...
&streamanalyticsmanagedprivateendpoint.StreamAnalyticsManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.streamAnalyticsManagedPrivateEndpoint.StreamAnalyticsManagedPrivateEndpointTimeouts,
}
```
