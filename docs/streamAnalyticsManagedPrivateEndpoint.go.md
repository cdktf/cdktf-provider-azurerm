...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/streamanalyticsmanagedprivateendpoint"
...
&streamanalyticsmanagedprivateendpoint.StreamAnalyticsManagedPrivateEndpointConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.streamAnalyticsManagedPrivateEndpoint.StreamAnalyticsManagedPrivateEndpointTimeouts,
}
```
