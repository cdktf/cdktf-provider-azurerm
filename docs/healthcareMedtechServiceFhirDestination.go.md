...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/healthcaremedtechservicefhirdestination"
...
&healthcaremedtechservicefhirdestination.HealthcareMedtechServiceFhirDestinationConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.healthcareMedtechServiceFhirDestination.HealthcareMedtechServiceFhirDestinationTimeouts,
}
```
