...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/synapseworkspacekey"
...
&synapseworkspacekey.SynapseWorkspaceKeyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.synapseWorkspaceKey.SynapseWorkspaceKeyTimeouts,
}
```
