...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/applicationinsightsworkbooktemplate"
...
&applicationinsightsworkbooktemplate.ApplicationInsightsWorkbookTemplateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.applicationInsightsWorkbookTemplate.ApplicationInsightsWorkbookTemplateTimeouts,
}
```
