...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/devcenternetworkconnection"
...
&devcenternetworkconnection.DevCenterNetworkConnectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.devCenterNetworkConnection.DevCenterNetworkConnectionTimeouts,
}
```
