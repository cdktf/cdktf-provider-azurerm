...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermoracleresourceanchor"
...
&dataazurermoracleresourceanchor.DataAzurermOracleResourceAnchorConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermOracleResourceAnchor.DataAzurermOracleResourceAnchorTimeouts,
}
```
