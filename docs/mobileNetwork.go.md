...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mobilenetwork"
...
&mobilenetwork.MobileNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mobileNetwork.MobileNetworkTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mobileNetwork.MobileNetworkConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.65.0/docs/resources/mobile_network#tags MobileNetwork#tags}. |
