...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mobilenetwork"
...
&mobilenetwork.MobileNetworkConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mobileNetwork.MobileNetworkTimeouts,
}
```
