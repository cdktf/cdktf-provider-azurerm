...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbsqlroleassignment"
...
&cosmosdbsqlroleassignment.CosmosdbSqlRoleAssignmentConfig {
	...
	Id: *string,
	Name: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbSqlRoleAssignment.CosmosdbSqlRoleAssignmentTimeouts,
}
```
