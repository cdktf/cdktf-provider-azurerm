...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/vmwareexpressrouteauthorization"
...
| <code><a href="#@cdktf/provider-azurerm.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorization.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&vmwareexpressrouteauthorization.VmwareExpressRouteAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorizationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorizationConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
