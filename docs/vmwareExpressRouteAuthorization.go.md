...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/vmwareexpressrouteauthorization"
...
&vmwareexpressrouteauthorization.VmwareExpressRouteAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorizationTimeouts,
}
```
