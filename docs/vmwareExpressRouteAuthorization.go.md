...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/vmwareexpressrouteauthorization"
...
&vmwareexpressrouteauthorization.VmwareExpressRouteAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorizationTimeouts,
}
```
