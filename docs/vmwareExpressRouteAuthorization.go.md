...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/vmwareexpressrouteauthorization"
...
&vmwareexpressrouteauthorization.VmwareExpressRouteAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorizationTimeouts,
}
```
