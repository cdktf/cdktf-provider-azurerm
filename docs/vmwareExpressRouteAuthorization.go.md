...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/vmwareexpressrouteauthorization"
...
&vmwareexpressrouteauthorization.VmwareExpressRouteAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.vmwareExpressRouteAuthorization.VmwareExpressRouteAuthorizationTimeouts,
}
```
