...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/routeserver"
...
&routeserver.RouteServerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.routeServer.RouteServerTimeouts,
}
```
