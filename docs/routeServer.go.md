...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/routeserver"
...
&routeserver.RouteServerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.routeServer.RouteServerTimeouts,
}
```
