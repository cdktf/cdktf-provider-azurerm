...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/routeserver"
...
&routeserver.RouteServerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.routeServer.RouteServerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.routeServer.RouteServerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.55.0/docs/resources/route_server#tags RouteServer#tags}. |
