...
postgresqlActiveDirectoryAdministrator.PostgresqlActiveDirectoryAdministrator.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
```typescript
public readonly timeoutsInput: IResolvable | PostgresqlActiveDirectoryAdministratorTimeouts;
```
...
```typescript
public readonly internalValue: IResolvable | PostgresqlActiveDirectoryAdministratorTimeouts;
```
