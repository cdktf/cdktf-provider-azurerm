...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/diskaccess"
...
&diskaccess.DiskAccessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.diskAccess.DiskAccessTimeouts,
}
```
