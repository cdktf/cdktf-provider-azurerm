...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/diskaccess"
...
| <code><a href="#@cdktf/provider-azurerm.diskAccess.DiskAccess.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&diskaccess.DiskAccessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.diskAccess.DiskAccessTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.diskAccess.DiskAccessConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.diskAccess.DiskAccessConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/disk_access#tags DiskAccess#tags}. |
