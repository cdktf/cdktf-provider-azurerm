...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/networkmanageripampoolstaticcidr"
...
&networkmanageripampoolstaticcidr.NetworkManagerIpamPoolStaticCidrConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.networkManagerIpamPoolStaticCidr.NetworkManagerIpamPoolStaticCidrTimeouts,
}
```
