...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/iothubenrichment"
...
&iothubenrichment.IothubEnrichmentAConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.iothubEnrichment.IothubEnrichmentTimeouts,
}
```
