...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubenrichment"
...
&iothubenrichment.IothubEnrichmentAConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubEnrichment.IothubEnrichmentTimeouts,
}
```
