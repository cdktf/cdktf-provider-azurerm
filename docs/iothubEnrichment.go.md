...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/iothubenrichment"
...
| <code><a href="#@cdktf/provider-azurerm.iothubEnrichment.IothubEnrichmentA.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&iothubenrichment.IothubEnrichmentAConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.iothubEnrichment.IothubEnrichmentTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iothubEnrichment.IothubEnrichmentAConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
