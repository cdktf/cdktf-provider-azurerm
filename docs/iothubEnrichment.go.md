...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/iothubenrichment"
...
&iothubenrichment.IothubEnrichmentAConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.iothubEnrichment.IothubEnrichmentTimeouts,
}
```
