...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermspringcloudservice"
...
&dataazurermspringcloudservice.DataAzurermSpringCloudServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermSpringCloudService.DataAzurermSpringCloudServiceTimeouts,
}
```
