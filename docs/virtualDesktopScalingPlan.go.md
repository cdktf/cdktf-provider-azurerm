...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/virtualdesktopscalingplan"
...
&virtualdesktopscalingplan.VirtualDesktopScalingPlanConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.virtualDesktopScalingPlan.VirtualDesktopScalingPlanTimeouts,
}
```
