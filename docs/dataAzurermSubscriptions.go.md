...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsubscriptions"
...
&dataazurermsubscriptions.DataAzurermSubscriptionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSubscriptions.DataAzurermSubscriptionsTimeouts,
}
```
