...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsubscriptions"
...
&dataazurermsubscriptions.DataAzurermSubscriptionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSubscriptions.DataAzurermSubscriptionsTimeouts,
}
```
