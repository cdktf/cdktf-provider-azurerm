...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermservicebustopic"
...
&dataazurermservicebustopic.DataAzurermServicebusTopicConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermServicebusTopic.DataAzurermServicebusTopicTimeouts,
}
```
