...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermservicebustopic"
...
&dataazurermservicebustopic.DataAzurermServicebusTopicConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermServicebusTopic.DataAzurermServicebusTopicTimeouts,
}
```
