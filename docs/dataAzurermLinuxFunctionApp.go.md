...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermlinuxfunctionapp"
...
&dataazurermlinuxfunctionapp.DataAzurermLinuxFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermLinuxFunctionApp.DataAzurermLinuxFunctionAppTimeouts,
}
```
