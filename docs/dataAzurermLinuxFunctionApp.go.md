...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermlinuxfunctionapp"
...
&dataazurermlinuxfunctionapp.DataAzurermLinuxFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermLinuxFunctionApp.DataAzurermLinuxFunctionAppTimeouts,
}
```
