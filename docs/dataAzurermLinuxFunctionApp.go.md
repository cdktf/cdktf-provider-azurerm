...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermlinuxfunctionapp"
...
&dataazurermlinuxfunctionapp.DataAzurermLinuxFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermLinuxFunctionApp.DataAzurermLinuxFunctionAppTimeouts,
}
```
