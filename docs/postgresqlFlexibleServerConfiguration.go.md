...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/postgresqlflexibleserverconfiguration"
...
| <code><a href="#@cdktf/provider-azurerm.postgresqlFlexibleServerConfiguration.PostgresqlFlexibleServerConfiguration.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&postgresqlflexibleserverconfiguration.PostgresqlFlexibleServerConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.postgresqlFlexibleServerConfiguration.PostgresqlFlexibleServerConfigurationTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.postgresqlFlexibleServerConfiguration.PostgresqlFlexibleServerConfigurationConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
