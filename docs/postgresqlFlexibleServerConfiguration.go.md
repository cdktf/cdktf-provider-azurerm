...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/postgresqlflexibleserverconfiguration"
...
&postgresqlflexibleserverconfiguration.PostgresqlFlexibleServerConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.postgresqlFlexibleServerConfiguration.PostgresqlFlexibleServerConfigurationTimeouts,
}
```
