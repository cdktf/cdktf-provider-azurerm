...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/networkmanageripampool"
...
&networkmanageripampool.NetworkManagerIpamPoolConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.networkManagerIpamPool.NetworkManagerIpamPoolTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.networkManagerIpamPool.NetworkManagerIpamPoolConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.25.0/docs/resources/network_manager_ipam_pool#tags NetworkManagerIpamPool#tags}. |
