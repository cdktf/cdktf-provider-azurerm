...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/relaynamespace"
...
&relaynamespace.RelayNamespaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.relayNamespace.RelayNamespaceTimeouts,
}
```
