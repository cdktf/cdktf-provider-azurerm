...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/relaynamespace"
...
&relaynamespace.RelayNamespaceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.relayNamespace.RelayNamespaceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.relayNamespace.RelayNamespaceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.65.0/docs/resources/relay_namespace#tags RelayNamespace#tags}. |
