...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/expressrouteportauthorization"
...
&expressrouteportauthorization.ExpressRoutePortAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.expressRoutePortAuthorization.ExpressRoutePortAuthorizationTimeouts,
}
```
