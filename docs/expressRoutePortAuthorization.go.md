...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/expressrouteportauthorization"
...
&expressrouteportauthorization.ExpressRoutePortAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.expressRoutePortAuthorization.ExpressRoutePortAuthorizationTimeouts,
}
```
