...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/expressrouteportauthorization"
...
&expressrouteportauthorization.ExpressRoutePortAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.expressRoutePortAuthorization.ExpressRoutePortAuthorizationTimeouts,
}
```
