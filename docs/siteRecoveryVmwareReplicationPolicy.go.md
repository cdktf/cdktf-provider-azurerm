...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/siterecoveryvmwarereplicationpolicy"
...
&siterecoveryvmwarereplicationpolicy.SiteRecoveryVmwareReplicationPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.siteRecoveryVmwareReplicationPolicy.SiteRecoveryVmwareReplicationPolicyTimeouts,
}
```
