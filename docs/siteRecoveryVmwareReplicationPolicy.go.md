...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/siterecoveryvmwarereplicationpolicy"
...
&siterecoveryvmwarereplicationpolicy.SiteRecoveryVmwareReplicationPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.siteRecoveryVmwareReplicationPolicy.SiteRecoveryVmwareReplicationPolicyTimeouts,
}
```
