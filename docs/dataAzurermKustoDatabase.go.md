...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkustodatabase"
...
&dataazurermkustodatabase.DataAzurermKustoDatabaseConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKustoDatabase.DataAzurermKustoDatabaseTimeouts,
}
```
