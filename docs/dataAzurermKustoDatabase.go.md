...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermkustodatabase"
...
&dataazurermkustodatabase.DataAzurermKustoDatabaseConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermKustoDatabase.DataAzurermKustoDatabaseTimeouts,
}
```
