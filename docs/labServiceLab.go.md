...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/labservicelab"
...
&labservicelab.LabServiceLabConfig {
	...
	Security: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabSecurity,
	Title: *string,
	VirtualMachine: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabVirtualMachine,
	AutoShutdown: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabAutoShutdown,
	ConnectionSetting: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabConnectionSetting,
	Description: *string,
	Id: *string,
	LabPlanId: *string,
	Network: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabNetwork,
	Roster: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabRoster,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.labServiceLab.LabServiceLabConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/lab_service_lab#tags LabServiceLab#tags}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azurerm.labServiceLab.LabServiceLabSecurity.property.openAccessEnabled">OpenAccessEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/lab_service_lab#open_access_enabled LabServiceLab#open_access_enabled}. |
...
&labservicelab.LabServiceLabVirtualMachine {
	AdminUser: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabVirtualMachineAdminUser,
	ImageReference: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabVirtualMachineImageReference,
	Sku: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabVirtualMachineSku,
	AdditionalCapabilityGpuDriversInstalled: interface{},
	CreateOption: *string,
	NonAdminUser: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.labServiceLab.LabServiceLabVirtualMachineNonAdminUser,
...
| <code><a href="#@cdktf/provider-azurerm.labServiceLab.LabServiceLabVirtualMachine.property.additionalCapabilityGpuDriversInstalled">AdditionalCapabilityGpuDriversInstalled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/lab_service_lab#additional_capability_gpu_drivers_installed LabServiceLab#additional_capability_gpu_drivers_installed}. |
...
| <code><a href="#@cdktf/provider-azurerm.labServiceLab.LabServiceLabVirtualMachine.property.sharedPasswordEnabled">SharedPasswordEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/lab_service_lab#shared_password_enabled LabServiceLab#shared_password_enabled}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azurerm.labServiceLab.LabServiceLabVirtualMachineSku.property.capacity">Capacity</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.63.0/docs/resources/lab_service_lab#capacity LabServiceLab#capacity}. |
