...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/loganalyticssavedsearch"
...
&loganalyticssavedsearch.LogAnalyticsSavedSearchConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logAnalyticsSavedSearch.LogAnalyticsSavedSearchTimeouts,
}
```
