...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/loganalyticssavedsearch"
...
&loganalyticssavedsearch.LogAnalyticsSavedSearchConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logAnalyticsSavedSearch.LogAnalyticsSavedSearchTimeouts,
}
```
