...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/diskpooliscsitarget"
...
&diskpooliscsitarget.DiskPoolIscsiTargetConfig {
	...
	Id: *string,
	TargetIqn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.diskPoolIscsiTarget.DiskPoolIscsiTargetTimeouts,
}
```
