...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/diskpooliscsitarget"
...
&diskpooliscsitarget.DiskPoolIscsiTargetConfig {
	...
	Id: *string,
	TargetIqn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.diskPoolIscsiTarget.DiskPoolIscsiTargetTimeouts,
}
```
