...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/diskpooliscsitarget"
...
&diskpooliscsitarget.DiskPoolIscsiTargetConfig {
	...
	Id: *string,
	TargetIqn: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.diskPoolIscsiTarget.DiskPoolIscsiTargetTimeouts,
}
```
