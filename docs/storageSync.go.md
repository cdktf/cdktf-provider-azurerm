...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/storagesync"
...
&storagesync.StorageSyncConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.storageSync.StorageSyncTimeouts,
}
```
