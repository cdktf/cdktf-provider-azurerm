...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagesync"
...
&storagesync.StorageSyncConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageSync.StorageSyncTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageSync.StorageSyncConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/storage_sync#tags StorageSync#tags}. |
