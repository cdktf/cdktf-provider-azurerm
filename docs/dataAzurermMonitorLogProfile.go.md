...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmonitorlogprofile"
...
&dataazurermmonitorlogprofile.DataAzurermMonitorLogProfileConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMonitorLogProfile.DataAzurermMonitorLogProfileTimeouts,
}
```
