...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/botwebapp"
...
| <code><a href="#@cdktf/provider-azurerm.botWebApp.BotWebApp.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&botwebapp.BotWebAppConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.botWebApp.BotWebAppTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.botWebApp.BotWebAppConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.botWebApp.BotWebAppConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/bot_web_app#tags BotWebApp#tags}. |
