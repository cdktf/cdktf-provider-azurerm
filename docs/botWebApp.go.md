...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/botwebapp"
...
&botwebapp.BotWebAppConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.botWebApp.BotWebAppTimeouts,
}
```
