...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermsubscription"
...
&dataazurermsubscription.DataAzurermSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermSubscription.DataAzurermSubscriptionTimeouts,
}
```
