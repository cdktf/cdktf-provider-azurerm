...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednscnamerecord"
...
&privatednscnamerecord.PrivateDnsCnameRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsCnameRecord.PrivateDnsCnameRecordTimeouts,
}
```
