...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/loganalyticsquerypackquery"
...
&loganalyticsquerypackquery.LogAnalyticsQueryPackQueryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.logAnalyticsQueryPackQuery.LogAnalyticsQueryPackQueryTimeouts,
}
```
