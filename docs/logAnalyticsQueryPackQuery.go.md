...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/loganalyticsquerypackquery"
...
&loganalyticsquerypackquery.LogAnalyticsQueryPackQueryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logAnalyticsQueryPackQuery.LogAnalyticsQueryPackQueryTimeouts,
}
```
