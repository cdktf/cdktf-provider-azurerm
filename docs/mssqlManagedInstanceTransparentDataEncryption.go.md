...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mssqlmanagedinstancetransparentdataencryption"
...
&mssqlmanagedinstancetransparentdataencryption.MssqlManagedInstanceTransparentDataEncryptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mssqlManagedInstanceTransparentDataEncryption.MssqlManagedInstanceTransparentDataEncryptionTimeouts,
}
```
