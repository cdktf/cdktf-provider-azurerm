...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mssqlmanagedinstancetransparentdataencryption"
...
&mssqlmanagedinstancetransparentdataencryption.MssqlManagedInstanceTransparentDataEncryptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mssqlManagedInstanceTransparentDataEncryption.MssqlManagedInstanceTransparentDataEncryptionTimeouts,
}
```
