...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cosmosdbsqlfunction"
...
&cosmosdbsqlfunction.CosmosdbSqlFunctionConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cosmosdbSqlFunction.CosmosdbSqlFunctionTimeouts,
}
```
