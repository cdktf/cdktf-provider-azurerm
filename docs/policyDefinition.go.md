...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/policydefinition"
...
&policydefinition.PolicyDefinitionConfig {
	...
	Parameters: *string,
	PolicyRule: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.policyDefinition.PolicyDefinitionTimeouts,
}
```
