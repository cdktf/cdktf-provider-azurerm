...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/policydefinition"
...
&policydefinition.PolicyDefinitionConfig {
	...
	Parameters: *string,
	PolicyRule: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.policyDefinition.PolicyDefinitionTimeouts,
}
```
