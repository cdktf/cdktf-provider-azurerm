...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/backupcontainerstorageaccount"
...
&backupcontainerstorageaccount.BackupContainerStorageAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.backupContainerStorageAccount.BackupContainerStorageAccountTimeouts,
}
```
