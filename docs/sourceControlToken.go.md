...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sourcecontroltoken"
...
&sourcecontroltoken.SourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sourceControlToken.SourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
