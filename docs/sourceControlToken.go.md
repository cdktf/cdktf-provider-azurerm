...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/sourcecontroltoken"
...
&sourcecontroltoken.SourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.sourceControlToken.SourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
