...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/sourcecontroltoken"
...
&sourcecontroltoken.SourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.sourceControlToken.SourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
