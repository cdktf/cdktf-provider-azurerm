...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/sourcecontroltoken"
...
&sourcecontroltoken.SourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.sourceControlToken.SourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
