...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sourcecontroltoken"
...
&sourcecontroltoken.SourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sourceControlToken.SourceControlTokenTimeouts,
	TokenSecret: *string,
}
```
