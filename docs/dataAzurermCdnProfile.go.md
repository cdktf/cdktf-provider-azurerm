...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermcdnprofile"
...
&dataazurermcdnprofile.DataAzurermCdnProfileConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermCdnProfile.DataAzurermCdnProfileTimeouts,
}
```
