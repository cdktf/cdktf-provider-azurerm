...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermcdnprofile"
...
&dataazurermcdnprofile.DataAzurermCdnProfileConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermCdnProfile.DataAzurermCdnProfileTimeouts,
}
```
