...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcdnprofile"
...
&dataazurermcdnprofile.DataAzurermCdnProfileConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermCdnProfile.DataAzurermCdnProfileTimeouts,
}
```
