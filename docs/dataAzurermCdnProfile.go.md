...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermcdnprofile"
...
&dataazurermcdnprofile.DataAzurermCdnProfileConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermCdnProfile.DataAzurermCdnProfileTimeouts,
}
```
