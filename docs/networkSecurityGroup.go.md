...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networksecuritygroup"
...
&networksecuritygroup.NetworkSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkSecurityGroup.NetworkSecurityGroupTimeouts,
}
```
