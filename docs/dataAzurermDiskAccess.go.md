...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermdiskaccess"
...
&dataazurermdiskaccess.DataAzurermDiskAccessConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermDiskAccess.DataAzurermDiskAccessTimeouts,
}
```
