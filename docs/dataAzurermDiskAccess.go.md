...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdiskaccess"
...
&dataazurermdiskaccess.DataAzurermDiskAccessConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDiskAccess.DataAzurermDiskAccessTimeouts,
}
```
