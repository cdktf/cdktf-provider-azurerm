...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/labserviceuser"
...
&labserviceuser.LabServiceUserConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.labServiceUser.LabServiceUserTimeouts,
}
```
