...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mysqlserverkey"
...
&mysqlserverkey.MysqlServerKeyConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mysqlServerKey.MysqlServerKeyTimeouts,
}
```
