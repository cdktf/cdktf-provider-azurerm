...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mysqlserverkey"
...
&mysqlserverkey.MysqlServerKeyConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mysqlServerKey.MysqlServerKeyTimeouts,
}
```
