...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustoclustercustomermanagedkey"
...
&kustoclustercustomermanagedkey.KustoClusterCustomerManagedKeyConfig {
	...
	Id: *string,
	KeyVersion: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoClusterCustomerManagedKey.KustoClusterCustomerManagedKeyTimeouts,
	UserIdentity: *string,
}
```
