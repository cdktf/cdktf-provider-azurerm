...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmssqlmanagedinstance"
...
&dataazurermmssqlmanagedinstance.DataAzurermMssqlManagedInstanceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMssqlManagedInstance.DataAzurermMssqlManagedInstanceTimeouts,
}
```
