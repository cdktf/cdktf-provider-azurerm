...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermmssqlmanagedinstance"
...
&dataazurermmssqlmanagedinstance.DataAzurermMssqlManagedInstanceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermMssqlManagedInstance.DataAzurermMssqlManagedInstanceTimeouts,
}
```
