...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmssqlmanagedinstance"
...
&dataazurermmssqlmanagedinstance.DataAzurermMssqlManagedInstanceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMssqlManagedInstance.DataAzurermMssqlManagedInstanceTimeouts,
}
```
