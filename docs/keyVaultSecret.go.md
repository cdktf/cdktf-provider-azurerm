...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/keyvaultsecret"
...
&keyvaultsecret.KeyVaultSecretConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.keyVaultSecret.KeyVaultSecretTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.keyVaultSecret.KeyVaultSecretConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.66.0/docs/resources/key_vault_secret#tags KeyVaultSecret#tags}. |
