...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermcdnfrontdoororigingroup"
...
&dataazurermcdnfrontdoororigingroup.DataAzurermCdnFrontdoorOriginGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermCdnFrontdoorOriginGroup.DataAzurermCdnFrontdoorOriginGroupTimeouts,
}
```
