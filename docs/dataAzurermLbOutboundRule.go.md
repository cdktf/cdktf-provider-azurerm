...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/dataazurermlboutboundrule"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermLbOutboundRule.DataAzurermLbOutboundRule.property.enableTcpReset">EnableTcpReset</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IResolvable</code> | *No description.* |
...
&dataazurermlboutboundrule.DataAzurermLbOutboundRuleConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.dataAzurermLbOutboundRule.DataAzurermLbOutboundRuleTimeouts,
}
```
