...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/lboutboundrule"
...
&lboutboundrule.LbOutboundRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.lbOutboundRule.LbOutboundRuleTimeouts,
}
```
