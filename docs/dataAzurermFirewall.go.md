...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermfirewall"
...
&dataazurermfirewall.DataAzurermFirewallConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermFirewall.DataAzurermFirewallTimeouts,
}
```
