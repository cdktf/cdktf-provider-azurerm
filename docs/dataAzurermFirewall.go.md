...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermfirewall"
...
&dataazurermfirewall.DataAzurermFirewallConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermFirewall.DataAzurermFirewallTimeouts,
}
```
