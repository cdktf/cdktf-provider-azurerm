...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermiothubdps"
...
&dataazurermiothubdps.DataAzurermIothubDpsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermIothubDps.DataAzurermIothubDpsTimeouts,
}
```
