...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermiothubdps"
...
&dataazurermiothubdps.DataAzurermIothubDpsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermIothubDps.DataAzurermIothubDpsTimeouts,
}
```
