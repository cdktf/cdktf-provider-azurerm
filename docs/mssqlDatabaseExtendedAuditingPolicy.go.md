...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mssqldatabaseextendedauditingpolicy"
...
&mssqldatabaseextendedauditingpolicy.MssqlDatabaseExtendedAuditingPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mssqlDatabaseExtendedAuditingPolicy.MssqlDatabaseExtendedAuditingPolicyTimeouts,
}
```
