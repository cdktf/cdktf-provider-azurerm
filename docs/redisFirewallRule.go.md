...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/redisfirewallrule"
...
| <code><a href="#@cdktf/provider-azurerm.redisFirewallRule.RedisFirewallRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&redisfirewallrule.RedisFirewallRuleConfig {
	...
	StartIp: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.redisFirewallRule.RedisFirewallRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.redisFirewallRule.RedisFirewallRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
