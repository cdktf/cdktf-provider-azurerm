...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/redisfirewallrule"
...
&redisfirewallrule.RedisFirewallRuleConfig {
	...
	StartIp: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.redisFirewallRule.RedisFirewallRuleTimeouts,
}
```
