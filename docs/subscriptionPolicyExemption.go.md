...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/subscriptionpolicyexemption"
...
&subscriptionpolicyexemption.SubscriptionPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.subscriptionPolicyExemption.SubscriptionPolicyExemptionTimeouts,
}
```
