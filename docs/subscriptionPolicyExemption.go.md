...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/subscriptionpolicyexemption"
...
&subscriptionpolicyexemption.SubscriptionPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.subscriptionPolicyExemption.SubscriptionPolicyExemptionTimeouts,
}
```
