...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/subscriptionpolicyexemption"
...
&subscriptionpolicyexemption.SubscriptionPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.subscriptionPolicyExemption.SubscriptionPolicyExemptionTimeouts,
}
```
