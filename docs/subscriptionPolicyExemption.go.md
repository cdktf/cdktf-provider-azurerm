...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/subscriptionpolicyexemption"
...
&subscriptionpolicyexemption.SubscriptionPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.subscriptionPolicyExemption.SubscriptionPolicyExemptionTimeouts,
}
```
