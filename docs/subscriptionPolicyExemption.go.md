...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/subscriptionpolicyexemption"
...
&subscriptionpolicyexemption.SubscriptionPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subscriptionPolicyExemption.SubscriptionPolicyExemptionTimeouts,
}
```
