...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorylinkedserviceazuresearch"
...
&datafactorylinkedserviceazuresearch.DataFactoryLinkedServiceAzureSearchConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryLinkedServiceAzureSearch.DataFactoryLinkedServiceAzureSearchTimeouts,
}
```
