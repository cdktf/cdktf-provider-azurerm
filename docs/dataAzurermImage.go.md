...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermimage"
...
&dataazurermimage.DataAzurermImageConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermImage.DataAzurermImageTimeouts,
}
```
