...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermimage"
...
&dataazurermimage.DataAzurermImageConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermImage.DataAzurermImageTimeouts,
}
```
