...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/hpccacheblobnfstarget"
...
&hpccacheblobnfstarget.HpcCacheBlobNfsTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.hpcCacheBlobNfsTarget.HpcCacheBlobNfsTargetTimeouts,
}
```
