...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/hpccacheblobnfstarget"
...
&hpccacheblobnfstarget.HpcCacheBlobNfsTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.hpcCacheBlobNfsTarget.HpcCacheBlobNfsTargetTimeouts,
}
```
