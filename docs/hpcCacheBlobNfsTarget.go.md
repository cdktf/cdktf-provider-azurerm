...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/hpccacheblobnfstarget"
...
&hpccacheblobnfstarget.HpcCacheBlobNfsTargetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.hpcCacheBlobNfsTarget.HpcCacheBlobNfsTargetTimeouts,
}
```
