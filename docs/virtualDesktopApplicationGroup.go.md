...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualdesktopapplicationgroup"
...
&virtualdesktopapplicationgroup.VirtualDesktopApplicationGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualDesktopApplicationGroup.VirtualDesktopApplicationGroupTimeouts,
}
```
