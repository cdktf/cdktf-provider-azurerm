...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednssrvrecord"
...
&privatednssrvrecord.PrivateDnsSrvRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsSrvRecord.PrivateDnsSrvRecordTimeouts,
}
```
