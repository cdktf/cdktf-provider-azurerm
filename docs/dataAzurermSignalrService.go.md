...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsignalrservice"
...
&dataazurermsignalrservice.DataAzurermSignalrServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSignalrService.DataAzurermSignalrServiceTimeouts,
}
```
