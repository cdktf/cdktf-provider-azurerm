...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermsignalrservice"
...
&dataazurermsignalrservice.DataAzurermSignalrServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSignalrService.DataAzurermSignalrServiceTimeouts,
}
```
