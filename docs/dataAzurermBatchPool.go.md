...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermbatchpool"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBatchPool.DataAzurermBatchPool.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermbatchpool.DataAzurermBatchPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermBatchPool.DataAzurermBatchPoolTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBatchPool.DataAzurermBatchPoolConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
