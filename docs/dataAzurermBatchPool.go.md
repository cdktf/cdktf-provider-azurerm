...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermbatchpool"
...
&dataazurermbatchpool.DataAzurermBatchPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermBatchPool.DataAzurermBatchPoolTimeouts,
}
```
