...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermbatchpool"
...
&dataazurermbatchpool.DataAzurermBatchPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermBatchPool.DataAzurermBatchPoolTimeouts,
}
```
