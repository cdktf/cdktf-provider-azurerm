...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/dataazurermbatchpool"
...
&dataazurermbatchpool.DataAzurermBatchPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.dataAzurermBatchPool.DataAzurermBatchPoolTimeouts,
}
```
