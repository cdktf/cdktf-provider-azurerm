...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagemoverproject"
...
&storagemoverproject.StorageMoverProjectConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageMoverProject.StorageMoverProjectTimeouts,
}
```
