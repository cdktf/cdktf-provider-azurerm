...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermbackuppolicyvm"
...
&dataazurermbackuppolicyvm.DataAzurermBackupPolicyVmConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermBackupPolicyVm.DataAzurermBackupPolicyVmTimeouts,
}
```
