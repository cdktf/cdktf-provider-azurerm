...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/dataazurermbackuppolicyvm"
...
&dataazurermbackuppolicyvm.DataAzurermBackupPolicyVmConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.dataAzurermBackupPolicyVm.DataAzurermBackupPolicyVmTimeouts,
}
```
