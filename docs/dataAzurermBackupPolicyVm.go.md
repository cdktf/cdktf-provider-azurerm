...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermbackuppolicyvm"
...
&dataazurermbackuppolicyvm.DataAzurermBackupPolicyVmConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermBackupPolicyVm.DataAzurermBackupPolicyVmTimeouts,
}
```
