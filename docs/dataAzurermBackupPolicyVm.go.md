...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermbackuppolicyvm"
...
&dataazurermbackuppolicyvm.DataAzurermBackupPolicyVmConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermBackupPolicyVm.DataAzurermBackupPolicyVmTimeouts,
}
```
