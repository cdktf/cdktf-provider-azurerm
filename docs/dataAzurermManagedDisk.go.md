...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmanageddisk"
...
&dataazurermmanageddisk.DataAzurermManagedDiskConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermManagedDisk.DataAzurermManagedDiskTimeouts,
}
```
