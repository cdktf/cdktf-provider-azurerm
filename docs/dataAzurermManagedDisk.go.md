...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmanageddisk"
...
&dataazurermmanageddisk.DataAzurermManagedDiskConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermManagedDisk.DataAzurermManagedDiskTimeouts,
}
```
