...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermroutefilter"
...
&dataazurermroutefilter.DataAzurermRouteFilterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermRouteFilter.DataAzurermRouteFilterTimeouts,
}
```
