...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermroutefilter"
...
&dataazurermroutefilter.DataAzurermRouteFilterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermRouteFilter.DataAzurermRouteFilterTimeouts,
}
```
