...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermroutefilter"
...
&dataazurermroutefilter.DataAzurermRouteFilterConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermRouteFilter.DataAzurermRouteFilterTimeouts,
}
```
