...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/digitaltwinsinstance"
...
&digitaltwinsinstance.DigitalTwinsInstanceConfig {
	...
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.digitalTwinsInstance.DigitalTwinsInstanceIdentity,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.digitalTwinsInstance.DigitalTwinsInstanceTimeouts,
}
```
