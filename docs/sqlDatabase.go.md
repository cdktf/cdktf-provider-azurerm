...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sqldatabase"
...
&sqldatabase.SqlDatabaseConfig {
	...
	Id: *string,
	Import: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlDatabase.SqlDatabaseImport,
	MaxSizeBytes: *string,
	MaxSizeGb: *string,
	ReadScale: interface{},
	...
	ThreatDetectionPolicy: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlDatabase.SqlDatabaseThreatDetectionPolicy,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlDatabase.SqlDatabaseTimeouts,
