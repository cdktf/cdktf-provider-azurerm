...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmonitordiagnosticcategories"
...
&dataazurermmonitordiagnosticcategories.DataAzurermMonitorDiagnosticCategoriesConfig {
	...
	ResourceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMonitorDiagnosticCategories.DataAzurermMonitorDiagnosticCategoriesTimeouts,
}
```
