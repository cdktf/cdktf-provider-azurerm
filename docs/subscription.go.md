...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/subscription"
...
&subscription.SubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subscription.SubscriptionTimeouts,
	Workload: *string,
}
```
