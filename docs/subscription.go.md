...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/subscription"
...
&subscription.SubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.subscription.SubscriptionTimeouts,
	Workload: *string,
}
```
