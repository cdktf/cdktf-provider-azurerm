...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/subscription"
...
&subscription.SubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.subscription.SubscriptionTimeouts,
	Workload: *string,
}
```
