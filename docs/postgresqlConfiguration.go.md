...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/postgresqlconfiguration"
...
&postgresqlconfiguration.PostgresqlConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.postgresqlConfiguration.PostgresqlConfigurationTimeouts,
}
```
