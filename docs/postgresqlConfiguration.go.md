...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/postgresqlconfiguration"
...
&postgresqlconfiguration.PostgresqlConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.postgresqlConfiguration.PostgresqlConfigurationTimeouts,
}
```
