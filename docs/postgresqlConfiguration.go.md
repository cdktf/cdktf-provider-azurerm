...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/postgresqlconfiguration"
...
&postgresqlconfiguration.PostgresqlConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.postgresqlConfiguration.PostgresqlConfigurationTimeouts,
}
```
