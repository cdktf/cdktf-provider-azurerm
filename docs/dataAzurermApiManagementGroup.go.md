...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermapimanagementgroup"
...
&dataazurermapimanagementgroup.DataAzurermApiManagementGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermApiManagementGroup.DataAzurermApiManagementGroupTimeouts,
}
```
