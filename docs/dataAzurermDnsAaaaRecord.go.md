...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdnsaaaarecord"
...
&dataazurermdnsaaaarecord.DataAzurermDnsAaaaRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDnsAaaaRecord.DataAzurermDnsAaaaRecordTimeouts,
}
```
