...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdnsaaaarecord"
...
&dataazurermdnsaaaarecord.DataAzurermDnsAaaaRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDnsAaaaRecord.DataAzurermDnsAaaaRecordTimeouts,
}
```
