...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/redisenterprisedatabase"
...
&redisenterprisedatabase.RedisEnterpriseDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.redisEnterpriseDatabase.RedisEnterpriseDatabaseTimeouts,
}
```
