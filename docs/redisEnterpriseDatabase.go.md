...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/redisenterprisedatabase"
...
&redisenterprisedatabase.RedisEnterpriseDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.redisEnterpriseDatabase.RedisEnterpriseDatabaseTimeouts,
}
```
