...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualhubip"
...
&virtualhubip.VirtualHubIpConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualHubIp.VirtualHubIpTimeouts,
}
```
