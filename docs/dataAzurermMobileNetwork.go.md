...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmobilenetwork"
...
&dataazurermmobilenetwork.DataAzurermMobileNetworkConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMobileNetwork.DataAzurermMobileNetworkTimeouts,
}
```
