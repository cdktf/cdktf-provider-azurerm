...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmobilenetwork"
...
&dataazurermmobilenetwork.DataAzurermMobileNetworkConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMobileNetwork.DataAzurermMobileNetworkTimeouts,
}
```
