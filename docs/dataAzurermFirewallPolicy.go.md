...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermfirewallpolicy"
...
&dataazurermfirewallpolicy.DataAzurermFirewallPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermFirewallPolicy.DataAzurermFirewallPolicyTimeouts,
}
```
