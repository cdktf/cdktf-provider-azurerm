...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermfirewallpolicy"
...
&dataazurermfirewallpolicy.DataAzurermFirewallPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermFirewallPolicy.DataAzurermFirewallPolicyTimeouts,
}
```
