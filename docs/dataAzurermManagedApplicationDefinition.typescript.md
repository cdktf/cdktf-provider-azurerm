...
dataAzurermManagedApplicationDefinition.DataAzurermManagedApplicationDefinition.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
```typescript
public readonly timeoutsInput: IResolvable | DataAzurermManagedApplicationDefinitionTimeouts;
```
...
```typescript
public readonly internalValue: IResolvable | DataAzurermManagedApplicationDefinitionTimeouts;
```
