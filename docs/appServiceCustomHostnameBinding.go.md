...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/appservicecustomhostnamebinding"
...
&appservicecustomhostnamebinding.AppServiceCustomHostnameBindingConfig {
	...
	SslState: *string,
	Thumbprint: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.appServiceCustomHostnameBinding.AppServiceCustomHostnameBindingTimeouts,
}
```
