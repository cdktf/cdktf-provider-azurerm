...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/appservicecustomhostnamebinding"
...
&appservicecustomhostnamebinding.AppServiceCustomHostnameBindingConfig {
	...
	SslState: *string,
	Thumbprint: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.appServiceCustomHostnameBinding.AppServiceCustomHostnameBindingTimeouts,
}
```
