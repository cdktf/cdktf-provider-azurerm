...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdevtestlab"
...
&dataazurermdevtestlab.DataAzurermDevTestLabConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDevTestLab.DataAzurermDevTestLabTimeouts,
}
```
