...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcdnfrontdoorfirewallpolicy"
...
&dataazurermcdnfrontdoorfirewallpolicy.DataAzurermCdnFrontdoorFirewallPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermCdnFrontdoorFirewallPolicy.DataAzurermCdnFrontdoorFirewallPolicyTimeouts,
}
```
