...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmobilenetworkslice"
...
&dataazurermmobilenetworkslice.DataAzurermMobileNetworkSliceConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMobileNetworkSlice.DataAzurermMobileNetworkSliceTimeouts,
}
```
