...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/logicappactioncustom"
...
&logicappactioncustom.LogicAppActionCustomConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logicAppActionCustom.LogicAppActionCustomTimeouts,
}
```
