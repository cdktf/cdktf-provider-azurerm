...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagemover"
...
&storagemover.StorageMoverConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageMover.StorageMoverTimeouts,
}
```
