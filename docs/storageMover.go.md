...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/storagemover"
...
&storagemover.StorageMoverConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.storageMover.StorageMoverTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageMover.StorageMoverConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/storage_mover#tags StorageMover#tags}. |
