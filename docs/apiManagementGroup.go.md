...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementgroup"
...
&apimanagementgroup.ApiManagementGroupConfig {
	...
	ExternalId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementGroup.ApiManagementGroupTimeouts,
	Type: *string,
}
```
