...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementgroup"
...
&apimanagementgroup.ApiManagementGroupConfig {
	...
	ExternalId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementGroup.ApiManagementGroupTimeouts,
	Type: *string,
}
```
