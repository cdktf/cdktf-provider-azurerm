...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementgroup"
...
&apimanagementgroup.ApiManagementGroupConfig {
	...
	ExternalId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementGroup.ApiManagementGroupTimeouts,
	Type: *string,
}
```
