...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/kustoiothubdataconnection"
...
&kustoiothubdataconnection.KustoIothubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.kustoIothubDataConnection.KustoIothubDataConnectionTimeouts,
}
```
