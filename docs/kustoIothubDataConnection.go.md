...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/kustoiothubdataconnection"
...
&kustoiothubdataconnection.KustoIothubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.kustoIothubDataConnection.KustoIothubDataConnectionTimeouts,
}
```
