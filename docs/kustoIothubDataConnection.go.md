...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustoiothubdataconnection"
...
&kustoiothubdataconnection.KustoIothubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoIothubDataConnection.KustoIothubDataConnectionTimeouts,
}
```
