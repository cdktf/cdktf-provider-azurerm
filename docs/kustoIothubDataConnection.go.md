...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/kustoiothubdataconnection"
...
&kustoiothubdataconnection.KustoIothubDataConnectionConfig {
	...
	TableName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.kustoIothubDataConnection.KustoIothubDataConnectionTimeouts,
}
```
