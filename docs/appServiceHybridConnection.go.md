...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/appservicehybridconnection"
...
&appservicehybridconnection.AppServiceHybridConnectionConfig {
	...
	Id: *string,
	SendKeyName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.appServiceHybridConnection.AppServiceHybridConnectionTimeouts,
}
```
