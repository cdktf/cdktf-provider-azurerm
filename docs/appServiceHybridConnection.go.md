...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/appservicehybridconnection"
...
&appservicehybridconnection.AppServiceHybridConnectionConfig {
	...
	Id: *string,
	SendKeyName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.appServiceHybridConnection.AppServiceHybridConnectionTimeouts,
}
```
