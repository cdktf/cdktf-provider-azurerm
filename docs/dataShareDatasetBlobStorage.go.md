...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datasharedatasetblobstorage"
...
&datasharedatasetblobstorage.DataShareDatasetBlobStorageConfig {
	...
	DataShareId: *string,
	Name: *string,
	StorageAccount: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataShareDatasetBlobStorage.DataShareDatasetBlobStorageStorageAccount,
	FilePath: *string,
	FolderPath: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataShareDatasetBlobStorage.DataShareDatasetBlobStorageTimeouts,
}
```
