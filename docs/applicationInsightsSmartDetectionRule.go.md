...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/applicationinsightssmartdetectionrule"
...
&applicationinsightssmartdetectionrule.ApplicationInsightsSmartDetectionRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.applicationInsightsSmartDetectionRule.ApplicationInsightsSmartDetectionRuleTimeouts,
}
```
