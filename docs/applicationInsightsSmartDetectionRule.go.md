...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/applicationinsightssmartdetectionrule"
...
&applicationinsightssmartdetectionrule.ApplicationInsightsSmartDetectionRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.applicationInsightsSmartDetectionRule.ApplicationInsightsSmartDetectionRuleTimeouts,
}
```
