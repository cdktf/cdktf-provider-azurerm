...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/networkwatcher"
...
&networkwatcher.NetworkWatcherConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkWatcher.NetworkWatcherTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.networkWatcher.NetworkWatcherConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/network_watcher#tags NetworkWatcher#tags}. |
