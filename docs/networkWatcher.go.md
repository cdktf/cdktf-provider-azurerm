...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkwatcher"
...
&networkwatcher.NetworkWatcherConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkWatcher.NetworkWatcherTimeouts,
}
```
