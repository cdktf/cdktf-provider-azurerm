...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/networkwatcher"
...
| <code><a href="#@cdktf/provider-azurerm.networkWatcher.NetworkWatcher.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&networkwatcher.NetworkWatcherConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.networkWatcher.NetworkWatcherTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.networkWatcher.NetworkWatcherConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.networkWatcher.NetworkWatcherConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/network_watcher#tags NetworkWatcher#tags}. |
