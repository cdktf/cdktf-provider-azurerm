...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/voiceservicescommunicationsgateway"
...
&voiceservicescommunicationsgateway.VoiceServicesCommunicationsGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.voiceServicesCommunicationsGateway.VoiceServicesCommunicationsGatewayTimeouts,
}
```
