...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/voiceservicescommunicationsgateway"
...
&voiceservicescommunicationsgateway.VoiceServicesCommunicationsGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.voiceServicesCommunicationsGateway.VoiceServicesCommunicationsGatewayTimeouts,
}
```
