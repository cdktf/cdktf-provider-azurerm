...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/voiceservicescommunicationsgateway"
...
&voiceservicescommunicationsgateway.VoiceServicesCommunicationsGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.voiceServicesCommunicationsGateway.VoiceServicesCommunicationsGatewayTimeouts,
}
```
