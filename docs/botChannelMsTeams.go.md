...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/botchannelmsteams"
...
&botchannelmsteams.BotChannelMsTeamsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.botChannelMsTeams.BotChannelMsTeamsTimeouts,
}
```
