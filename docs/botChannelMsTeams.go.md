...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchannelmsteams"
...
&botchannelmsteams.BotChannelMsTeamsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelMsTeams.BotChannelMsTeamsTimeouts,
}
```
