...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logztagrule"
...
&logztagrule.LogzTagRuleConfig {
	...
	TagFilter: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logzTagRule.LogzTagRuleTimeouts,
}
```
