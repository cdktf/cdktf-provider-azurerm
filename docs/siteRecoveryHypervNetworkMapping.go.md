...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/siterecoveryhypervnetworkmapping"
...
&siterecoveryhypervnetworkmapping.SiteRecoveryHypervNetworkMappingConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.siteRecoveryHypervNetworkMapping.SiteRecoveryHypervNetworkMappingTimeouts,
}
```
