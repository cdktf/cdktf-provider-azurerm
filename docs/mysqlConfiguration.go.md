...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/mysqlconfiguration"
...
&mysqlconfiguration.MysqlConfigurationConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.mysqlConfiguration.MysqlConfigurationTimeouts,
}
```
