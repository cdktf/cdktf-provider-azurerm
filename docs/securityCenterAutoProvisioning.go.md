...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/securitycenterautoprovisioning"
...
&securitycenterautoprovisioning.SecurityCenterAutoProvisioningConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.securityCenterAutoProvisioning.SecurityCenterAutoProvisioningTimeouts,
}
```
