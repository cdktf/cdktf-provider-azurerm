...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/securitycenterautoprovisioning"
...
&securitycenterautoprovisioning.SecurityCenterAutoProvisioningConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.securityCenterAutoProvisioning.SecurityCenterAutoProvisioningTimeouts,
}
```
