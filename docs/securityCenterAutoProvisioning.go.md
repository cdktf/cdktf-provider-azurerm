...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/securitycenterautoprovisioning"
...
&securitycenterautoprovisioning.SecurityCenterAutoProvisioningConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.securityCenterAutoProvisioning.SecurityCenterAutoProvisioningTimeouts,
}
```
