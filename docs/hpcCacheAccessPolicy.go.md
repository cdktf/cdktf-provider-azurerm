...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/hpccacheaccesspolicy"
...
&hpccacheaccesspolicy.HpcCacheAccessPolicyConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.hpcCacheAccessPolicy.HpcCacheAccessPolicyTimeouts,
}
```
