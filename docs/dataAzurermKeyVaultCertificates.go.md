...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermkeyvaultcertificates"
...
&dataazurermkeyvaultcertificates.DataAzurermKeyVaultCertificatesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermKeyVaultCertificates.DataAzurermKeyVaultCertificatesTimeouts,
}
```
