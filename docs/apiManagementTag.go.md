...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementtag"
...
&apimanagementtag.ApiManagementTagConfig {
	...
	DisplayName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementTag.ApiManagementTagTimeouts,
}
```
