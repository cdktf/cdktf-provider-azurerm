...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermkeyvaultsecrets"
...
&dataazurermkeyvaultsecrets.DataAzurermKeyVaultSecretsConfig {
	...
	KeyVaultId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermKeyVaultSecrets.DataAzurermKeyVaultSecretsTimeouts,
}
```
