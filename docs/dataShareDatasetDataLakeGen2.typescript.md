...
dataShareDatasetDataLakeGen2.DataShareDatasetDataLakeGen2.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
