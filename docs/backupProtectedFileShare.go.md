...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/backupprotectedfileshare"
...
&backupprotectedfileshare.BackupProtectedFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.backupProtectedFileShare.BackupProtectedFileShareTimeouts,
}
```
