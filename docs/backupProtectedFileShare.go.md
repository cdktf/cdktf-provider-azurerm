...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/backupprotectedfileshare"
...
&backupprotectedfileshare.BackupProtectedFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.backupProtectedFileShare.BackupProtectedFileShareTimeouts,
}
```
