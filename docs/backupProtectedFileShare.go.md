...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/backupprotectedfileshare"
...
&backupprotectedfileshare.BackupProtectedFileShareConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.backupProtectedFileShare.BackupProtectedFileShareTimeouts,
}
```
