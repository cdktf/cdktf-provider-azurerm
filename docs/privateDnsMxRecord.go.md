...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednsmxrecord"
...
&privatednsmxrecord.PrivateDnsMxRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsMxRecord.PrivateDnsMxRecordTimeouts,
}
```
