...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsmxrecord"
...
&privatednsmxrecord.PrivateDnsMxRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsMxRecord.PrivateDnsMxRecordTimeouts,
}
```
