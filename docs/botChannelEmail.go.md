...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/botchannelemail"
...
| <code><a href="#@cdktf/provider-azurerm.botChannelEmail.BotChannelEmail.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&botchannelemail.BotChannelEmailConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.botChannelEmail.BotChannelEmailTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.botChannelEmail.BotChannelEmailConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
