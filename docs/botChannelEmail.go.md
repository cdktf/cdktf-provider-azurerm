...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchannelemail"
...
&botchannelemail.BotChannelEmailConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelEmail.BotChannelEmailTimeouts,
}
```
