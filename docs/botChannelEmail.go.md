...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/botchannelemail"
...
&botchannelemail.BotChannelEmailConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.botChannelEmail.BotChannelEmailTimeouts,
}
```
