...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/appservicemanagedcertificate"
...
&appservicemanagedcertificate.AppServiceManagedCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.appServiceManagedCertificate.AppServiceManagedCertificateTimeouts,
}
```
