...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/appservicemanagedcertificate"
...
&appservicemanagedcertificate.AppServiceManagedCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.appServiceManagedCertificate.AppServiceManagedCertificateTimeouts,
}
```
