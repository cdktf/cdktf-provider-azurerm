...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/datafactoryintegrationruntimeselfhosted"
...
&datafactoryintegrationruntimeselfhosted.DataFactoryIntegrationRuntimeSelfHostedConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataFactoryIntegrationRuntimeSelfHosted.DataFactoryIntegrationRuntimeSelfHostedTimeouts,
}
```
