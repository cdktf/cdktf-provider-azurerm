...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactoryintegrationruntimeselfhosted"
...
&datafactoryintegrationruntimeselfhosted.DataFactoryIntegrationRuntimeSelfHostedConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryIntegrationRuntimeSelfHosted.DataFactoryIntegrationRuntimeSelfHostedTimeouts,
}
```
