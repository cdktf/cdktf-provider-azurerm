...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/datafactoryintegrationruntimeselfhosted"
...
&datafactoryintegrationruntimeselfhosted.DataFactoryIntegrationRuntimeSelfHostedConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataFactoryIntegrationRuntimeSelfHosted.DataFactoryIntegrationRuntimeSelfHostedTimeouts,
}
```
