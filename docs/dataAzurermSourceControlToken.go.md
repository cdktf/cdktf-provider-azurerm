...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermsourcecontroltoken"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermSourceControlToken.DataAzurermSourceControlToken.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermsourcecontroltoken.DataAzurermSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermSourceControlToken.DataAzurermSourceControlTokenTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermSourceControlToken.DataAzurermSourceControlTokenConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
