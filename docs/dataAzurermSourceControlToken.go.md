...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsourcecontroltoken"
...
&dataazurermsourcecontroltoken.DataAzurermSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSourceControlToken.DataAzurermSourceControlTokenTimeouts,
}
```
