...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermsourcecontroltoken"
...
&dataazurermsourcecontroltoken.DataAzurermSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSourceControlToken.DataAzurermSourceControlTokenTimeouts,
}
```
