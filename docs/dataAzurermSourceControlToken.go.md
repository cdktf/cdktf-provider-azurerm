...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermsourcecontroltoken"
...
&dataazurermsourcecontroltoken.DataAzurermSourceControlTokenConfig {
	...
	Type: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermSourceControlToken.DataAzurermSourceControlTokenTimeouts,
}
```
