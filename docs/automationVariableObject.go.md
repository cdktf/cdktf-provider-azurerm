...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/automationvariableobject"
...
&automationvariableobject.AutomationVariableObjectConfig {
	...
	Encrypted: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.automationVariableObject.AutomationVariableObjectTimeouts,
	Value: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.automationVariableObject.AutomationVariableObjectConfig.property.encrypted">Encrypted</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.69.0/docs/resources/automation_variable_object#encrypted AutomationVariableObject#encrypted}. |
