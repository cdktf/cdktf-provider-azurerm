...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/expressroutegateway"
...
&expressroutegateway.ExpressRouteGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.expressRouteGateway.ExpressRouteGatewayTimeouts,
}
```
