...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/expressroutegateway"
...
&expressroutegateway.ExpressRouteGatewayConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.expressRouteGateway.ExpressRouteGatewayTimeouts,
}
```
