...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementglobalschema"
...
&apimanagementglobalschema.ApiManagementGlobalSchemaConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementGlobalSchema.ApiManagementGlobalSchemaTimeouts,
}
```
