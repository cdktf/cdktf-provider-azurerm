...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/diskpoolmanageddiskattachment"
...
&diskpoolmanageddiskattachment.DiskPoolManagedDiskAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.diskPoolManagedDiskAttachment.DiskPoolManagedDiskAttachmentTimeouts,
}
```
