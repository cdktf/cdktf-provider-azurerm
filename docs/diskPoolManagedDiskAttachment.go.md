...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/diskpoolmanageddiskattachment"
...
&diskpoolmanageddiskattachment.DiskPoolManagedDiskAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.diskPoolManagedDiskAttachment.DiskPoolManagedDiskAttachmentTimeouts,
}
```
