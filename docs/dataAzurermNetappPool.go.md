...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetapppool"
...
&dataazurermnetapppool.DataAzurermNetappPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetappPool.DataAzurermNetappPoolTimeouts,
}
```
