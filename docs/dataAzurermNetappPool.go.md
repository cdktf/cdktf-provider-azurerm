...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermnetapppool"
...
&dataazurermnetapppool.DataAzurermNetappPoolConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermNetappPool.DataAzurermNetappPoolTimeouts,
}
```
