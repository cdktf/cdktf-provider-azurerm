...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermcognitiveaccount"
...
&dataazurermcognitiveaccount.DataAzurermCognitiveAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermCognitiveAccount.DataAzurermCognitiveAccountTimeouts,
}
```
