...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermcognitiveaccount"
...
&dataazurermcognitiveaccount.DataAzurermCognitiveAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermCognitiveAccount.DataAzurermCognitiveAccountTimeouts,
}
```
