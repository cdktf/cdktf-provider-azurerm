...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudconfigurationservice"
...
&springcloudconfigurationservice.SpringCloudConfigurationServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudConfigurationService.SpringCloudConfigurationServiceTimeouts,
}
```
