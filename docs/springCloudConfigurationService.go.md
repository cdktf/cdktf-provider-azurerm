...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/springcloudconfigurationservice"
...
&springcloudconfigurationservice.SpringCloudConfigurationServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.springCloudConfigurationService.SpringCloudConfigurationServiceTimeouts,
}
```
