...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mariadbvirtualnetworkrule"
...
&mariadbvirtualnetworkrule.MariadbVirtualNetworkRuleConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mariadbVirtualNetworkRule.MariadbVirtualNetworkRuleTimeouts,
}
```
