...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mariadbvirtualnetworkrule"
...
&mariadbvirtualnetworkrule.MariadbVirtualNetworkRuleConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mariadbVirtualNetworkRule.MariadbVirtualNetworkRuleTimeouts,
}
```
