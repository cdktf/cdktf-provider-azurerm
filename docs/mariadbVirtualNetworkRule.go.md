...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mariadbvirtualnetworkrule"
...
| <code><a href="#@cdktf/provider-azurerm.mariadbVirtualNetworkRule.MariadbVirtualNetworkRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&mariadbvirtualnetworkrule.MariadbVirtualNetworkRuleConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mariadbVirtualNetworkRule.MariadbVirtualNetworkRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.mariadbVirtualNetworkRule.MariadbVirtualNetworkRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
