...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mariadbvirtualnetworkrule"
...
&mariadbvirtualnetworkrule.MariadbVirtualNetworkRuleConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mariadbVirtualNetworkRule.MariadbVirtualNetworkRuleTimeouts,
}
```
