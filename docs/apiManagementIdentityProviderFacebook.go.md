...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementidentityproviderfacebook"
...
&apimanagementidentityproviderfacebook.ApiManagementIdentityProviderFacebookConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementIdentityProviderFacebook.ApiManagementIdentityProviderFacebookTimeouts,
}
```
