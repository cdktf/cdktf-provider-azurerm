...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementidentityproviderfacebook"
...
&apimanagementidentityproviderfacebook.ApiManagementIdentityProviderFacebookConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementIdentityProviderFacebook.ApiManagementIdentityProviderFacebookTimeouts,
}
```
