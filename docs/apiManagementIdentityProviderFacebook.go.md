...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementidentityproviderfacebook"
...
&apimanagementidentityproviderfacebook.ApiManagementIdentityProviderFacebookConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementIdentityProviderFacebook.ApiManagementIdentityProviderFacebookTimeouts,
}
```
