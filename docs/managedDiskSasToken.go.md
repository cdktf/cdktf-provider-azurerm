...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/manageddisksastoken"
...
&manageddisksastoken.ManagedDiskSasTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.managedDiskSasToken.ManagedDiskSasTokenTimeouts,
}
```
