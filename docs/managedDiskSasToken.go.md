...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/manageddisksastoken"
...
&manageddisksastoken.ManagedDiskSasTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managedDiskSasToken.ManagedDiskSasTokenTimeouts,
}
```
