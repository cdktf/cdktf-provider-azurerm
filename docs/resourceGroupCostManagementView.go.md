...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/resourcegroupcostmanagementview"
...
&resourcegroupcostmanagementview.ResourceGroupCostManagementViewConfig {
	...
	ChartType: *string,
	Dataset: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourceGroupCostManagementView.ResourceGroupCostManagementViewDataset,
	DisplayName: *string,
	Name: *string,
	ReportType: *string,
	...
	Kpi: interface{},
	Pivot: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourceGroupCostManagementView.ResourceGroupCostManagementViewTimeouts,
}
```
