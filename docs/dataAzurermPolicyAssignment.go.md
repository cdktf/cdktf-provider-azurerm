...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermpolicyassignment"
...
&dataazurermpolicyassignment.DataAzurermPolicyAssignmentConfig {
	...
	ScopeId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermPolicyAssignment.DataAzurermPolicyAssignmentTimeouts,
}
```
