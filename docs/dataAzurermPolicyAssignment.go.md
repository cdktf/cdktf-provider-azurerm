...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpolicyassignment"
...
&dataazurermpolicyassignment.DataAzurermPolicyAssignmentConfig {
	...
	ScopeId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPolicyAssignment.DataAzurermPolicyAssignmentTimeouts,
}
```
