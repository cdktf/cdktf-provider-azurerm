...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermresources"
...
&dataazurermresources.DataAzurermResourcesConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermResources.DataAzurermResourcesTimeouts,
	Type: *string,
}
```
