...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednstxtrecord"
...
&privatednstxtrecord.PrivateDnsTxtRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsTxtRecord.PrivateDnsTxtRecordTimeouts,
}
```
