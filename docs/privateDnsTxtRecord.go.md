...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednstxtrecord"
...
&privatednstxtrecord.PrivateDnsTxtRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsTxtRecord.PrivateDnsTxtRecordTimeouts,
}
```
