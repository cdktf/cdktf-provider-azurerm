...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetappvolume"
...
&dataazurermnetappvolume.DataAzurermNetappVolumeConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetappVolume.DataAzurermNetappVolumeTimeouts,
}
```
