...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storagemovertargetendpoint"
...
&storagemovertargetendpoint.StorageMoverTargetEndpointConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageMoverTargetEndpoint.StorageMoverTargetEndpointTimeouts,
}
```
