...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/springcloudcustomizedaccelerator"
...
| <code><a href="#@cdktf/provider-azurerm.springCloudCustomizedAccelerator.SpringCloudCustomizedAccelerator.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&springcloudcustomizedaccelerator.SpringCloudCustomizedAcceleratorConfig {
	...
	GitRepository: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudCustomizedAccelerator.SpringCloudCustomizedAcceleratorGitRepository,
	Name: *string,
	...
	IconUrl: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudCustomizedAccelerator.SpringCloudCustomizedAcceleratorTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.springCloudCustomizedAccelerator.SpringCloudCustomizedAcceleratorConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&springcloudcustomizedaccelerator.SpringCloudCustomizedAcceleratorGitRepository {
	Url: *string,
	BasicAuth: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudCustomizedAccelerator.SpringCloudCustomizedAcceleratorGitRepositoryBasicAuth,
	Branch: *string,
	Commit: *string,
	GitTag: *string,
	IntervalInSeconds: *f64,
	SshAuth: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.springCloudCustomizedAccelerator.SpringCloudCustomizedAcceleratorGitRepositorySshAuth,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.springCloudCustomizedAccelerator.SpringCloudCustomizedAcceleratorGitRepository.property.intervalInSeconds">IntervalInSeconds</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/spring_cloud_customized_accelerator#interval_in_seconds SpringCloudCustomizedAccelerator#interval_in_seconds}. |
