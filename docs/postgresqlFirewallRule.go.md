...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/postgresqlfirewallrule"
...
&postgresqlfirewallrule.PostgresqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.postgresqlFirewallRule.PostgresqlFirewallRuleTimeouts,
}
```
