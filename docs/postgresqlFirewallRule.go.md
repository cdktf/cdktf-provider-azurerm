...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/postgresqlfirewallrule"
...
&postgresqlfirewallrule.PostgresqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.postgresqlFirewallRule.PostgresqlFirewallRuleTimeouts,
}
```
