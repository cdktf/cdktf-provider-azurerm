...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermapplicationinsights"
...
&dataazurermapplicationinsights.DataAzurermApplicationInsightsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermApplicationInsights.DataAzurermApplicationInsightsTimeouts,
}
```
