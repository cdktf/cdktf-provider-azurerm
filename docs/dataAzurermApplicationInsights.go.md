...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapplicationinsights"
...
&dataazurermapplicationinsights.DataAzurermApplicationInsightsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApplicationInsights.DataAzurermApplicationInsightsTimeouts,
}
```
