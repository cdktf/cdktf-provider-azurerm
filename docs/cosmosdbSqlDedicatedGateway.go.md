...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cosmosdbsqldedicatedgateway"
...
&cosmosdbsqldedicatedgateway.CosmosdbSqlDedicatedGatewayConfig {
	...
	InstanceSize: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cosmosdbSqlDedicatedGateway.CosmosdbSqlDedicatedGatewayTimeouts,
}
```
