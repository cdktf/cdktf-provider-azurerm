...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cosmosdbsqldedicatedgateway"
...
&cosmosdbsqldedicatedgateway.CosmosdbSqlDedicatedGatewayConfig {
	...
	InstanceSize: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cosmosdbSqlDedicatedGateway.CosmosdbSqlDedicatedGatewayTimeouts,
}
```
