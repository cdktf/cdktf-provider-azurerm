...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/logicappintegrationaccountpartner"
...
&logicappintegrationaccountpartner.LogicAppIntegrationAccountPartnerConfig {
	...
	Id: *string,
	Metadata: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logicAppIntegrationAccountPartner.LogicAppIntegrationAccountPartnerTimeouts,
}
```
