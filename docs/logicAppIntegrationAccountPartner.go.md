...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappintegrationaccountpartner"
...
&logicappintegrationaccountpartner.LogicAppIntegrationAccountPartnerConfig {
	...
	Id: *string,
	Metadata: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppIntegrationAccountPartner.LogicAppIntegrationAccountPartnerTimeouts,
}
```
