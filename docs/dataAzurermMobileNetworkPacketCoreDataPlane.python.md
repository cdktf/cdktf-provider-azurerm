...
```python
timeouts_input: typing.Union[DataAzurermMobileNetworkPacketCoreDataPlaneTimeouts, IResolvable]
```

- *Type:* typing.Union[<a href="#@cdktf/provider-azurerm.dataAzurermMobileNetworkPacketCoreDataPlane.DataAzurermMobileNetworkPacketCoreDataPlaneTimeouts">DataAzurermMobileNetworkPacketCoreDataPlaneTimeouts</a>, cdktf.IResolvable]
...
```python
internal_value: typing.Union[DataAzurermMobileNetworkPacketCoreDataPlaneTimeouts, IResolvable]
```
