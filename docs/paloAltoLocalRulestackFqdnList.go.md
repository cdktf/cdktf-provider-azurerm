...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/paloaltolocalrulestackfqdnlist"
...
&paloaltolocalrulestackfqdnlist.PaloAltoLocalRulestackFqdnListConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.paloAltoLocalRulestackFqdnList.PaloAltoLocalRulestackFqdnListTimeouts,
}
```
