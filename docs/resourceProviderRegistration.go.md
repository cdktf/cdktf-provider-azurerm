...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/resourceproviderregistration"
...
&resourceproviderregistration.ResourceProviderRegistrationConfig {
	...
	Feature: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourceProviderRegistration.ResourceProviderRegistrationTimeouts,
}
```
