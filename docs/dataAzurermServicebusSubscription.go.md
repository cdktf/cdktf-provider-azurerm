...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermservicebussubscription"
...
&dataazurermservicebussubscription.DataAzurermServicebusSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionTimeouts,
	TopicId: *string,
	TopicName: *string,
}
```
