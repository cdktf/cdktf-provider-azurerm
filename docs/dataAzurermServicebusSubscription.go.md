...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermservicebussubscription"
...
&dataazurermservicebussubscription.DataAzurermServicebusSubscriptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermServicebusSubscription.DataAzurermServicebusSubscriptionTimeouts,
	TopicId: *string,
	TopicName: *string,
}
```
