...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/iottimeseriesinsightsreferencedataset"
...
&iottimeseriesinsightsreferencedataset.IotTimeSeriesInsightsReferenceDataSetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.iotTimeSeriesInsightsReferenceDataSet.IotTimeSeriesInsightsReferenceDataSetTimeouts,
}
```
