...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/subnetserviceendpointstoragepolicy"
...
&subnetserviceendpointstoragepolicy.SubnetServiceEndpointStoragePolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.subnetServiceEndpointStoragePolicy.SubnetServiceEndpointStoragePolicyTimeouts,
}
```
