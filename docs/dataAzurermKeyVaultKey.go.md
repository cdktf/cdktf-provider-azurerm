...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermkeyvaultkey"
...
&dataazurermkeyvaultkey.DataAzurermKeyVaultKeyConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermKeyVaultKey.DataAzurermKeyVaultKeyTimeouts,
}
```
