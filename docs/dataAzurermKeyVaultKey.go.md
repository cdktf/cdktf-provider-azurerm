...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkeyvaultkey"
...
&dataazurermkeyvaultkey.DataAzurermKeyVaultKeyConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKeyVaultKey.DataAzurermKeyVaultKeyTimeouts,
}
```
