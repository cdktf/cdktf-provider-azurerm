...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermkeyvaultkey"
...
&dataazurermkeyvaultkey.DataAzurermKeyVaultKeyConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermKeyVaultKey.DataAzurermKeyVaultKeyTimeouts,
}
```
