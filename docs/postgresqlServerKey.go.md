...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/postgresqlserverkey"
...
&postgresqlserverkey.PostgresqlServerKeyConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.postgresqlServerKey.PostgresqlServerKeyTimeouts,
}
```
