...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/postgresqlserverkey"
...
&postgresqlserverkey.PostgresqlServerKeyConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.postgresqlServerKey.PostgresqlServerKeyTimeouts,
}
```
