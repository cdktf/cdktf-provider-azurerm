...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/postgresqlserverkey"
...
| <code><a href="#@cdktf/provider-azurerm.postgresqlServerKey.PostgresqlServerKey.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&postgresqlserverkey.PostgresqlServerKeyConfig {
	...
	ServerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.postgresqlServerKey.PostgresqlServerKeyTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.postgresqlServerKey.PostgresqlServerKeyConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
