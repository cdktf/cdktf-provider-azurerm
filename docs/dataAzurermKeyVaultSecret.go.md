...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermkeyvaultsecret"
...
&dataazurermkeyvaultsecret.DataAzurermKeyVaultSecretConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermKeyVaultSecret.DataAzurermKeyVaultSecretTimeouts,
	Version: *string,
}
```
