...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermkeyvaultsecret"
...
&dataazurermkeyvaultsecret.DataAzurermKeyVaultSecretConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermKeyVaultSecret.DataAzurermKeyVaultSecretTimeouts,
}
```
