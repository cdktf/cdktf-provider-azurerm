...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappintegrationaccountsession"
...
&logicappintegrationaccountsession.LogicAppIntegrationAccountSessionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppIntegrationAccountSession.LogicAppIntegrationAccountSessionTimeouts,
}
```
