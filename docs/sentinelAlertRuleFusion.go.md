...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/sentinelalertrulefusion"
...
&sentinelalertrulefusion.SentinelAlertRuleFusionConfig {
	...
	Id: *string,
	Source: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.sentinelAlertRuleFusion.SentinelAlertRuleFusionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.sentinelAlertRuleFusion.SentinelAlertRuleFusionConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.72.0/docs/resources/sentinel_alert_rule_fusion#enabled SentinelAlertRuleFusion#enabled}. |
