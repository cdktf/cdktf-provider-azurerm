...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/siterecoveryservicesvaulthypervsite"
...
&siterecoveryservicesvaulthypervsite.SiteRecoveryServicesVaultHypervSiteConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.siteRecoveryServicesVaultHypervSite.SiteRecoveryServicesVaultHypervSiteTimeouts,
}
```
