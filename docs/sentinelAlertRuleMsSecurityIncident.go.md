...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentinelalertrulemssecurityincident"
...
&sentinelalertrulemssecurityincident.SentinelAlertRuleMsSecurityIncidentConfig {
	...
	Enabled: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelAlertRuleMsSecurityIncident.SentinelAlertRuleMsSecurityIncidentTimeouts,
}
```
