...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermwindowsfunctionapp"
...
&dataazurermwindowsfunctionapp.DataAzurermWindowsFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermWindowsFunctionApp.DataAzurermWindowsFunctionAppTimeouts,
}
```
