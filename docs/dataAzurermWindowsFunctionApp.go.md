...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermwindowsfunctionapp"
...
&dataazurermwindowsfunctionapp.DataAzurermWindowsFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermWindowsFunctionApp.DataAzurermWindowsFunctionAppTimeouts,
}
```
