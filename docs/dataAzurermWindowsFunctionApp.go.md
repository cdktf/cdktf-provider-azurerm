...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermwindowsfunctionapp"
...
&dataazurermwindowsfunctionapp.DataAzurermWindowsFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermWindowsFunctionApp.DataAzurermWindowsFunctionAppTimeouts,
}
```
