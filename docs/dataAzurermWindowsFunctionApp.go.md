...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermwindowsfunctionapp"
...
&dataazurermwindowsfunctionapp.DataAzurermWindowsFunctionAppConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermWindowsFunctionApp.DataAzurermWindowsFunctionAppTimeouts,
}
```
