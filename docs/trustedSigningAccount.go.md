...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/trustedsigningaccount"
...
&trustedsigningaccount.TrustedSigningAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.trustedSigningAccount.TrustedSigningAccountTimeouts,
}
```
