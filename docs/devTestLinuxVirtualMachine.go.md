...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/devtestlinuxvirtualmachine"
...
&devtestlinuxvirtualmachine.DevTestLinuxVirtualMachineConfig {
	...
	GalleryImageReference: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.devTestLinuxVirtualMachine.DevTestLinuxVirtualMachineGalleryImageReference,
	LabName: *string,
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.devTestLinuxVirtualMachine.DevTestLinuxVirtualMachineTimeouts,
}
```
