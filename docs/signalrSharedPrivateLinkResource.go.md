...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/signalrsharedprivatelinkresource"
...
&signalrsharedprivatelinkresource.SignalrSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.signalrSharedPrivateLinkResource.SignalrSharedPrivateLinkResourceTimeouts,
}
```
