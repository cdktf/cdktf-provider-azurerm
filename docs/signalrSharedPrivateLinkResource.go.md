...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/signalrsharedprivatelinkresource"
...
&signalrsharedprivatelinkresource.SignalrSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.signalrSharedPrivateLinkResource.SignalrSharedPrivateLinkResourceTimeouts,
}
```
