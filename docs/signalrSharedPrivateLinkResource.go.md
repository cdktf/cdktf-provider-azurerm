...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/signalrsharedprivatelinkresource"
...
&signalrsharedprivatelinkresource.SignalrSharedPrivateLinkResourceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.signalrSharedPrivateLinkResource.SignalrSharedPrivateLinkResourceTimeouts,
}
```
