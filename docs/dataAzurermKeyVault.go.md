...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermkeyvault"
...
&dataazurermkeyvault.DataAzurermKeyVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermKeyVault.DataAzurermKeyVaultTimeouts,
}
```
