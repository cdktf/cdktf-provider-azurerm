...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermkeyvault"
...
&dataazurermkeyvault.DataAzurermKeyVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermKeyVault.DataAzurermKeyVaultTimeouts,
}
```
