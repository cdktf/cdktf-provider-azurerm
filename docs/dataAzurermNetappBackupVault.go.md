...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermnetappbackupvault"
...
&dataazurermnetappbackupvault.DataAzurermNetappBackupVaultConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermNetappBackupVault.DataAzurermNetappBackupVaultTimeouts,
}
```
