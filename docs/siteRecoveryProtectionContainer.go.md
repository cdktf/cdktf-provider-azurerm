...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/siterecoveryprotectioncontainer"
...
&siterecoveryprotectioncontainer.SiteRecoveryProtectionContainerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainerTimeouts,
}
```
