...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/siterecoveryprotectioncontainer"
...
&siterecoveryprotectioncontainer.SiteRecoveryProtectionContainerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainerTimeouts,
}
```
