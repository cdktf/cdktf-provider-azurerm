...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/siterecoveryprotectioncontainer"
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainer.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&siterecoveryprotectioncontainer.SiteRecoveryProtectionContainerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainerConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
