...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/siterecoveryprotectioncontainer"
...
&siterecoveryprotectioncontainer.SiteRecoveryProtectionContainerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainerTimeouts,
}
```
