...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/siterecoveryprotectioncontainer"
...
&siterecoveryprotectioncontainer.SiteRecoveryProtectionContainerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.siteRecoveryProtectionContainer.SiteRecoveryProtectionContainerTimeouts,
}
```
