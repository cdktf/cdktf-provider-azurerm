...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/restorepointcollection"
...
&restorepointcollection.RestorePointCollectionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.restorePointCollection.RestorePointCollectionTimeouts,
}
```
