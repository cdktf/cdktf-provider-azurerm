...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/orbitalcontact"
...
&orbitalcontact.OrbitalContactConfig {
	...
	SpacecraftId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.orbitalContact.OrbitalContactTimeouts,
}
```
