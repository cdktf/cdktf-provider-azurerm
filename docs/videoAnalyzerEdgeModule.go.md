...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/videoanalyzeredgemodule"
...
&videoanalyzeredgemodule.VideoAnalyzerEdgeModuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.videoAnalyzerEdgeModule.VideoAnalyzerEdgeModuleTimeouts,
}
```
