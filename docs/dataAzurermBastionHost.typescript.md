...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermBastionHost.DataAzurermBastionHost.property.sessionRecordingEnabled">sessionRecordingEnabled</a></code> | <code>cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly sessionRecordingEnabled: IResolvable;
```
