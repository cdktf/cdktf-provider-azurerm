...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/graphaccount"
...
&graphaccount.GraphAccountConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.graphAccount.GraphAccountTimeouts,
}
```
