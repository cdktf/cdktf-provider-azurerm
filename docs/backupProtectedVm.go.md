...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/backupprotectedvm"
...
&backupprotectedvm.BackupProtectedVmConfig {
	...
	IncludeDiskLuns: *[]*f64,
	SourceVmId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.backupProtectedVm.BackupProtectedVmTimeouts,
}
```
