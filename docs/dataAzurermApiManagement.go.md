...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermapimanagement"
...
&dataazurermapimanagement.DataAzurermApiManagementConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermApiManagement.DataAzurermApiManagementTimeouts,
}
```
