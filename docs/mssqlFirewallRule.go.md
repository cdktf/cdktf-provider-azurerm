...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/mssqlfirewallrule"
...
&mssqlfirewallrule.MssqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.mssqlFirewallRule.MssqlFirewallRuleTimeouts,
}
```
