...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mssqlfirewallrule"
...
&mssqlfirewallrule.MssqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mssqlFirewallRule.MssqlFirewallRuleTimeouts,
}
```
