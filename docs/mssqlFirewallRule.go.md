...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mssqlfirewallrule"
...
&mssqlfirewallrule.MssqlFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mssqlFirewallRule.MssqlFirewallRuleTimeouts,
}
```
