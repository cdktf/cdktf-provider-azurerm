...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermwebapplicationfirewallpolicy"
...
&dataazurermwebapplicationfirewallpolicy.DataAzurermWebApplicationFirewallPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermWebApplicationFirewallPolicy.DataAzurermWebApplicationFirewallPolicyTimeouts,
}
```
