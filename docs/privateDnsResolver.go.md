...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednsresolver"
...
&privatednsresolver.PrivateDnsResolverConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsResolver.PrivateDnsResolverTimeouts,
}
```
