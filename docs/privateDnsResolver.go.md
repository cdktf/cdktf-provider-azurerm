...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsresolver"
...
&privatednsresolver.PrivateDnsResolverConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsResolver.PrivateDnsResolverTimeouts,
}
```
