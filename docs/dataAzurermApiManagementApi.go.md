...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermapimanagementapi"
...
&dataazurermapimanagementapi.DataAzurermApiManagementApiConfig {
	...
	Revision: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermApiManagementApi.DataAzurermApiManagementApiTimeouts,
}
```
