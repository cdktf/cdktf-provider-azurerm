...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermapimanagementapi"
...
&dataazurermapimanagementapi.DataAzurermApiManagementApiConfig {
	...
	Revision: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermApiManagementApi.DataAzurermApiManagementApiTimeouts,
}
```
