...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/mobilenetworksim"
...
&mobilenetworksim.MobileNetworkSimConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.mobileNetworkSim.MobileNetworkSimTimeouts,
}
```
