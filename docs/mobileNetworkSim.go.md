...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/mobilenetworksim"
...
&mobilenetworksim.MobileNetworkSimConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.mobileNetworkSim.MobileNetworkSimTimeouts,
}
```
