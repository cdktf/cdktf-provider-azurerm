...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/mobilenetworksim"
...
&mobilenetworksim.MobileNetworkSimConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.mobileNetworkSim.MobileNetworkSimTimeouts,
}
```
