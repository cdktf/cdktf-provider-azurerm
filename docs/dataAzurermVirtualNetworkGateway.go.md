...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermvirtualnetworkgateway"
...
&dataazurermvirtualnetworkgateway.DataAzurermVirtualNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermVirtualNetworkGateway.DataAzurermVirtualNetworkGatewayTimeouts,
}
```
