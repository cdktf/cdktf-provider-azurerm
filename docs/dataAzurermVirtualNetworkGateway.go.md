...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermvirtualnetworkgateway"
...
&dataazurermvirtualnetworkgateway.DataAzurermVirtualNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermVirtualNetworkGateway.DataAzurermVirtualNetworkGatewayTimeouts,
}
```
