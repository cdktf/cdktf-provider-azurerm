...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualnetworkgateway"
...
&dataazurermvirtualnetworkgateway.DataAzurermVirtualNetworkGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualNetworkGateway.DataAzurermVirtualNetworkGatewayTimeouts,
}
```
