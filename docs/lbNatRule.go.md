...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/lbnatrule"
...
&lbnatrule.LbNatRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.lbNatRule.LbNatRuleTimeouts,
}
```
