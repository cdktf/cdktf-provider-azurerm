...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/lbnatrule"
...
&lbnatrule.LbNatRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.lbNatRule.LbNatRuleTimeouts,
}
```
