...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermstorageshare"
...
&dataazurermstorageshare.DataAzurermStorageShareConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermStorageShare.DataAzurermStorageShareTimeouts,
}
```
