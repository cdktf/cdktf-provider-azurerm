...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermautomationvariabledatetime"
...
&dataazurermautomationvariabledatetime.DataAzurermAutomationVariableDatetimeConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAutomationVariableDatetime.DataAzurermAutomationVariableDatetimeTimeouts,
}
```
