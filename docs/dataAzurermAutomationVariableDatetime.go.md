...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermautomationvariabledatetime"
...
&dataazurermautomationvariabledatetime.DataAzurermAutomationVariableDatetimeConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAutomationVariableDatetime.DataAzurermAutomationVariableDatetimeTimeouts,
}
```
