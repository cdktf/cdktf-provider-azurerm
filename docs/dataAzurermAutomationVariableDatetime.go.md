...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermautomationvariabledatetime"
...
&dataazurermautomationvariabledatetime.DataAzurermAutomationVariableDatetimeConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermAutomationVariableDatetime.DataAzurermAutomationVariableDatetimeTimeouts,
}
```
