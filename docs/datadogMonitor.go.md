...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/datadogmonitor"
...
| <code><a href="#@cdktf/provider-azurerm.datadogMonitor.DatadogMonitor.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datadogmonitor.DatadogMonitorConfig {
	...
	DatadogOrganization: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.datadogMonitor.DatadogMonitorDatadogOrganization,
	Location: *string,
	Name: *string,
	ResourceGroupName: *string,
	SkuName: *string,
	User: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.datadogMonitor.DatadogMonitorUser,
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.datadogMonitor.DatadogMonitorIdentity,
	MonitoringEnabled: interface{},
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.datadogMonitor.DatadogMonitorTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.datadogMonitor.DatadogMonitorConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.datadogMonitor.DatadogMonitorConfig.property.monitoringEnabled">MonitoringEnabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/datadog_monitor#monitoring_enabled DatadogMonitor#monitoring_enabled}. |
| <code><a href="#@cdktf/provider-azurerm.datadogMonitor.DatadogMonitorConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/datadog_monitor#tags DatadogMonitor#tags}. |
