...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/searchsharedprivatelinkservice"
...
&searchsharedprivatelinkservice.SearchSharedPrivateLinkServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.searchSharedPrivateLinkService.SearchSharedPrivateLinkServiceTimeouts,
}
```
