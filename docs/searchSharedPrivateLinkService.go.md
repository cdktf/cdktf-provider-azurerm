...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/searchsharedprivatelinkservice"
...
&searchsharedprivatelinkservice.SearchSharedPrivateLinkServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.searchSharedPrivateLinkService.SearchSharedPrivateLinkServiceTimeouts,
}
```
