...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/searchsharedprivatelinkservice"
...
&searchsharedprivatelinkservice.SearchSharedPrivateLinkServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.searchSharedPrivateLinkService.SearchSharedPrivateLinkServiceTimeouts,
}
```
