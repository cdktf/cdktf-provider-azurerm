...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/searchsharedprivatelinkservice"
...
&searchsharedprivatelinkservice.SearchSharedPrivateLinkServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.searchSharedPrivateLinkService.SearchSharedPrivateLinkServiceTimeouts,
}
```
