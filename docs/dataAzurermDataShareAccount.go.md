...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdatashareaccount"
...
&dataazurermdatashareaccount.DataAzurermDataShareAccountConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDataShareAccount.DataAzurermDataShareAccountTimeouts,
}
```
