...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mssqlserversecurityalertpolicy"
...
&mssqlserversecurityalertpolicy.MssqlServerSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mssqlServerSecurityAlertPolicy.MssqlServerSecurityAlertPolicyTimeouts,
}
```
