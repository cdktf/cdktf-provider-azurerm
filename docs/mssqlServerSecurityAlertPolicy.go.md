...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mssqlserversecurityalertpolicy"
...
&mssqlserversecurityalertpolicy.MssqlServerSecurityAlertPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mssqlServerSecurityAlertPolicy.MssqlServerSecurityAlertPolicyTimeouts,
}
```
