...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermappconfiguration"
...
&dataazurermappconfiguration.DataAzurermAppConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermAppConfiguration.DataAzurermAppConfigurationTimeouts,
}
```
