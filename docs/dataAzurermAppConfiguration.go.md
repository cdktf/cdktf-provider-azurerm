...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermappconfiguration"
...
&dataazurermappconfiguration.DataAzurermAppConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAppConfiguration.DataAzurermAppConfigurationTimeouts,
}
```
