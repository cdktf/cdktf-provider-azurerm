...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudcertificate"
...
&springcloudcertificate.SpringCloudCertificateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudCertificate.SpringCloudCertificateTimeouts,
}
```
