...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/netappsnapshot"
...
&netappsnapshot.NetappSnapshotConfig {
	...
	VolumeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.netappSnapshot.NetappSnapshotTimeouts,
}
```
