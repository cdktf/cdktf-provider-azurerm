...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/netappsnapshot"
...
&netappsnapshot.NetappSnapshotConfig {
	...
	VolumeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.netappSnapshot.NetappSnapshotTimeouts,
}
```
