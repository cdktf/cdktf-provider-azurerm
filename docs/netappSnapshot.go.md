...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/netappsnapshot"
...
| <code><a href="#@cdktf/provider-azurerm.netappSnapshot.NetappSnapshot.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&netappsnapshot.NetappSnapshotConfig {
	...
	VolumeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.netappSnapshot.NetappSnapshotTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.netappSnapshot.NetappSnapshotConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
