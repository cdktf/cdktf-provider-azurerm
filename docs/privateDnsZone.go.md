...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednszone"
...
&privatednszone.PrivateDnsZoneConfig {
	...
	Id: *string,
	SoaRecord: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsZone.PrivateDnsZoneSoaRecord,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsZone.PrivateDnsZoneTimeouts,
}
```
