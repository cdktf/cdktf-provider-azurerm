...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/staticsite"
...
&staticsite.StaticSiteConfig {
	...
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.staticSite.StaticSiteIdentity,
	SkuSize: *string,
	SkuTier: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.staticSite.StaticSiteTimeouts,
}
```
