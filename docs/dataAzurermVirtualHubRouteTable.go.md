...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermvirtualhubroutetable"
...
&dataazurermvirtualhubroutetable.DataAzurermVirtualHubRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermVirtualHubRouteTable.DataAzurermVirtualHubRouteTableTimeouts,
}
```
