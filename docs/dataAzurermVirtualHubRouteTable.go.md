...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermvirtualhubroutetable"
...
&dataazurermvirtualhubroutetable.DataAzurermVirtualHubRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermVirtualHubRouteTable.DataAzurermVirtualHubRouteTableTimeouts,
}
```
