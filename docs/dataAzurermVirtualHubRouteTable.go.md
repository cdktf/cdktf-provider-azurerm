...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermvirtualhubroutetable"
...
&dataazurermvirtualhubroutetable.DataAzurermVirtualHubRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermVirtualHubRouteTable.DataAzurermVirtualHubRouteTableTimeouts,
}
```
