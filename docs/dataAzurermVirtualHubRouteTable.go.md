...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualhubroutetable"
...
&dataazurermvirtualhubroutetable.DataAzurermVirtualHubRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualHubRouteTable.DataAzurermVirtualHubRouteTableTimeouts,
}
```
