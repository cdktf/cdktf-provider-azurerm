...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/privatednsresolverforwardingrule"
...
&privatednsresolverforwardingrule.PrivateDnsResolverForwardingRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.privateDnsResolverForwardingRule.PrivateDnsResolverForwardingRuleTimeouts,
}
```
