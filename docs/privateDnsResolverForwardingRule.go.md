...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/privatednsresolverforwardingrule"
...
&privatednsresolverforwardingrule.PrivateDnsResolverForwardingRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.privateDnsResolverForwardingRule.PrivateDnsResolverForwardingRuleTimeouts,
}
```
