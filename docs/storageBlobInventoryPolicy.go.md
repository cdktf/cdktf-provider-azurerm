...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storageblobinventorypolicy"
...
&storageblobinventorypolicy.StorageBlobInventoryPolicyConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageBlobInventoryPolicy.StorageBlobInventoryPolicyTimeouts,
}
```
...
&storageblobinventorypolicy.StorageBlobInventoryPolicyRules {
	...
	Filter: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageBlobInventoryPolicy.StorageBlobInventoryPolicyRulesFilter,
}
```
