...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermdatafactory"
...
&dataazurermdatafactory.DataAzurermDataFactoryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermDataFactory.DataAzurermDataFactoryTimeouts,
}
```
