...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermdatafactory"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDataFactory.DataAzurermDataFactory.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermdatafactory.DataAzurermDataFactoryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermDataFactory.DataAzurermDataFactoryTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermDataFactory.DataAzurermDataFactoryConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
