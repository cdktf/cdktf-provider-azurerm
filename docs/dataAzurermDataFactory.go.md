...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermdatafactory"
...
&dataazurermdatafactory.DataAzurermDataFactoryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermDataFactory.DataAzurermDataFactoryTimeouts,
}
```
