...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdatafactory"
...
&dataazurermdatafactory.DataAzurermDataFactoryConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDataFactory.DataAzurermDataFactoryTimeouts,
}
```
