...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sqlmanageddatabase"
...
&sqlmanageddatabase.SqlManagedDatabaseConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sqlManagedDatabase.SqlManagedDatabaseTimeouts,
}
```
