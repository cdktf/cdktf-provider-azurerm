...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/webpubsubhub"
...
&webpubsubhub.WebPubsubHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.webPubsubHub.WebPubsubHubTimeouts,
}
```
