...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/webpubsubhub"
...
&webpubsubhub.WebPubsubHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.webPubsubHub.WebPubsubHubTimeouts,
}
```
...
&webpubsubhub.WebPubsubHubEventHandler {
	UrlTemplate: *string,
	Auth: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.webPubsubHub.WebPubsubHubEventHandlerAuth,
	SystemEvents: *[]*string,
