...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/webpubsubhub"
...
&webpubsubhub.WebPubsubHubConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.webPubsubHub.WebPubsubHubTimeouts,
}
```
...
&webpubsubhub.WebPubsubHubEventHandler {
	UrlTemplate: *string,
	Auth: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.webPubsubHub.WebPubsubHubEventHandlerAuth,
	SystemEvents: *[]*string,
