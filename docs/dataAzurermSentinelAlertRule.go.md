...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermsentinelalertrule"
...
&dataazurermsentinelalertrule.DataAzurermSentinelAlertRuleConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSentinelAlertRule.DataAzurermSentinelAlertRuleTimeouts,
}
```
