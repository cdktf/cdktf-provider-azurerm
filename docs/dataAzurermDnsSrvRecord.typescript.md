...
dataAzurermDnsSrvRecord.DataAzurermDnsSrvRecord.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
