...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/capacityreservation"
...
&capacityreservation.CapacityReservationConfig {
	...
	Name: *string,
	Sku: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.capacityReservation.CapacityReservationSku,
	Id: *string,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.capacityReservation.CapacityReservationTimeouts,
	Zone: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.capacityReservation.CapacityReservationConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.74.0/docs/resources/capacity_reservation#tags CapacityReservation#tags}. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-azurerm.capacityReservation.CapacityReservationSku.property.capacity">Capacity</a></code> | <code>*f64</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.74.0/docs/resources/capacity_reservation#capacity CapacityReservation#capacity}. |
