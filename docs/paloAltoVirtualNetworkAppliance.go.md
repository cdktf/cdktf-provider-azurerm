...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/paloaltovirtualnetworkappliance"
...
&paloaltovirtualnetworkappliance.PaloAltoVirtualNetworkApplianceConfig {
	...
	VirtualHubId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.paloAltoVirtualNetworkAppliance.PaloAltoVirtualNetworkApplianceTimeouts,
}
```
