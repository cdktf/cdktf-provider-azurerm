...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermexpressroutecircuit"
...
&dataazurermexpressroutecircuit.DataAzurermExpressRouteCircuitConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermExpressRouteCircuit.DataAzurermExpressRouteCircuitTimeouts,
}
```
