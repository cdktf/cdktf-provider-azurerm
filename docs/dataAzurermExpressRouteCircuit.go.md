...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermexpressroutecircuit"
...
&dataazurermexpressroutecircuit.DataAzurermExpressRouteCircuitConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermExpressRouteCircuit.DataAzurermExpressRouteCircuitTimeouts,
}
```
