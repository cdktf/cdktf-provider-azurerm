...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermexpressroutecircuit"
...
&dataazurermexpressroutecircuit.DataAzurermExpressRouteCircuitConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermExpressRouteCircuit.DataAzurermExpressRouteCircuitTimeouts,
}
```
