...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementopenidconnectprovider"
...
&apimanagementopenidconnectprovider.ApiManagementOpenidConnectProviderConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementOpenidConnectProvider.ApiManagementOpenidConnectProviderTimeouts,
}
```
