...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementopenidconnectprovider"
...
&apimanagementopenidconnectprovider.ApiManagementOpenidConnectProviderConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementOpenidConnectProvider.ApiManagementOpenidConnectProviderTimeouts,
}
```
