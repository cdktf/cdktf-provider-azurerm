...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermpostgresqlflexibleserver"
...
&dataazurermpostgresqlflexibleserver.DataAzurermPostgresqlFlexibleServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermPostgresqlFlexibleServer.DataAzurermPostgresqlFlexibleServerTimeouts,
}
```
