...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationhybridrunbookworker"
...
&automationhybridrunbookworker.AutomationHybridRunbookWorkerConfig {
	...
	WorkerId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationHybridRunbookWorker.AutomationHybridRunbookWorkerTimeouts,
}
```
