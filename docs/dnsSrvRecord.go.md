...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dnssrvrecord"
...
&dnssrvrecord.DnsSrvRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dnsSrvRecord.DnsSrvRecordTimeouts,
}
```
