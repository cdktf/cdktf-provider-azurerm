...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dnssrvrecord"
...
&dnssrvrecord.DnsSrvRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dnsSrvRecord.DnsSrvRecordTimeouts,
}
```
