...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/virtualhubroutetableroute"
...
&virtualhubroutetableroute.VirtualHubRouteTableRouteAConfig {
	...
	Id: *string,
	NextHopType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.virtualHubRouteTableRoute.VirtualHubRouteTableRouteTimeouts,
}
```
