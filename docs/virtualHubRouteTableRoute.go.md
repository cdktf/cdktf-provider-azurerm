...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/virtualhubroutetableroute"
...
&virtualhubroutetableroute.VirtualHubRouteTableRouteAConfig {
	...
	Id: *string,
	NextHopType: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.virtualHubRouteTableRoute.VirtualHubRouteTableRouteTimeouts,
}
```
