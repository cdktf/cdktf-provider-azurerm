...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/subnetnetworksecuritygroupassociation"
...
&subnetnetworksecuritygroupassociation.SubnetNetworkSecurityGroupAssociationConfig {
	...
	SubnetId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.subnetNetworkSecurityGroupAssociation.SubnetNetworkSecurityGroupAssociationTimeouts,
}
```
