...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/networkinterfacenatruleassociation"
...
&networkinterfacenatruleassociation.NetworkInterfaceNatRuleAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.networkInterfaceNatRuleAssociation.NetworkInterfaceNatRuleAssociationTimeouts,
}
```
