...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/networkinterfacenatruleassociation"
...
&networkinterfacenatruleassociation.NetworkInterfaceNatRuleAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.networkInterfaceNatRuleAssociation.NetworkInterfaceNatRuleAssociationTimeouts,
}
```
