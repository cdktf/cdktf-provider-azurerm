...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/networkinterfacenatruleassociation"
...
&networkinterfacenatruleassociation.NetworkInterfaceNatRuleAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.networkInterfaceNatRuleAssociation.NetworkInterfaceNatRuleAssociationTimeouts,
}
```
