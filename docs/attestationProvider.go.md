...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/attestationprovider"
...
&attestationprovider.AttestationProviderConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.attestationProvider.AttestationProviderTimeouts,
}
```
