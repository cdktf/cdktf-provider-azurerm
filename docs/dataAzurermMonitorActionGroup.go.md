...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmonitoractiongroup"
...
&dataazurermmonitoractiongroup.DataAzurermMonitorActionGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMonitorActionGroup.DataAzurermMonitorActionGroupTimeouts,
}
```
