...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/expressroutecircuitauthorization"
...
&expressroutecircuitauthorization.ExpressRouteCircuitAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.expressRouteCircuitAuthorization.ExpressRouteCircuitAuthorizationTimeouts,
}
```
