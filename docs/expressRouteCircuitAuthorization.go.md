...
Refer to the Terraform Registory for docs: [`azurerm_express_route_circuit_authorization`](https://registry.terraform.io/providers/hashicorp/azurerm/3.76.0/docs/resources/express_route_circuit_authorization).
...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/expressroutecircuitauthorization"
...
&expressroutecircuitauthorization.ExpressRouteCircuitAuthorizationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.expressRouteCircuitAuthorization.ExpressRouteCircuitAuthorizationTimeouts,
}
```
