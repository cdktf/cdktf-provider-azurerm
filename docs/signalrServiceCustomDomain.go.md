...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/signalrservicecustomdomain"
...
&signalrservicecustomdomain.SignalrServiceCustomDomainConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.signalrServiceCustomDomain.SignalrServiceCustomDomainTimeouts,
}
```
