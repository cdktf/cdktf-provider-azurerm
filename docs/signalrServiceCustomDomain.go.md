...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/signalrservicecustomdomain"
...
&signalrservicecustomdomain.SignalrServiceCustomDomainConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.signalrServiceCustomDomain.SignalrServiceCustomDomainTimeouts,
}
```
