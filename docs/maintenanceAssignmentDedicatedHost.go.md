...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/maintenanceassignmentdedicatedhost"
...
&maintenanceassignmentdedicatedhost.MaintenanceAssignmentDedicatedHostConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.maintenanceAssignmentDedicatedHost.MaintenanceAssignmentDedicatedHostTimeouts,
}
```
