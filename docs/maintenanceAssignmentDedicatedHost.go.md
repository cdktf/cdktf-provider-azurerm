...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/maintenanceassignmentdedicatedhost"
...
&maintenanceassignmentdedicatedhost.MaintenanceAssignmentDedicatedHostConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.maintenanceAssignmentDedicatedHost.MaintenanceAssignmentDedicatedHostTimeouts,
}
```
