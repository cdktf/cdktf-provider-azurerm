...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermnetworksecuritygroup"
...
&dataazurermnetworksecuritygroup.DataAzurermNetworkSecurityGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermNetworkSecurityGroup.DataAzurermNetworkSecurityGroupTimeouts,
}
```
