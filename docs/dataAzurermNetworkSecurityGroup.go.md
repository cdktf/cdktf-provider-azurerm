...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermnetworksecuritygroup"
...
&dataazurermnetworksecuritygroup.DataAzurermNetworkSecurityGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermNetworkSecurityGroup.DataAzurermNetworkSecurityGroupTimeouts,
}
```
