...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/kustodatabase"
...
&kustodatabase.KustoDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.kustoDatabase.KustoDatabaseTimeouts,
}
```
