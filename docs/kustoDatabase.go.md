...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/kustodatabase"
...
&kustodatabase.KustoDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.kustoDatabase.KustoDatabaseTimeouts,
}
```
