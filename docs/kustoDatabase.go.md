...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/kustodatabase"
...
&kustodatabase.KustoDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.kustoDatabase.KustoDatabaseTimeouts,
}
```
