...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/kustodatabase"
...
&kustodatabase.KustoDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.kustoDatabase.KustoDatabaseTimeouts,
}
```
