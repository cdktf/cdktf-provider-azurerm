...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermdevcenterproject"
...
&dataazurermdevcenterproject.DataAzurermDevCenterProjectConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermDevCenterProject.DataAzurermDevCenterProjectTimeouts,
}
```
