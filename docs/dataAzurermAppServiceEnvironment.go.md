...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermappserviceenvironment"
...
&dataazurermappserviceenvironment.DataAzurermAppServiceEnvironmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAppServiceEnvironment.DataAzurermAppServiceEnvironmentTimeouts,
}
```
