...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermappserviceenvironment"
...
&dataazurermappserviceenvironment.DataAzurermAppServiceEnvironmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermAppServiceEnvironment.DataAzurermAppServiceEnvironmentTimeouts,
}
```
