...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermappserviceenvironment"
...
&dataazurermappserviceenvironment.DataAzurermAppServiceEnvironmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAppServiceEnvironment.DataAzurermAppServiceEnvironmentTimeouts,
}
```
