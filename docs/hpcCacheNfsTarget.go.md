...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/hpccachenfstarget"
...
&hpccachenfstarget.HpcCacheNfsTargetConfig {
	...
	UsageModel: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.hpcCacheNfsTarget.HpcCacheNfsTargetTimeouts,
}
```
