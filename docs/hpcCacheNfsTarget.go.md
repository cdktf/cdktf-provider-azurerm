...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/hpccachenfstarget"
...
| <code><a href="#@cdktf/provider-azurerm.hpcCacheNfsTarget.HpcCacheNfsTarget.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&hpccachenfstarget.HpcCacheNfsTargetConfig {
	...
	UsageModel: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.hpcCacheNfsTarget.HpcCacheNfsTargetTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.hpcCacheNfsTarget.HpcCacheNfsTargetConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
