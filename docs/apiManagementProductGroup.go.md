...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementproductgroup"
...
&apimanagementproductgroup.ApiManagementProductGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementProductGroup.ApiManagementProductGroupTimeouts,
}
```
