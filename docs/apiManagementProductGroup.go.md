...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/apimanagementproductgroup"
...
&apimanagementproductgroup.ApiManagementProductGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.apiManagementProductGroup.ApiManagementProductGroupTimeouts,
}
```
