...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementproductgroup"
...
&apimanagementproductgroup.ApiManagementProductGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementProductGroup.ApiManagementProductGroupTimeouts,
}
```
