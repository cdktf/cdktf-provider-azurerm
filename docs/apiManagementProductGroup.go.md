...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementproductgroup"
...
&apimanagementproductgroup.ApiManagementProductGroupConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementProductGroup.ApiManagementProductGroupTimeouts,
}
```
