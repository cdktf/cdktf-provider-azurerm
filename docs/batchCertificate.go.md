...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/batchcertificate"
...
&batchcertificate.BatchCertificateConfig {
	...
	Id: *string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.batchCertificate.BatchCertificateTimeouts,
}
```
