...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/batchcertificate"
...
&batchcertificate.BatchCertificateConfig {
	...
	Id: *string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.batchCertificate.BatchCertificateTimeouts,
}
```
