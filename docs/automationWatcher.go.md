...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationwatcher"
...
&automationwatcher.AutomationWatcherConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationWatcher.AutomationWatcherTimeouts,
}
```
