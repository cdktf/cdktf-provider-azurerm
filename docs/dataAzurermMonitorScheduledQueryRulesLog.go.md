...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmonitorscheduledqueryruleslog"
...
&dataazurermmonitorscheduledqueryruleslog.DataAzurermMonitorScheduledQueryRulesLogConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMonitorScheduledQueryRulesLog.DataAzurermMonitorScheduledQueryRulesLogTimeouts,
}
```
