...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/datasharedatasetkustocluster"
...
&datasharedatasetkustocluster.DataShareDatasetKustoClusterConfig {
	...
	ShareId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataShareDatasetKustoCluster.DataShareDatasetKustoClusterTimeouts,
}
```
