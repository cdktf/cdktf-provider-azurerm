...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datasharedatasetkustocluster"
...
&datasharedatasetkustocluster.DataShareDatasetKustoClusterConfig {
	...
	ShareId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataShareDatasetKustoCluster.DataShareDatasetKustoClusterTimeouts,
}
```
