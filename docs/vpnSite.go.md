...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/vpnsite"
...
&vpnsite.VpnSiteConfig {
	...
	Id: *string,
	Link: interface{},
	O365Policy: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.vpnSite.VpnSiteO365Policy,
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.vpnSite.VpnSiteTimeouts,
}
```
...
&vpnsite.VpnSiteLink {
	Name: *string,
	Bgp: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.vpnSite.VpnSiteLinkBgp,
	Fqdn: *string,
	IpAddress: *string,
	ProviderName: *string,
	SpeedInMbps: *f64,
...
&vpnsite.VpnSiteO365Policy {
	TrafficCategory: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.vpnSite.VpnSiteO365PolicyTrafficCategory,
}
```
