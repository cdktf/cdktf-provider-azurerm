...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermsynapseworkspace"
...
&dataazurermsynapseworkspace.DataAzurermSynapseWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermSynapseWorkspace.DataAzurermSynapseWorkspaceTimeouts,
}
```
