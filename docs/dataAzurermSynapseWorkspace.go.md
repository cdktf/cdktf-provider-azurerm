...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsynapseworkspace"
...
&dataazurermsynapseworkspace.DataAzurermSynapseWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSynapseWorkspace.DataAzurermSynapseWorkspaceTimeouts,
}
```
