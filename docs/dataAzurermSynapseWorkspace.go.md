...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermsynapseworkspace"
...
&dataazurermsynapseworkspace.DataAzurermSynapseWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermSynapseWorkspace.DataAzurermSynapseWorkspaceTimeouts,
}
```
