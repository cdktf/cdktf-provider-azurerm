...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/availabilityset"
...
&availabilityset.AvailabilitySetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.availabilitySet.AvailabilitySetTimeouts,
}
```
