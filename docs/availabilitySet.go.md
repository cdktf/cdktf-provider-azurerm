...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/availabilityset"
...
&availabilityset.AvailabilitySetConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.availabilitySet.AvailabilitySetTimeouts,
}
```
