...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/dataazurermkubernetesfleetmanager"
...
&dataazurermkubernetesfleetmanager.DataAzurermKubernetesFleetManagerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.dataAzurermKubernetesFleetManager.DataAzurermKubernetesFleetManagerTimeouts,
}
```
