...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/cosmosdbcassandradatacenter"
...
&cosmosdbcassandradatacenter.CosmosdbCassandraDatacenterConfig {
	...
	NodeCount: *f64,
	SkuName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.cosmosdbCassandraDatacenter.CosmosdbCassandraDatacenterTimeouts,
}
```
