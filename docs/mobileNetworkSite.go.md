...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mobilenetworksite"
...
&mobilenetworksite.MobileNetworkSiteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mobileNetworkSite.MobileNetworkSiteTimeouts,
}
```
