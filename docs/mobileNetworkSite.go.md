...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mobilenetworksite"
...
&mobilenetworksite.MobileNetworkSiteConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mobileNetworkSite.MobileNetworkSiteTimeouts,
}
```
