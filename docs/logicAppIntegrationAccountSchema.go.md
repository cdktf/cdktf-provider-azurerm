...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/logicappintegrationaccountschema"
...
&logicappintegrationaccountschema.LogicAppIntegrationAccountSchemaConfig {
	...
	Id: *string,
	Metadata: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logicAppIntegrationAccountSchema.LogicAppIntegrationAccountSchemaTimeouts,
}
```
