...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappintegrationaccountschema"
...
&logicappintegrationaccountschema.LogicAppIntegrationAccountSchemaConfig {
	...
	Id: *string,
	Metadata: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppIntegrationAccountSchema.LogicAppIntegrationAccountSchemaTimeouts,
}
```
