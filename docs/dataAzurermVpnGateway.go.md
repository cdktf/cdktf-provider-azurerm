...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermvpngateway"
...
&dataazurermvpngateway.DataAzurermVpnGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermVpnGateway.DataAzurermVpnGatewayTimeouts,
}
```
