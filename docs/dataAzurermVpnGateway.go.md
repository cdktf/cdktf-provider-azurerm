...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvpngateway"
...
&dataazurermvpngateway.DataAzurermVpnGatewayConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVpnGateway.DataAzurermVpnGatewayTimeouts,
}
```
