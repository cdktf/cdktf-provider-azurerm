...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdataboxedgedevice"
...
&dataazurermdataboxedgedevice.DataAzurermDataboxEdgeDeviceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDataboxEdgeDevice.DataAzurermDataboxEdgeDeviceTimeouts,
}
```
