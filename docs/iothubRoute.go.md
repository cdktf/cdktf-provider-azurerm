...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/iothubroute"
...
&iothubroute.IothubRouteAConfig {
	...
	Condition: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.iothubRoute.IothubRouteTimeouts,
}
```
