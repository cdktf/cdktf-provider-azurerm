...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/iothubroute"
...
&iothubroute.IothubRouteAConfig {
	...
	Condition: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.iothubRoute.IothubRouteTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iothubRoute.IothubRouteAConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.21.1/docs/resources/iothub_route#enabled IothubRouteA#enabled}. |
