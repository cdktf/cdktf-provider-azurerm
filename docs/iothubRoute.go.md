...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubroute"
...
&iothubroute.IothubRouteAConfig {
	...
	Condition: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubRoute.IothubRouteTimeouts,
}
```
