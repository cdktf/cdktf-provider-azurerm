...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/iothubroute"
...
&iothubroute.IothubRouteAConfig {
	...
	Condition: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.iothubRoute.IothubRouteTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iothubRoute.IothubRouteAConfig.property.enabled">Enabled</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.56.0/docs/resources/iothub_route#enabled IothubRouteA#enabled}. |
