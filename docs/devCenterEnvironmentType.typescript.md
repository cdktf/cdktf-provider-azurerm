...
| <code><a href="#@cdktf/provider-azurerm.devCenterEnvironmentType.DevCenterEnvironmentTypeConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.34.0/docs/resources/dev_center_environment_type#tags DevCenterEnvironmentType#tags}. |
