...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/applicationsecuritygroup"
...
&applicationsecuritygroup.ApplicationSecurityGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.applicationSecurityGroup.ApplicationSecurityGroupTimeouts,
}
```
