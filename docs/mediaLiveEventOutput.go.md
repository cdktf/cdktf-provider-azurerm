...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/medialiveeventoutput"
...
&medialiveeventoutput.MediaLiveEventOutputConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mediaLiveEventOutput.MediaLiveEventOutputTimeouts,
}
```
