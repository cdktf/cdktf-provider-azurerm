...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/roledefinition"
...
&roledefinition.RoleDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.roleDefinition.RoleDefinitionTimeouts,
}
```
