...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/roledefinition"
...
&roledefinition.RoleDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.roleDefinition.RoleDefinitionTimeouts,
}
```
