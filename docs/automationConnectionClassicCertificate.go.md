...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/automationconnectionclassiccertificate"
...
&automationconnectionclassiccertificate.AutomationConnectionClassicCertificateConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.automationConnectionClassicCertificate.AutomationConnectionClassicCertificateTimeouts,
}
```
