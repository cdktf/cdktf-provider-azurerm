...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sentinelloganalyticsworkspaceonboarding"
...
&sentinelloganalyticsworkspaceonboarding.SentinelLogAnalyticsWorkspaceOnboardingConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sentinelLogAnalyticsWorkspaceOnboarding.SentinelLogAnalyticsWorkspaceOnboardingTimeouts,
}
```
