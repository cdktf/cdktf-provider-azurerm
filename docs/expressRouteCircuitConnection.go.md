...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/expressroutecircuitconnection"
...
&expressroutecircuitconnection.ExpressRouteCircuitConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.expressRouteCircuitConnection.ExpressRouteCircuitConnectionTimeouts,
}
```
