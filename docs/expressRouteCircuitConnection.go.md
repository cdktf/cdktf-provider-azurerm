...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/expressroutecircuitconnection"
...
&expressroutecircuitconnection.ExpressRouteCircuitConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.expressRouteCircuitConnection.ExpressRouteCircuitConnectionTimeouts,
}
```
