...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermspringcloudapp"
...
&dataazurermspringcloudapp.DataAzurermSpringCloudAppConfig {
	...
	ServiceName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSpringCloudApp.DataAzurermSpringCloudAppTimeouts,
}
```
