...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/dataazurermsubnet"
...
&dataazurermsubnet.DataAzurermSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.dataAzurermSubnet.DataAzurermSubnetTimeouts,
}
```
