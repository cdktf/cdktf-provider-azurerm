...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermsubnet"
...
&dataazurermsubnet.DataAzurermSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSubnet.DataAzurermSubnetTimeouts,
}
```
