...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsubnet"
...
&dataazurermsubnet.DataAzurermSubnetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSubnet.DataAzurermSubnetTimeouts,
}
```
