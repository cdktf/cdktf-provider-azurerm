...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/webapphybridconnection"
...
&webapphybridconnection.WebAppHybridConnectionConfig {
	...
	Id: *string,
	SendKeyName: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.webAppHybridConnection.WebAppHybridConnectionTimeouts,
}
```
