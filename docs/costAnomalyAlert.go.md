...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/costanomalyalert"
...
&costanomalyalert.CostAnomalyAlertConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.costAnomalyAlert.CostAnomalyAlertTimeouts,
}
```
