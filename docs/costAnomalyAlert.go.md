...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/costanomalyalert"
...
&costanomalyalert.CostAnomalyAlertConfig {
	...
	Id: *string,
	Message: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.costAnomalyAlert.CostAnomalyAlertTimeouts,
}
```
