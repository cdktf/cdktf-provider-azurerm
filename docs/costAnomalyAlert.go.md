...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/costanomalyalert"
...
&costanomalyalert.CostAnomalyAlertConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.costAnomalyAlert.CostAnomalyAlertTimeouts,
}
```
