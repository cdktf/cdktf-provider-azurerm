...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/costanomalyalert"
...
&costanomalyalert.CostAnomalyAlertConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.costAnomalyAlert.CostAnomalyAlertTimeouts,
}
```
