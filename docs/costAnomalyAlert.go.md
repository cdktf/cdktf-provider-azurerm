...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/costanomalyalert"
...
&costanomalyalert.CostAnomalyAlertConfig {
	...
	Id: *string,
	Message: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.costAnomalyAlert.CostAnomalyAlertTimeouts,
}
```
