...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/costanomalyalert"
...
&costanomalyalert.CostAnomalyAlertConfig {
	...
	Id: *string,
	Message: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.costAnomalyAlert.CostAnomalyAlertTimeouts,
}
```
