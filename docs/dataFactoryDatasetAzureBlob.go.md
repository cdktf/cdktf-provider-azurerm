...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorydatasetazureblob"
...
&datafactorydatasetazureblob.DataFactoryDatasetAzureBlobConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryDatasetAzureBlob.DataFactoryDatasetAzureBlobTimeouts,
}
```
