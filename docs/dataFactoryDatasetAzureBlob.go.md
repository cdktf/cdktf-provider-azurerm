...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/datafactorydatasetazureblob"
...
&datafactorydatasetazureblob.DataFactoryDatasetAzureBlobConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataFactoryDatasetAzureBlob.DataFactoryDatasetAzureBlobTimeouts,
}
```
