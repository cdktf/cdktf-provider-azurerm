...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/networkfunctionazuretrafficcollector"
...
&networkfunctionazuretrafficcollector.NetworkFunctionAzureTrafficCollectorConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.networkFunctionAzureTrafficCollector.NetworkFunctionAzureTrafficCollectorTimeouts,
}
```
