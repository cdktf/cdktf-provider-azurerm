...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/synapseprivatelinkhub"
...
| <code><a href="#@cdktf/provider-azurerm.synapsePrivateLinkHub.SynapsePrivateLinkHub.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&synapseprivatelinkhub.SynapsePrivateLinkHubConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.synapsePrivateLinkHub.SynapsePrivateLinkHubTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.synapsePrivateLinkHub.SynapsePrivateLinkHubConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.synapsePrivateLinkHub.SynapsePrivateLinkHubConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/synapse_private_link_hub#tags SynapsePrivateLinkHub#tags}. |
