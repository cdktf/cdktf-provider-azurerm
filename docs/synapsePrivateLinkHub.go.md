...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/synapseprivatelinkhub"
...
| <code><a href="#@cdktf/provider-azurerm.synapsePrivateLinkHub.SynapsePrivateLinkHubConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.18.0/docs/resources/synapse_private_link_hub#tags SynapsePrivateLinkHub#tags}. |
