...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/synapseprivatelinkhub"
...
&synapseprivatelinkhub.SynapsePrivateLinkHubConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.synapsePrivateLinkHub.SynapsePrivateLinkHubTimeouts,
}
```
