...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/cosmosdbsqlroledefinition"
...
&cosmosdbsqlroledefinition.CosmosdbSqlRoleDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.cosmosdbSqlRoleDefinition.CosmosdbSqlRoleDefinitionTimeouts,
	Type: *string,
}
```
