...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cosmosdbsqlroledefinition"
...
&cosmosdbsqlroledefinition.CosmosdbSqlRoleDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cosmosdbSqlRoleDefinition.CosmosdbSqlRoleDefinitionTimeouts,
	Type: *string,
}
```
