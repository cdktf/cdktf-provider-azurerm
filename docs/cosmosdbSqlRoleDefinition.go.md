...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/cosmosdbsqlroledefinition"
...
&cosmosdbsqlroledefinition.CosmosdbSqlRoleDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.cosmosdbSqlRoleDefinition.CosmosdbSqlRoleDefinitionTimeouts,
	Type: *string,
}
```
