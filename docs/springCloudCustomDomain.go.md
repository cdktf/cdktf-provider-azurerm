...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/springcloudcustomdomain"
...
&springcloudcustomdomain.SpringCloudCustomDomainConfig {
	...
	Id: *string,
	Thumbprint: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.springCloudCustomDomain.SpringCloudCustomDomainTimeouts,
}
```
