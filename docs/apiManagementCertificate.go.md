...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementcertificate"
...
&apimanagementcertificate.ApiManagementCertificateAConfig {
	...
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementCertificate.ApiManagementCertificateTimeouts,
}
```
