...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermprivatednsptrrecord"
...
&dataazurermprivatednsptrrecord.DataAzurermPrivateDnsPtrRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermPrivateDnsPtrRecord.DataAzurermPrivateDnsPtrRecordTimeouts,
}
```
