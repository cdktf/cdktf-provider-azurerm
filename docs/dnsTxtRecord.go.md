...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dnstxtrecord"
...
&dnstxtrecord.DnsTxtRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dnsTxtRecord.DnsTxtRecordTimeouts,
}
```
