...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/sentinelalertruleanomalyduplicate"
...
&sentinelalertruleanomalyduplicate.SentinelAlertRuleAnomalyDuplicateConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.sentinelAlertRuleAnomalyDuplicate.SentinelAlertRuleAnomalyDuplicateTimeouts,
}
```
