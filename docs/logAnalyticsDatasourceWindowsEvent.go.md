...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/loganalyticsdatasourcewindowsevent"
...
&loganalyticsdatasourcewindowsevent.LogAnalyticsDatasourceWindowsEventConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logAnalyticsDatasourceWindowsEvent.LogAnalyticsDatasourceWindowsEventTimeouts,
}
```
