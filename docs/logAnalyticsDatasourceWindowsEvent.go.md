...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/loganalyticsdatasourcewindowsevent"
...
&loganalyticsdatasourcewindowsevent.LogAnalyticsDatasourceWindowsEventConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.logAnalyticsDatasourceWindowsEvent.LogAnalyticsDatasourceWindowsEventTimeouts,
}
```
