...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/loganalyticsdatasourcewindowsevent"
...
&loganalyticsdatasourcewindowsevent.LogAnalyticsDatasourceWindowsEventConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.logAnalyticsDatasourceWindowsEvent.LogAnalyticsDatasourceWindowsEventTimeouts,
}
```
