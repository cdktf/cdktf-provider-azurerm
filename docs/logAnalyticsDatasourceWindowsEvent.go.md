...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/loganalyticsdatasourcewindowsevent"
...
&loganalyticsdatasourcewindowsevent.LogAnalyticsDatasourceWindowsEventConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.logAnalyticsDatasourceWindowsEvent.LogAnalyticsDatasourceWindowsEventTimeouts,
}
```
