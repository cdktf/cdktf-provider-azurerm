...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/storagesharedirectory"
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
