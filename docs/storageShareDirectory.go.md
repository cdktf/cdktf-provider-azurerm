...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storagesharedirectory"
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
