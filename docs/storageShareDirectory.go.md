...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/storagesharedirectory"
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
