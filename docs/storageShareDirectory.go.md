...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/storagesharedirectory"
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
