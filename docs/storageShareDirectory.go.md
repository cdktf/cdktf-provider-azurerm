...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagesharedirectory"
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
