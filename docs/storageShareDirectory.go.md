...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagesharedirectory"
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
