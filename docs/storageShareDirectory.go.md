...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14/storagesharedirectory"
...
| <code><a href="#@cdktf/provider-azurerm.storageShareDirectory.StorageShareDirectory.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func StorageShareUrlInput() *string
```
...
&storagesharedirectory.StorageShareDirectoryConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v14.storageShareDirectory.StorageShareDirectoryTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageShareDirectory.StorageShareDirectoryConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
