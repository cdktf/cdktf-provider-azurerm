...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/ipgroupcidr"
...
| <code><a href="#@cdktf/provider-azurerm.ipGroupCidr.IpGroupCidr.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&ipgroupcidr.IpGroupCidrConfig {
	...
	IpGroupId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.ipGroupCidr.IpGroupCidrTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.ipGroupCidr.IpGroupCidrConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
