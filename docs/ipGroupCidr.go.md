...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/ipgroupcidr"
...
&ipgroupcidr.IpGroupCidrConfig {
	...
	IpGroupId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.ipGroupCidr.IpGroupCidrTimeouts,
}
```
