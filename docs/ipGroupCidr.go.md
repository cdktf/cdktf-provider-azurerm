...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/ipgroupcidr"
...
&ipgroupcidr.IpGroupCidrConfig {
	...
	IpGroupId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.ipGroupCidr.IpGroupCidrTimeouts,
}
```
