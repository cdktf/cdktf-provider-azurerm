...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/ipgroupcidr"
...
&ipgroupcidr.IpGroupCidrConfig {
	...
	IpGroupId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.ipGroupCidr.IpGroupCidrTimeouts,
}
```
