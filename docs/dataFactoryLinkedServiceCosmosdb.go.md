...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorylinkedservicecosmosdb"
...
&datafactorylinkedservicecosmosdb.DataFactoryLinkedServiceCosmosdbConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryLinkedServiceCosmosdb.DataFactoryLinkedServiceCosmosdbTimeouts,
}
```
