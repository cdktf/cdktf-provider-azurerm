...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementproducttag"
...
&apimanagementproducttag.ApiManagementProductTagConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementProductTag.ApiManagementProductTagTimeouts,
}
```
