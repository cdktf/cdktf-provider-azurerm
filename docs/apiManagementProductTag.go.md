...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementproducttag"
...
&apimanagementproducttag.ApiManagementProductTagConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementProductTag.ApiManagementProductTagTimeouts,
}
```
