...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementproducttag"
...
&apimanagementproducttag.ApiManagementProductTagConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementProductTag.ApiManagementProductTagTimeouts,
}
```
