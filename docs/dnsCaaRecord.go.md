...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dnscaarecord"
...
&dnscaarecord.DnsCaaRecordConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dnsCaaRecord.DnsCaaRecordTimeouts,
}
```
