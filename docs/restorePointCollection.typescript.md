...
| <code><a href="#@cdktf/provider-azurerm.restorePointCollection.RestorePointCollectionConfig.property.tags">tags</a></code> | <code>{[ key: string ]: string}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.52.0/docs/resources/restore_point_collection#tags RestorePointCollection#tags}. |
