...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/apimanagementgatewayapi"
...
&apimanagementgatewayapi.ApiManagementGatewayApiConfig {
	...
	GatewayId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.apiManagementGatewayApi.ApiManagementGatewayApiTimeouts,
}
```
