...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.botChannelSlack.BotChannelSlackTimeouts,
}
```
