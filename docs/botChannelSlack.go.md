...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v12.botChannelSlack.BotChannelSlackTimeouts,
}
```
