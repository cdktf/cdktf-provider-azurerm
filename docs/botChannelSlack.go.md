...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v13.botChannelSlack.BotChannelSlackTimeouts,
}
```
