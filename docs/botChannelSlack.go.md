...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.botChannelSlack.BotChannelSlackTimeouts,
}
```
