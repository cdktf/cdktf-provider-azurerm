...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchannelslack"
...
&botchannelslack.BotChannelSlackConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelSlack.BotChannelSlackTimeouts,
}
```
