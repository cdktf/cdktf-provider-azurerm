...
| <code><a href="#@cdktf/provider-azurerm.devCenter.DevCenter.property.projectCatalogItemSyncEnabledInput">ProjectCatalogItemSyncEnabledInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-azurerm.devCenter.DevCenter.property.projectCatalogItemSyncEnabled">ProjectCatalogItemSyncEnabled</a></code> | <code>object</code> | *No description.* |
...
```csharp
public object ProjectCatalogItemSyncEnabledInput { get; }
```
...
```csharp
public object ProjectCatalogItemSyncEnabled { get; }
```
...
new DevCenterConfig {
    ...
    object ProjectCatalogItemSyncEnabled = null,
...
| <code><a href="#@cdktf/provider-azurerm.devCenter.DevCenterConfig.property.projectCatalogItemSyncEnabled">ProjectCatalogItemSyncEnabled</a></code> | <code>object</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/dev_center#project_catalog_item_sync_enabled DevCenter#project_catalog_item_sync_enabled}. |
| <code><a href="#@cdktf/provider-azurerm.devCenter.DevCenterConfig.property.tags">Tags</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/4.42.0/docs/resources/dev_center#tags DevCenter#tags}. |
...
```csharp
public object ProjectCatalogItemSyncEnabled { get; set; }
```
