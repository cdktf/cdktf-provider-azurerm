...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdnsnsrecord"
...
&dataazurermdnsnsrecord.DataAzurermDnsNsRecordConfig {
	...
	ZoneName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDnsNsRecord.DataAzurermDnsNsRecordTimeouts,
}
```
