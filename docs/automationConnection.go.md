...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/automationconnection"
...
&automationconnection.AutomationConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.automationConnection.AutomationConnectionTimeouts,
}
```
