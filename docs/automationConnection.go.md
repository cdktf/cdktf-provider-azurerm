...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/automationconnection"
...
&automationconnection.AutomationConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.automationConnection.AutomationConnectionTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.automationConnection.AutomationConnectionConfig.property.values">Values</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.57.0/docs/resources/automation_connection#values AutomationConnection#values}. |
