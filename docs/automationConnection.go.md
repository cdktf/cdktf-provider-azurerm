...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/automationconnection"
...
&automationconnection.AutomationConnectionConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.automationConnection.AutomationConnectionTimeouts,
}
```
