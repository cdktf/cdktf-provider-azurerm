...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermlbbackendaddresspool"
...
&dataazurermlbbackendaddresspool.DataAzurermLbBackendAddressPoolConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermLbBackendAddressPool.DataAzurermLbBackendAddressPoolTimeouts,
}
```
