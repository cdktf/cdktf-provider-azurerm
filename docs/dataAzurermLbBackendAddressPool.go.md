...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermlbbackendaddresspool"
...
&dataazurermlbbackendaddresspool.DataAzurermLbBackendAddressPoolConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermLbBackendAddressPool.DataAzurermLbBackendAddressPoolTimeouts,
}
```
