...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsharedimageversions"
...
&dataazurermsharedimageversions.DataAzurermSharedImageVersionsConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSharedImageVersions.DataAzurermSharedImageVersionsTimeouts,
}
```
