...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpublicmaintenanceconfigurations"
...
&dataazurermpublicmaintenanceconfigurations.DataAzurermPublicMaintenanceConfigurationsConfig {
	...
	RecurEvery: *string,
	Scope: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPublicMaintenanceConfigurations.DataAzurermPublicMaintenanceConfigurationsTimeouts,
}
```
