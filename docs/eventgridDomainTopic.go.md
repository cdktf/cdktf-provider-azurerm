...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/eventgriddomaintopic"
...
&eventgriddomaintopic.EventgridDomainTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.eventgridDomainTopic.EventgridDomainTopicTimeouts,
}
```
