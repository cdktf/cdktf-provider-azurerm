...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/eventgriddomaintopic"
...
&eventgriddomaintopic.EventgridDomainTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.eventgridDomainTopic.EventgridDomainTopicTimeouts,
}
```
