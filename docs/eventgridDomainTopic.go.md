...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/eventgriddomaintopic"
...
| <code><a href="#@cdktf/provider-azurerm.eventgridDomainTopic.EventgridDomainTopic.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&eventgriddomaintopic.EventgridDomainTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.eventgridDomainTopic.EventgridDomainTopicTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.eventgridDomainTopic.EventgridDomainTopicConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
