...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/eventgriddomaintopic"
...
&eventgriddomaintopic.EventgridDomainTopicConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.eventgridDomainTopic.EventgridDomainTopicTimeouts,
}
```
