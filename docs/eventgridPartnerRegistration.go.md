...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/eventgridpartnerregistration"
...
&eventgridpartnerregistration.EventgridPartnerRegistrationConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.eventgridPartnerRegistration.EventgridPartnerRegistrationTimeouts,
}
```
