...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermdiskencryptionset"
...
&dataazurermdiskencryptionset.DataAzurermDiskEncryptionSetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermDiskEncryptionSet.DataAzurermDiskEncryptionSetTimeouts,
}
```
