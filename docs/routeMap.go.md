...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/routemap"
...
| <code><a href="#@cdktf/provider-azurerm.routeMap.RouteMap.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&routemap.RouteMapConfig {
	...
	Id: *string,
	Rule: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.routeMap.RouteMapTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.routeMap.RouteMapConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
