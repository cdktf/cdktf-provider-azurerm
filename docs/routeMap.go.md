...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/routemap"
...
&routemap.RouteMapConfig {
	...
	Id: *string,
	Rule: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.routeMap.RouteMapTimeouts,
}
```
