...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/routemap"
...
&routemap.RouteMapConfig {
	...
	Id: *string,
	Rule: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.routeMap.RouteMapTimeouts,
}
```
