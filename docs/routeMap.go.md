...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/routemap"
...
&routemap.RouteMapConfig {
	...
	Id: *string,
	Rule: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.routeMap.RouteMapTimeouts,
}
```
