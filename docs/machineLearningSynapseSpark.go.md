...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/machinelearningsynapsespark"
...
&machinelearningsynapsespark.MachineLearningSynapseSparkConfig {
	...
	Description: *string,
	Id: *string,
	Identity: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.machineLearningSynapseSpark.MachineLearningSynapseSparkIdentity,
	LocalAuthEnabled: interface{},
	Tags: *map[string]*string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.machineLearningSynapseSpark.MachineLearningSynapseSparkTimeouts,
}
```
