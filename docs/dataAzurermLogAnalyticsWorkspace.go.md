...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermloganalyticsworkspace"
...
&dataazurermloganalyticsworkspace.DataAzurermLogAnalyticsWorkspaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermLogAnalyticsWorkspace.DataAzurermLogAnalyticsWorkspaceTimeouts,
}
```
