...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermmaintenanceconfiguration"
...
&dataazurermmaintenanceconfiguration.DataAzurermMaintenanceConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermMaintenanceConfiguration.DataAzurermMaintenanceConfigurationTimeouts,
}
```
