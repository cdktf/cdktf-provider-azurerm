...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermmaintenanceconfiguration"
...
&dataazurermmaintenanceconfiguration.DataAzurermMaintenanceConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermMaintenanceConfiguration.DataAzurermMaintenanceConfigurationTimeouts,
}
```
