...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermmaintenanceconfiguration"
...
&dataazurermmaintenanceconfiguration.DataAzurermMaintenanceConfigurationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermMaintenanceConfiguration.DataAzurermMaintenanceConfigurationTimeouts,
}
```
