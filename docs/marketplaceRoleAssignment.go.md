...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/marketplaceroleassignment"
...
&marketplaceroleassignment.MarketplaceRoleAssignmentConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.marketplaceRoleAssignment.MarketplaceRoleAssignmentTimeouts,
}
```
