...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermsnapshot"
...
&dataazurermsnapshot.DataAzurermSnapshotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermSnapshot.DataAzurermSnapshotTimeouts,
}
```
