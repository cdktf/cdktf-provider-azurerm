...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermsnapshot"
...
&dataazurermsnapshot.DataAzurermSnapshotConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermSnapshot.DataAzurermSnapshotTimeouts,
}
```
