...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermpostgresqlserver"
...
&dataazurermpostgresqlserver.DataAzurermPostgresqlServerConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPostgresqlServer.DataAzurermPostgresqlServerTimeouts,
}
```
