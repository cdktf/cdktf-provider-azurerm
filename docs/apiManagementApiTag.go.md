...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/apimanagementapitag"
...
&apimanagementapitag.ApiManagementApiTagConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.apiManagementApiTag.ApiManagementApiTagTimeouts,
}
```
