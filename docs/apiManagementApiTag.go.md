...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/apimanagementapitag"
...
&apimanagementapitag.ApiManagementApiTagConfig {
	...
	Name: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.apiManagementApiTag.ApiManagementApiTagTimeouts,
}
```
