...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/batchjob"
...
&batchjob.BatchJobConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.batchJob.BatchJobTimeouts,
}
```
