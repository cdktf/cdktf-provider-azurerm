...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/proximityplacementgroup"
...
&proximityplacementgroup.ProximityPlacementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.proximityPlacementGroup.ProximityPlacementGroupTimeouts,
	Zone: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.proximityPlacementGroup.ProximityPlacementGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.62.1/docs/resources/proximity_placement_group#tags ProximityPlacementGroup#tags}. |
