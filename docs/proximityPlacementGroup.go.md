...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/proximityplacementgroup"
...
&proximityplacementgroup.ProximityPlacementGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.proximityPlacementGroup.ProximityPlacementGroupTimeouts,
	Zone: *string,
}
```
