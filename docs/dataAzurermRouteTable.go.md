...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermroutetable"
...
&dataazurermroutetable.DataAzurermRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermRouteTable.DataAzurermRouteTableTimeouts,
}
```
