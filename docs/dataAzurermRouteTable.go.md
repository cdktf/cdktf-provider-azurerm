...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermroutetable"
...
&dataazurermroutetable.DataAzurermRouteTableConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermRouteTable.DataAzurermRouteTableTimeouts,
}
```
