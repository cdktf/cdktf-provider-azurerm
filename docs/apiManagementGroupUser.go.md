...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/apimanagementgroupuser"
...
&apimanagementgroupuser.ApiManagementGroupUserConfig {
	...
	UserId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.apiManagementGroupUser.ApiManagementGroupUserTimeouts,
}
```
