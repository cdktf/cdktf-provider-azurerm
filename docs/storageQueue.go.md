...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/storagequeue"
...
&storagequeue.StorageQueueConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.storageQueue.StorageQueueTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageQueue.StorageQueueConfig.property.metadata">Metadata</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.72.0/docs/resources/storage_queue#metadata StorageQueue#metadata}. |
