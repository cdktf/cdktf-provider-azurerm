...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchannelwebchat"
...
&botchannelwebchat.BotChannelWebChatConfig {
	...
	SiteNames: *[]*string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelWebChat.BotChannelWebChatTimeouts,
}
```
