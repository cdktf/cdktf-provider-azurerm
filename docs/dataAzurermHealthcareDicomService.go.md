...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermhealthcaredicomservice"
...
&dataazurermhealthcaredicomservice.DataAzurermHealthcareDicomServiceConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceTimeouts,
}
```
