...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermhealthcaredicomservice"
...
&dataazurermhealthcaredicomservice.DataAzurermHealthcareDicomServiceConfig {
	...
	WorkspaceId: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermHealthcareDicomService.DataAzurermHealthcareDicomServiceTimeouts,
}
```
