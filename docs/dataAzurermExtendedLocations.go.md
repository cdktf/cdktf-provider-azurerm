...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermextendedlocations"
...
&dataazurermextendedlocations.DataAzurermExtendedLocationsConfig {
	...
	Location: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermExtendedLocations.DataAzurermExtendedLocationsTimeouts,
}
```
