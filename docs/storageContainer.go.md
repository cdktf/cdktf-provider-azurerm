...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/storagecontainer"
...
&storagecontainer.StorageContainerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.storageContainer.StorageContainerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.storageContainer.StorageContainerConfig.property.metadata">Metadata</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.70.0/docs/resources/storage_container#metadata StorageContainer#metadata}. |
