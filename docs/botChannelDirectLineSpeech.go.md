...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/botchanneldirectlinespeech"
...
&botchanneldirectlinespeech.BotChannelDirectLineSpeechConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.botChannelDirectLineSpeech.BotChannelDirectLineSpeechTimeouts,
}
```
