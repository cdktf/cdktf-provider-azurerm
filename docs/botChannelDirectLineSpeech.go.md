...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/botchanneldirectlinespeech"
...
&botchanneldirectlinespeech.BotChannelDirectLineSpeechConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.botChannelDirectLineSpeech.BotChannelDirectLineSpeechTimeouts,
}
```
