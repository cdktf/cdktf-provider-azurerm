...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/botchanneldirectlinespeech"
...
&botchanneldirectlinespeech.BotChannelDirectLineSpeechConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.botChannelDirectLineSpeech.BotChannelDirectLineSpeechTimeouts,
}
```
