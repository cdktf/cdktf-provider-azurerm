...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/botchanneldirectlinespeech"
...
&botchanneldirectlinespeech.BotChannelDirectLineSpeechConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.botChannelDirectLineSpeech.BotChannelDirectLineSpeechTimeouts,
}
```
