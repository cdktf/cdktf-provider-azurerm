...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvirtualmachine"
...
&dataazurermvirtualmachine.DataAzurermVirtualMachineConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVirtualMachine.DataAzurermVirtualMachineTimeouts,
}
```
