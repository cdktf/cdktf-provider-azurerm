...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/applicationinsightswebtest"
...
&applicationinsightswebtest.ApplicationInsightsWebTestConfig {
	...
	Timeout: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.applicationInsightsWebTest.ApplicationInsightsWebTestTimeouts,
}
```
