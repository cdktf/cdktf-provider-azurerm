...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/dataazurermpublicips"
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermPublicIps.DataAzurermPublicIps.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&dataazurermpublicips.DataAzurermPublicIpsConfig {
	...
	Id: *string,
	NamePrefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.dataAzurermPublicIps.DataAzurermPublicIpsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.dataAzurermPublicIps.DataAzurermPublicIpsConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
