...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermpublicips"
...
&dataazurermpublicips.DataAzurermPublicIpsConfig {
	...
	Id: *string,
	NamePrefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermPublicIps.DataAzurermPublicIpsTimeouts,
}
```
