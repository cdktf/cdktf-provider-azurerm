...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermpublicips"
...
&dataazurermpublicips.DataAzurermPublicIpsConfig {
	...
	Id: *string,
	NamePrefix: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermPublicIps.DataAzurermPublicIpsTimeouts,
}
```
