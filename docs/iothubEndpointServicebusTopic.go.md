...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/iothubendpointservicebustopic"
...
&iothubendpointservicebustopic.IothubEndpointServicebusTopicConfig {
	...
	Id: *string,
	IdentityId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.iothubEndpointServicebusTopic.IothubEndpointServicebusTopicTimeouts,
}
```
