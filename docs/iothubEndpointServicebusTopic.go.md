...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/iothubendpointservicebustopic"
...
&iothubendpointservicebustopic.IothubEndpointServicebusTopicConfig {
	...
	Id: *string,
	IdentityId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.iothubEndpointServicebusTopic.IothubEndpointServicebusTopicTimeouts,
}
```
