...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/iothubendpointservicebustopic"
...
| <code><a href="#@cdktf/provider-azurerm.iothubEndpointServicebusTopic.IothubEndpointServicebusTopic.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&iothubendpointservicebustopic.IothubEndpointServicebusTopicConfig {
	...
	Id: *string,
	IdentityId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.iothubEndpointServicebusTopic.IothubEndpointServicebusTopicTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.iothubEndpointServicebusTopic.IothubEndpointServicebusTopicConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
