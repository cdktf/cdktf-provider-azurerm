...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/monitorprivatelinkscopedservice"
...
&monitorprivatelinkscopedservice.MonitorPrivateLinkScopedServiceConfig {
	...
	ScopeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.monitorPrivateLinkScopedService.MonitorPrivateLinkScopedServiceTimeouts,
}
```
