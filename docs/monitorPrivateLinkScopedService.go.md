...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/monitorprivatelinkscopedservice"
...
&monitorprivatelinkscopedservice.MonitorPrivateLinkScopedServiceConfig {
	...
	ScopeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.monitorPrivateLinkScopedService.MonitorPrivateLinkScopedServiceTimeouts,
}
```
