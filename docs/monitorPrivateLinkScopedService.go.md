...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/monitorprivatelinkscopedservice"
...
&monitorprivatelinkscopedservice.MonitorPrivateLinkScopedServiceConfig {
	...
	ScopeName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.monitorPrivateLinkScopedService.MonitorPrivateLinkScopedServiceTimeouts,
}
```
