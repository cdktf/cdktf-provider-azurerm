...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermprivatelinkservice"
...
&dataazurermprivatelinkservice.DataAzurermPrivateLinkServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermPrivateLinkService.DataAzurermPrivateLinkServiceTimeouts,
}
```
