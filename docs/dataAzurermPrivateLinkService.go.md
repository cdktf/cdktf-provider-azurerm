...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/dataazurermprivatelinkservice"
...
&dataazurermprivatelinkservice.DataAzurermPrivateLinkServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.dataAzurermPrivateLinkService.DataAzurermPrivateLinkServiceTimeouts,
}
```
