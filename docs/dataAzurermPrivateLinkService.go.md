...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermprivatelinkservice"
...
&dataazurermprivatelinkservice.DataAzurermPrivateLinkServiceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermPrivateLinkService.DataAzurermPrivateLinkServiceTimeouts,
}
```
