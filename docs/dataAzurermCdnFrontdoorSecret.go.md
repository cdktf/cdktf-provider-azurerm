...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermcdnfrontdoorsecret"
...
&dataazurermcdnfrontdoorsecret.DataAzurermCdnFrontdoorSecretConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermCdnFrontdoorSecret.DataAzurermCdnFrontdoorSecretTimeouts,
}
```
