...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/analysisservicesserver"
...
&analysisservicesserver.AnalysisServicesServerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.analysisServicesServer.AnalysisServicesServerTimeouts,
}
```
