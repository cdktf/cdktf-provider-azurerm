...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/analysisservicesserver"
...
&analysisservicesserver.AnalysisServicesServerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.analysisServicesServer.AnalysisServicesServerTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.analysisServicesServer.AnalysisServicesServerConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.61.0/docs/resources/analysis_services_server#tags AnalysisServicesServer#tags}. |
