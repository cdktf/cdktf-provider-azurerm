...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/servicebusnamespacedisasterrecoveryconfig"
...
&servicebusnamespacedisasterrecoveryconfig.ServicebusNamespaceDisasterRecoveryConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.servicebusNamespaceDisasterRecoveryConfig.ServicebusNamespaceDisasterRecoveryConfigTimeouts,
}
```
