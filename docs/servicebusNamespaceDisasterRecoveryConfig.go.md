...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/servicebusnamespacedisasterrecoveryconfig"
...
&servicebusnamespacedisasterrecoveryconfig.ServicebusNamespaceDisasterRecoveryConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.servicebusNamespaceDisasterRecoveryConfig.ServicebusNamespaceDisasterRecoveryConfigTimeouts,
}
```
