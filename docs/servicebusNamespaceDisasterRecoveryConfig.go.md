...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/servicebusnamespacedisasterrecoveryconfig"
...
&servicebusnamespacedisasterrecoveryconfig.ServicebusNamespaceDisasterRecoveryConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.servicebusNamespaceDisasterRecoveryConfig.ServicebusNamespaceDisasterRecoveryConfigTimeouts,
}
```
