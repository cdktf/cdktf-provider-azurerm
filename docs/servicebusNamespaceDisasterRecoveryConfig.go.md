...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/servicebusnamespacedisasterrecoveryconfig"
...
&servicebusnamespacedisasterrecoveryconfig.ServicebusNamespaceDisasterRecoveryConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.servicebusNamespaceDisasterRecoveryConfig.ServicebusNamespaceDisasterRecoveryConfigTimeouts,
}
```
