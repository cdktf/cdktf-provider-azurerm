...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/datafactorydatasetcosmosdbsqlapi"
...
&datafactorydatasetcosmosdbsqlapi.DataFactoryDatasetCosmosdbSqlapiConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiTimeouts,
}
```
