...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorydatasetcosmosdbsqlapi"
...
&datafactorydatasetcosmosdbsqlapi.DataFactoryDatasetCosmosdbSqlapiConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryDatasetCosmosdbSqlapi.DataFactoryDatasetCosmosdbSqlapiTimeouts,
}
```
