...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/apimanagementworkspace"
...
&apimanagementworkspace.ApiManagementWorkspaceConfig {
	...
	Description: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm.apiManagementWorkspace.ApiManagementWorkspaceTimeouts,
}
```
