...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/communicationservice"
...
&communicationservice.CommunicationServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.communicationService.CommunicationServiceTimeouts,
}
```
