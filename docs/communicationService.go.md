...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/communicationservice"
...
&communicationservice.CommunicationServiceConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.communicationService.CommunicationServiceTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.communicationService.CommunicationServiceConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.72.0/docs/resources/communication_service#tags CommunicationService#tags}. |
