...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/mapscreator"
...
&mapscreator.MapsCreatorConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.mapsCreator.MapsCreatorTimeouts,
}
```
