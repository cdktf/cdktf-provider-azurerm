...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mapscreator"
...
&mapscreator.MapsCreatorConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mapsCreator.MapsCreatorTimeouts,
}
```
