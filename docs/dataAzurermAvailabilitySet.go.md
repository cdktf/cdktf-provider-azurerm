...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermavailabilityset"
...
&dataazurermavailabilityset.DataAzurermAvailabilitySetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermAvailabilitySet.DataAzurermAvailabilitySetTimeouts,
}
```
