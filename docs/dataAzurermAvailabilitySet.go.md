...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermavailabilityset"
...
&dataazurermavailabilityset.DataAzurermAvailabilitySetConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermAvailabilitySet.DataAzurermAvailabilitySetTimeouts,
}
```
