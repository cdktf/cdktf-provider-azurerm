...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/cognitiveaccountcustomermanagedkey"
...
&cognitiveaccountcustomermanagedkey.CognitiveAccountCustomerManagedKeyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.cognitiveAccountCustomerManagedKey.CognitiveAccountCustomerManagedKeyTimeouts,
}
```
