...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/cognitiveaccountcustomermanagedkey"
...
&cognitiveaccountcustomermanagedkey.CognitiveAccountCustomerManagedKeyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.cognitiveAccountCustomerManagedKey.CognitiveAccountCustomerManagedKeyTimeouts,
}
```
