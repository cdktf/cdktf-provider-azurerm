...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/cognitiveaccountcustomermanagedkey"
...
&cognitiveaccountcustomermanagedkey.CognitiveAccountCustomerManagedKeyAConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.cognitiveAccountCustomerManagedKey.CognitiveAccountCustomerManagedKeyTimeouts,
}
```
