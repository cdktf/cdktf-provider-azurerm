...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/dataazurermvmwareprivatecloud"
...
&dataazurermvmwareprivatecloud.DataAzurermVmwarePrivateCloudConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.dataAzurermVmwarePrivateCloud.DataAzurermVmwarePrivateCloudTimeouts,
}
```
