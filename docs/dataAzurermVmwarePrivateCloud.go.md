...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermvmwareprivatecloud"
...
&dataazurermvmwareprivatecloud.DataAzurermVmwarePrivateCloudConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermVmwarePrivateCloud.DataAzurermVmwarePrivateCloudTimeouts,
}
```
