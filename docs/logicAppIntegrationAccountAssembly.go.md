...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/logicappintegrationaccountassembly"
...
&logicappintegrationaccountassembly.LogicAppIntegrationAccountAssemblyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.logicAppIntegrationAccountAssembly.LogicAppIntegrationAccountAssemblyTimeouts,
}
```
