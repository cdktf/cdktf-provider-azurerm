...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/natgatewaypublicipprefixassociation"
...
&natgatewaypublicipprefixassociation.NatGatewayPublicIpPrefixAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.natGatewayPublicIpPrefixAssociation.NatGatewayPublicIpPrefixAssociationTimeouts,
}
```
