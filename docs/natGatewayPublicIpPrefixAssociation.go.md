...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/natgatewaypublicipprefixassociation"
...
&natgatewaypublicipprefixassociation.NatGatewayPublicIpPrefixAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.natGatewayPublicIpPrefixAssociation.NatGatewayPublicIpPrefixAssociationTimeouts,
}
```
