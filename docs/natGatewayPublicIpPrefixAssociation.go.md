...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/natgatewaypublicipprefixassociation"
...
&natgatewaypublicipprefixassociation.NatGatewayPublicIpPrefixAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.natGatewayPublicIpPrefixAssociation.NatGatewayPublicIpPrefixAssociationTimeouts,
}
```
