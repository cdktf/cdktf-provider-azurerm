...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/natgatewaypublicipprefixassociation"
...
&natgatewaypublicipprefixassociation.NatGatewayPublicIpPrefixAssociationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.natGatewayPublicIpPrefixAssociation.NatGatewayPublicIpPrefixAssociationTimeouts,
}
```
