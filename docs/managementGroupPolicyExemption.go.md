...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/managementgrouppolicyexemption"
...
&managementgrouppolicyexemption.ManagementGroupPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.managementGroupPolicyExemption.ManagementGroupPolicyExemptionTimeouts,
}
```
