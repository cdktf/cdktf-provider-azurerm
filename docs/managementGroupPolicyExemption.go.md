...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/managementgrouppolicyexemption"
...
&managementgrouppolicyexemption.ManagementGroupPolicyExemptionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.managementGroupPolicyExemption.ManagementGroupPolicyExemptionTimeouts,
}
```
