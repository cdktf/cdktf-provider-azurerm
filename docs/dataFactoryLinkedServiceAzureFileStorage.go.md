...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/datafactorylinkedserviceazurefilestorage"
...
&datafactorylinkedserviceazurefilestorage.DataFactoryLinkedServiceAzureFileStorageConfig {
	...
	KeyVaultPassword: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryLinkedServiceAzureFileStorage.DataFactoryLinkedServiceAzureFileStorageKeyVaultPassword,
	Parameters: *map[string]*string,
	Password: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataFactoryLinkedServiceAzureFileStorage.DataFactoryLinkedServiceAzureFileStorageTimeouts,
	UserId: *string,
}
```
