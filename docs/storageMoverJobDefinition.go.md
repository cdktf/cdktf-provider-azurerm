...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagemoverjobdefinition"
...
&storagemoverjobdefinition.StorageMoverJobDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageMoverJobDefinition.StorageMoverJobDefinitionTimeouts,
}
```
