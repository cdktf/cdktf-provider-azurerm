...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagemoverjobdefinition"
...
&storagemoverjobdefinition.StorageMoverJobDefinitionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageMoverJobDefinition.StorageMoverJobDefinitionTimeouts,
}
```
