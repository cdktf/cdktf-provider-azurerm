...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/resourcegroup"
...
&resourcegroup.ResourceGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.resourceGroup.ResourceGroupTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.resourceGroup.ResourceGroupConfig.property.tags">Tags</a></code> | <code>*map[string]*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/azurerm/3.76.0/docs/resources/resource_group#tags ResourceGroup#tags}. |
