...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/resourcegroup"
...
&resourcegroup.ResourceGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.resourceGroup.ResourceGroupTimeouts,
}
```
