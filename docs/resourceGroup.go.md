...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/resourcegroup"
...
&resourcegroup.ResourceGroupConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.resourceGroup.ResourceGroupTimeouts,
}
```
