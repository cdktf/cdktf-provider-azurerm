...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/storagemoversourceendpoint"
...
&storagemoversourceendpoint.StorageMoverSourceEndpointConfig {
	...
	Id: *string,
	NfsVersion: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.storageMoverSourceEndpoint.StorageMoverSourceEndpointTimeouts,
}
```
