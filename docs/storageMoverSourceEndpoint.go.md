...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7/storagemoversourceendpoint"
...
&storagemoversourceendpoint.StorageMoverSourceEndpointConfig {
	...
	Id: *string,
	NfsVersion: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v7.storageMoverSourceEndpoint.StorageMoverSourceEndpointTimeouts,
}
```
