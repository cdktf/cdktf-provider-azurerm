...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/storagemoversourceendpoint"
...
&storagemoversourceendpoint.StorageMoverSourceEndpointConfig {
	...
	Id: *string,
	NfsVersion: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.storageMoverSourceEndpoint.StorageMoverSourceEndpointTimeouts,
}
```
