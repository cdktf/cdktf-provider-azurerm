...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/sentineldataconnectoriot"
...
&sentineldataconnectoriot.SentinelDataConnectorIotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.sentinelDataConnectorIot.SentinelDataConnectorIotTimeouts,
}
```
