...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/sentineldataconnectoriot"
...
&sentineldataconnectoriot.SentinelDataConnectorIotConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.sentinelDataConnectorIot.SentinelDataConnectorIotTimeouts,
}
```
