...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/mariadbfirewallrule"
...
&mariadbfirewallrule.MariadbFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.mariadbFirewallRule.MariadbFirewallRuleTimeouts,
}
```
