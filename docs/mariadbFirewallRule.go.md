...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/mariadbfirewallrule"
...
&mariadbfirewallrule.MariadbFirewallRuleConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.mariadbFirewallRule.MariadbFirewallRuleTimeouts,
}
```
