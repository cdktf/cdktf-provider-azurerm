...
```typescript
public readonly timeoutsInput: SiteRecoveryHypervNetworkMappingTimeouts | IResolvable;
```

- *Type:* <a href="#@cdktf/provider-azurerm.siteRecoveryHypervNetworkMapping.SiteRecoveryHypervNetworkMappingTimeouts">SiteRecoveryHypervNetworkMappingTimeouts</a> | cdktf.IResolvable
...
```typescript
public readonly internalValue: SiteRecoveryHypervNetworkMappingTimeouts | IResolvable;
```
