...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10/vpngatewaynatrule"
...
&vpngatewaynatrule.VpnGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v10.vpnGatewayNatRule.VpnGatewayNatRuleTimeouts,
	Type: *string,
}
```
