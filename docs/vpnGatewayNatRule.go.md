...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/vpngatewaynatrule"
...
&vpngatewaynatrule.VpnGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.vpnGatewayNatRule.VpnGatewayNatRuleTimeouts,
	Type: *string,
}
```
