...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/vpngatewaynatrule"
...
&vpngatewaynatrule.VpnGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.vpnGatewayNatRule.VpnGatewayNatRuleTimeouts,
	Type: *string,
}
```
