...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9/vpngatewaynatrule"
...
&vpngatewaynatrule.VpnGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v9.vpnGatewayNatRule.VpnGatewayNatRuleTimeouts,
	Type: *string,
}
```
