...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6/vpngatewaynatrule"
...
| <code><a href="#@cdktf/provider-azurerm.vpnGatewayNatRule.VpnGatewayNatRule.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&vpngatewaynatrule.VpnGatewayNatRuleConfig {
	...
	Mode: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v6.vpnGatewayNatRule.VpnGatewayNatRuleTimeouts,
	Type: *string,
}
```
...
| <code><a href="#@cdktf/provider-azurerm.vpnGatewayNatRule.VpnGatewayNatRuleConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
