...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8/dataazurermeventhubnamespace"
...
&dataazurermeventhubnamespace.DataAzurermEventhubNamespaceConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v8.dataAzurermEventhubNamespace.DataAzurermEventhubNamespaceTimeouts,
}
```
