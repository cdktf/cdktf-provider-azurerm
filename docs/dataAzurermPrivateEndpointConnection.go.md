...
```go
import "github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5/dataazurermprivateendpointconnection"
...
&dataazurermprivateendpointconnection.DataAzurermPrivateEndpointConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-azurerm-go/azurerm/v5.dataAzurermPrivateEndpointConnection.DataAzurermPrivateEndpointConnectionTimeouts,
}
```
